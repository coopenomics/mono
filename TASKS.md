...
- [ ] Рефакторинг по чистой архитектуре (по аналогии с capital)
- [ ] Исправить процесс: решение совета перед получением, а не перед поставкой (одно заявление вместо двух)
- [ ] Накопительный характер заявок (порог запуска поставки)
- [ ] Ядро клиринга — стандартизированные действия, расширяемые контракты поставок
- [ ] Путь «имущество уже в кооперативе» — возврат без взноса
- [ ] Гарантийный возврат — обратный процесс с документами
- [ ] Уничтожение/перепредложение просроченного имущества
- [ ] Обратное направление: заказчик публикует запрос → поставщики откликаются
- [ ] Система перевозок (Shipment) — групповые перевозки с 4 этапами
...
- [ ] Стол заказов: витрина предложений
- [ ] Стол заказов: карточка заявки с документооборотом
- [ ] Стол заказов: процесс поставки (timeline/stepper)
- [ ] Стол заказов: управление перевозками
- [ ] Стол заказов: гарантийный возврат с чатом/спором
- [ ] Стол заказов: панель председателя КУ (склад, выдача)
