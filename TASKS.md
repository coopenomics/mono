...
- [ ] Накопительный характер заявок (min_units threshold)
- [ ] Уничтожение/перепредложение просроченного имущества (destroy/reoffer)
- [ ] Система перевозок — уже реализована (shipment/)
- [ ] Гарантийный возврат — уже реализован частично (dispute_on_offer/)
