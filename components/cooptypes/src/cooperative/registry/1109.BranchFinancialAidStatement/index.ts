...
export const translations = {
  ru: {
    ...
    tax_note: 'Уведомлён(а), что кооператив как налоговый агент удерживает из указанной суммы налог на доходы физических лиц и перечисляет мне сумму за вычетом налога.',
