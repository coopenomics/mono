...
/**
 * Шаблон оферты преподавателя ЦПП «Образование» для утверждения Советом.
...
export const description = 'Шаблон оферты преподавателя по ЦПП «ОБРАЗОВАНИЕ» для утверждения Советом'
