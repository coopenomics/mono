...
export const translations = {
  ru: {
    ...
    return_through_digital_wallet: 'Возврат Паевого взноса Пайщику по результатам участия в хозяйственной деятельности Общества в рамках настоящего Договора производится через начисление на ЦК Пайщика с указанием назначения платежа «Возврат Паевого взноса в соответствии с Договором об участии в хозяйственной деятельности № {0}», номера и даты настоящего Договора.',
