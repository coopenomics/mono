...
export const translations = {
  ru: {
    ...
    quorum_description: 'В заседании участвуют {0} из {1} членов Совета ({2}%)',
