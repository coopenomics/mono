...
export const translations = {
  ru: {
    ...
    decision_aid_text: 'Выплатить материальную помощь в размере {0} пайщику {1} с расчётного счёта кооператива на указанные им реквизиты, списав сумму с персонального кошелька членских средств получателя по кооперативному участку «{2}». Налог на доходы физических лиц с полученной суммы получатель оплачивает самостоятельно; кооператив налоговым агентом не выступает.',
  },
}
