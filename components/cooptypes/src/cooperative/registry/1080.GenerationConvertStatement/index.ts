...
export const title = 'Заявление о конвертации целевого паевого взноса'
export const description = 'Форма заявления о конвертации целевого паевого взноса в цифровой кошелёк и/или программу «Благорост»'
