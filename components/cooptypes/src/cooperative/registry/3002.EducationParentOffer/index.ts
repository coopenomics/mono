...
/**
 * Экземпляр оферты родителя-слушателя ЦПП «Образование» для конкретного пайщика
 * (рендерится из шаблона 3001.EducationParentOfferTemplate с подстановкой ФИО). Подписывает пайщик.
...
export const description = 'Оферта родителя-слушателя по ЦПП «ОБРАЗОВАНИЕ» для пайщика по утверждённому шаблону'
...
export const translations = {
  ru: {
    ...
    c1_2: '<strong>1.2.</strong> Пайщик получает доступ к курсам ЦПП для себя либо для несовершеннолетнего, законным представителем которого он является, на оплаченный период подписки. Подписанием настоящего соглашения пайщик даёт согласие на передачу адреса электронной почты обучающегося образовательной площадке для организации доступа к курсу.',
    c2: '2. Взносы',
