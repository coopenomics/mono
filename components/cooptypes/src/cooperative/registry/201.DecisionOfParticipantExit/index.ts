...
export const translations = {
  ru: {
    ...
    decision_leavecoop1: 'Рассмотреть заявление о выходе и заявление об аннулировании соглашений об участии в целевых потребительских программах',
    decision_leavecoop2: 'Вывести из состава пайщиков, аннулировать соглашения об участии в целевых потребительских программах и вернуть паевые взносы вместе с остатками кошельков программ, возвратными по их Положениям,',
