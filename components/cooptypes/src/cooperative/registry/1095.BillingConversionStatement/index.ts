 ...
 * программе «Цифровой Кошелек» в членский взнос по соглашению о подключении
 ...
 * канон реестра. Членский взнос зачисляется на биллинг-кошелёк, с которого
 * оплачиваются подписки; сам факт трансляции трактуется как согласие на
...
export const translations = {
  ru: {
    ...
    convert_request_text: 'Прошу транслировать мой паевой взнос по программе "Цифровой Кошелек" в сумме {0} в членский взнос по соглашению о подключении. Подтверждаю своё согласие на последующие списания членских взносов в счёт оплаты подписок.',
