...
export const translations = {
  ru: {
    ...
    contribution: 'Для покрытия затрат, связанных с получением вышеуказанного имущества, Пайщик внес паевой взнос в размере {0} {1}. Пайщик, в соответствии с соглашением новации, получил от Кооператива имущество в достаточном для Пайщика качестве и количестве. Пайщик претензий к Кооперативу не имеет.',
