...
/**
 * Интерфейс генерации договора о материальной ответственности доверенного лица
 * кооперативного участка. Текст полностью
...
export const title = 'Договор о материальной ответственности доверенного лица кооперативного участка'
export const description = 'Форма договора о материальной ответственности доверенного лица кооперативного участка между кооперативом в лице Председателя кооперативного участка и доверенным лицом'
