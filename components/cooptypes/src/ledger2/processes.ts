...
export const LEDGER2_PROCESS_REGISTRY: readonly ProcessMeta[] = [
  ...
  // marketplace
  { type: 'p.mkt.supply',   contract: 'marketplace',  name: 'SUPPLY',      human_name: 'Прямая поставка и приобретение имущества пайщиком' },
  ...
  { type: 'p.brn.fees',     contract: 'branch',       name: 'FEES',        human_name: 'Распределение членских взносов кооперативного участка' },
