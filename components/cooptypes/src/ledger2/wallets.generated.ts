...
export const LEDGER2_WALLET_REGISTRY: readonly WalletMeta[] = [
  ...
  { name: "w.mkt.morder", human_name: "ЦПП «Стол Заказов» — членский резерв под заказ у пайщика", kind: "USER_SHARED" },
...
export const LEDGER2_USER_SHARED_PROGRAM_MAPPING: readonly ProgramWalletMapping[] = [
  ...
  { wallet_name: "w.mkt.morder", required_program_id: 2, program_label: "Marketplace" },
