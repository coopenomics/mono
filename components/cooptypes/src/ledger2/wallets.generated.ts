...
export const LEDGER2_WALLET_REGISTRY: readonly WalletMeta[] = [
  ...
  { name: "w.mkt.claim", human_name: "ЦПП «Стол Заказов» — гарантийные претензии поставщику, ожидающие ответа", kind: "USER_SHARED" },
  { name: "w.mkt.debt", human_name: "ЦПП «Стол Заказов» — признанный гарантийный долг поставщика к удержанию", kind: "USER_SHARED" },
  { name: "w.mkt.refuse", human_name: "ЦПП «Стол Заказов» — отказанные поставщиком гарантийные претензии", kind: "USER_SHARED" },
...
export const LEDGER2_USER_SHARED_PROGRAM_MAPPING: readonly ProgramWalletMapping[] = [
  ...
  { wallet_name: "w.mkt.refuse", required_program_id: 0, program_label: null },
