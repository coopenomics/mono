 ...
 * паевого «Стола заказов»: членский кошелёк первым (o.mkt.fee, o.mkt.lockm), остаток
 * тела — o.mkt.lockp; недостающее переведено заранее действием convert (o.mkt.convp).
 */
