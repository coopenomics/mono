 ...
 * аккаунта с ключом робота, типы решений, по которым робот голосует сразу, типы, по которым робот
 * повторяет голос другого члена совета (пара «тип → за кем»), и (для председателя) типы решений,
 * протоколы которых робот подписывает. Одна запись на члена совета, повторный вызов заменяет настройки.
 */
