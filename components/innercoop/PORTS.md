...
| `CHAIN_CHANGES_PORT` | `IChainChangesPort` (4)<br><sub>core-ports/chain-changes.port.ts</sub> | `ChainChangesService` | capital*, cardcoop*, chairman*, expenses*, marketplace*, reports*, soviet-robot* | Лента изменений цепи — сигнал столу «эти данные изменились, перечитай». |
