...
| `MEMBER_EXIT_REGISTRY_PORT` | `IMemberExitRegistryPort` (2)<br><sub>core-ports/member-exit.port.ts</sub> | `MemberExitRegistryService` | — | Выход пайщика из кооператива глазами расширения. |
