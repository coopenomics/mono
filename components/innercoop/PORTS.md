...
| `CHAIN_PORT` | `IChainPort` (4)<br><sub>core-ports/chain.port.ts</sub> | `ChainInnercoopAdapter` | capital, cardcoop, chairman, expenses, ku, marketplace, reports | Проводка действий в цепь и чтение её таблиц. |
