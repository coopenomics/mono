...
| `CHAIN_CHANGES_PORT` | `IChainChangesPort` (1)<br><sub>core-ports/chain-changes.port.ts</sub> | `ChainChangesService` | capital* | Лента изменений цепи — сигнал столу «эти данные изменились, перечитай». |
