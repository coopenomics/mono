...
export const name = 'generateCooperativeInvestDecisionDocument'

// Селектор мутации
export const mutation = Selector('Mutation')({
  [name]: [
    {
      data: $('data', 'CooperativeInvestDecisionGenerateDocumentInput!'),
...
export interface IInput {
  data: ModelTypes['CooperativeInvestDecisionGenerateDocumentInput']
