...
Однако, в дальнейшем, при введении функционала "карты кооператора", которая сделает допустимым "быстрый вход" для пайщиков одного кооператива - в другой, система замены ключа будет требовать подтверждения нескольких кооперативов.
...
/** Сохранить собственные паспортные данные в реестре пайщиков. Только если паспорт ранее не был указан; существующие данные не перезаписываются. */
export * as SaveMyPassport from './saveMyPassport'
