...
Нам всегда известно какое действие является закрывающим для пакета документов, и именно на основе этого действия формируются наборы данных, которые содержат в себе необходимую информацию для совершения бухгалтерских проводок. 
