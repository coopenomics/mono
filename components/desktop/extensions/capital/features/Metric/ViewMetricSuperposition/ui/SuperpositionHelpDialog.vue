  ...
  .sp-help
    ...
    .sp-help__step
      ...
      .sp-help__step-body
        ...
        ul.sp-help__list
          ...
          li
            strong Центр
            |  — сводка: суперпозиция и три составляющие. Наведите курсор.
    ...
    .sp-help__step
      ...
      .sp-help__step-body
        ...
        p.sp-help__p
          | В одном ряду четыре показателя: баланс, рост, движение и выделенная
          strong  суперпозиция
          | — единый процент резонанса от 0 до 100.
        ul.sp-help__list
          li
            strong Движение
          ...
          li
            strong Суперпозиция
            |  — сводный резонанс из баланса, роста и движения.
