  ...
  .row.q-col-gutter-md
    ...
    .col-12.col-lg-8
      BaseCard(variant="default" title="Подписки и доступ")
        BaseTable(v-if="loadingEnrollments || enrollments.length" :columns="columns" :rows="enrollments" row-key="id" :loading="loadingEnrollments && !enrollments.length" min-width="900px")
