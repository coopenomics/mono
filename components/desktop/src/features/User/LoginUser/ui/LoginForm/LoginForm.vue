<template>
  <BaseForm :loading="loading" :error="errorMessage" @submit="submit">
    ...
    <template v-if="mode === 'login'">
      ...
      <!-- Вход по карте пайщика (карта пайщика, story 9.2): карта опознаёт человека и ведёт
...
// Вход по карте пайщика (story 9.2). Доступность спрашивается один раз при открытии формы:
