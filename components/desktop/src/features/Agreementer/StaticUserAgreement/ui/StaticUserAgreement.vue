 ...
 */
// realtime: нет источника — гостевая страница с текстом соглашения: лента доступна только вошедшему пайщику, текст утверждённой редакции читается при открытии.
onMounted(async () => {
  if (isPending.value) {
