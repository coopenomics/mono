...
.profile-page(v-if='currentProfile')
  ...
  BaseCard(title='Удостоверение пайщика')
    .cert
      ...
      .cert__main
        //- Фотография стоит на месте инициалов, там же её и меняют: наведение на
        //- кружок открывает загрузку. Снимок один на пайщика — заменённый на
        //- столе расширения виден и тут.
