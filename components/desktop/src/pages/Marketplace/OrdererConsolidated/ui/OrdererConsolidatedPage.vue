...
q-page.collective(role="region", aria-label="Коллективный заказ")
  ...
  .collective__col
    ...
    EmptyState(
      ...
      body="Здесь отображаются коллективные заказы на этапе сбора и подготовки поставки. После того как партия передана на выдачу, заказ переходит в раздел «Мои заказы»."
    )
      template(#icon)
