...
const STATUS_LABEL: Record<MarketplaceOrderStatusView, string> = {
  ACTIVE: 'Активен (ждёт цикла)',
  ACCEPTED_PENDING_SUPPLIER: 'Ждёт акцепта поставщиком',
  ACCEPTED_PENDING_SUPPLIER_INDIVIDUAL: 'Ждёт акцепта (индивид.)',
  ACCEPTED: 'Принят',
  SUPPLY_PREPARED: 'Поставка готова',
  ACCEPTED_TO_COOP: 'Принят кооперативом',
  READY_TO_RECEIVE: 'Готов к выдаче',
  RECEIVED: 'Получен',
  RETURNED: 'Возвращён',
  CANCELLED_BY_ORDERER: 'Отменён заказчиком',
  CANCELLED_BY_SUPPLIER: 'Отменён',
