...
.q-pa-md
  ...
  EmptyState(
    v-else,
    title='Вы не привязаны к кооперативному участку',
    body='Здесь появится ваш участок после того, как вы выберете его для участия в общих собраниях или будете избраны его председателем. Участки кооператива — на вкладке «Кооперативные участки», учреждение нового — на вкладке «Собрания».'
  )
    template(#icon)
