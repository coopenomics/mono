...
// Lifecycle хуки
// realtime: нет источника — подключение к союзу ведёт сервер провайдера (другой узел), в ленте кооператива его нет; статус установки обновляется опросом провайдера (startInstanceAutoRefresh).
onMounted(() => {
