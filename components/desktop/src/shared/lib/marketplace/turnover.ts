 ...
 *     получения заказчиком и целевой членский взнос).
...
export interface TurnoverRow {
  ...
  issuedUnits: number;
  issuedAmount: number;
  /** Целевой членский взнос с выданного — доход участка выдачи. */
  feeAmount: number;
}
...
/** Выдача: что и на какую сумму получили пайщики за период, и целевой членский взнос с этого. */
function addOrders(
  map: Map<string, TurnoverRow>,
