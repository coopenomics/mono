...
export default {
  ...
  accounts: [
    ...
    {
      // Корень цепочки доверия. Ключами АНО не владеет ни одна установка: право
      // подписывать за неё передано оператору по имени и отбирается одной
      // транзакцией. Лежи ключ у оператора на диске — корень ничем не отличался
      // бы от обычного кооператива.
      name: 'ano',
      delegate_active_to: provider,
    },
    // {
