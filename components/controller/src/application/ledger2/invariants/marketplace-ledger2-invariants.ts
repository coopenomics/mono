...
//   только членские средства — перевод по заявлению 1110 (o.mkt.conv /
//   o.mkt.convp Кт 86), удержание при отказе (o.mkt.penal Кт 86), выдача в
//   счёт членского резерва (o.mkt.consm Дт 86) и её гарантийный возврат
//   (o.mkt.retm Кт 86); взнос под заказ, членский резерв и их сторно
//   (o.mkt.fee / o.mkt.refund / o.mkt.lockm / o.mkt.unlkm / o.mkt.penalm) идут
//   внутри 86 без проводки — и списание скоропорта (o.mkt.wroff Дт 86). Приём имущества идёт Дт 10 / Кт 60,
