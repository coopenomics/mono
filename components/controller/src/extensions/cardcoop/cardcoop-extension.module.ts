/**
 * Расширение «Карта кооператора» — сторона кооператива в сети card.coop.
 *
 * Что оно делает: по факту установления связи пайщика с картой формирует
 ...
 *
 * `api_url` — адрес узла сети «Карта кооператора». Он одинаков для всех
