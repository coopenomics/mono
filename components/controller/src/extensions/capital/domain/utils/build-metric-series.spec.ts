...
describe('buildMetricSeries (562-34 stage 2)', () => {
  ...
  it('на границе бакета не добавляет пустой следующий период', () => {
    const points = buildMetricSeries(
  ...
  it('учитывает вклады до окна в стартовом cumulative', () => {
    const points = buildMetricSeries(
      ...
      ],
      {
        ...
        to: new Date('2026-07-13T00:00:00Z'), // конец недели 6–12
        target_value: 20,
      }
    );
  ...
  it('агрегирует по минутам', () => {
    const points = buildMetricSeries(
      ...
      ],
      {
        ...
        to: new Date('2026-07-27T12:03:00Z'),
        target_value: 10,
      }
    );
  ...
  it('агрегирует по 5-минутным бакетам', () => {
    const points = buildMetricSeries(
      ...
      ],
      {
        ...
        to: new Date('2026-07-27T12:10:00Z'),
        target_value: 20,
      }
    );
