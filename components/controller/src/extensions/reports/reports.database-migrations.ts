import { ReportsBaseline1790197276759 } from './migrations/database/1790197276759-baseline';
 ...
 */
export const reportsDatabaseMigrations = [ReportsBaseline1790197276759];
