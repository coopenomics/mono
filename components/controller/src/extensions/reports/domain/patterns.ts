...
// (3-3-6, 12 цифр с тире). Отдельное поле от sfrRegNumber (10-значный
// унифицированный номер СФР) — эти два номера нужны в разных местах и
// подменять одно другим наугад не стоит: в ЕФС-1 СберКорус принимает
// именно номер ПФР, другие операторы — номер СФР. Подробности в
// fss4.generator.ts у тега ЕФС8:РегНомер.
