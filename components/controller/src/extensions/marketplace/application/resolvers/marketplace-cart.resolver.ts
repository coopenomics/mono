...
export class MarketplaceCartResolver {
  ...
  @Query(() => MarketplaceCheckoutPreviewDTO, {
    ...
    description:
      'Превью оформления: по каждой позиции корзины — идентификатор будущего заказа и суммы по частям (членский взнос ' +
      'участка покрывается остатком внутреннего членского кошелька «Стола заказов», нехватка — переводом по заявлению; тело ' +
      'всегда с паевого) и заявление 1110 о переводе с Цифрового кошелька в программу на тело и недостающую часть взноса — ' +
