...
export class Generator implements IGenerator {
  ...
  async connect(mongoUri: string): Promise<void> {
    ...
    this.factories = {
      ...
      [Actions.ProgramAgreementsAnnulmentStatement.Template.registry_id]: new Actions.ProgramAgreementsAnnulmentStatement.Factory(this.storage), // 190
      ...
      [Actions.EducationReturnStatement.Template.registry_id]: new Actions.EducationReturnStatement.Factory(this.storage), // 3013 — заявление о возврате членского взноса программы в паевой
