...
namespace processes {
  ...
  namespace capital {
    ...
    inline constexpr eosio::name DEBT      = "p.cap.debt"_n;     ///< Займ пайщику (o.cap.lend + o.cap.repay; альтернативная ветка невозврата — o.cap.dflt + o.cap.lnwoff, решение 2026-05-19).
