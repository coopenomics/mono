 ...
 * в программу Благорост): commit → Dr 08 / Cr 76, accept → Dr 04 / Cr 08,
 * признание паевого взноса на акте-2 → Dr 76 / Cr 80 (пересмотр 2026-09-20:
 * до заявления пайщика и решения совета результат лежит на ответственном
 * хранении, поэтому коммит кредитует расчёты, а не паевой фонд).
 * Тем же путём идут материалы занятия в ЦПП «Образование» (o.edu.hold).
 *
 * Состав (10 счетов):
 *
