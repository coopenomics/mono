 ...
 * Получатель сам подписывает заявление и сам платит НДФЛ с полученной суммы —
 * кооператив налог не удерживает и налоговым агентом не выступает (решение
 * владельца 2026-06-10).
 *
 ...
 * Списание o.brn.aid (Дт 86 / Кт 51) выполняется ещё позже — в `aidconfirm`,
 * после фактического банковского перевода кассиром.
 *
