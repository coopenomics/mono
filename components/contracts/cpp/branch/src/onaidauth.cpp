 ...
 *
 * Само списание o.brn.aid (Дт 86 / Кт 51) произойдёт ещё позже — в callback'е
 * `aidconfirm`, после фактического банковского перевода кассиром.
 *
 * Guards:
...
[[eosio::action]] void branch::onaidauth(eosio::name coopname,
  ...
  Gateway::create_outcome(_branch, coopname, it->username, it->hash, it->amount,
