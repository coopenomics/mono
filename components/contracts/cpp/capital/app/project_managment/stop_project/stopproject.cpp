...
void capital::stopproject(name coopname, checksum256 project_hash) {
    ...
    // Возвращаем неизрасходованные средства в программу: пока проект стоит,
    // деньги не должны быть заперты в нём. Если работы возобновят, средства
    // аллоцируют заново. Повторный возврат ничего не отдаст — возвращённое
    // списано с пулов проекта.
