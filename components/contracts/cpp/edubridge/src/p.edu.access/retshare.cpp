 ...
 *
 * Заявление о прекращении участия подписывает пайщик, кооператив согласует его
 * и до этого действия закрывает все подписки пайщика с возвратом по Положению.
...
void edubridge::retshare(eosio::name coopname,
  ...
  eosio::check(!is_empty_document(statement),
               "Отсутствует заявление о прекращении участия в программе");
