...
void registrator::confirmpay(name coopname, checksum256 registration_hash){
  ...
  Ledger2::apply(_registrator, coopname, operations::registrator::RECEIVE_PAYMENT, processes::registrator::ACCEPT, registration_quantity, candidate -> username, registration_hash, memo);
