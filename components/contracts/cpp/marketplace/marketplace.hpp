...
public:
   ...
   * Паевая модель: членский взнос участка — с внутреннего членского кошелька
   * w.mkt.member (o.mkt.fee; членские средства от отмен и возвратов идут
   * только на взносы следующих заказов), тело заказа — паевой резерв
   * o.mkt.lock (w.wal.share → w.mkt.order, без проводки). Заявления здесь
   * нет: недостающую часть взноса пайщик заранее перевёл действием `convert`
   * по заявлению 1110; кошелька обязано хватать на взнос целиком.
   ...
   * гарантийные возвраты): взнос с членского кошелька (o.mkt.fee), тело —
   * o.mkt.lockp (w.mkt.share → w.mkt.order). Недостающую часть взноса пайщик
   * заранее перевёл действием `convert` (o.mkt.convp); при нехватке
