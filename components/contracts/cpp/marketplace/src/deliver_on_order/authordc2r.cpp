...
\brief Авторизация сегмента "c2r" для направления deliver_on_order (authordc2r).
...
*/
[[eosio::action]] void marketplace::authordc2r(eosio::name coopname, checksum256 request_hash, document2 authorization) {
  ...
  eosio::check(change.type == "offer"_n, "Метод authordc2r применим только к заявкам типа offer");
