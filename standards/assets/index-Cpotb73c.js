const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-8onw1bhO.js","assets/HomePage-BsofTH-U.css","assets/ProcessPage-b4bx9n77.js","assets/ProcessPage-C7c8Hala.css"])))=>i.map(i=>d[i]);
...
* @license MIT
**/function Qi(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const re={},rn=[],lt=()=>{},Ho=()=>!1,Ps=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Ls=e=>e.startsWith("onUpdate:"),Ee=Object.assign,Xi=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},sl=Object.prototype.hasOwnProperty,X=(e,t)=>sl.call(e,t),K=Array.isArray,on=e=>Xn(e)==="[object Map]",Vo=e=>Xn(e)==="[object Set]",Mr=e=>Xn(e)==="[object Date]",V=e=>typeof e=="function",fe=e=>typeof e=="string",Ke=e=>typeof e=="symbol",Z=e=>e!==null&&typeof e=="object",qo=e=>(Z(e)||V(e))&&V(e.then)&&V(e.catch),Go=Object.prototype.toString,Xn=e=>Go.call(e),il=e=>Xn(e).slice(8,-1),zo=e=>Xn(e)==="[object Object]",Ds=e=>fe(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Cn=Qi(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ms=e=>{const t=Object.create(null);return(n=>t[n]||(t[n]=e(n)))},rl=/-\w/g,Me=Ms(e=>e.replace(rl,t=>t.slice(1).toUpperCase())),ol=/\B([A-Z])/g,qt=Ms(e=>e.replace(ol,"-$1").toLowerCase()),xs=Ms(e=>e.charAt(0).toUpperCase()+e.slice(1)),oi=Ms(e=>e?`on${xs(e)}`:""),Ye=(e,t)=>!Object.is(e,t),ai=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},Yo=(e,t,n,s=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:s,value:n})},al=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let xr;const $s=()=>xr||(xr=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Zi(e){if(K(e)){const t={};for(let n=0;n<e.length;n++){const s=e[n],i=fe(s)?fl(s):Zi(s);if(i)for(const r in i)t[r]=i[r]}return t}else if(fe(e)||Z(e))return e}const cl=/;(?![^(]*\))/g,ll=/:([^]+)/,ul=/\/\*[^]*?\*\//g;function fl(e){const t={};return e.replace(ul,"").split(cl).forEach(n=>{if(n){const s=n.split(ll);s.length>1&&(t[s[0].trim()]=s[1].trim())}}),t}function Fs(e){let t="";if(fe(e))t=e;else if(K(e))for(let n=0;n<e.length;n++){const s=Fs(e[n]);s&&(t+=s+" ")}else if(Z(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const pl="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",dl=Qi(pl);function Wo(e){return!!e||e===""}function hl(e,t){if(e.length!==t.length)return!1;let n=!0;for(let s=0;n&&s<e.length;s++)n=er(e[s],t[s]);return n}function er(e,t){if(e===t)return!0;let n=Mr(e),s=Mr(t);if(n||s)return n&&s?e.getTime()===t.getTime():!1;if(n=Ke(e),s=Ke(t),n||s)return e===t;if(n=K(e),s=K(t),n||s)return n&&s?hl(e,t):!1;if(n=Z(e),s=Z(t),n||s){if(!n||!s)return!1;const i=Object.keys(e).length,r=Object.keys(t).length;if(i!==r)return!1;for(const o in e){const a=e.hasOwnProperty(o),c=t.hasOwnProperty(o);if(a&&!c||!a&&c||!er(e[o],t[o]))return!1}}return String(e)===String(t)}const Jo=e=>!!(e&&e.__v_isRef===!0),Pn=e=>fe(e)?e:e==null?"":K(e)||Z(e)&&(e.toString===Go||!V(e.toString))?Jo(e)?Pn(e.value):JSON.stringify(e,Qo,2):String(e),Qo=(e,t)=>Jo(t)?Qo(e,t.value):on(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[s,i],r)=>(n[ci(s,r)+" =>"]=i,n),{})}:Vo(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>ci(n))}:Ke(t)?ci(t):Z(t)&&!K(t)&&!zo(t)?String(t):t,ci=(e,t="")=>{var n;return Ke(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
* @vue/reactivity v3.5.31
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let ke;class Xo{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=ke,!t&&ke&&(this.index=(ke.scopes||(ke.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,n;if(this.scopes)for(t=0,n=this.scopes.length;t<n;t++)this.scopes[t].pause();for(t=0,n=this.effects.length;t<n;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,n;if(this.scopes)for(t=0,n=this.scopes.length;t<n;t++)this.scopes[t].resume();for(t=0,n=this.effects.length;t<n;t++)this.effects[t].resume()}}run(t){if(this._active){const n=ke;try{return ke=this,t()}finally{ke=n}}}on(){++this._on===1&&(this.prevScope=ke,ke=this)}off(){this._on>0&&--this._on===0&&(ke=this.prevScope,this.prevScope=void 0)}stop(t){if(this._active){this._active=!1;let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(this.effects.length=0,n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const i=this.parent.scopes.pop();i&&i!==this&&(this.parent.scopes[this.index]=i,i.index=this.index)}this.parent=void 0}}}function Mh(e){return new Xo(e)}function ml(){return ke}function xh(e,t=!1){ke&&ke.cleanups.push(e)}let ie;const li=new WeakSet;class Zo{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,ke&&ke.active&&ke.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,li.has(this)&&(li.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||ta(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,$r(this),na(this);const t=ie,n=We;ie=this,We=!0;try{return this.fn()}finally{sa(this),ie=t,We=n,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)sr(t);this.deps=this.depsTail=void 0,$r(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?li.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Oi(this)&&this.run()}get dirty(){return Oi(this)}}let ea=0,Ln,Dn;function ta(e,t=!1){if(e.flags|=8,t){e.next=Dn,Dn=e;return}e.next=Ln,Ln=e}function tr(){ea++}function nr(){if(--ea>0)return;if(Dn){let t=Dn;for(Dn=void 0;t;){const n=t.next;t.next=void 0,t.flags&=-9,t=n}}let e;for(;Ln;){let t=Ln;for(Ln=void 0;t;){const n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(s){e||(e=s)}t=n}}if(e)throw e}function na(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function sa(e){let t,n=e.depsTail,s=n;for(;s;){const i=s.prevDep;s.version===-1?(s===n&&(n=i),sr(s),gl(s)):t=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=i}e.deps=t,e.depsTail=n}function Oi(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(ia(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function ia(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Kn)||(e.globalVersion=Kn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Oi(e))))return;e.flags|=2;const t=e.dep,n=ie,s=We;ie=e,We=!0;try{na(e);const i=e.fn(e._value);(t.version===0||Ye(i,e._value))&&(e.flags|=128,e._value=i,t.version++)}catch(i){throw t.version++,i}finally{ie=n,We=s,sa(e),e.flags&=-3}}function sr(e,t=!1){const{dep:n,prevSub:s,nextSub:i}=e;if(s&&(s.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=s,e.nextSub=void 0),n.subs===e&&(n.subs=s,!s&&n.computed)){n.computed.flags&=-5;for(let r=n.computed.deps;r;r=r.nextDep)sr(r,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function gl(e){const{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}let We=!0;const ra=[];function wt(){ra.push(We),We=!1}function vt(){const e=ra.pop();We=e===void 0?!0:e}function $r(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const n=ie;ie=void 0;try{t()}finally{ie=n}}}let Kn=0;class yl{constructor(t,n){this.sub=t,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class Bs{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!ie||!We||ie===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==ie)n=this.activeLink=new yl(ie,this),ie.deps?(n.prevDep=ie.depsTail,ie.depsTail.nextDep=n,ie.depsTail=n):ie.deps=ie.depsTail=n,oa(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const s=n.nextDep;s.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=s),n.prevDep=ie.depsTail,n.nextDep=void 0,ie.depsTail.nextDep=n,ie.depsTail=n,ie.deps===n&&(ie.deps=s)}return n}trigger(t){this.version++,Kn++,this.notify(t)}notify(t){tr();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{nr()}}}function oa(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let s=t.deps;s;s=s.nextDep)oa(s)}const n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}const Ss=new WeakMap,Kt=Symbol(""),Ri=Symbol(""),Hn=Symbol("");function Ae(e,t,n){if(We&&ie){let s=Ss.get(e);s||Ss.set(e,s=new Map);let i=s.get(n);i||(s.set(n,i=new Bs),i.map=s,i.key=n),i.track()}}function yt(e,t,n,s,i,r){const o=Ss.get(e);if(!o){Kn++;return}const a=c=>{c&&c.trigger()};if(tr(),t==="clear")o.forEach(a);else{const c=K(e),l=c&&Ds(n);if(c&&n==="length"){const u=Number(s);o.forEach((f,p)=>{(p==="length"||p===Hn||!Ke(p)&&p>=u)&&a(f)})}else switch((n!==void 0||o.has(void 0))&&a(o.get(n)),l&&a(o.get(Hn)),t){case"add":c?l&&a(o.get("length")):(a(o.get(Kt)),on(e)&&a(o.get(Ri)));break;case"delete":c||(a(o.get(Kt)),on(e)&&a(o.get(Ri)));break;case"set":on(e)&&a(o.get(Kt));break}}nr()}function _l(e,t){const n=Ss.get(e);return n&&n.get(t)}function Jt(e){const t=W(e);return t===e?t:(Ae(t,"iterate",Hn),Ue(e)?t:t.map(Qe))}function js(e){return Ae(e=W(e),"iterate",Hn),e}function at(e,t){return St(e)?pn(Ht(e)?Qe(t):t):Qe(t)}const bl={__proto__:null,[Symbol.iterator](){return ui(this,Symbol.iterator,e=>at(this,e))},concat(...e){return Jt(this).concat(...e.map(t=>K(t)?Jt(t):t))},entries(){return ui(this,"entries",e=>(e[1]=at(this,e[1]),e))},every(e,t){return dt(this,"every",e,t,void 0,arguments)},filter(e,t){return dt(this,"filter",e,t,n=>n.map(s=>at(this,s)),arguments)},find(e,t){return dt(this,"find",e,t,n=>at(this,n),arguments)},findIndex(e,t){return dt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return dt(this,"findLast",e,t,n=>at(this,n),arguments)},findLastIndex(e,t){return dt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return dt(this,"forEach",e,t,void 0,arguments)},includes(...e){return fi(this,"includes",e)},indexOf(...e){return fi(this,"indexOf",e)},join(e){return Jt(this).join(e)},lastIndexOf(...e){return fi(this,"lastIndexOf",e)},map(e,t){return dt(this,"map",e,t,void 0,arguments)},pop(){return kn(this,"pop")},push(...e){return kn(this,"push",e)},reduce(e,...t){return Fr(this,"reduce",e,t)},reduceRight(e,...t){return Fr(this,"reduceRight",e,t)},shift(){return kn(this,"shift")},some(e,t){return dt(this,"some",e,t,void 0,arguments)},splice(...e){return kn(this,"splice",e)},toReversed(){return Jt(this).toReversed()},toSorted(e){return Jt(this).toSorted(e)},toSpliced(...e){return Jt(this).toSpliced(...e)},unshift(...e){return kn(this,"unshift",e)},values(){return ui(this,"values",e=>at(this,e))}};function ui(e,t,n){const s=js(e),i=s[t]();return s!==e&&!Ue(e)&&(i._next=i.next,i.next=()=>{const r=i._next();return r.done||(r.value=n(r.value)),r}),i}const wl=Array.prototype;function dt(e,t,n,s,i,r){const o=js(e),a=o!==e&&!Ue(e),c=o[t];if(c!==wl[t]){const f=c.apply(e,r);return a?Qe(f):f}let l=n;o!==e&&(a?l=function(f,p){return n.call(this,at(e,f),p,e)}:n.length>2&&(l=function(f,p){return n.call(this,f,p,e)}));const u=c.call(o,l,s);return a&&i?i(u):u}function Fr(e,t,n,s){const i=js(e),r=i!==e&&!Ue(e);let o=n,a=!1;i!==e&&(r?(a=s.length===0,o=function(l,u,f){return a&&(a=!1,l=at(e,l)),n.call(this,l,at(e,u),f,e)}):n.length>3&&(o=function(l,u,f){return n.call(this,l,u,f,e)}));const c=i[t](o,...s);return a?at(e,c):c}function fi(e,t,n){const s=W(e);Ae(s,"iterate",Hn);const i=s[t](...n);return(i===-1||i===!1)&&Ks(n[0])?(n[0]=W(n[0]),s[t](...n)):i}function kn(e,t,n=[]){wt(),tr();const s=W(e)[t].apply(e,n);return nr(),vt(),s}const vl=Qi("__proto__,__v_isRef,__isVue"),aa=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ke));function Sl(e){Ke(e)||(e=String(e));const t=W(this);return Ae(t,"has",e),t.hasOwnProperty(e)}class ca{constructor(t=!1,n=!1){this._isReadonly=t,this._isShallow=n}get(t,n,s){if(n==="__v_skip")return t.__v_skip;const i=this._isReadonly,r=this._isShallow;if(n==="__v_isReactive")return!i;if(n==="__v_isReadonly")return i;if(n==="__v_isShallow")return r;if(n==="__v_raw")return s===(i?r?Pl:pa:r?fa:ua).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(s)?t:void 0;const o=K(t);if(!i){let c;if(o&&(c=bl[n]))return c;if(n==="hasOwnProperty")return Sl}const a=Reflect.get(t,n,ye(t)?t:s);if((Ke(n)?aa.has(n):vl(n))||(i||Ae(t,"get",n),r))return a;if(ye(a)){const c=o&&Ds(n)?a:a.value;return i&&Z(c)?Ci(c):c}return Z(a)?i?Ci(a):Us(a):a}}class la extends ca{constructor(t=!1){super(!1,t)}set(t,n,s,i){let r=t[n];const o=K(t)&&Ds(n);if(!this._isShallow){const l=St(r);if(!Ue(s)&&!St(s)&&(r=W(r),s=W(s)),!o&&ye(r)&&!ye(s))return l||(r.value=s),!0}const a=o?Number(n)<t.length:X(t,n),c=Reflect.set(t,n,s,ye(t)?t:i);return t===W(i)&&(a?Ye(s,r)&&yt(t,"set",n,s):yt(t,"add",n,s)),c}deleteProperty(t,n){const s=X(t,n);t[n];const i=Reflect.deleteProperty(t,n);return i&&s&&yt(t,"delete",n,void 0),i}has(t,n){const s=Reflect.has(t,n);return(!Ke(n)||!aa.has(n))&&Ae(t,"has",n),s}ownKeys(t){return Ae(t,"iterate",K(t)?"length":Kt),Reflect.ownKeys(t)}}class El extends ca{constructor(t=!1){super(!0,t)}set(t,n){return!0}deleteProperty(t,n){return!0}}const kl=new la,Al=new El,Nl=new la(!0);const Ii=e=>e,os=e=>Reflect.getPrototypeOf(e);function Tl(e,t,n){return function(...s){const i=this.__v_raw,r=W(i),o=on(r),a=e==="entries"||e===Symbol.iterator&&o,c=e==="keys"&&o,l=i[e](...s),u=n?Ii:t?pn:Qe;return!t&&Ae(r,"iterate",c?Ri:Kt),Ee(Object.create(l),{next(){const{value:f,done:p}=l.next();return p?{value:f,done:p}:{value:a?[u(f[0]),u(f[1])]:u(f),done:p}}})}}function as(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function Ol(e,t){const n={get(i){const r=this.__v_raw,o=W(r),a=W(i);e||(Ye(i,a)&&Ae(o,"get",i),Ae(o,"get",a));const{has:c}=os(o),l=t?Ii:e?pn:Qe;if(c.call(o,i))return l(r.get(i));if(c.call(o,a))return l(r.get(a));r!==o&&r.get(i)},get size(){const i=this.__v_raw;return!e&&Ae(W(i),"iterate",Kt),i.size},has(i){const r=this.__v_raw,o=W(r),a=W(i);return e||(Ye(i,a)&&Ae(o,"has",i),Ae(o,"has",a)),i===a?r.has(i):r.has(i)||r.has(a)},forEach(i,r){const o=this,a=o.__v_raw,c=W(a),l=t?Ii:e?pn:Qe;return!e&&Ae(c,"iterate",Kt),a.forEach((u,f)=>i.call(r,l(u),l(f),o))}};return Ee(n,e?{add:as("add"),set:as("set"),delete:as("delete"),clear:as("clear")}:{add(i){const r=W(this),o=os(r),a=W(i),c=!t&&!Ue(i)&&!St(i)?a:i;return o.has.call(r,c)||Ye(i,c)&&o.has.call(r,i)||Ye(a,c)&&o.has.call(r,a)||(r.add(c),yt(r,"add",c,c)),this},set(i,r){!t&&!Ue(r)&&!St(r)&&(r=W(r));const o=W(this),{has:a,get:c}=os(o);let l=a.call(o,i);l||(i=W(i),l=a.call(o,i));const u=c.call(o,i);return o.set(i,r),l?Ye(r,u)&&yt(o,"set",i,r):yt(o,"add",i,r),this},delete(i){const r=W(this),{has:o,get:a}=os(r);let c=o.call(r,i);c||(i=W(i),c=o.call(r,i)),a&&a.call(r,i);const l=r.delete(i);return c&&yt(r,"delete",i,void 0),l},clear(){const i=W(this),r=i.size!==0,o=i.clear();return r&&yt(i,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(i=>{n[i]=Tl(i,e,t)}),n}function ir(e,t){const n=Ol(e,t);return(s,i,r)=>i==="__v_isReactive"?!e:i==="__v_isReadonly"?e:i==="__v_raw"?s:Reflect.get(X(n,i)&&i in s?n:s,i,r)}const Rl={get:ir(!1,!1)},Il={get:ir(!1,!0)},Cl={get:ir(!0,!1)};const ua=new WeakMap,fa=new WeakMap,pa=new WeakMap,Pl=new WeakMap;function Ll(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Dl(e){return e.__v_skip||!Object.isExtensible(e)?0:Ll(il(e))}function Us(e){return St(e)?e:rr(e,!1,kl,Rl,ua)}function da(e){return rr(e,!1,Nl,Il,fa)}function Ci(e){return rr(e,!0,Al,Cl,pa)}function rr(e,t,n,s,i){if(!Z(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const r=Dl(e);if(r===0)return e;const o=i.get(e);if(o)return o;const a=new Proxy(e,r===2?s:n);return i.set(e,a),a}function Ht(e){return St(e)?Ht(e.__v_raw):!!(e&&e.__v_isReactive)}function St(e){return!!(e&&e.__v_isReadonly)}function Ue(e){return!!(e&&e.__v_isShallow)}function Ks(e){return e?!!e.__v_raw:!1}function W(e){const t=e&&e.__v_raw;return t?W(t):e}function Ml(e){return!X(e,"__v_skip")&&Object.isExtensible(e)&&Yo(e,"__v_skip",!0),e}const Qe=e=>Z(e)?Us(e):e,pn=e=>Z(e)?Ci(e):e;function ye(e){return e?e.__v_isRef===!0:!1}function Hs(e){return ha(e,!1)}function xl(e){return ha(e,!0)}function ha(e,t){return ye(e)?e:new $l(e,t)}class $l{constructor(t,n){this.dep=new Bs,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?t:W(t),this._value=n?t:Qe(t),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(t){const n=this._rawValue,s=this.__v_isShallow||Ue(t)||St(t);t=s?t:W(t),Ye(t,n)&&(this._rawValue=t,this._value=s?t:Qe(t),this.dep.trigger())}}function we(e){return ye(e)?e.value:e}function $h(e){return V(e)?e():we(e)}const Fl={get:(e,t,n)=>t==="__v_raw"?e:we(Reflect.get(e,t,n)),set:(e,t,n,s)=>{const i=e[t];return ye(i)&&!ye(n)?(i.value=n,!0):Reflect.set(e,t,n,s)}};function ma(e){return Ht(e)?e:new Proxy(e,Fl)}class Bl{constructor(t){this.__v_isRef=!0,this._value=void 0;const n=this.dep=new Bs,{get:s,set:i}=t(n.track.bind(n),n.trigger.bind(n));this._get=s,this._set=i}get value(){return this._value=this._get()}set value(t){this._set(t)}}function Fh(e){return new Bl(e)}function Bh(e){const t=K(e)?new Array(e.length):{};for(const n in e)t[n]=ga(e,n);return t}class jl{constructor(t,n,s){this._object=t,this._defaultValue=s,this.__v_isRef=!0,this._value=void 0,this._key=Ke(n)?n:String(n),this._raw=W(t);let i=!0,r=t;if(!K(t)||Ke(this._key)||!Ds(this._key))do i=!Ks(r)||Ue(r);while(i&&(r=r.__v_raw));this._shallow=i}get value(){let t=this._object[this._key];return this._shallow&&(t=we(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&ye(this._raw[this._key])){const n=this._object[this._key];if(ye(n)){n.value=t;return}}this._object[this._key]=t}get dep(){return _l(this._raw,this._key)}}class Ul{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function jh(e,t,n){return ye(e)?e:V(e)?new Ul(e):Z(e)&&arguments.length>1?ga(e,t,n):Hs(e)}function ga(e,t,n){return new jl(e,t,n)}class Kl{constructor(t,n,s){this.fn=t,this.setter=n,this._value=void 0,this.dep=new Bs(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Kn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&ie!==this)return ta(this,!0),!0}get value(){const t=this.dep.track();return ia(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Hl(e,t,n=!1){let s,i;return V(e)?s=e:(s=e.get,i=e.set),new Kl(s,i,n)}const cs={},Es=new WeakMap;let $t;function Vl(e,t=!1,n=$t){if(n){let s=Es.get(n);s||Es.set(n,s=[]),s.push(e)}}function ql(e,t,n=re){const{immediate:s,deep:i,once:r,scheduler:o,augmentJob:a,call:c}=n,l=N=>i?N:Ue(N)||i===!1||i===0?Ct(N,1):Ct(N);let u,f,p,d,b=!1,g=!1;if(ye(e)?(f=()=>e.value,b=Ue(e)):Ht(e)?(f=()=>l(e),b=!0):K(e)?(g=!0,b=e.some(N=>Ht(N)||Ue(N)),f=()=>e.map(N=>{if(ye(N))return N.value;if(Ht(N))return l(N);if(V(N))return c?c(N,2):N()})):V(e)?t?f=c?()=>c(e,2):e:f=()=>{if(p){wt();try{p()}finally{vt()}}const N=$t;$t=u;try{return c?c(e,3,[d]):e(d)}finally{$t=N}}:f=lt,t&&i){const N=f,P=i===!0?1/0:i;f=()=>Ct(N(),P)}const _=ml(),v=()=>{u.stop(),_&&_.active&&Xi(_.effects,u)};if(r&&t){const N=t;t=(...P)=>{N(...P),v()}}let w=g?new Array(e.length).fill(cs):cs;const T=N=>{if(!(!(u.flags&1)||!u.dirty&&!N))if(t){const P=u.run();if(i||b||(g?P.some((U,M)=>Ye(U,w[M])):Ye(P,w))){p&&p();const U=$t;$t=u;try{const M=[P,w===cs?void 0:g&&w[0]===cs?[]:w,d];w=P,c?c(t,3,M):t(...M)}finally{$t=U}}}else u.run()};return a&&a(T),u=new Zo(f),u.scheduler=o?()=>o(T,!1):T,d=N=>Vl(N,!1,u),p=u.onStop=()=>{const N=Es.get(u);if(N){if(c)c(N,4);else for(const P of N)P();Es.delete(u)}},t?s?T(!0):w=u.run():o?o(T.bind(null,!0),!0):u.run(),v.pause=u.pause.bind(u),v.resume=u.resume.bind(u),v.stop=v,v}function Ct(e,t=1/0,n){if(t<=0||!Z(e)||e.__v_skip||(n=n||new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,ye(e))Ct(e.value,t,n);else if(K(e))for(let s=0;s<e.length;s++)Ct(e[s],t,n);else if(Vo(e)||on(e))e.forEach(s=>{Ct(s,t,n)});else if(zo(e)){for(const s in e)Ct(e[s],t,n);for(const s of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,s)&&Ct(e[s],t,n)}return e}/**
* @vue/runtime-core v3.5.31
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Zn(e,t,n,s){try{return s?e(...s):e()}catch(i){Vs(i,t,n)}}function ut(e,t,n,s){if(V(e)){const i=Zn(e,t,n,s);return i&&qo(i)&&i.catch(r=>{Vs(r,t,n)}),i}if(K(e)){const i=[];for(let r=0;r<e.length;r++)i.push(ut(e[r],t,n,s));return i}}function Vs(e,t,n,s=!0){const i=t?t.vnode:null,{errorHandler:r,throwUnhandledErrorInProduction:o}=t&&t.appContext.config||re;if(t){let a=t.parent;const c=t.proxy,l=`https://vuejs.org/error-reference/#runtime-${n}`;for(;a;){const u=a.ec;if(u){for(let f=0;f<u.length;f++)if(u[f](e,c,l)===!1)return}a=a.parent}if(r){wt(),Zn(r,null,10,[e,c,l]),vt();return}}Gl(e,n,i,s,o)}function Gl(e,t,n,s=!0,i=!1){if(i)throw e;console.error(e)}const Ce=[];let rt=-1;const an=[];let Ot=null,Zt=0;const ya=Promise.resolve();let ks=null;function _a(e){const t=ks||ya;return e?t.then(this?e.bind(this):e):t}function zl(e){let t=rt+1,n=Ce.length;for(;t<n;){const s=t+n>>>1,i=Ce[s],r=Vn(i);r<e||r===e&&i.flags&2?t=s+1:n=s}return t}function or(e){if(!(e.flags&1)){const t=Vn(e),n=Ce[Ce.length-1];!n||!(e.flags&2)&&t>=Vn(n)?Ce.push(e):Ce.splice(zl(t),0,e),e.flags|=1,ba()}}function ba(){ks||(ks=ya.then(va))}function Yl(e){K(e)?an.push(...e):Ot&&e.id===-1?Ot.splice(Zt+1,0,e):e.flags&1||(an.push(e),e.flags|=1),ba()}function Br(e,t,n=rt+1){for(;n<Ce.length;n++){const s=Ce[n];if(s&&s.flags&2){if(e&&s.id!==e.uid)continue;Ce.splice(n,1),n--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function wa(e){if(an.length){const t=[...new Set(an)].sort((n,s)=>Vn(n)-Vn(s));if(an.length=0,Ot){Ot.push(...t);return}for(Ot=t,Zt=0;Zt<Ot.length;Zt++){const n=Ot[Zt];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}Ot=null,Zt=0}}const Vn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function va(e){try{for(rt=0;rt<Ce.length;rt++){const t=Ce[rt];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Zn(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;rt<Ce.length;rt++){const t=Ce[rt];t&&(t.flags&=-2)}rt=-1,Ce.length=0,wa(),ks=null,(Ce.length||an.length)&&va()}}let Le=null,Sa=null;function As(e){const t=Le;return Le=e,Sa=e&&e.type.__scopeId||null,t}function Pi(e,t=Le,n){if(!t||e._n)return e;const s=(...i)=>{s._d&&Os(-1);const r=As(t);let o;try{o=e(...i)}finally{As(r),s._d&&Os(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function Mt(e,t,n,s){const i=e.dirs,r=t&&t.dirs;for(let o=0;o<i.length;o++){const a=i[o];r&&(a.oldValue=r[o].value);let c=a.dir[s];c&&(wt(),ut(c,n,8,[e.el,a,e,t]),vt())}}function ms(e,t){if(Ne){let n=Ne.provides;const s=Ne.parent&&Ne.parent.provides;s===n&&(n=Ne.provides=Object.create(s)),n[e]=t}}function Je(e,t,n=!1){const s=Za();if(s||ln){let i=ln?ln._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return n&&V(t)?t.call(s&&s.proxy):t}}const Wl=Symbol.for("v-scx"),Jl=()=>Je(Wl);function Mn(e,t,n){return Ea(e,t,n)}function Ea(e,t,n=re){const{immediate:s,deep:i,flush:r,once:o}=n,a=Ee({},n),c=t&&s||!t&&r!=="post";let l;if(zn){if(r==="sync"){const d=Jl();l=d.__watcherHandles||(d.__watcherHandles=[])}else if(!c){const d=()=>{};return d.stop=lt,d.resume=lt,d.pause=lt,d}}const u=Ne;a.call=(d,b,g)=>ut(d,u,b,g);let f=!1;r==="post"?a.scheduler=d=>{Fe(d,u&&u.suspense)}:r!=="sync"&&(f=!0,a.scheduler=(d,b)=>{b?d():or(d)}),a.augmentJob=d=>{t&&(d.flags|=4),f&&(d.flags|=2,u&&(d.id=u.uid,d.i=u))};const p=ql(e,t,a);return zn&&(l?l.push(p):c&&p()),p}function Ql(e,t,n){const s=this.proxy,i=fe(e)?e.includes(".")?ka(s,e):()=>s[e]:e.bind(s,s);let r;V(t)?r=t:(r=t.handler,n=t);const o=ts(this),a=Ea(i,r.bind(s),n);return o(),a}function ka(e,t){const n=t.split(".");return()=>{let s=e;for(let i=0;i<n.length&&s;i++)s=s[n[i]];return s}}const Xl=Symbol("_vte"),Zl=e=>e.__isTeleport,eu=Symbol("_leaveCb");function ar(e,t){e.shapeFlag&6&&e.component?(e.transition=t,ar(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function es(e,t){return V(e)?Ee({name:e.name},t,{setup:e}):e}function Aa(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function jr(e,t){let n;return!!((n=Object.getOwnPropertyDescriptor(e,t))&&!n.configurable)}const Ns=new WeakMap;function xn(e,t,n,s,i=!1){if(K(e)){e.forEach((g,_)=>xn(g,t&&(K(t)?t[_]:t),n,s,i));return}if(cn(s)&&!i){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&xn(e,t,n,s.component.subTree);return}const r=s.shapeFlag&4?dr(s.component):s.el,o=i?null:r,{i:a,r:c}=e,l=t&&t.r,u=a.refs===re?a.refs={}:a.refs,f=a.setupState,p=W(f),d=f===re?Ho:g=>jr(u,g)?!1:X(p,g),b=(g,_)=>!(_&&jr(u,_));if(l!=null&&l!==c){if(Ur(t),fe(l))u[l]=null,d(l)&&(f[l]=null);else if(ye(l)){const g=t;b(l,g.k)&&(l.value=null),g.k&&(u[g.k]=null)}}if(V(c))Zn(c,a,12,[o,u]);else{const g=fe(c),_=ye(c);if(g||_){const v=()=>{if(e.f){const w=g?d(c)?f[c]:u[c]:b()||!e.k?c.value:u[e.k];if(i)K(w)&&Xi(w,r);else if(K(w))w.includes(r)||w.push(r);else if(g)u[c]=[r],d(c)&&(f[c]=u[c]);else{const T=[r];b(c,e.k)&&(c.value=T),e.k&&(u[e.k]=T)}}else g?(u[c]=o,d(c)&&(f[c]=o)):_&&(b(c,e.k)&&(c.value=o),e.k&&(u[e.k]=o))};if(o){const w=()=>{v(),Ns.delete(e)};w.id=-1,Ns.set(e,w),Fe(w,n)}else Ur(e),v()}}}function Ur(e){const t=Ns.get(e);t&&(t.flags|=8,Ns.delete(e))}$s().requestIdleCallback;$s().cancelIdleCallback;const cn=e=>!!e.type.__asyncLoader,Na=e=>e.type.__isKeepAlive;function tu(e,t){Ta(e,"a",t)}function nu(e,t){Ta(e,"da",t)}function Ta(e,t,n=Ne){const s=e.__wdc||(e.__wdc=()=>{let i=n;for(;i;){if(i.isDeactivated)return;i=i.parent}return e()});if(qs(t,s,n),n){let i=n.parent;for(;i&&i.parent;)Na(i.parent.vnode)&&su(s,t,n,i),i=i.parent}}function su(e,t,n,s){const i=qs(t,e,s,!0);Oa(()=>{Xi(s[t],i)},n)}function qs(e,t,n=Ne,s=!1){if(n){const i=n[e]||(n[e]=[]),r=t.__weh||(t.__weh=(...o)=>{wt();const a=ts(n),c=ut(t,n,e,o);return a(),vt(),c});return s?i.unshift(r):i.push(r),r}}const kt=e=>(t,n=Ne)=>{(!zn||e==="sp")&&qs(e,(...s)=>t(...s),n)},iu=kt("bm"),cr=kt("m"),ru=kt("bu"),ou=kt("u"),lr=kt("bum"),Oa=kt("um"),au=kt("sp"),cu=kt("rtg"),lu=kt("rtc");function uu(e,t=Ne){qs("ec",e,t)}const Ra="components";function fu(e,t){return Ca(Ra,e,!0,t)||e}const Ia=Symbol.for("v-ndc");function Uh(e){return fe(e)?Ca(Ra,e,!1)||e:e||Ia}function Ca(e,t,n=!0,s=!1){const i=Le||Ne;if(i){const r=i.type;{const a=Yu(r,!1);if(a&&(a===t||a===Me(t)||a===xs(Me(t))))return r}const o=Kr(i[e]||r[e],t)||Kr(i.appContext[e],t);return!o&&s?r:o}}function Kr(e,t){return e&&(e[t]||e[Me(t)]||e[xs(Me(t))])}function Hr(e,t,n,s){let i;const r=n&&n[s],o=K(e);if(o||fe(e)){const a=o&&Ht(e);let c=!1,l=!1;a&&(c=!Ue(e),l=St(e),e=js(e)),i=new Array(e.length);for(let u=0,f=e.length;u<f;u++)i[u]=t(c?l?pn(Qe(e[u])):Qe(e[u]):e[u],u,void 0,r&&r[u])}else if(typeof e=="number"){i=new Array(e);for(let a=0;a<e;a++)i[a]=t(a+1,a,void 0,r&&r[a])}else if(Z(e))if(e[Symbol.iterator])i=Array.from(e,(a,c)=>t(a,c,void 0,r&&r[c]));else{const a=Object.keys(e);i=new Array(a.length);for(let c=0,l=a.length;c<l;c++){const u=a[c];i[c]=t(e[u],u,c,r&&r[c])}}else i=[];return n&&(n[s]=i),i}function Kh(e,t,n={},s,i){if(Le.ce||Le.parent&&cn(Le.parent)&&Le.parent.ce){const l=Object.keys(n).length>0;return t!=="default"&&(n.name=t),Ie(),qn(Be,null,[ge("slot",n,s&&s())],l?-2:64)}let r=e[t];r&&r._c&&(r._d=!1),Ie();const o=r&&Pa(r(n)),a=n.key||o&&o.key,c=qn(Be,{key:(a&&!Ke(a)?a:`_${t}`)+(!o&&s?"_fb":"")},o||(s?s():[]),o&&e._===1?64:-2);return c.scopeId&&(c.slotScopeIds=[c.scopeId+"-s"]),r&&r._c&&(r._d=!0),c}function Pa(e){return e.some(t=>Gn(t)?!(t.type===Et||t.type===Be&&!Pa(t.children)):!0)?e:null}const Li=e=>e?ec(e)?dr(e):Li(e.parent):null,$n=Ee(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Li(e.parent),$root:e=>Li(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Ma(e),$forceUpdate:e=>e.f||(e.f=()=>{or(e.update)}),$nextTick:e=>e.n||(e.n=_a.bind(e.proxy)),$watch:e=>Ql.bind(e)}),pi=(e,t)=>e!==re&&!e.__isScriptSetup&&X(e,t),pu={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:n,setupState:s,data:i,props:r,accessCache:o,type:a,appContext:c}=e;if(t[0]!=="$"){const p=o[t];if(p!==void 0)switch(p){case 1:return s[t];case 2:return i[t];case 4:return n[t];case 3:return r[t]}else{if(pi(s,t))return o[t]=1,s[t];if(i!==re&&X(i,t))return o[t]=2,i[t];if(X(r,t))return o[t]=3,r[t];if(n!==re&&X(n,t))return o[t]=4,n[t];Di&&(o[t]=0)}}const l=$n[t];let u,f;if(l)return t==="$attrs"&&Ae(e.attrs,"get",""),l(e);if((u=a.__cssModules)&&(u=u[t]))return u;if(n!==re&&X(n,t))return o[t]=4,n[t];if(f=c.config.globalProperties,X(f,t))return f[t]},set({_:e},t,n){const{data:s,setupState:i,ctx:r}=e;return pi(i,t)?(i[t]=n,!0):s!==re&&X(s,t)?(s[t]=n,!0):X(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(r[t]=n,!0)},has({_:{data:e,setupState:t,accessCache:n,ctx:s,appContext:i,props:r,type:o}},a){let c;return!!(n[a]||e!==re&&a[0]!=="$"&&X(e,a)||pi(t,a)||X(r,a)||X(s,a)||X($n,a)||X(i.config.globalProperties,a)||(c=o.__cssModules)&&c[a])},defineProperty(e,t,n){return n.get!=null?e._.accessCache[t]=0:X(n,"value")&&this.set(e,t,n.value,null),Reflect.defineProperty(e,t,n)}};function Hh(){return La().slots}function Vh(){return La().attrs}function La(e){const t=Za();return t.setupContext||(t.setupContext=nc(t))}function Vr(e){return K(e)?e.reduce((t,n)=>(t[n]=null,t),{}):e}function qh(e,t){const n={};for(const s in e)t.includes(s)||Object.defineProperty(n,s,{enumerable:!0,get:()=>e[s]});return n}let Di=!0;function du(e){const t=Ma(e),n=e.proxy,s=e.ctx;Di=!1,t.beforeCreate&&qr(t.beforeCreate,e,"bc");const{data:i,computed:r,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:f,mounted:p,beforeUpdate:d,updated:b,activated:g,deactivated:_,beforeDestroy:v,beforeUnmount:w,destroyed:T,unmounted:N,render:P,renderTracked:U,renderTriggered:M,errorCaptured:$,serverPrefetch:G,expose:ne,inheritAttrs:_e,components:he,directives:ae,filters:At}=t;if(l&&hu(l,s,null),o)for(const ee in o){const J=o[ee];V(J)&&(s[ee]=J.bind(n))}if(i){const ee=i.call(n,n);Z(ee)&&(e.data=Us(ee))}if(Di=!0,r)for(const ee in r){const J=r[ee],pt=V(J)?J.bind(n,n):V(J.get)?J.get.bind(n,n):lt,Nt=!V(J)&&V(J.set)?J.set.bind(n):lt,et=Pe({get:pt,set:Nt});Object.defineProperty(s,ee,{enumerable:!0,configurable:!0,get:()=>et.value,set:$e=>et.value=$e})}if(a)for(const ee in a)Da(a[ee],s,n,ee);if(c){const ee=V(c)?c.call(n):c;Reflect.ownKeys(ee).forEach(J=>{ms(J,ee[J])})}u&&qr(u,e,"c");function be(ee,J){K(J)?J.forEach(pt=>ee(pt.bind(n))):J&&ee(J.bind(n))}if(be(iu,f),be(cr,p),be(ru,d),be(ou,b),be(tu,g),be(nu,_),be(uu,$),be(lu,U),be(cu,M),be(lr,w),be(Oa,N),be(au,G),K(ne))if(ne.length){const ee=e.exposed||(e.exposed={});ne.forEach(J=>{Object.defineProperty(ee,J,{get:()=>n[J],set:pt=>n[J]=pt,enumerable:!0})})}else e.exposed||(e.exposed={});P&&e.render===lt&&(e.render=P),_e!=null&&(e.inheritAttrs=_e),he&&(e.components=he),ae&&(e.directives=ae),G&&Aa(e)}function hu(e,t,n=lt){K(e)&&(e=Mi(e));for(const s in e){const i=e[s];let r;Z(i)?"default"in i?r=Je(i.from||s,i.default,!0):r=Je(i.from||s):r=Je(i),ye(r)?Object.defineProperty(t,s,{enumerable:!0,configurable:!0,get:()=>r.value,set:o=>r.value=o}):t[s]=r}}function qr(e,t,n){ut(K(e)?e.map(s=>s.bind(t.proxy)):e.bind(t.proxy),t,n)}function Da(e,t,n,s){let i=s.includes(".")?ka(n,s):()=>n[s];if(fe(e)){const r=t[e];V(r)&&Mn(i,r)}else if(V(e))Mn(i,e.bind(n));else if(Z(e))if(K(e))e.forEach(r=>Da(r,t,n,s));else{const r=V(e.handler)?e.handler.bind(n):t[e.handler];V(r)&&Mn(i,r,e)}}function Ma(e){const t=e.type,{mixins:n,extends:s}=t,{mixins:i,optionsCache:r,config:{optionMergeStrategies:o}}=e.appContext,a=r.get(t);let c;return a?c=a:!i.length&&!n&&!s?c=t:(c={},i.length&&i.forEach(l=>Ts(c,l,o,!0)),Ts(c,t,o)),Z(t)&&r.set(t,c),c}function Ts(e,t,n,s=!1){const{mixins:i,extends:r}=t;r&&Ts(e,r,n,!0),i&&i.forEach(o=>Ts(e,o,n,!0));for(const o in t)if(!(s&&o==="expose")){const a=mu[o]||n&&n[o];e[o]=a?a(e[o],t[o]):t[o]}return e}const mu={data:Gr,props:zr,emits:zr,methods:On,computed:On,beforeCreate:Te,created:Te,beforeMount:Te,mounted:Te,beforeUpdate:Te,updated:Te,beforeDestroy:Te,beforeUnmount:Te,destroyed:Te,unmounted:Te,activated:Te,deactivated:Te,errorCaptured:Te,serverPrefetch:Te,components:On,directives:On,watch:yu,provide:Gr,inject:gu};function Gr(e,t){return t?e?function(){return Ee(V(e)?e.call(this,this):e,V(t)?t.call(this,this):t)}:t:e}function gu(e,t){return On(Mi(e),Mi(t))}function Mi(e){if(K(e)){const t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function Te(e,t){return e?[...new Set([].concat(e,t))]:t}function On(e,t){return e?Ee(Object.create(null),e,t):t}function zr(e,t){return e?K(e)&&K(t)?[...new Set([...e,...t])]:Ee(Object.create(null),Vr(e),Vr(t??{})):t}function yu(e,t){if(!e)return t;if(!t)return e;const n=Ee(Object.create(null),e);for(const s in t)n[s]=Te(e[s],t[s]);return n}function xa(){return{app:null,config:{isNativeTag:Ho,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let _u=0;function bu(e,t){return function(s,i=null){V(s)||(s=Ee({},s)),i!=null&&!Z(i)&&(i=null);const r=xa(),o=new WeakSet,a=[];let c=!1;const l=r.app={_uid:_u++,_component:s,_props:i,_container:null,_context:r,_instance:null,version:Ju,get config(){return r.config},set config(u){},use(u,...f){return o.has(u)||(u&&V(u.install)?(o.add(u),u.install(l,...f)):V(u)&&(o.add(u),u(l,...f))),l},mixin(u){return r.mixins.includes(u)||r.mixins.push(u),l},component(u,f){return f?(r.components[u]=f,l):r.components[u]},directive(u,f){return f?(r.directives[u]=f,l):r.directives[u]},mount(u,f,p){if(!c){const d=l._ceVNode||ge(s,i);return d.appContext=r,p===!0?p="svg":p===!1&&(p=void 0),e(d,u,p),c=!0,l._container=u,u.__vue_app__=l,dr(d.component)}},onUnmount(u){a.push(u)},unmount(){c&&(ut(a,l._instance,16),e(null,l._container),delete l._container.__vue_app__)},provide(u,f){return r.provides[u]=f,l},runWithContext(u){const f=ln;ln=l;try{return u()}finally{ln=f}}};return l}}let ln=null;const wu=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${Me(t)}Modifiers`]||e[`${qt(t)}Modifiers`];function vu(e,t,...n){if(e.isUnmounted)return;const s=e.vnode.props||re;let i=n;const r=t.startsWith("update:"),o=r&&wu(s,t.slice(7));o&&(o.trim&&(i=n.map(u=>fe(u)?u.trim():u)),o.number&&(i=n.map(al)));let a,c=s[a=oi(t)]||s[a=oi(Me(t))];!c&&r&&(c=s[a=oi(qt(t))]),c&&ut(c,e,6,i);const l=s[a+"Once"];if(l){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,ut(l,e,6,i)}}const Su=new WeakMap;function $a(e,t,n=!1){const s=n?Su:t.emitsCache,i=s.get(e);if(i!==void 0)return i;const r=e.emits;let o={},a=!1;if(!V(e)){const c=l=>{const u=$a(l,t,!0);u&&(a=!0,Ee(o,u))};!n&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!r&&!a?(Z(e)&&s.set(e,null),null):(K(r)?r.forEach(c=>o[c]=null):Ee(o,r),Z(e)&&s.set(e,o),o)}function Gs(e,t){return!e||!Ps(t)?!1:(t=t.slice(2).replace(/Once$/,""),X(e,t[0].toLowerCase()+t.slice(1))||X(e,qt(t))||X(e,t))}function Yr(e){const{type:t,vnode:n,proxy:s,withProxy:i,propsOptions:[r],slots:o,attrs:a,emit:c,render:l,renderCache:u,props:f,data:p,setupState:d,ctx:b,inheritAttrs:g}=e,_=As(e);let v,w;try{if(n.shapeFlag&4){const N=i||s,P=N;v=ct(l.call(P,N,u,f,d,p,b)),w=a}else{const N=t;v=ct(N.length>1?N(f,{attrs:a,slots:o,emit:c}):N(f,null)),w=t.props?a:Eu(a)}}catch(N){Fn.length=0,Vs(N,e,1),v=ge(Et)}let T=v;if(w&&g!==!1){const N=Object.keys(w),{shapeFlag:P}=T;N.length&&P&7&&(r&&N.some(Ls)&&(w=ku(w,r)),T=hn(T,w,!1,!0))}return n.dirs&&(T=hn(T,null,!1,!0),T.dirs=T.dirs?T.dirs.concat(n.dirs):n.dirs),n.transition&&ar(T,n.transition),v=T,As(_),v}const Eu=e=>{let t;for(const n in e)(n==="class"||n==="style"||Ps(n))&&((t||(t={}))[n]=e[n]);return t},ku=(e,t)=>{const n={};for(const s in e)(!Ls(s)||!(s.slice(9)in t))&&(n[s]=e[s]);return n};function Au(e,t,n){const{props:s,children:i,component:r}=e,{props:o,children:a,patchFlag:c}=t,l=r.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return s?Wr(s,o,l):!!o;if(c&8){const u=t.dynamicProps;for(let f=0;f<u.length;f++){const p=u[f];if(Fa(o,s,p)&&!Gs(l,p))return!0}}}else return(i||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Wr(s,o,l):!0:!!o;return!1}function Wr(e,t,n){const s=Object.keys(t);if(s.length!==Object.keys(e).length)return!0;for(let i=0;i<s.length;i++){const r=s[i];if(Fa(t,e,r)&&!Gs(n,r))return!0}return!1}function Fa(e,t,n){const s=e[n],i=t[n];return n==="style"&&Z(s)&&Z(i)?!er(s,i):s!==i}function Nu({vnode:e,parent:t,suspense:n},s){for(;t;){const i=t.subTree;if(i.suspense&&i.suspense.activeBranch===e&&(i.suspense.vnode.el=i.el=s,e=i),i===e)(e=t.vnode).el=s,t=t.parent;else break}n&&n.activeBranch===e&&(n.vnode.el=s)}const Ba={},ja=()=>Object.create(Ba),Ua=e=>Object.getPrototypeOf(e)===Ba;function Tu(e,t,n,s=!1){const i={},r=ja();e.propsDefaults=Object.create(null),Ka(e,t,i,r);for(const o in e.propsOptions[0])o in i||(i[o]=void 0);n?e.props=s?i:da(i):e.type.props?e.props=i:e.props=r,e.attrs=r}function Ou(e,t,n,s){const{props:i,attrs:r,vnode:{patchFlag:o}}=e,a=W(i),[c]=e.propsOptions;let l=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=e.vnode.dynamicProps;for(let f=0;f<u.length;f++){let p=u[f];if(Gs(e.emitsOptions,p))continue;const d=t[p];if(c)if(X(r,p))d!==r[p]&&(r[p]=d,l=!0);else{const b=Me(p);i[b]=xi(c,a,b,d,e,!1)}else d!==r[p]&&(r[p]=d,l=!0)}}}else{Ka(e,t,i,r)&&(l=!0);let u;for(const f in a)(!t||!X(t,f)&&((u=qt(f))===f||!X(t,u)))&&(c?n&&(n[f]!==void 0||n[u]!==void 0)&&(i[f]=xi(c,a,f,void 0,e,!0)):delete i[f]);if(r!==a)for(const f in r)(!t||!X(t,f))&&(delete r[f],l=!0)}l&&yt(e.attrs,"set","")}function Ka(e,t,n,s){const[i,r]=e.propsOptions;let o=!1,a;if(t)for(let c in t){if(Cn(c))continue;const l=t[c];let u;i&&X(i,u=Me(c))?!r||!r.includes(u)?n[u]=l:(a||(a={}))[u]=l:Gs(e.emitsOptions,c)||(!(c in s)||l!==s[c])&&(s[c]=l,o=!0)}if(r){const c=W(n),l=a||re;for(let u=0;u<r.length;u++){const f=r[u];n[f]=xi(i,c,f,l[f],e,!X(l,f))}}return o}function xi(e,t,n,s,i,r){const o=e[n];if(o!=null){const a=X(o,"default");if(a&&s===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&V(c)){const{propsDefaults:l}=i;if(n in l)s=l[n];else{const u=ts(i);s=l[n]=c.call(null,t),u()}}else s=c;i.ce&&i.ce._setProp(n,s)}o[0]&&(r&&!a?s=!1:o[1]&&(s===""||s===qt(n))&&(s=!0))}return s}const Ru=new WeakMap;function Ha(e,t,n=!1){const s=n?Ru:t.propsCache,i=s.get(e);if(i)return i;const r=e.props,o={},a=[];let c=!1;if(!V(e)){const u=f=>{c=!0;const[p,d]=Ha(f,t,!0);Ee(o,p),d&&a.push(...d)};!n&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!r&&!c)return Z(e)&&s.set(e,rn),rn;if(K(r))for(let u=0;u<r.length;u++){const f=Me(r[u]);Jr(f)&&(o[f]=re)}else if(r)for(const u in r){const f=Me(u);if(Jr(f)){const p=r[u],d=o[f]=K(p)||V(p)?{type:p}:Ee({},p),b=d.type;let g=!1,_=!0;if(K(b))for(let v=0;v<b.length;++v){const w=b[v],T=V(w)&&w.name;if(T==="Boolean"){g=!0;break}else T==="String"&&(_=!1)}else g=V(b)&&b.name==="Boolean";d[0]=g,d[1]=_,(g||X(d,"default"))&&a.push(f)}}const l=[o,a];return Z(e)&&s.set(e,l),l}function Jr(e){return e[0]!=="$"&&!Cn(e)}const ur=e=>e==="_"||e==="_ctx"||e==="$stable",fr=e=>K(e)?e.map(ct):[ct(e)],Iu=(e,t,n)=>{if(t._n)return t;const s=Pi((...i)=>fr(t(...i)),n);return s._c=!1,s},Va=(e,t,n)=>{const s=e._ctx;for(const i in e){if(ur(i))continue;const r=e[i];if(V(r))t[i]=Iu(i,r,s);else if(r!=null){const o=fr(r);t[i]=()=>o}}},qa=(e,t)=>{const n=fr(t);e.slots.default=()=>n},Ga=(e,t,n)=>{for(const s in t)(n||!ur(s))&&(e[s]=t[s])},Cu=(e,t,n)=>{const s=e.slots=ja();if(e.vnode.shapeFlag&32){const i=t._;i?(Ga(s,t,n),n&&Yo(s,"_",i,!0)):Va(t,s)}else t&&qa(e,t)},Pu=(e,t,n)=>{const{vnode:s,slots:i}=e;let r=!0,o=re;if(s.shapeFlag&32){const a=t._;a?n&&a===1?r=!1:Ga(i,t,n):(r=!t.$stable,Va(t,i)),o=t}else t&&(qa(e,t),o={default:1});if(r)for(const a in i)!ur(a)&&o[a]==null&&delete i[a]},Fe=$u;function Lu(e){return Du(e)}function Du(e,t){const n=$s();n.__VUE__=!0;const{insert:s,remove:i,patchProp:r,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:f,nextSibling:p,setScopeId:d=lt,insertStaticContent:b}=e,g=(h,m,y,S=null,A=null,E=null,C=void 0,I=null,R=!!m.dynamicChildren)=>{if(h===m)return;h&&!An(h,m)&&(S=k(h),$e(h,A,E,!0),h=null),m.patchFlag===-2&&(R=!1,m.dynamicChildren=null);const{type:O,ref:j,shapeFlag:D}=m;switch(O){case zs:_(h,m,y,S);break;case Et:v(h,m,y,S);break;case hi:h==null&&w(m,y,S,C);break;case Be:he(h,m,y,S,A,E,C,I,R);break;default:D&1?P(h,m,y,S,A,E,C,I,R):D&6?ae(h,m,y,S,A,E,C,I,R):(D&64||D&128)&&O.process(h,m,y,S,A,E,C,I,R,F)}j!=null&&A?xn(j,h&&h.ref,E,m||h,!m):j==null&&h&&h.ref!=null&&xn(h.ref,null,E,h,!0)},_=(h,m,y,S)=>{if(h==null)s(m.el=a(m.children),y,S);else{const A=m.el=h.el;m.children!==h.children&&l(A,m.children)}},v=(h,m,y,S)=>{h==null?s(m.el=c(m.children||""),y,S):m.el=h.el},w=(h,m,y,S)=>{[h.el,h.anchor]=b(h.children,m,y,S,h.el,h.anchor)},T=({el:h,anchor:m},y,S)=>{let A;for(;h&&h!==m;)A=p(h),s(h,y,S),h=A;s(m,y,S)},N=({el:h,anchor:m})=>{let y;for(;h&&h!==m;)y=p(h),i(h),h=y;i(m)},P=(h,m,y,S,A,E,C,I,R)=>{if(m.type==="svg"?C="svg":m.type==="math"&&(C="mathml"),h==null)U(m,y,S,A,E,C,I,R);else{const O=h.el&&h.el._isVueCE?h.el:null;try{O&&O._beginPatch(),G(h,m,A,E,C,I,R)}finally{O&&O._endPatch()}}},U=(h,m,y,S,A,E,C,I)=>{let R,O;const{props:j,shapeFlag:D,transition:B,dirs:H}=h;if(R=h.el=o(h.type,E,j&&j.is,j),D&8?u(R,h.children):D&16&&$(h.children,R,null,S,A,di(h,E),C,I),H&&Mt(h,null,S,"created"),M(R,h,h.scopeId,C,S),j){for(const te in j)te!=="value"&&!Cn(te)&&r(R,te,null,j[te],E,S);"value"in j&&r(R,"value",null,j.value,E),(O=j.onVnodeBeforeMount)&&it(O,S,h)}H&&Mt(h,null,S,"beforeMount");const Y=Mu(A,B);Y&&B.beforeEnter(R),s(R,m,y),((O=j&&j.onVnodeMounted)||Y||H)&&Fe(()=>{try{O&&it(O,S,h),Y&&B.enter(R),H&&Mt(h,null,S,"mounted")}finally{}},A)},M=(h,m,y,S,A)=>{if(y&&d(h,y),S)for(let E=0;E<S.length;E++)d(h,S[E]);if(A){let E=A.subTree;if(m===E||Ja(E.type)&&(E.ssContent===m||E.ssFallback===m)){const C=A.vnode;M(h,C,C.scopeId,C.slotScopeIds,A.parent)}}},$=(h,m,y,S,A,E,C,I,R=0)=>{for(let O=R;O<h.length;O++){const j=h[O]=I?gt(h[O]):ct(h[O]);g(null,j,m,y,S,A,E,C,I)}},G=(h,m,y,S,A,E,C)=>{const I=m.el=h.el;let{patchFlag:R,dynamicChildren:O,dirs:j}=m;R|=h.patchFlag&16;const D=h.props||re,B=m.props||re;let H;if(y&&xt(y,!1),(H=B.onVnodeBeforeUpdate)&&it(H,y,m,h),j&&Mt(m,h,y,"beforeUpdate"),y&&xt(y,!0),(D.innerHTML&&B.innerHTML==null||D.textContent&&B.textContent==null)&&u(I,""),O?ne(h.dynamicChildren,O,I,y,S,di(m,A),E):C||J(h,m,I,null,y,S,di(m,A),E,!1),R>0){if(R&16)_e(I,D,B,y,A);else if(R&2&&D.class!==B.class&&r(I,"class",null,B.class,A),R&4&&r(I,"style",D.style,B.style,A),R&8){const Y=m.dynamicProps;for(let te=0;te<Y.length;te++){const se=Y[te],de=D[se],ve=B[se];(ve!==de||se==="value")&&r(I,se,de,ve,A,y)}}R&1&&h.children!==m.children&&u(I,m.children)}else!C&&O==null&&_e(I,D,B,y,A);((H=B.onVnodeUpdated)||j)&&Fe(()=>{H&&it(H,y,m,h),j&&Mt(m,h,y,"updated")},S)},ne=(h,m,y,S,A,E,C)=>{for(let I=0;I<m.length;I++){const R=h[I],O=m[I],j=R.el&&(R.type===Be||!An(R,O)||R.shapeFlag&198)?f(R.el):y;g(R,O,j,null,S,A,E,C,!0)}},_e=(h,m,y,S,A)=>{if(m!==y){if(m!==re)for(const E in m)!Cn(E)&&!(E in y)&&r(h,E,m[E],null,A,S);for(const E in y){if(Cn(E))continue;const C=y[E],I=m[E];C!==I&&E!=="value"&&r(h,E,I,C,A,S)}"value"in y&&r(h,"value",m.value,y.value,A)}},he=(h,m,y,S,A,E,C,I,R)=>{const O=m.el=h?h.el:a(""),j=m.anchor=h?h.anchor:a("");let{patchFlag:D,dynamicChildren:B,slotScopeIds:H}=m;H&&(I=I?I.concat(H):H),h==null?(s(O,y,S),s(j,y,S),$(m.children||[],y,j,A,E,C,I,R)):D>0&&D&64&&B&&h.dynamicChildren&&h.dynamicChildren.length===B.length?(ne(h.dynamicChildren,B,y,A,E,C,I),(m.key!=null||A&&m===A.subTree)&&za(h,m,!0)):J(h,m,y,j,A,E,C,I,R)},ae=(h,m,y,S,A,E,C,I,R)=>{m.slotScopeIds=I,h==null?m.shapeFlag&512?A.ctx.activate(m,y,S,C,R):At(m,y,S,A,E,C,R):zt(h,m,R)},At=(h,m,y,S,A,E,C)=>{const I=h.component=Vu(h,S,A);if(Na(h)&&(I.ctx.renderer=F),qu(I,!1,C),I.asyncDep){if(A&&A.registerDep(I,be,C),!h.el){const R=I.subTree=ge(Et);v(null,R,m,y),h.placeholder=R.el}}else be(I,h,m,y,A,E,C)},zt=(h,m,y)=>{const S=m.component=h.component;if(Au(h,m,y))if(S.asyncDep&&!S.asyncResolved){ee(S,m,y);return}else S.next=m,S.update();else m.el=h.el,S.vnode=m},be=(h,m,y,S,A,E,C)=>{const I=()=>{if(h.isMounted){let{next:D,bu:B,u:H,parent:Y,vnode:te}=h;{const nt=Ya(h);if(nt){D&&(D.el=te.el,ee(h,D,C)),nt.asyncDep.then(()=>{Fe(()=>{h.isUnmounted||O()},A)});return}}let se=D,de;xt(h,!1),D?(D.el=te.el,ee(h,D,C)):D=te,B&&ai(B),(de=D.props&&D.props.onVnodeBeforeUpdate)&&it(de,Y,D,te),xt(h,!0);const ve=Yr(h),tt=h.subTree;h.subTree=ve,g(tt,ve,f(tt.el),k(tt),h,A,E),D.el=ve.el,se===null&&Nu(h,ve.el),H&&Fe(H,A),(de=D.props&&D.props.onVnodeUpdated)&&Fe(()=>it(de,Y,D,te),A)}else{let D;const{el:B,props:H}=m,{bm:Y,m:te,parent:se,root:de,type:ve}=h,tt=cn(m);xt(h,!1),Y&&ai(Y),!tt&&(D=H&&H.onVnodeBeforeMount)&&it(D,se,m),xt(h,!0);{de.ce&&de.ce._hasShadowRoot()&&de.ce._injectChildStyle(ve,h.parent?h.parent.type:void 0);const nt=h.subTree=Yr(h);g(null,nt,y,S,h,A,E),m.el=nt.el}if(te&&Fe(te,A),!tt&&(D=H&&H.onVnodeMounted)){const nt=m;Fe(()=>it(D,se,nt),A)}(m.shapeFlag&256||se&&cn(se.vnode)&&se.vnode.shapeFlag&256)&&h.a&&Fe(h.a,A),h.isMounted=!0,m=y=S=null}};h.scope.on();const R=h.effect=new Zo(I);h.scope.off();const O=h.update=R.run.bind(R),j=h.job=R.runIfDirty.bind(R);j.i=h,j.id=h.uid,R.scheduler=()=>or(j),xt(h,!0),O()},ee=(h,m,y)=>{m.component=h;const S=h.vnode.props;h.vnode=m,h.next=null,Ou(h,m.props,S,y),Pu(h,m.children,y),wt(),Br(h),vt()},J=(h,m,y,S,A,E,C,I,R=!1)=>{const O=h&&h.children,j=h?h.shapeFlag:0,D=m.children,{patchFlag:B,shapeFlag:H}=m;if(B>0){if(B&128){Nt(O,D,y,S,A,E,C,I,R);return}else if(B&256){pt(O,D,y,S,A,E,C,I,R);return}}H&8?(j&16&&He(O,A,E),D!==O&&u(y,D)):j&16?H&16?Nt(O,D,y,S,A,E,C,I,R):He(O,A,E,!0):(j&8&&u(y,""),H&16&&$(D,y,S,A,E,C,I,R))},pt=(h,m,y,S,A,E,C,I,R)=>{h=h||rn,m=m||rn;const O=h.length,j=m.length,D=Math.min(O,j);let B;for(B=0;B<D;B++){const H=m[B]=R?gt(m[B]):ct(m[B]);g(h[B],H,y,null,A,E,C,I,R)}O>j?He(h,A,E,!0,!1,D):$(m,y,S,A,E,C,I,R,D)},Nt=(h,m,y,S,A,E,C,I,R)=>{let O=0;const j=m.length;let D=h.length-1,B=j-1;for(;O<=D&&O<=B;){const H=h[O],Y=m[O]=R?gt(m[O]):ct(m[O]);if(An(H,Y))g(H,Y,y,null,A,E,C,I,R);else break;O++}for(;O<=D&&O<=B;){const H=h[D],Y=m[B]=R?gt(m[B]):ct(m[B]);if(An(H,Y))g(H,Y,y,null,A,E,C,I,R);else break;D--,B--}if(O>D){if(O<=B){const H=B+1,Y=H<j?m[H].el:S;for(;O<=B;)g(null,m[O]=R?gt(m[O]):ct(m[O]),y,Y,A,E,C,I,R),O++}}else if(O>B)for(;O<=D;)$e(h[O],A,E,!0),O++;else{const H=O,Y=O,te=new Map;for(O=Y;O<=B;O++){const je=m[O]=R?gt(m[O]):ct(m[O]);je.key!=null&&te.set(je.key,O)}let se,de=0;const ve=B-Y+1;let tt=!1,nt=0;const En=new Array(ve);for(O=0;O<ve;O++)En[O]=0;for(O=H;O<=D;O++){const je=h[O];if(de>=ve){$e(je,A,E,!0);continue}let st;if(je.key!=null)st=te.get(je.key);else for(se=Y;se<=B;se++)if(En[se-Y]===0&&An(je,m[se])){st=se;break}st===void 0?$e(je,A,E,!0):(En[st-Y]=O+1,st>=nt?nt=st:tt=!0,g(je,m[st],y,null,A,E,C,I,R),de++)}const Pr=tt?xu(En):rn;for(se=Pr.length-1,O=ve-1;O>=0;O--){const je=Y+O,st=m[je],Lr=m[je+1],Dr=je+1<j?Lr.el||Wa(Lr):S;En[O]===0?g(null,st,y,Dr,A,E,C,I,R):tt&&(se<0||O!==Pr[se]?et(st,y,Dr,2):se--)}}},et=(h,m,y,S,A=null)=>{const{el:E,type:C,transition:I,children:R,shapeFlag:O}=h;if(O&6){et(h.component.subTree,m,y,S);return}if(O&128){h.suspense.move(m,y,S);return}if(O&64){C.move(h,m,y,F);return}if(C===Be){s(E,m,y);for(let D=0;D<R.length;D++)et(R[D],m,y,S);s(h.anchor,m,y);return}if(C===hi){T(h,m,y);return}if(S!==2&&O&1&&I)if(S===0)I.beforeEnter(E),s(E,m,y),Fe(()=>I.enter(E),A);else{const{leave:D,delayLeave:B,afterLeave:H}=I,Y=()=>{h.ctx.isUnmounted?i(E):s(E,m,y)},te=()=>{E._isLeaving&&E[eu](!0),D(E,()=>{Y(),H&&H()})};B?B(E,Y,te):te()}else s(E,m,y)},$e=(h,m,y,S=!1,A=!1)=>{const{type:E,props:C,ref:I,children:R,dynamicChildren:O,shapeFlag:j,patchFlag:D,dirs:B,cacheIndex:H,memo:Y}=h;if(D===-2&&(A=!1),I!=null&&(wt(),xn(I,null,y,h,!0),vt()),H!=null&&(m.renderCache[H]=void 0),j&256){m.ctx.deactivate(h);return}const te=j&1&&B,se=!cn(h);let de;if(se&&(de=C&&C.onVnodeBeforeUnmount)&&it(de,m,h),j&6)Dt(h.component,y,S);else{if(j&128){h.suspense.unmount(y,S);return}te&&Mt(h,null,m,"beforeUnmount"),j&64?h.type.remove(h,m,y,F,S):O&&!O.hasOnce&&(E!==Be||D>0&&D&64)?He(O,m,y,!1,!0):(E===Be&&D&384||!A&&j&16)&&He(R,m,y),S&&Yt(h)}const ve=Y!=null&&H==null;(se&&(de=C&&C.onVnodeUnmounted)||te||ve)&&Fe(()=>{de&&it(de,m,h),te&&Mt(h,null,m,"unmounted"),ve&&(h.el=null)},y)},Yt=h=>{const{type:m,el:y,anchor:S,transition:A}=h;if(m===Be){Wt(y,S);return}if(m===hi){N(h);return}const E=()=>{i(y),A&&!A.persisted&&A.afterLeave&&A.afterLeave()};if(h.shapeFlag&1&&A&&!A.persisted){const{leave:C,delayLeave:I}=A,R=()=>C(y,E);I?I(h.el,E,R):R()}else E()},Wt=(h,m)=>{let y;for(;h!==m;)y=p(h),i(h),h=y;i(m)},Dt=(h,m,y)=>{const{bum:S,scope:A,job:E,subTree:C,um:I,m:R,a:O}=h;Qr(R),Qr(O),S&&ai(S),A.stop(),E&&(E.flags|=8,$e(C,h,m,y)),I&&Fe(I,m),Fe(()=>{h.isUnmounted=!0},m)},He=(h,m,y,S=!1,A=!1,E=0)=>{for(let C=E;C<h.length;C++)$e(h[C],m,y,S,A)},k=h=>{if(h.shapeFlag&6)return k(h.component.subTree);if(h.shapeFlag&128)return h.suspense.next();const m=p(h.anchor||h.el),y=m&&m[Xl];return y?p(y):m};let x=!1;const L=(h,m,y)=>{let S;h==null?m._vnode&&($e(m._vnode,null,null,!0),S=m._vnode.component):g(m._vnode||null,h,m,null,null,null,y),m._vnode=h,x||(x=!0,Br(S),wa(),x=!1)},F={p:g,um:$e,m:et,r:Yt,mt:At,mc:$,pc:J,pbc:ne,n:k,o:e};return{render:L,hydrate:void 0,createApp:bu(L)}}function di({type:e,props:t},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:n}function xt({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Mu(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function za(e,t,n=!1){const s=e.children,i=t.children;if(K(s)&&K(i))for(let r=0;r<s.length;r++){const o=s[r];let a=i[r];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[r]=gt(i[r]),a.el=o.el),!n&&a.patchFlag!==-2&&za(o,a)),a.type===zs&&(a.patchFlag===-1&&(a=i[r]=gt(a)),a.el=o.el),a.type===Et&&!a.el&&(a.el=o.el)}}function xu(e){const t=e.slice(),n=[0];let s,i,r,o,a;const c=e.length;for(s=0;s<c;s++){const l=e[s];if(l!==0){if(i=n[n.length-1],e[i]<l){t[s]=i,n.push(s);continue}for(r=0,o=n.length-1;r<o;)a=r+o>>1,e[n[a]]<l?r=a+1:o=a;l<e[n[r]]&&(r>0&&(t[s]=n[r-1]),n[r]=s)}}for(r=n.length,o=n[r-1];r-- >0;)n[r]=o,o=t[o];return n}function Ya(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Ya(t)}function Qr(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Wa(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Wa(t.subTree):null}const Ja=e=>e.__isSuspense;function $u(e,t){t&&t.pendingBranch?K(e)?t.effects.push(...e):t.effects.push(e):Yl(e)}const Be=Symbol.for("v-fgt"),zs=Symbol.for("v-txt"),Et=Symbol.for("v-cmt"),hi=Symbol.for("v-stc"),Fn=[];let De=null;function Ie(e=!1){Fn.push(De=e?null:[])}function Fu(){Fn.pop(),De=Fn[Fn.length-1]||null}let dn=1;function Os(e,t=!1){dn+=e,e<0&&De&&t&&(De.hasOnce=!0)}function Qa(e){return e.dynamicChildren=dn>0?De||rn:null,Fu(),dn>0&&De&&De.push(e),e}function ot(e,t,n,s,i,r){return Qa(Se(e,t,n,s,i,r,!0))}function qn(e,t,n,s,i){return Qa(ge(e,t,n,s,i,!0))}function Gn(e){return e?e.__v_isVNode===!0:!1}function An(e,t){return e.type===t.type&&e.key===t.key}const Xa=({key:e})=>e??null,gs=({ref:e,ref_key:t,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?fe(e)||ye(e)||V(e)?{i:Le,r:e,k:t,f:!!n}:e:null);function Se(e,t=null,n=null,s=0,i=null,r=e===Be?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Xa(t),ref:t&&gs(t),scopeId:Sa,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:r,patchFlag:s,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:Le};return a?(pr(c,n),r&128&&e.normalize(c)):n&&(c.shapeFlag|=fe(n)?8:16),dn>0&&!o&&De&&(c.patchFlag>0||r&6)&&c.patchFlag!==32&&De.push(c),c}const ge=Bu;function Bu(e,t=null,n=null,s=0,i=null,r=!1){if((!e||e===Ia)&&(e=Et),Gn(e)){const a=hn(e,t,!0);return n&&pr(a,n),dn>0&&!r&&De&&(a.shapeFlag&6?De[De.indexOf(e)]=a:De.push(a)),a.patchFlag=-2,a}if(Wu(e)&&(e=e.__vccOpts),t){t=ju(t);let{class:a,style:c}=t;a&&!fe(a)&&(t.class=Fs(a)),Z(c)&&(Ks(c)&&!K(c)&&(c=Ee({},c)),t.style=Zi(c))}const o=fe(e)?1:Ja(e)?128:Zl(e)?64:Z(e)?4:V(e)?2:0;return Se(e,t,n,s,i,o,r,!0)}function ju(e){return e?Ks(e)||Ua(e)?Ee({},e):e:null}function hn(e,t,n=!1,s=!1){const{props:i,ref:r,patchFlag:o,children:a,transition:c}=e,l=t?Uu(i||{},t):i,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Xa(l),ref:t&&t.ref?n&&r?K(r)?r.concat(gs(t)):[r,gs(t)]:gs(t):r,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==Be?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:c,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&hn(e.ssContent),ssFallback:e.ssFallback&&hn(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return c&&s&&ar(u,c.clone(u)),u}function ys(e=" ",t=0){return ge(zs,null,e,t)}function Xr(e="",t=!1){return t?(Ie(),qn(Et,null,e)):ge(Et,null,e)}function ct(e){return e==null||typeof e=="boolean"?ge(Et):K(e)?ge(Be,null,e.slice()):Gn(e)?gt(e):ge(zs,null,String(e))}function gt(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:hn(e)}function pr(e,t){let n=0;const{shapeFlag:s}=e;if(t==null)t=null;else if(K(t))n=16;else if(typeof t=="object")if(s&65){const i=t.default;i&&(i._c&&(i._d=!1),pr(e,i()),i._c&&(i._d=!0));return}else{n=32;const i=t._;!i&&!Ua(t)?t._ctx=Le:i===3&&Le&&(Le.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else V(t)?(t={default:t,_ctx:Le},n=32):(t=String(t),s&64?(n=16,t=[ys(t)]):n=8);e.children=t,e.shapeFlag|=n}function Uu(...e){const t={};for(let n=0;n<e.length;n++){const s=e[n];for(const i in s)if(i==="class")t.class!==s.class&&(t.class=Fs([t.class,s.class]));else if(i==="style")t.style=Zi([t.style,s.style]);else if(Ps(i)){const r=t[i],o=s[i];o&&r!==o&&!(K(r)&&r.includes(o))?t[i]=r?[].concat(r,o):o:o==null&&r==null&&!Ls(i)&&(t[i]=o)}else i!==""&&(t[i]=s[i])}return t}function it(e,t,n,s=null){ut(e,t,7,[n,s])}const Ku=xa();let Hu=0;function Vu(e,t,n){const s=e.type,i=(t?t.appContext:e.appContext)||Ku,r={uid:Hu++,vnode:e,type:s,parent:t,appContext:i,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Xo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(i.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Ha(s,i),emitsOptions:$a(s,i),emit:null,emitted:null,propsDefaults:re,inheritAttrs:s.inheritAttrs,ctx:re,data:re,props:re,attrs:re,slots:re,refs:re,setupState:re,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return r.ctx={_:r},r.root=t?t.root:r,r.emit=vu.bind(null,r),e.ce&&e.ce(r),r}let Ne=null;const Za=()=>Ne||Le;let Rs,$i;{const e=$s(),t=(n,s)=>{let i;return(i=e[n])||(i=e[n]=[]),i.push(s),r=>{i.length>1?i.forEach(o=>o(r)):i[0](r)}};Rs=t("__VUE_INSTANCE_SETTERS__",n=>Ne=n),$i=t("__VUE_SSR_SETTERS__",n=>zn=n)}const ts=e=>{const t=Ne;return Rs(e),e.scope.on(),()=>{e.scope.off(),Rs(t)}},Zr=()=>{Ne&&Ne.scope.off(),Rs(null)};function ec(e){return e.vnode.shapeFlag&4}let zn=!1;function qu(e,t=!1,n=!1){t&&$i(t);const{props:s,children:i}=e.vnode,r=ec(e);Tu(e,s,r,t),Cu(e,i,n||t);const o=r?Gu(e,t):void 0;return t&&$i(!1),o}function Gu(e,t){const n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,pu);const{setup:s}=n;if(s){wt();const i=e.setupContext=s.length>1?nc(e):null,r=ts(e),o=Zn(s,e,0,[e.props,i]),a=qo(o);if(vt(),r(),(a||e.sp)&&!cn(e)&&Aa(e),a){if(o.then(Zr,Zr),t)return o.then(c=>{eo(e,c)}).catch(c=>{Vs(c,e,0)});e.asyncDep=o}else eo(e,o)}else tc(e)}function eo(e,t,n){V(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Z(t)&&(e.setupState=ma(t)),tc(e)}function tc(e,t,n){const s=e.type;e.render||(e.render=s.render||lt);{const i=ts(e);wt();try{du(e)}finally{vt(),i()}}}const zu={get(e,t){return Ae(e,"get",""),e[t]}};function nc(e){const t=n=>{e.exposed=n||{}};return{attrs:new Proxy(e.attrs,zu),slots:e.slots,emit:e.emit,expose:t}}function dr(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(ma(Ml(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in $n)return $n[n](e)},has(t,n){return n in t||n in $n}})):e.proxy}function Yu(e,t=!0){return V(e)?e.displayName||e.name:e.name||t&&e.__name}function Wu(e){return V(e)&&"__vccOpts"in e}const Pe=(e,t)=>Hl(e,t,zn);function Yn(e,t,n){try{Os(-1);const s=arguments.length;return s===2?Z(t)&&!K(t)?Gn(t)?ge(e,null,[t]):ge(e,t):ge(e,null,t):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&Gn(n)&&(n=[n]),ge(e,t,n))}finally{Os(1)}}function Gh(e,t){const n=e.memo;if(n.length!=t.length)return!1;for(let s=0;s<n.length;s++)if(Ye(n[s],t[s]))return!1;return dn>0&&De&&De.push(e),!0}const Ju="3.5.31";/**
* @vue/runtime-dom v3.5.31
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Fi;const to=typeof window<"u"&&window.trustedTypes;if(to)try{Fi=to.createPolicy("vue",{createHTML:e=>e})}catch{}const sc=Fi?e=>Fi.createHTML(e):e=>e,Qu="http://www.w3.org/2000/svg",Xu="http://www.w3.org/1998/Math/MathML",mt=typeof document<"u"?document:null,no=mt&&mt.createElement("template"),Zu={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,s)=>{const i=t==="svg"?mt.createElementNS(Qu,e):t==="mathml"?mt.createElementNS(Xu,e):n?mt.createElement(e,{is:n}):mt.createElement(e);return e==="select"&&s&&s.multiple!=null&&i.setAttribute("multiple",s.multiple),i},createText:e=>mt.createTextNode(e),createComment:e=>mt.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>mt.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,n,s,i,r){const o=n?n.previousSibling:t.lastChild;if(i&&(i===r||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),n),!(i===r||!(i=i.nextSibling)););else{no.innerHTML=sc(s==="svg"?`<svg>${e}</svg>`:s==="mathml"?`<math>${e}</math>`:e);const a=no.content;if(s==="svg"||s==="mathml"){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}t.insertBefore(a,n)}return[o?o.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},ef=Symbol("_vtc");function tf(e,t,n){const s=e[ef];s&&(t=(t?[t,...s]:[...s]).join(" ")),t==null?e.removeAttribute("class"):n?e.setAttribute("class",t):e.className=t}const so=Symbol("_vod"),nf=Symbol("_vsh"),sf=Symbol(""),rf=/(?:^|;)\s*display\s*:/;function of(e,t,n){const s=e.style,i=fe(n);let r=!1;if(n&&!i){if(t)if(fe(t))for(const o of t.split(";")){const a=o.slice(0,o.indexOf(":")).trim();n[a]==null&&_s(s,a,"")}else for(const o in t)n[o]==null&&_s(s,o,"");for(const o in n)o==="display"&&(r=!0),_s(s,o,n[o])}else if(i){if(t!==n){const o=s[sf];o&&(n+=";"+o),s.cssText=n,r=rf.test(n)}}else t&&e.removeAttribute("style");so in e&&(e[so]=r?s.display:"",e[nf]&&(s.display="none"))}const io=/\s*!important$/;function _s(e,t,n){if(K(n))n.forEach(s=>_s(e,t,s));else if(n==null&&(n=""),t.startsWith("--"))e.setProperty(t,n);else{const s=af(e,t);io.test(n)?e.setProperty(qt(s),n.replace(io,""),"important"):e[s]=n}}const ro=["Webkit","Moz","ms"],mi={};function af(e,t){const n=mi[t];if(n)return n;let s=Me(t);if(s!=="filter"&&s in e)return mi[t]=s;s=xs(s);for(let i=0;i<ro.length;i++){const r=ro[i]+s;if(r in e)return mi[t]=r}return t}const oo="http://www.w3.org/1999/xlink";function ao(e,t,n,s,i,r=dl(t)){s&&t.startsWith("xlink:")?n==null?e.removeAttributeNS(oo,t.slice(6,t.length)):e.setAttributeNS(oo,t,n):n==null||r&&!Wo(n)?e.removeAttribute(t):e.setAttribute(t,r?"":Ke(n)?String(n):n)}function co(e,t,n,s,i){if(t==="innerHTML"||t==="textContent"){n!=null&&(e[t]=t==="innerHTML"?sc(n):n);return}const r=e.tagName;if(t==="value"&&r!=="PROGRESS"&&!r.includes("-")){const a=r==="OPTION"?e.getAttribute("value")||"":e.value,c=n==null?e.type==="checkbox"?"on":"":String(n);(a!==c||!("_value"in e))&&(e.value=c),n==null&&e.removeAttribute(t),e._value=n;return}let o=!1;if(n===""||n==null){const a=typeof e[t];a==="boolean"?n=Wo(n):n==null&&a==="string"?(n="",o=!0):a==="number"&&(n=0,o=!0)}try{e[t]=n}catch{}o&&e.removeAttribute(i||t)}function cf(e,t,n,s){e.addEventListener(t,n,s)}function lf(e,t,n,s){e.removeEventListener(t,n,s)}const lo=Symbol("_vei");function uf(e,t,n,s,i=null){const r=e[lo]||(e[lo]={}),o=r[t];if(s&&o)o.value=s;else{const[a,c]=ff(t);if(s){const l=r[t]=hf(s,i);cf(e,a,l,c)}else o&&(lf(e,a,o,c),r[t]=void 0)}}const uo=/(?:Once|Passive|Capture)$/;function ff(e){let t;if(uo.test(e)){t={};let s;for(;s=e.match(uo);)e=e.slice(0,e.length-s[0].length),t[s[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):qt(e.slice(2)),t]}let gi=0;const pf=Promise.resolve(),df=()=>gi||(pf.then(()=>gi=0),gi=Date.now());function hf(e,t){const n=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=n.attached)return;ut(mf(s,n.value),t,5,[s])};return n.value=e,n.attached=df(),n}function mf(e,t){if(K(t)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},t.map(s=>i=>!i._stopped&&s&&s(i))}else return t}const fo=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,gf=(e,t,n,s,i,r)=>{const o=i==="svg";t==="class"?tf(e,s,o):t==="style"?of(e,n,s):Ps(t)?Ls(t)||uf(e,t,n,s,r):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):yf(e,t,s,o))?(co(e,t,s),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&ao(e,t,s,o,r,t!=="value")):e._isVueCE&&(_f(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!fe(s)))?co(e,Me(t),s,r,t):(t==="true-value"?e._trueValue=s:t==="false-value"&&(e._falseValue=s),ao(e,t,s,o))};function yf(e,t,n,s){if(s)return!!(t==="innerHTML"||t==="textContent"||t in e&&fo(t)&&V(n));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const i=e.tagName;if(i==="IMG"||i==="VIDEO"||i==="CANVAS"||i==="SOURCE")return!1}return fo(t)&&fe(n)?!1:t in e}function _f(e,t){const n=e._def.props;if(!n)return!1;const s=Me(t);return Array.isArray(n)?n.some(i=>Me(i)===s):Object.keys(n).some(i=>Me(i)===s)}const bf=Ee({patchProp:gf},Zu);let po;function wf(){return po||(po=Lu(bf))}const vf=((...e)=>{const t=wf().createApp(...e),{mount:n}=t;return t.mount=s=>{const i=Ef(s);if(!i)return;const r=t._component;!V(r)&&!r.render&&!r.template&&(r.template=i.innerHTML),i.nodeType===1&&(i.textContent="");const o=n(i,!1,Sf(i));return i instanceof Element&&(i.removeAttribute("v-cloak"),i.setAttribute("data-v-app","")),o},t});function Sf(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function Ef(e){return fe(e)?document.querySelector(e):e}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const en=typeof document<"u";function ic(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function kf(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&ic(e.default)}const Q=Object.assign;function yi(e,t){const n={};for(const s in t){const i=t[s];n[s]=Xe(i)?i.map(e):e(i)}return n}const Bn=()=>{},Xe=Array.isArray;function ho(e,t){const n={};for(const s in e)n[s]=s in t?t[s]:e[s];return n}const rc=/#/g,Af=/&/g,Nf=/\//g,Tf=/=/g,Of=/\?/g,oc=/\+/g,Rf=/%5B/g,If=/%5D/g,ac=/%5E/g,Cf=/%60/g,cc=/%7B/g,Pf=/%7C/g,lc=/%7D/g,Lf=/%20/g;function hr(e){return e==null?"":encodeURI(""+e).replace(Pf,"|").replace(Rf,"[").replace(If,"]")}function Df(e){return hr(e).replace(cc,"{").replace(lc,"}").replace(ac,"^")}function Bi(e){return hr(e).replace(oc,"%2B").replace(Lf,"+").replace(rc,"%23").replace(Af,"%26").replace(Cf,"`").replace(cc,"{").replace(lc,"}").replace(ac,"^")}function Mf(e){return Bi(e).replace(Tf,"%3D")}function xf(e){return hr(e).replace(rc,"%23").replace(Of,"%3F")}function $f(e){return xf(e).replace(Nf,"%2F")}function Wn(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const Ff=/\/$/,Bf=e=>e.replace(Ff,"");function _i(e,t,n="/"){let s,i={},r="",o="";const a=t.indexOf("#");let c=t.indexOf("?");return c=a>=0&&c>a?-1:c,c>=0&&(s=t.slice(0,c),r=t.slice(c,a>0?a:t.length),i=e(r.slice(1))),a>=0&&(s=s||t.slice(0,a),o=t.slice(a,t.length)),s=Hf(s??t,n),{fullPath:s+r+o,path:s,query:i,hash:Wn(o)}}function jf(e,t){const n=t.query?e(t.query):"";return t.path+(n&&"?")+n+(t.hash||"")}function mo(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Uf(e,t,n){const s=t.matched.length-1,i=n.matched.length-1;return s>-1&&s===i&&mn(t.matched[s],n.matched[i])&&uc(t.params,n.params)&&e(t.query)===e(n.query)&&t.hash===n.hash}function mn(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function uc(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var n in e)if(!Kf(e[n],t[n]))return!1;return!0}function Kf(e,t){return Xe(e)?go(e,t):Xe(t)?go(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function go(e,t){return Xe(t)?e.length===t.length&&e.every((n,s)=>n===t[s]):e.length===1&&e[0]===t}function Hf(e,t){if(e.startsWith("/"))return e;if(!e)return t;const n=t.split("/"),s=e.split("/"),i=s[s.length-1];(i===".."||i===".")&&s.push("");let r=n.length-1,o,a;for(o=0;o<s.length;o++)if(a=s[o],a!==".")if(a==="..")r>1&&r--;else break;return n.slice(0,r).join("/")+"/"+s.slice(o).join("/")}const Tt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let ji=(function(e){return e.pop="pop",e.push="push",e})({}),bi=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Vf(e){if(!e)if(en){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Bf(e)}const qf=/^[^#]+#/;function Gf(e,t){return e.replace(qf,"#")+t}function zf(e,t){const n=document.documentElement.getBoundingClientRect(),s=e.getBoundingClientRect();return{behavior:t.behavior,left:s.left-n.left-(t.left||0),top:s.top-n.top-(t.top||0)}}const Ys=()=>({left:window.scrollX,top:window.scrollY});function Yf(e){let t;if("el"in e){const n=e.el,s=typeof n=="string"&&n.startsWith("#"),i=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;t=zf(i,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function yo(e,t){return(history.state?history.state.position-t:-1)+e}const Ui=new Map;function Wf(e,t){Ui.set(e,t)}function Jf(e){const t=Ui.get(e);return Ui.delete(e),t}function Qf(e){return typeof e=="string"||e&&typeof e=="object"}function fc(e){return typeof e=="string"||typeof e=="symbol"}let ce=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const pc=Symbol("");ce.MATCHER_NOT_FOUND+"",ce.NAVIGATION_GUARD_REDIRECT+"",ce.NAVIGATION_ABORTED+"",ce.NAVIGATION_CANCELLED+"",ce.NAVIGATION_DUPLICATED+"";function gn(e,t){return Q(new Error,{type:e,[pc]:!0},t)}function ht(e,t){return e instanceof Error&&pc in e&&(t==null||!!(e.type&t))}const Xf=["params","query","hash"];function Zf(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const n of Xf)n in e&&(t[n]=e[n]);return JSON.stringify(t,null,2)}function ep(e){const t={};if(e===""||e==="?")return t;const n=(e[0]==="?"?e.slice(1):e).split("&");for(let s=0;s<n.length;++s){const i=n[s].replace(oc," "),r=i.indexOf("="),o=Wn(r<0?i:i.slice(0,r)),a=r<0?null:Wn(i.slice(r+1));if(o in t){let c=t[o];Xe(c)||(c=t[o]=[c]),c.push(a)}else t[o]=a}return t}function _o(e){let t="";for(let n in e){const s=e[n];if(n=Mf(n),s==null){s!==void 0&&(t+=(t.length?"&":"")+n);continue}(Xe(s)?s.map(i=>i&&Bi(i)):[s&&Bi(s)]).forEach(i=>{i!==void 0&&(t+=(t.length?"&":"")+n,i!=null&&(t+="="+i))})}return t}function tp(e){const t={};for(const n in e){const s=e[n];s!==void 0&&(t[n]=Xe(s)?s.map(i=>i==null?null:""+i):s==null?s:""+s)}return t}const np=Symbol(""),bo=Symbol(""),Ws=Symbol(""),mr=Symbol(""),Ki=Symbol("");function Nn(){let e=[];function t(s){return e.push(s),()=>{const i=e.indexOf(s);i>-1&&e.splice(i,1)}}function n(){e=[]}return{add:t,list:()=>e.slice(),reset:n}}function Rt(e,t,n,s,i,r=o=>o()){const o=s&&(s.enterCallbacks[i]=s.enterCallbacks[i]||[]);return()=>new Promise((a,c)=>{const l=p=>{p===!1?c(gn(ce.NAVIGATION_ABORTED,{from:n,to:t})):p instanceof Error?c(p):Qf(p)?c(gn(ce.NAVIGATION_GUARD_REDIRECT,{from:t,to:p})):(o&&s.enterCallbacks[i]===o&&typeof p=="function"&&o.push(p),a())},u=r(()=>e.call(s&&s.instances[i],t,n,l));let f=Promise.resolve(u);e.length<3&&(f=f.then(l)),f.catch(p=>c(p))})}function wi(e,t,n,s,i=r=>r()){const r=[];for(const o of e)for(const a in o.components){let c=o.components[a];if(!(t!=="beforeRouteEnter"&&!o.instances[a]))if(ic(c)){const l=(c.__vccOpts||c)[t];l&&r.push(Rt(l,n,s,o,a,i))}else{let l=c();r.push(()=>l.then(u=>{if(!u)throw new Error(`Couldn't resolve component "${a}" at "${o.path}"`);const f=kf(u)?u.default:u;o.mods[a]=u,o.components[a]=f;const p=(f.__vccOpts||f)[t];return p&&Rt(p,n,s,o,a,i)()}))}}return r}function sp(e,t){const n=[],s=[],i=[],r=Math.max(t.matched.length,e.matched.length);for(let o=0;o<r;o++){const a=t.matched[o];a&&(e.matched.find(l=>mn(l,a))?s.push(a):n.push(a));const c=e.matched[o];c&&(t.matched.find(l=>mn(l,c))||i.push(c))}return[n,s,i]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let ip=()=>location.protocol+"//"+location.host;function dc(e,t){const{pathname:n,search:s,hash:i}=t,r=e.indexOf("#");if(r>-1){let o=i.includes(e.slice(r))?e.slice(r).length:1,a=i.slice(o);return a[0]!=="/"&&(a="/"+a),mo(a,"")}return mo(n,e)+s+i}function rp(e,t,n,s){let i=[],r=[],o=null;const a=({state:p})=>{const d=dc(e,location),b=n.value,g=t.value;let _=0;if(p){if(n.value=d,t.value=p,o&&o===b){o=null;return}_=g?p.position-g.position:0}else s(d);i.forEach(v=>{v(n.value,b,{delta:_,type:ji.pop,direction:_?_>0?bi.forward:bi.back:bi.unknown})})};function c(){o=n.value}function l(p){i.push(p);const d=()=>{const b=i.indexOf(p);b>-1&&i.splice(b,1)};return r.push(d),d}function u(){if(document.visibilityState==="hidden"){const{history:p}=window;if(!p.state)return;p.replaceState(Q({},p.state,{scroll:Ys()}),"")}}function f(){for(const p of r)p();r=[],window.removeEventListener("popstate",a),window.removeEventListener("pagehide",u),document.removeEventListener("visibilitychange",u)}return window.addEventListener("popstate",a),window.addEventListener("pagehide",u),document.addEventListener("visibilitychange",u),{pauseListeners:c,listen:l,destroy:f}}function wo(e,t,n,s=!1,i=!1){return{back:e,current:t,forward:n,replaced:s,position:window.history.length,scroll:i?Ys():null}}function op(e){const{history:t,location:n}=window,s={value:dc(e,n)},i={value:t.state};i.value||r(s.value,{back:null,current:s.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function r(c,l,u){const f=e.indexOf("#"),p=f>-1?(n.host&&document.querySelector("base")?e:e.slice(f))+c:ip()+e+c;try{t[u?"replaceState":"pushState"](l,"",p),i.value=l}catch(d){console.error(d),n[u?"replace":"assign"](p)}}function o(c,l){r(c,Q({},t.state,wo(i.value.back,c,i.value.forward,!0),l,{position:i.value.position}),!0),s.value=c}function a(c,l){const u=Q({},i.value,t.state,{forward:c,scroll:Ys()});r(u.current,u,!0),r(c,Q({},wo(s.value,c,null),{position:u.position+1},l),!1),s.value=c}return{location:s,state:i,push:a,replace:o}}function ap(e){e=Vf(e);const t=op(e),n=rp(e,t.state,t.location,t.replace);function s(r,o=!0){o||n.pauseListeners(),history.go(r)}const i=Q({location:"",base:e,go:s,createHref:Gf.bind(null,e)},t,n);return Object.defineProperty(i,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(i,"state",{enumerable:!0,get:()=>t.state.value}),i}function cp(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),ap(e)}let Bt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var me=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(me||{});const lp={type:Bt.Static,value:""},up=/[a-zA-Z0-9_]/;function fp(e){if(!e)return[[]];if(e==="/")return[[lp]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(d){throw new Error(`ERR (${n})/"${l}": ${d}`)}let n=me.Static,s=n;const i=[];let r;function o(){r&&i.push(r),r=[]}let a=0,c,l="",u="";function f(){l&&(n===me.Static?r.push({type:Bt.Static,value:l}):n===me.Param||n===me.ParamRegExp||n===me.ParamRegExpEnd?(r.length>1&&(c==="*"||c==="+")&&t(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),r.push({type:Bt.Param,value:l,regexp:u,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):t("Invalid state to consume buffer"),l="")}function p(){l+=c}for(;a<e.length;){if(c=e[a++],c==="\\"&&n!==me.ParamRegExp){s=n,n=me.EscapeNext;continue}switch(n){case me.Static:c==="/"?(l&&f(),o()):c===":"?(f(),n=me.Param):p();break;case me.EscapeNext:p(),n=s;break;case me.Param:c==="("?n=me.ParamRegExp:up.test(c)?p():(f(),n=me.Static,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case me.ParamRegExp:c===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+c:n=me.ParamRegExpEnd:u+=c;break;case me.ParamRegExpEnd:f(),n=me.Static,c!=="*"&&c!=="?"&&c!=="+"&&a--,u="";break;default:t("Unknown state");break}}return n===me.ParamRegExp&&t(`Unfinished custom RegExp for param "${l}"`),f(),o(),i}const vo="[^/]+?",pp={sensitive:!1,strict:!1,start:!0,end:!0};var Oe=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Oe||{});const dp=/[.+*?^${}()[\]/\\]/g;function hp(e,t){const n=Q({},pp,t),s=[];let i=n.start?"^":"";const r=[];for(const l of e){const u=l.length?[]:[Oe.Root];n.strict&&!l.length&&(i+="/");for(let f=0;f<l.length;f++){const p=l[f];let d=Oe.Segment+(n.sensitive?Oe.BonusCaseSensitive:0);if(p.type===Bt.Static)f||(i+="/"),i+=p.value.replace(dp,"\\$&"),d+=Oe.Static;else if(p.type===Bt.Param){const{value:b,repeatable:g,optional:_,regexp:v}=p;r.push({name:b,repeatable:g,optional:_});const w=v||vo;if(w!==vo){d+=Oe.BonusCustomRegExp;try{`${w}`}catch(N){throw new Error(`Invalid custom RegExp for param "${b}" (${w}): `+N.message)}}let T=g?`((?:${w})(?:/(?:${w}))*)`:`(${w})`;f||(T=_&&l.length<2?`(?:/${T})`:"/"+T),_&&(T+="?"),i+=T,d+=Oe.Dynamic,_&&(d+=Oe.BonusOptional),g&&(d+=Oe.BonusRepeatable),w===".*"&&(d+=Oe.BonusWildcard)}u.push(d)}s.push(u)}if(n.strict&&n.end){const l=s.length-1;s[l][s[l].length-1]+=Oe.BonusStrict}n.strict||(i+="/?"),n.end?i+="$":n.strict&&!i.endsWith("/")&&(i+="(?:/|$)");const o=new RegExp(i,n.sensitive?"":"i");function a(l){const u=l.match(o),f={};if(!u)return null;for(let p=1;p<u.length;p++){const d=u[p]||"",b=r[p-1];f[b.name]=d&&b.repeatable?d.split("/"):d}return f}function c(l){let u="",f=!1;for(const p of e){(!f||!u.endsWith("/"))&&(u+="/"),f=!1;for(const d of p)if(d.type===Bt.Static)u+=d.value;else if(d.type===Bt.Param){const{value:b,repeatable:g,optional:_}=d,v=b in l?l[b]:"";if(Xe(v)&&!g)throw new Error(`Provided param "${b}" is an array but it is not repeatable (* or + modifiers)`);const w=Xe(v)?v.join("/"):v;if(!w)if(_)p.length<2&&(u.endsWith("/")?u=u.slice(0,-1):f=!0);else throw new Error(`Missing required param "${b}"`);u+=w}}return u||"/"}return{re:o,score:s,keys:r,parse:a,stringify:c}}function mp(e,t){let n=0;for(;n<e.length&&n<t.length;){const s=t[n]-e[n];if(s)return s;n++}return e.length<t.length?e.length===1&&e[0]===Oe.Static+Oe.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Oe.Static+Oe.Segment?1:-1:0}function hc(e,t){let n=0;const s=e.score,i=t.score;for(;n<s.length&&n<i.length;){const r=mp(s[n],i[n]);if(r)return r;n++}if(Math.abs(i.length-s.length)===1){if(So(s))return 1;if(So(i))return-1}return i.length-s.length}function So(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const gp={strict:!1,end:!0,sensitive:!1};function yp(e,t,n){const s=hp(fp(e.path),n),i=Q(s,{record:e,parent:t,children:[],alias:[]});return t&&!i.record.aliasOf==!t.record.aliasOf&&t.children.push(i),i}function _p(e,t){const n=[],s=new Map;t=ho(gp,t);function i(f){return s.get(f)}function r(f,p,d){const b=!d,g=ko(f);g.aliasOf=d&&d.record;const _=ho(t,f),v=[g];if("alias"in f){const N=typeof f.alias=="string"?[f.alias]:f.alias;for(const P of N)v.push(ko(Q({},g,{components:d?d.record.components:g.components,path:P,aliasOf:d?d.record:g})))}let w,T;for(const N of v){const{path:P}=N;if(p&&P[0]!=="/"){const U=p.record.path,M=U[U.length-1]==="/"?"":"/";N.path=p.record.path+(P&&M+P)}if(w=yp(N,p,_),d?d.alias.push(w):(T=T||w,T!==w&&T.alias.push(w),b&&f.name&&!Ao(w)&&o(f.name)),mc(w)&&c(w),g.children){const U=g.children;for(let M=0;M<U.length;M++)r(U[M],w,d&&d.children[M])}d=d||w}return T?()=>{o(T)}:Bn}function o(f){if(fc(f)){const p=s.get(f);p&&(s.delete(f),n.splice(n.indexOf(p),1),p.children.forEach(o),p.alias.forEach(o))}else{const p=n.indexOf(f);p>-1&&(n.splice(p,1),f.record.name&&s.delete(f.record.name),f.children.forEach(o),f.alias.forEach(o))}}function a(){return n}function c(f){const p=vp(f,n);n.splice(p,0,f),f.record.name&&!Ao(f)&&s.set(f.record.name,f)}function l(f,p){let d,b={},g,_;if("name"in f&&f.name){if(d=s.get(f.name),!d)throw gn(ce.MATCHER_NOT_FOUND,{location:f});_=d.record.name,b=Q(Eo(p.params,d.keys.filter(T=>!T.optional).concat(d.parent?d.parent.keys.filter(T=>T.optional):[]).map(T=>T.name)),f.params&&Eo(f.params,d.keys.map(T=>T.name))),g=d.stringify(b)}else if(f.path!=null)g=f.path,d=n.find(T=>T.re.test(g)),d&&(b=d.parse(g),_=d.record.name);else{if(d=p.name?s.get(p.name):n.find(T=>T.re.test(p.path)),!d)throw gn(ce.MATCHER_NOT_FOUND,{location:f,currentLocation:p});_=d.record.name,b=Q({},p.params,f.params),g=d.stringify(b)}const v=[];let w=d;for(;w;)v.unshift(w.record),w=w.parent;return{name:_,path:g,params:b,matched:v,meta:wp(v)}}e.forEach(f=>r(f));function u(){n.length=0,s.clear()}return{addRoute:r,resolve:l,removeRoute:o,clearRoutes:u,getRoutes:a,getRecordMatcher:i}}function Eo(e,t){const n={};for(const s of t)s in e&&(n[s]=e[s]);return n}function ko(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:bp(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function bp(e){const t={},n=e.props||!1;if("component"in e)t.default=n;else for(const s in e.components)t[s]=typeof n=="object"?n[s]:n;return t}function Ao(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function wp(e){return e.reduce((t,n)=>Q(t,n.meta),{})}function vp(e,t){let n=0,s=t.length;for(;n!==s;){const r=n+s>>1;hc(e,t[r])<0?s=r:n=r+1}const i=Sp(e);return i&&(s=t.lastIndexOf(i,s-1)),s}function Sp(e){let t=e;for(;t=t.parent;)if(mc(t)&&hc(e,t)===0)return t}function mc({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function No(e){const t=Je(Ws),n=Je(mr),s=Pe(()=>{const c=we(e.to);return t.resolve(c)}),i=Pe(()=>{const{matched:c}=s.value,{length:l}=c,u=c[l-1],f=n.matched;if(!u||!f.length)return-1;const p=f.findIndex(mn.bind(null,u));if(p>-1)return p;const d=To(c[l-2]);return l>1&&To(u)===d&&f[f.length-1].path!==d?f.findIndex(mn.bind(null,c[l-2])):p}),r=Pe(()=>i.value>-1&&Np(n.params,s.value.params)),o=Pe(()=>i.value>-1&&i.value===n.matched.length-1&&uc(n.params,s.value.params));function a(c={}){if(Ap(c)){const l=t[we(e.replace)?"replace":"push"](we(e.to)).catch(Bn);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>l),l}return Promise.resolve()}return{route:s,href:Pe(()=>s.value.href),isActive:r,isExactActive:o,navigate:a}}function Ep(e){return e.length===1?e[0]:e}const kp=es({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:No,setup(e,{slots:t}){const n=Us(No(e)),{options:s}=Je(Ws),i=Pe(()=>({[Oo(e.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[Oo(e.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const r=t.default&&Ep(t.default(n));return e.custom?r:Yn("a",{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},r)}}}),Hi=kp;function Ap(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Np(e,t){for(const n in t){const s=t[n],i=e[n];if(typeof s=="string"){if(s!==i)return!1}else if(!Xe(i)||i.length!==s.length||s.some((r,o)=>r.valueOf()!==i[o].valueOf()))return!1}return!0}function To(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const Oo=(e,t,n)=>e??t??n,Tp=es({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:n}){const s=Je(Ki),i=Pe(()=>e.route||s.value),r=Je(bo,0),o=Pe(()=>{let l=we(r);const{matched:u}=i.value;let f;for(;(f=u[l])&&!f.components;)l++;return l}),a=Pe(()=>i.value.matched[o.value]);ms(bo,Pe(()=>o.value+1)),ms(np,a),ms(Ki,i);const c=Hs();return Mn(()=>[c.value,a.value,e.name],([l,u,f],[p,d,b])=>{u&&(u.instances[f]=l,d&&d!==u&&l&&l===p&&(u.leaveGuards.size||(u.leaveGuards=d.leaveGuards),u.updateGuards.size||(u.updateGuards=d.updateGuards))),l&&u&&(!d||!mn(u,d)||!p)&&(u.enterCallbacks[f]||[]).forEach(g=>g(l))},{flush:"post"}),()=>{const l=i.value,u=e.name,f=a.value,p=f&&f.components[u];if(!p)return Ro(n.default,{Component:p,route:l});const d=f.props[u],b=d?d===!0?l.params:typeof d=="function"?d(l):d:null,_=Yn(p,Q({},b,t,{onVnodeUnmounted:v=>{v.component.isUnmounted&&(f.instances[u]=null)},ref:c}));return Ro(n.default,{Component:_,route:l})||_}}});function Ro(e,t){if(!e)return null;const n=e(t);return n.length===1?n[0]:n}const Op=Tp;function Rp(e){const t=_p(e.routes,e),n=e.parseQuery||ep,s=e.stringifyQuery||_o,i=e.history,r=Nn(),o=Nn(),a=Nn(),c=xl(Tt);let l=Tt;en&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=yi.bind(null,k=>""+k),f=yi.bind(null,$f),p=yi.bind(null,Wn);function d(k,x){let L,F;return fc(k)?(L=t.getRecordMatcher(k),F=x):F=k,t.addRoute(F,L)}function b(k){const x=t.getRecordMatcher(k);x&&t.removeRoute(x)}function g(){return t.getRoutes().map(k=>k.record)}function _(k){return!!t.getRecordMatcher(k)}function v(k,x){if(x=Q({},x||c.value),typeof k=="string"){const y=_i(n,k,x.path),S=t.resolve({path:y.path},x),A=i.createHref(y.fullPath);return Q(y,S,{params:p(S.params),hash:Wn(y.hash),redirectedFrom:void 0,href:A})}let L;if(k.path!=null)L=Q({},k,{path:_i(n,k.path,x.path).path});else{const y=Q({},k.params);for(const S in y)y[S]==null&&delete y[S];L=Q({},k,{params:f(y)}),x.params=f(x.params)}const F=t.resolve(L,x),z=k.hash||"";F.params=u(p(F.params));const h=jf(s,Q({},k,{hash:Df(z),path:F.path})),m=i.createHref(h);return Q({fullPath:h,hash:z,query:s===_o?tp(k.query):k.query||{}},F,{redirectedFrom:void 0,href:m})}function w(k){return typeof k=="string"?_i(n,k,c.value.path):Q({},k)}function T(k,x){if(l!==k)return gn(ce.NAVIGATION_CANCELLED,{from:x,to:k})}function N(k){return M(k)}function P(k){return N(Q(w(k),{replace:!0}))}function U(k,x){const L=k.matched[k.matched.length-1];if(L&&L.redirect){const{redirect:F}=L;let z=typeof F=="function"?F(k,x):F;return typeof z=="string"&&(z=z.includes("?")||z.includes("#")?z=w(z):{path:z},z.params={}),Q({query:k.query,hash:k.hash,params:z.path!=null?{}:k.params},z)}}function M(k,x){const L=l=v(k),F=c.value,z=k.state,h=k.force,m=k.replace===!0,y=U(L,F);if(y)return M(Q(w(y),{state:typeof y=="object"?Q({},z,y.state):z,force:h,replace:m}),x||L);const S=L;S.redirectedFrom=x;let A;return!h&&Uf(s,F,L)&&(A=gn(ce.NAVIGATION_DUPLICATED,{to:S,from:F}),et(F,F,!0,!1)),(A?Promise.resolve(A):ne(S,F)).catch(E=>ht(E)?ht(E,ce.NAVIGATION_GUARD_REDIRECT)?E:Nt(E):J(E,S,F)).then(E=>{if(E){if(ht(E,ce.NAVIGATION_GUARD_REDIRECT))return M(Q({replace:m},w(E.to),{state:typeof E.to=="object"?Q({},z,E.to.state):z,force:h}),x||S)}else E=he(S,F,!0,m,z);return _e(S,F,E),E})}function $(k,x){const L=T(k,x);return L?Promise.reject(L):Promise.resolve()}function G(k){const x=Wt.values().next().value;return x&&typeof x.runWithContext=="function"?x.runWithContext(k):k()}function ne(k,x){let L;const[F,z,h]=sp(k,x);L=wi(F.reverse(),"beforeRouteLeave",k,x);for(const y of F)y.leaveGuards.forEach(S=>{L.push(Rt(S,k,x))});const m=$.bind(null,k,x);return L.push(m),He(L).then(()=>{L=[];for(const y of r.list())L.push(Rt(y,k,x));return L.push(m),He(L)}).then(()=>{L=wi(z,"beforeRouteUpdate",k,x);for(const y of z)y.updateGuards.forEach(S=>{L.push(Rt(S,k,x))});return L.push(m),He(L)}).then(()=>{L=[];for(const y of h)if(y.beforeEnter)if(Xe(y.beforeEnter))for(const S of y.beforeEnter)L.push(Rt(S,k,x));else L.push(Rt(y.beforeEnter,k,x));return L.push(m),He(L)}).then(()=>(k.matched.forEach(y=>y.enterCallbacks={}),L=wi(h,"beforeRouteEnter",k,x,G),L.push(m),He(L))).then(()=>{L=[];for(const y of o.list())L.push(Rt(y,k,x));return L.push(m),He(L)}).catch(y=>ht(y,ce.NAVIGATION_CANCELLED)?y:Promise.reject(y))}function _e(k,x,L){a.list().forEach(F=>G(()=>F(k,x,L)))}function he(k,x,L,F,z){const h=T(k,x);if(h)return h;const m=x===Tt,y=en?history.state:{};L&&(F||m?i.replace(k.fullPath,Q({scroll:m&&y&&y.scroll},z)):i.push(k.fullPath,z)),c.value=k,et(k,x,L,m),Nt()}let ae;function At(){ae||(ae=i.listen((k,x,L)=>{if(!Dt.listening)return;const F=v(k),z=U(F,Dt.currentRoute.value);if(z){M(Q(z,{replace:!0,force:!0}),F).catch(Bn);return}l=F;const h=c.value;en&&Wf(yo(h.fullPath,L.delta),Ys()),ne(F,h).catch(m=>ht(m,ce.NAVIGATION_ABORTED|ce.NAVIGATION_CANCELLED)?m:ht(m,ce.NAVIGATION_GUARD_REDIRECT)?(M(Q(w(m.to),{force:!0}),F).then(y=>{ht(y,ce.NAVIGATION_ABORTED|ce.NAVIGATION_DUPLICATED)&&!L.delta&&L.type===ji.pop&&i.go(-1,!1)}).catch(Bn),Promise.reject()):(L.delta&&i.go(-L.delta,!1),J(m,F,h))).then(m=>{m=m||he(F,h,!1),m&&(L.delta&&!ht(m,ce.NAVIGATION_CANCELLED)?i.go(-L.delta,!1):L.type===ji.pop&&ht(m,ce.NAVIGATION_ABORTED|ce.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),_e(F,h,m)}).catch(Bn)}))}let zt=Nn(),be=Nn(),ee;function J(k,x,L){Nt(k);const F=be.list();return F.length?F.forEach(z=>z(k,x,L)):console.error(k),Promise.reject(k)}function pt(){return ee&&c.value!==Tt?Promise.resolve():new Promise((k,x)=>{zt.add([k,x])})}function Nt(k){return ee||(ee=!k,At(),zt.list().forEach(([x,L])=>k?L(k):x()),zt.reset()),k}function et(k,x,L,F){const{scrollBehavior:z}=e;if(!en||!z)return Promise.resolve();const h=!L&&Jf(yo(k.fullPath,0))||(F||!L)&&history.state&&history.state.scroll||null;return _a().then(()=>z(k,x,h)).then(m=>m&&Yf(m)).catch(m=>J(m,k,x))}const $e=k=>i.go(k);let Yt;const Wt=new Set,Dt={currentRoute:c,listening:!0,addRoute:d,removeRoute:b,clearRoutes:t.clearRoutes,hasRoute:_,getRoutes:g,resolve:v,options:e,push:N,replace:P,go:$e,back:()=>$e(-1),forward:()=>$e(1),beforeEach:r.add,beforeResolve:o.add,afterEach:a.add,onError:be.add,isReady:pt,install(k){k.component("RouterLink",Hi),k.component("RouterView",Op),k.config.globalProperties.$router=Dt,Object.defineProperty(k.config.globalProperties,"$route",{enumerable:!0,get:()=>we(c)}),en&&!Yt&&c.value===Tt&&(Yt=!0,N(i.location).catch(F=>{}));const x={};for(const F in Tt)Object.defineProperty(x,F,{get:()=>c.value[F],enumerable:!0});k.provide(Ws,Dt),k.provide(mr,da(x)),k.provide(Ki,c);const L=k.unmount;Wt.add(k),k.unmount=function(){Wt.delete(k),Wt.size<1&&(l=Tt,ae&&ae(),ae=null,c.value=Tt,Yt=!1,ee=!1),L()}}};function He(k){return k.reduce((x,L)=>x.then(()=>G(L)),Promise.resolve())}return Dt}function zh(){return Je(Ws)}function Ip(e){return Je(mr)}const Cp=`# ─────────────────────────────────────────────────────────────────────────────
...
`,gr=Symbol.for("yaml.alias"),Vi=Symbol.for("yaml.document"),Lt=Symbol.for("yaml.map"),gc=Symbol.for("yaml.pair"),ft=Symbol.for("yaml.scalar"),bn=Symbol.for("yaml.seq"),Ge=Symbol.for("yaml.node.type"),Gt=e=>!!e&&typeof e=="object"&&e[Ge]===gr,Js=e=>!!e&&typeof e=="object"&&e[Ge]===Vi,ns=e=>!!e&&typeof e=="object"&&e[Ge]===Lt,pe=e=>!!e&&typeof e=="object"&&e[Ge]===gc,oe=e=>!!e&&typeof e=="object"&&e[Ge]===ft,ss=e=>!!e&&typeof e=="object"&&e[Ge]===bn;function le(e){if(e&&typeof e=="object")switch(e[Ge]){case Lt:case bn:return!0}return!1}function ue(e){if(e&&typeof e=="object")switch(e[Ge]){case gr:case Lt:case ft:case bn:return!0}return!1}const yc=e=>(oe(e)||le(e))&&!!e.anchor,Ft=Symbol("break visit"),Vp=Symbol("skip children"),jn=Symbol("remove node");function wn(e,t){const n=qp(t);Js(e)?tn(null,e.contents,n,Object.freeze([e]))===jn&&(e.contents=null):tn(null,e,n,Object.freeze([]))}wn.BREAK=Ft;wn.SKIP=Vp;wn.REMOVE=jn;function tn(e,t,n,s){const i=Gp(e,t,n,s);if(ue(i)||pe(i))return zp(e,s,i),tn(e,i,n,s);if(typeof i!="symbol"){if(le(t)){s=Object.freeze(s.concat(t));for(let r=0;r<t.items.length;++r){const o=tn(r,t.items[r],n,s);if(typeof o=="number")r=o-1;else{if(o===Ft)return Ft;o===jn&&(t.items.splice(r,1),r-=1)}}}else if(pe(t)){s=Object.freeze(s.concat(t));const r=tn("key",t.key,n,s);if(r===Ft)return Ft;r===jn&&(t.key=null);const o=tn("value",t.value,n,s);if(o===Ft)return Ft;o===jn&&(t.value=null)}}return i}function qp(e){return typeof e=="object"&&(e.Collection||e.Node||e.Value)?Object.assign({Alias:e.Node,Map:e.Node,Scalar:e.Node,Seq:e.Node},e.Value&&{Map:e.Value,Scalar:e.Value,Seq:e.Value},e.Collection&&{Map:e.Collection,Seq:e.Collection},e):e}function Gp(e,t,n,s){var i,r,o,a,c;if(typeof n=="function")return n(e,t,s);if(ns(t))return(i=n.Map)==null?void 0:i.call(n,e,t,s);if(ss(t))return(r=n.Seq)==null?void 0:r.call(n,e,t,s);if(pe(t))return(o=n.Pair)==null?void 0:o.call(n,e,t,s);if(oe(t))return(a=n.Scalar)==null?void 0:a.call(n,e,t,s);if(Gt(t))return(c=n.Alias)==null?void 0:c.call(n,e,t,s)}function zp(e,t,n){const s=t[t.length-1];if(le(s))s.items[e]=n;else if(pe(s))e==="key"?s.key=n:s.value=n;else if(Js(s))s.contents=n;else{const i=Gt(s)?"alias":"scalar";throw new Error(`Cannot replace node with ${i} parent`)}}const Yp={"!":"%21",",":"%2C","[":"%5B","]":"%5D","{":"%7B","}":"%7D"},Wp=e=>e.replace(/[!,[\]{}]/g,t=>Yp[t]);class Re{constructor(t,n){this.docStart=null,this.docEnd=!1,this.yaml=Object.assign({},Re.defaultYaml,t),this.tags=Object.assign({},Re.defaultTags,n)}clone(){const t=new Re(this.yaml,this.tags);return t.docStart=this.docStart,t}atDocument(){const t=new Re(this.yaml,this.tags);switch(this.yaml.version){case"1.1":this.atNextDocument=!0;break;case"1.2":this.atNextDocument=!1,this.yaml={explicit:Re.defaultYaml.explicit,version:"1.2"},this.tags=Object.assign({},Re.defaultTags);break}return t}add(t,n){this.atNextDocument&&(this.yaml={explicit:Re.defaultYaml.explicit,version:"1.1"},this.tags=Object.assign({},Re.defaultTags),this.atNextDocument=!1);const s=t.trim().split(/[ \t]+/),i=s.shift();switch(i){case"%TAG":{if(s.length!==2&&(n(0,"%TAG directive should contain exactly two parts"),s.length<2))return!1;const[r,o]=s;return this.tags[r]=o,!0}case"%YAML":{if(this.yaml.explicit=!0,s.length!==1)return n(0,"%YAML directive should contain exactly one part"),!1;const[r]=s;if(r==="1.1"||r==="1.2")return this.yaml.version=r,!0;{const o=/^\d+\.\d+$/.test(r);return n(6,`Unsupported YAML version ${r}`,o),!1}}default:return n(0,`Unknown directive ${i}`,!0),!1}}tagName(t,n){if(t==="!")return"!";if(t[0]!=="!")return n(`Not a valid tag: ${t}`),null;if(t[1]==="<"){const o=t.slice(2,-1);return o==="!"||o==="!!"?(n(`Verbatim tags aren't resolved, so ${t} is invalid.`),null):(t[t.length-1]!==">"&&n("Verbatim tags must end with a >"),o)}const[,s,i]=t.match(/^(.*!)([^!]*)$/s);i||n(`The ${t} tag has no suffix`);const r=this.tags[s];if(r)try{return r+decodeURIComponent(i)}catch(o){return n(String(o)),null}return s==="!"?t:(n(`Could not resolve tag: ${t}`),null)}tagString(t){for(const[n,s]of Object.entries(this.tags))if(t.startsWith(s))return n+Wp(t.substring(s.length));return t[0]==="!"?t:`!<${t}>`}toString(t){const n=this.yaml.explicit?[`%YAML ${this.yaml.version||"1.2"}`]:[],s=Object.entries(this.tags);let i;if(t&&s.length>0&&ue(t.contents)){const r={};wn(t.contents,(o,a)=>{ue(a)&&a.tag&&(r[a.tag]=!0)}),i=Object.keys(r)}else i=[];for(const[r,o]of s)r==="!!"&&o==="tag:yaml.org,2002:"||(!t||i.some(a=>a.startsWith(o)))&&n.push(`%TAG ${r} ${o}`);return n.join(`
`)}}Re.defaultYaml={explicit:!1,version:"1.2"};Re.defaultTags={"!!":"tag:yaml.org,2002:"};function _c(e){if(/[\x00-\x19\s,[\]{}]/.test(e)){const n=`Anchor must not contain whitespace or control characters: ${JSON.stringify(e)}`;throw new Error(n)}return!0}function bc(e){const t=new Set;return wn(e,{Value(n,s){s.anchor&&t.add(s.anchor)}}),t}function wc(e,t){for(let n=1;;++n){const s=`${e}${n}`;if(!t.has(s))return s}}function Jp(e,t){const n=[],s=new Map;let i=null;return{onAnchor:r=>{n.push(r),i??(i=bc(e));const o=wc(t,i);return i.add(o),o},setAnchors:()=>{for(const r of n){const o=s.get(r);if(typeof o=="object"&&o.anchor&&(oe(o.node)||le(o.node)))o.node.anchor=o.anchor;else{const a=new Error("Failed to resolve repeated object (this should not happen)");throw a.source=r,a}}},sourceObjects:s}}function nn(e,t,n,s){if(s&&typeof s=="object")if(Array.isArray(s))for(let i=0,r=s.length;i<r;++i){const o=s[i],a=nn(e,s,String(i),o);a===void 0?delete s[i]:a!==o&&(s[i]=a)}else if(s instanceof Map)for(const i of Array.from(s.keys())){const r=s.get(i),o=nn(e,s,i,r);o===void 0?s.delete(i):o!==r&&s.set(i,o)}else if(s instanceof Set)for(const i of Array.from(s)){const r=nn(e,s,i,i);r===void 0?s.delete(i):r!==i&&(s.delete(i),s.add(r))}else for(const[i,r]of Object.entries(s)){const o=nn(e,s,i,r);o===void 0?delete s[i]:o!==r&&(s[i]=o)}return e.call(t,n,s)}function qe(e,t,n){if(Array.isArray(e))return e.map((s,i)=>qe(s,String(i),n));if(e&&typeof e.toJSON=="function"){if(!n||!yc(e))return e.toJSON(t,n);const s={aliasCount:0,count:1,res:void 0};n.anchors.set(e,s),n.onCreate=r=>{s.res=r,delete n.onCreate};const i=e.toJSON(t,n);return n.onCreate&&n.onCreate(i),i}return typeof e=="bigint"&&!(n!=null&&n.keep)?Number(e):e}class yr{constructor(t){Object.defineProperty(this,Ge,{value:t})}clone(){const t=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return this.range&&(t.range=this.range.slice()),t}toJS(t,{mapAsMap:n,maxAliasCount:s,onAnchor:i,reviver:r}={}){if(!Js(t))throw new TypeError("A document argument is required");const o={anchors:new Map,doc:t,keep:!0,mapAsMap:n===!0,mapKeyWarned:!1,maxAliasCount:typeof s=="number"?s:100},a=qe(this,"",o);if(typeof i=="function")for(const{count:c,res:l}of o.anchors.values())i(l,c);return typeof r=="function"?nn(r,{"":a},"",a):a}}class _r extends yr{constructor(t){super(gr),this.source=t,Object.defineProperty(this,"tag",{set(){throw new Error("Alias nodes cannot have tags")}})}resolve(t,n){let s;n!=null&&n.aliasResolveCache?s=n.aliasResolveCache:(s=[],wn(t,{Node:(r,o)=>{(Gt(o)||yc(o))&&s.push(o)}}),n&&(n.aliasResolveCache=s));let i;for(const r of s){if(r===this)break;r.anchor===this.source&&(i=r)}return i}toJSON(t,n){if(!n)return{source:this.source};const{anchors:s,doc:i,maxAliasCount:r}=n,o=this.resolve(i,n);if(!o){const c=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new ReferenceError(c)}let a=s.get(o);if(a||(qe(o,null,n),a=s.get(o)),(a==null?void 0:a.res)===void 0){const c="This should not happen: Alias anchor was not resolved?";throw new ReferenceError(c)}if(r>=0&&(a.count+=1,a.aliasCount===0&&(a.aliasCount=bs(i,o,s)),a.count*a.aliasCount>r)){const c="Excessive alias count indicates a resource exhaustion attack";throw new ReferenceError(c)}return a.res}toString(t,n,s){const i=`*${this.source}`;if(t){if(_c(this.source),t.options.verifyAliasOrder&&!t.anchors.has(this.source)){const r=`Unresolved alias (the anchor must be set before the alias): ${this.source}`;throw new Error(r)}if(t.implicitKey)return`${i} `}return i}}function bs(e,t,n){if(Gt(t)){const s=t.resolve(e),i=n&&s&&n.get(s);return i?i.count*i.aliasCount:0}else if(le(t)){let s=0;for(const i of t.items){const r=bs(e,i,n);r>s&&(s=r)}return s}else if(pe(t)){const s=bs(e,t.key,n),i=bs(e,t.value,n);return Math.max(s,i)}return 1}const vc=e=>!e||typeof e!="function"&&typeof e!="object";class q extends yr{constructor(t){super(ft),this.value=t}toJSON(t,n){return n!=null&&n.keep?this.value:qe(this.value,t,n)}toString(){return String(this.value)}}q.BLOCK_FOLDED="BLOCK_FOLDED";q.BLOCK_LITERAL="BLOCK_LITERAL";q.PLAIN="PLAIN";q.QUOTE_DOUBLE="QUOTE_DOUBLE";q.QUOTE_SINGLE="QUOTE_SINGLE";const Qp="tag:yaml.org,2002:";function Xp(e,t,n){if(t){const s=n.filter(r=>r.tag===t),i=s.find(r=>!r.format)??s[0];if(!i)throw new Error(`Tag ${t} not found`);return i}return n.find(s=>{var i;return((i=s.identify)==null?void 0:i.call(s,e))&&!s.format})}function Jn(e,t,n){var f,p,d;if(Js(e)&&(e=e.contents),ue(e))return e;if(pe(e)){const b=(p=(f=n.schema[Lt]).createNode)==null?void 0:p.call(f,n.schema,null,n);return b.items.push(e),b}(e instanceof String||e instanceof Number||e instanceof Boolean||typeof BigInt<"u"&&e instanceof BigInt)&&(e=e.valueOf());const{aliasDuplicateObjects:s,onAnchor:i,onTagObj:r,schema:o,sourceObjects:a}=n;let c;if(s&&e&&typeof e=="object"){if(c=a.get(e),c)return c.anchor??(c.anchor=i(e)),new _r(c.anchor);c={anchor:null,node:null},a.set(e,c)}t!=null&&t.startsWith("!!")&&(t=Qp+t.slice(2));let l=Xp(e,t,o.tags);if(!l){if(e&&typeof e.toJSON=="function"&&(e=e.toJSON()),!e||typeof e!="object"){const b=new q(e);return c&&(c.node=b),b}l=e instanceof Map?o[Lt]:Symbol.iterator in Object(e)?o[bn]:o[Lt]}r&&(r(l),delete n.onTagObj);const u=l!=null&&l.createNode?l.createNode(n.schema,e,n):typeof((d=l==null?void 0:l.nodeClass)==null?void 0:d.from)=="function"?l.nodeClass.from(n.schema,e,n):new q(e);return t?u.tag=t:l.default||(u.tag=l.tag),c&&(c.node=u),u}function Is(e,t,n){let s=n;for(let i=t.length-1;i>=0;--i){const r=t[i];if(typeof r=="number"&&Number.isInteger(r)&&r>=0){const o=[];o[r]=s,s=o}else s=new Map([[r,s]])}return Jn(s,void 0,{aliasDuplicateObjects:!1,keepUndefined:!1,onAnchor:()=>{throw new Error("This should not happen, please report a bug.")},schema:e,sourceObjects:new Map})}const Rn=e=>e==null||typeof e=="object"&&!!e[Symbol.iterator]().next().done;class Sc extends yr{constructor(t,n){super(t),Object.defineProperty(this,"schema",{value:n,configurable:!0,enumerable:!1,writable:!0})}clone(t){const n=Object.create(Object.getPrototypeOf(this),Object.getOwnPropertyDescriptors(this));return t&&(n.schema=t),n.items=n.items.map(s=>ue(s)||pe(s)?s.clone(t):s),this.range&&(n.range=this.range.slice()),n}addIn(t,n){if(Rn(t))this.add(n);else{const[s,...i]=t,r=this.get(s,!0);if(le(r))r.addIn(i,n);else if(r===void 0&&this.schema)this.set(s,Is(this.schema,i,n));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}deleteIn(t){const[n,...s]=t;if(s.length===0)return this.delete(n);const i=this.get(n,!0);if(le(i))return i.deleteIn(s);throw new Error(`Expected YAML collection at ${n}. Remaining path: ${s}`)}getIn(t,n){const[s,...i]=t,r=this.get(s,!0);return i.length===0?!n&&oe(r)?r.value:r:le(r)?r.getIn(i,n):void 0}hasAllNullValues(t){return this.items.every(n=>{if(!pe(n))return!1;const s=n.value;return s==null||t&&oe(s)&&s.value==null&&!s.commentBefore&&!s.comment&&!s.tag})}hasIn(t){const[n,...s]=t;if(s.length===0)return this.has(n);const i=this.get(n,!0);return le(i)?i.hasIn(s):!1}setIn(t,n){const[s,...i]=t;if(i.length===0)this.set(s,n);else{const r=this.get(s,!0);if(le(r))r.setIn(i,n);else if(r===void 0&&this.schema)this.set(s,Is(this.schema,i,n));else throw new Error(`Expected YAML collection at ${s}. Remaining path: ${i}`)}}}const Zp=e=>e.replace(/^(?!$)(?: $)?/gm,"#");function _t(e,t){return/^\n+$/.test(e)?e.substring(1):t?e.replace(/^(?! *$)/gm,t):e}const jt=(e,t,n)=>e.endsWith(`
`)?_t(n,t):n.includes(`
`)?`
`+_t(n,t):(e.endsWith(" ")?"":" ")+n,Ec="flow",qi="block",ws="quoted";function Qs(e,t,n="flow",{indentAtStart:s,lineWidth:i=80,minContentWidth:r=20,onFold:o,onOverflow:a}={}){if(!i||i<0)return e;i<r&&(r=0);const c=Math.max(1+r,1+i-t.length);if(e.length<=c)return e;const l=[],u={};let f=i-t.length;typeof s=="number"&&(s>i-Math.max(2,r)?l.push(0):f=i-s);let p,d,b=!1,g=-1,_=-1,v=-1;n===qi&&(g=Io(e,g,t.length),g!==-1&&(f=g+c));for(let T;T=e[g+=1];){if(n===ws&&T==="\\"){switch(_=g,e[g+1]){case"x":g+=3;break;case"u":g+=5;break;case"U":g+=9;break;default:g+=1}v=g}if(T===`
`)n===qi&&(g=Io(e,g,t.length)),f=g+t.length+c,p=void 0;else{if(T===" "&&d&&d!==" "&&d!==`
`&&d!=="	"){const N=e[g+1];N&&N!==" "&&N!==`
`&&N!=="	"&&(p=g)}if(g>=f)if(p)l.push(p),f=p+c,p=void 0;else if(n===ws){for(;d===" "||d==="	";)d=T,T=e[g+=1],b=!0;const N=g>v+1?g-2:_-1;if(u[N])return e;l.push(N),u[N]=!0,f=N+c,p=void 0}else b=!0}d=T}if(b&&a&&a(),l.length===0)return e;o&&o();let w=e.slice(0,l[0]);for(let T=0;T<l.length;++T){const N=l[T],P=l[T+1]||e.length;N===0?w=`
${t}${e.slice(0,P)}`:(n===ws&&u[N]&&(w+=`${e[N]}\\`),w+=`
${t}${e.slice(N+1,P)}`)}return w}function Io(e,t,n){let s=t,i=t+1,r=e[i];for(;r===" "||r==="	";)if(t<i+n)r=e[++t];else{do r=e[++t];while(r&&r!==`
`);s=t,i=t+1,r=e[i]}return s}const Xs=(e,t)=>({indentAtStart:t?e.indent.length:e.indentAtStart,lineWidth:e.options.lineWidth,minContentWidth:e.options.minContentWidth}),Zs=e=>/^(%|---|\.\.\.)/m.test(e);function ed(e,t,n){if(!t||t<0)return!1;const s=t-n,i=e.length;if(i<=s)return!1;for(let r=0,o=0;r<i;++r)if(e[r]===`
...
`,c+=2;o+=r,n[c+2]===" "&&(o+="\\"),c+=1,a=c+1}break;default:c+=1}return o=a?o+n.slice(a):n,s?o:Qs(o,r,ws,Xs(t,!1))}function Gi(e,t){if(t.options.singleQuote===!1||t.implicitKey&&e.includes(`
`)||/[ \t]\n|\n[ \t]/.test(e))return Un(e,t);const n=t.indent||(Zs(e)?"  ":""),s="'"+e.replace(/'/g,"''").replace(/\n+/g,`$&
${n}`)+"'";return t.implicitKey?s:Qs(s,n,Ec,Xs(t,!1))}function sn(e,t){const{singleQuote:n}=t.options;let s;if(n===!1)s=Un;else{const i=e.includes('"'),r=e.includes("'");i&&!r?s=Gi:r&&!i?s=Un:s=n?Gi:Un}return s(e,t)}let zi;try{zi=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{zi=/\n+(?!\n|$)/g}function vs({comment:e,type:t,value:n},s,i,r){const{blockQuote:o,commentString:a,lineWidth:c}=s.options;if(!o||/\n[\t ]+$/.test(n))return sn(n,s);const l=s.indent||(s.forceBlockIndent||Zs(n)?"  ":""),u=o==="literal"?!0:o==="folded"||t===q.BLOCK_FOLDED?!1:t===q.BLOCK_LITERAL?!0:!ed(n,c,l.length);if(!n)return u?`|
`:`>
...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${l}`);let U=!1;const M=Xs(s,!0);o!=="folded"&&t!==q.BLOCK_FOLDED&&(M.onOverflow=()=>{U=!0});const $=Qs(`${w}${P}${d}`,l,qi,M);if(!U)return`>${N}
${l}${$}`}return n=n.replace(/\n+/g,`$&${l}`),`|${N}
${l}${w}${n}${d}`}function td(e,t,n,s){const{type:i,value:r}=e,{actualString:o,implicitKey:a,indent:c,indentStep:l,inFlow:u}=t;if(a&&r.includes(`
`)||u&&/[[\]{},]/.test(r))return sn(r,t);if(/^[\n\t ,[\]{}#&*!|>'"%@`]|^[?-]$|^[?-][ \t]|[\n:][ \t]|[ \t]\n|[\n\t ]#|[\n\t :]$/.test(r))return a||u||!r.includes(`
`)?sn(r,t):vs(e,t,n,s);if(!a&&!u&&i!==q.PLAIN&&r.includes(`
`))return vs(e,t,n,s);if(Zs(r)){if(c==="")return t.forceBlockIndent=!0,vs(e,t,n,s);if(a&&c===l)return sn(r,t)}const f=r.replace(/\n+/g,`$&
${c}`);if(o){const p=g=>{var _;return g.default&&g.tag!=="tag:yaml.org,2002:str"&&((_=g.test)==null?void 0:_.test(f))},{compat:d,tags:b}=t.doc.schema;if(b.some(p)||d!=null&&d.some(p))return sn(r,t)}return a?f:Qs(f,c,Ec,Xs(t,!1))}function br(e,t,n,s){const{implicitKey:i,inFlow:r}=t,o=typeof e.value=="string"?e:Object.assign({},e,{value:String(e.value)});let{type:a}=e;a!==q.QUOTE_DOUBLE&&/[\x00-\x08\x0b-\x1f\x7f-\x9f\u{D800}-\u{DFFF}]/u.test(o.value)&&(a=q.QUOTE_DOUBLE);const c=u=>{switch(u){case q.BLOCK_FOLDED:case q.BLOCK_LITERAL:return i||r?sn(o.value,t):vs(o,t,n,s);case q.QUOTE_DOUBLE:return Un(o.value,t);case q.QUOTE_SINGLE:return Gi(o.value,t);case q.PLAIN:return td(o,t,n,s);default:return null}};let l=c(a);if(l===null){const{defaultKeyType:u,defaultStringType:f}=t.options,p=i&&u||f;if(l=c(p),l===null)throw new Error(`Unsupported default string type ${p}`)}return l}function kc(e,t){const n=Object.assign({blockQuote:!0,commentString:Zp,defaultKeyType:null,defaultStringType:"PLAIN",directives:null,doubleQuotedAsJSON:!1,doubleQuotedMinMultiLineLength:40,falseStr:"false",flowCollectionPadding:!0,indentSeq:!0,lineWidth:80,minContentWidth:20,nullStr:"null",simpleKeys:!1,singleQuote:null,trailingComma:!1,trueStr:"true",verifyAliasOrder:!0},e.schema.toStringOptions,t);let s;switch(n.collectionStyle){case"block":s=!1;break;case"flow":s=!0;break;default:s=null}return{anchors:new Set,doc:e,flowCollectionPadding:n.flowCollectionPadding?" ":"",indent:"",indentStep:typeof n.indent=="number"?" ".repeat(n.indent):"  ",inFlow:s,options:n}}function nd(e,t){var i;if(t.tag){const r=e.filter(o=>o.tag===t.tag);if(r.length>0)return r.find(o=>o.format===t.format)??r[0]}let n,s;if(oe(t)){s=t.value;let r=e.filter(o=>{var a;return(a=o.identify)==null?void 0:a.call(o,s)});if(r.length>1){const o=r.filter(a=>a.test);o.length>0&&(r=o)}n=r.find(o=>o.format===t.format)??r.find(o=>!o.format)}else s=t,n=e.find(r=>r.nodeClass&&s instanceof r.nodeClass);if(!n){const r=((i=s==null?void 0:s.constructor)==null?void 0:i.name)??(s===null?"null":typeof s);throw new Error(`Tag not resolved for ${r} value`)}return n}function sd(e,t,{anchors:n,doc:s}){if(!s.directives)return"";const i=[],r=(oe(e)||le(e))&&e.anchor;r&&_c(r)&&(n.add(r),i.push(`&${r}`));const o=e.tag??(t.default?null:t.tag);return o&&i.push(s.directives.tagString(o)),i.join(" ")}function yn(e,t,n,s){var c;if(pe(e))return e.toString(t,n,s);if(Gt(e)){if(t.doc.directives)return e.toString(t);if((c=t.resolvedAliases)!=null&&c.has(e))throw new TypeError("Cannot stringify circular structure without alias nodes");t.resolvedAliases?t.resolvedAliases.add(e):t.resolvedAliases=new Set([e]),e=e.resolve(t.doc)}let i;const r=ue(e)?e:t.doc.createNode(e,{onTagObj:l=>i=l});i??(i=nd(t.doc.schema.tags,r));const o=sd(r,i,t);o.length>0&&(t.indentAtStart=(t.indentAtStart??0)+o.length+1);const a=typeof i.stringify=="function"?i.stringify(r,t,n,s):oe(r)?br(r,t,n,s):r.toString(t,n,s);return o?oe(r)||a[0]==="{"||a[0]==="["?`${o} ${a}`:`${o}
${t.indent}${a}`:a}function id({key:e,value:t},n,s,i){const{allNullValues:r,doc:o,indent:a,indentStep:c,options:{commentString:l,indentSeq:u,simpleKeys:f}}=n;let p=ue(e)&&e.comment||null;if(f){if(p)throw new Error("With simple keys, key nodes cannot have comments");if(le(e)||!ue(e)&&typeof e=="object"){const M="With simple keys, collection cannot be used as a key value";throw new Error(M)}}let d=!f&&(!e||p&&t==null&&!n.inFlow||le(e)||(oe(e)?e.type===q.BLOCK_FOLDED||e.type===q.BLOCK_LITERAL:typeof e=="object"));n=Object.assign({},n,{allNullValues:!1,implicitKey:!d&&(f||!r),indent:a+c});let b=!1,g=!1,_=yn(e,n,()=>b=!0,()=>g=!0);if(!d&&!n.inFlow&&_.length>1024){if(f)throw new Error("With simple keys, single line scalar must not span more than 1024 characters");d=!0}if(n.inFlow){if(r||t==null)return b&&s&&s(),_===""?"?":d?`? ${_}`:_}else if(r&&!f||t==null&&d)return _=`? ${_}`,p&&!b?_+=jt(_,n.indent,l(p)):g&&i&&i(),_;b&&(p=null),d?(p&&(_+=jt(_,n.indent,l(p))),_=`? ${_}
${a}:`):(_=`${_}:`,p&&(_+=jt(_,n.indent,l(p))));let v,w,T;ue(t)?(v=!!t.spaceBefore,w=t.commentBefore,T=t.comment):(v=!1,w=null,T=null,t&&typeof t=="object"&&(t=o.createNode(t))),n.implicitKey=!1,!d&&!p&&oe(t)&&(n.indentAtStart=_.length+1),g=!1,!u&&c.length>=2&&!n.inFlow&&!d&&ss(t)&&!t.flow&&!t.tag&&!t.anchor&&(n.indent=n.indent.substring(2));let N=!1;const P=yn(t,n,()=>N=!0,()=>g=!0);let U=" ";if(p||v||w){if(U=v?`
`:"",w){const M=l(w);U+=`
...
`),G=$!==-1,ne=n.inFlow??t.flow??t.items.length===0;if(G||!ne){let _e=!1;if(G&&(M==="&"||M==="!")){let he=P.indexOf(" ");M==="&"&&he!==-1&&he<$&&P[he+1]==="!"&&(he=P.indexOf(" ",he+1)),(he===-1||$<he)&&(_e=!0)}_e||(U=`
${n.indent}`)}}else(P===""||P[0]===`
`)&&(U="");return _+=U+P,n.inFlow?N&&s&&s():T&&!N?_+=jt(_,n.indent,l(T)):g&&i&&i(),_}function Ac(e,t){(e==="debug"||e==="warn")&&console.warn(t)}const ls="<<",bt={identify:e=>e===ls||typeof e=="symbol"&&e.description===ls,default:"key",tag:"tag:yaml.org,2002:merge",test:/^<<$/,resolve:()=>Object.assign(new q(Symbol(ls)),{addToJSMap:Nc}),stringify:()=>ls},rd=(e,t)=>(bt.identify(t)||oe(t)&&(!t.type||t.type===q.PLAIN)&&bt.identify(t.value))&&(e==null?void 0:e.doc.schema.tags.some(n=>n.tag===bt.tag&&n.default));function Nc(e,t,n){if(n=e&&Gt(n)?n.resolve(e.doc):n,ss(n))for(const s of n.items)vi(e,t,s);else if(Array.isArray(n))for(const s of n)vi(e,t,s);else vi(e,t,n)}function vi(e,t,n){const s=e&&Gt(n)?n.resolve(e.doc):n;if(!ns(s))throw new Error("Merge sources must be maps or map aliases");const i=s.toJSON(null,e,Map);for(const[r,o]of i)t instanceof Map?t.has(r)||t.set(r,o):t instanceof Set?t.add(r):Object.prototype.hasOwnProperty.call(t,r)||Object.defineProperty(t,r,{value:o,writable:!0,enumerable:!0,configurable:!0});return t}function Tc(e,t,{key:n,value:s}){if(ue(n)&&n.addToJSMap)n.addToJSMap(e,t,s);else if(rd(e,n))Nc(e,t,s);else{const i=qe(n,"",e);if(t instanceof Map)t.set(i,qe(s,i,e));else if(t instanceof Set)t.add(i);else{const r=od(n,i,e),o=qe(s,r,e);r in t?Object.defineProperty(t,r,{value:o,writable:!0,enumerable:!0,configurable:!0}):t[r]=o}}return t}function od(e,t,n){if(t===null)return"";if(typeof t!="object")return String(t);if(ue(e)&&(n!=null&&n.doc)){const s=kc(n.doc,{});s.anchors=new Set;for(const r of n.anchors.keys())s.anchors.add(r.anchor);s.inFlow=!0,s.inStringifyKey=!0;const i=e.toString(s);if(!n.mapKeyWarned){let r=JSON.stringify(i);r.length>40&&(r=r.substring(0,36)+'..."'),Ac(n.doc.options.logLevel,`Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`),n.mapKeyWarned=!0}return i}return JSON.stringify(t)}function wr(e,t,n){const s=Jn(e,void 0,n),i=Jn(t,void 0,n);return new xe(s,i)}class xe{constructor(t,n=null){Object.defineProperty(this,Ge,{value:gc}),this.key=t,this.value=n}clone(t){let{key:n,value:s}=this;return ue(n)&&(n=n.clone(t)),ue(s)&&(s=s.clone(t)),new xe(n,s)}toJSON(t,n){const s=n!=null&&n.mapAsMap?new Map:{};return Tc(n,s,this)}toString(t,n,s){return t!=null&&t.doc?id(this,t,n,s):JSON.stringify(this)}}function Oc(e,t,n){return(t.inFlow??e.flow?cd:ad)(e,t,n)}function ad({comment:e,items:t},n,{blockItemPrefix:s,flowChars:i,itemIndent:r,onChompKeep:o,onComment:a}){const{indent:c,options:{commentString:l}}=n,u=Object.assign({},n,{indent:r,type:null});let f=!1;const p=[];for(let b=0;b<t.length;++b){const g=t[b];let _=null;if(ue(g))!f&&g.spaceBefore&&p.push(""),Cs(n,p,g.commentBefore,f),g.comment&&(_=g.comment);else if(pe(g)){const w=ue(g.key)?g.key:null;w&&(!f&&w.spaceBefore&&p.push(""),Cs(n,p,w.commentBefore,f))}f=!1;let v=yn(g,u,()=>_=null,()=>f=!0);_&&(v+=jt(v,r,l(_))),f&&_&&(f=!1),p.push(s+v)}let d;if(p.length===0)d=i.start+i.end;else{d=p[0];for(let b=1;b<p.length;++b){const g=p[b];d+=g?`
${c}${g}`:`
`}}return e?(d+=`
`+_t(l(e),c),a&&a()):f&&o&&o(),d}function cd({items:e},t,{flowChars:n,itemIndent:s}){const{indent:i,indentStep:r,flowCollectionPadding:o,options:{commentString:a}}=t;s+=r;const c=Object.assign({},t,{indent:s,inFlow:!0,type:null});let l=!1,u=0;const f=[];for(let b=0;b<e.length;++b){const g=e[b];let _=null;if(ue(g))g.spaceBefore&&f.push(""),Cs(t,f,g.commentBefore,!1),g.comment&&(_=g.comment);else if(pe(g)){const w=ue(g.key)?g.key:null;w&&(w.spaceBefore&&f.push(""),Cs(t,f,w.commentBefore,!1),w.comment&&(l=!0));const T=ue(g.value)?g.value:null;T?(T.comment&&(_=T.comment),T.commentBefore&&(l=!0)):g.value==null&&(w!=null&&w.comment)&&(_=w.comment)}_&&(l=!0);let v=yn(g,c,()=>_=null);l||(l=f.length>u||v.includes(`
`)),b<e.length-1?v+=",":t.options.trailingComma&&(t.options.lineWidth>0&&(l||(l=f.reduce((w,T)=>w+T.length+2,2)+(v.length+2)>t.options.lineWidth)),l&&(v+=",")),_&&(v+=jt(v,s,a(_))),f.push(v),u=f.length}const{start:p,end:d}=n;if(f.length===0)return p+d;if(!l){const b=f.reduce((g,_)=>g+_.length+2,2);l=t.options.lineWidth>0&&b>t.options.lineWidth}if(l){let b=p;for(const g of f)b+=g?`
${r}${i}${g}`:`
`;return`${b}
${i}${d}`}else return`${p}${o}${f.join(" ")}${o}${d}`}function Cs({indent:e,options:{commentString:t}},n,s,i){if(s&&i&&(s=s.replace(/^\n+/,"")),s){const r=_t(t(s),e);n.push(r.trimStart())}}function Ut(e,t){const n=oe(t)?t.value:t;for(const s of e)if(pe(s)&&(s.key===t||s.key===n||oe(s.key)&&s.key.value===n))return s}class Ve extends Sc{static get tagName(){return"tag:yaml.org,2002:map"}constructor(t){super(Lt,t),this.items=[]}static from(t,n,s){const{keepUndefined:i,replacer:r}=s,o=new this(t),a=(c,l)=>{if(typeof r=="function")l=r.call(n,c,l);else if(Array.isArray(r)&&!r.includes(c))return;(l!==void 0||i)&&o.items.push(wr(c,l,s))};if(n instanceof Map)for(const[c,l]of n)a(c,l);else if(n&&typeof n=="object")for(const c of Object.keys(n))a(c,n[c]);return typeof t.sortMapEntries=="function"&&o.items.sort(t.sortMapEntries),o}add(t,n){var o;let s;pe(t)?s=t:!t||typeof t!="object"||!("key"in t)?s=new xe(t,t==null?void 0:t.value):s=new xe(t.key,t.value);const i=Ut(this.items,s.key),r=(o=this.schema)==null?void 0:o.sortMapEntries;if(i){if(!n)throw new Error(`Key ${s.key} already set`);oe(i.value)&&vc(s.value)?i.value.value=s.value:i.value=s.value}else if(r){const a=this.items.findIndex(c=>r(s,c)<0);a===-1?this.items.push(s):this.items.splice(a,0,s)}else this.items.push(s)}delete(t){const n=Ut(this.items,t);return n?this.items.splice(this.items.indexOf(n),1).length>0:!1}get(t,n){const s=Ut(this.items,t),i=s==null?void 0:s.value;return(!n&&oe(i)?i.value:i)??void 0}has(t){return!!Ut(this.items,t)}set(t,n){this.add(new xe(t,n),!0)}toJSON(t,n,s){const i=s?new s:n!=null&&n.mapAsMap?new Map:{};n!=null&&n.onCreate&&n.onCreate(i);for(const r of this.items)Tc(n,i,r);return i}toString(t,n,s){if(!t)return JSON.stringify(this);for(const i of this.items)if(!pe(i))throw new Error(`Map items must all be pairs; found ${JSON.stringify(i)} instead`);return!t.allNullValues&&this.hasAllNullValues(!1)&&(t=Object.assign({},t,{allNullValues:!0})),Oc(this,t,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:t.indent||"",onChompKeep:s,onComment:n})}}const vn={collection:"map",default:!0,nodeClass:Ve,tag:"tag:yaml.org,2002:map",resolve(e,t){return ns(e)||t("Expected a mapping for this tag"),e},createNode:(e,t,n)=>Ve.from(e,t,n)};class Vt extends Sc{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(t){super(bn,t),this.items=[]}add(t){this.items.push(t)}delete(t){const n=us(t);return typeof n!="number"?!1:this.items.splice(n,1).length>0}get(t,n){const s=us(t);if(typeof s!="number")return;const i=this.items[s];return!n&&oe(i)?i.value:i}has(t){const n=us(t);return typeof n=="number"&&n<this.items.length}set(t,n){const s=us(t);if(typeof s!="number")throw new Error(`Expected a valid index, not ${t}.`);const i=this.items[s];oe(i)&&vc(n)?i.value=n:this.items[s]=n}toJSON(t,n){const s=[];n!=null&&n.onCreate&&n.onCreate(s);let i=0;for(const r of this.items)s.push(qe(r,String(i++),n));return s}toString(t,n,s){return t?Oc(this,t,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(t.indent||"")+"  ",onChompKeep:s,onComment:n}):JSON.stringify(this)}static from(t,n,s){const{replacer:i}=s,r=new this(t);if(n&&Symbol.iterator in Object(n)){let o=0;for(let a of n){if(typeof i=="function"){const c=n instanceof Set?a:String(o++);a=i.call(n,c,a)}r.items.push(Jn(a,void 0,s))}}return r}}function us(e){let t=oe(e)?e.value:e;return t&&typeof t=="string"&&(t=Number(t)),typeof t=="number"&&Number.isInteger(t)&&t>=0?t:null}const Sn={collection:"seq",default:!0,nodeClass:Vt,tag:"tag:yaml.org,2002:seq",resolve(e,t){return ss(e)||t("Expected a sequence for this tag"),e},createNode:(e,t,n)=>Vt.from(e,t,n)},ei={identify:e=>typeof e=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:e=>e,stringify(e,t,n,s){return t=Object.assign({actualString:!0},t),br(e,t,n,s)}},ti={identify:e=>e==null,createNode:()=>new q(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new q(null),stringify:({source:e},t)=>typeof e=="string"&&ti.test.test(e)?e:t.options.nullStr},vr={identify:e=>typeof e=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:e=>new q(e[0]==="t"||e[0]==="T"),stringify({source:e,value:t},n){if(e&&vr.test.test(e)){const s=e[0]==="t"||e[0]==="T";if(t===s)return e}return t?n.options.trueStr:n.options.falseStr}};function Ze({format:e,minFractionDigits:t,tag:n,value:s}){if(typeof s=="bigint")return String(s);const i=typeof s=="number"?s:Number(s);if(!isFinite(i))return isNaN(i)?".nan":i<0?"-.inf":".inf";let r=Object.is(s,-0)?"-0":JSON.stringify(s);if(!e&&t&&(!n||n==="tag:yaml.org,2002:float")&&/^\d/.test(r)){let o=r.indexOf(".");o<0&&(o=r.length,r+=".");let a=t-(r.length-o-1);for(;a-- >0;)r+="0"}return r}const Rc={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:e=>e.slice(-3).toLowerCase()==="nan"?NaN:e[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Ze},Ic={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:e=>parseFloat(e),stringify(e){const t=Number(e.value);return isFinite(t)?t.toExponential():Ze(e)}},Cc={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(e){const t=new q(parseFloat(e)),n=e.indexOf(".");return n!==-1&&e[e.length-1]==="0"&&(t.minFractionDigits=e.length-n-1),t},stringify:Ze},ni=e=>typeof e=="bigint"||Number.isInteger(e),Sr=(e,t,n,{intAsBigInt:s})=>s?BigInt(e):parseInt(e.substring(t),n);function Pc(e,t,n){const{value:s}=e;return ni(s)&&s>=0?n+s.toString(t):Ze(e)}const Lc={identify:e=>ni(e)&&e>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(e,t,n)=>Sr(e,2,8,n),stringify:e=>Pc(e,8,"0o")},Dc={identify:ni,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(e,t,n)=>Sr(e,0,10,n),stringify:Ze},Mc={identify:e=>ni(e)&&e>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(e,t,n)=>Sr(e,2,16,n),stringify:e=>Pc(e,16,"0x")},ld=[vn,Sn,ei,ti,vr,Lc,Dc,Mc,Rc,Ic,Cc];function Co(e){return typeof e=="bigint"||Number.isInteger(e)}const fs=({value:e})=>JSON.stringify(e),ud=[{identify:e=>typeof e=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:e=>e,stringify:fs},{identify:e=>e==null,createNode:()=>new q(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:fs},{identify:e=>typeof e=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:e=>e==="true",stringify:fs},{identify:Co,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(e,t,{intAsBigInt:n})=>n?BigInt(e):parseInt(e,10),stringify:({value:e})=>Co(e)?e.toString():JSON.stringify(e)},{identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:e=>parseFloat(e),stringify:fs}],fd={default:!0,tag:"",test:/^/,resolve(e,t){return t(`Unresolved plain scalar ${JSON.stringify(e)}`),e}},pd=[vn,Sn].concat(ud,fd),Er={identify:e=>e instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(e,t){if(typeof atob=="function"){const n=atob(e.replace(/[\n\r]/g,"")),s=new Uint8Array(n.length);for(let i=0;i<n.length;++i)s[i]=n.charCodeAt(i);return s}else return t("This environment does not support reading binary tags; either Buffer or atob is required"),e},stringify({comment:e,type:t,value:n},s,i,r){if(!n)return"";const o=n;let a;if(typeof btoa=="function"){let c="";for(let l=0;l<o.length;++l)c+=String.fromCharCode(o[l]);a=btoa(c)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(t??(t=q.BLOCK_LITERAL),t!==q.QUOTE_DOUBLE){const c=Math.max(s.options.lineWidth-s.indent.length,s.options.minContentWidth),l=Math.ceil(a.length/c),u=new Array(l);for(let f=0,p=0;f<l;++f,p+=c)u[f]=a.substr(p,c);a=u.join(t===q.BLOCK_LITERAL?`
`:" ")}return br({comment:e,type:t,value:a},s,i,r)}};function xc(e,t){if(ss(e))for(let n=0;n<e.items.length;++n){let s=e.items[n];if(!pe(s)){if(ns(s)){s.items.length>1&&t("Each pair must have its own sequence indicator");const i=s.items[0]||new xe(new q(null));if(s.commentBefore&&(i.key.commentBefore=i.key.commentBefore?`${s.commentBefore}
${i.key.commentBefore}`:s.commentBefore),s.comment){const r=i.value??i.key;r.comment=r.comment?`${s.comment}
${r.comment}`:s.comment}s=i}e.items[n]=pe(s)?s:new xe(s)}}else t("Expected a sequence for this tag");return e}function $c(e,t,n){const{replacer:s}=n,i=new Vt(e);i.tag="tag:yaml.org,2002:pairs";let r=0;if(t&&Symbol.iterator in Object(t))for(let o of t){typeof s=="function"&&(o=s.call(t,String(r++),o));let a,c;if(Array.isArray(o))if(o.length===2)a=o[0],c=o[1];else throw new TypeError(`Expected [key, value] tuple: ${o}`);else if(o&&o instanceof Object){const l=Object.keys(o);if(l.length===1)a=l[0],c=o[a];else throw new TypeError(`Expected tuple with one key, not ${l.length} keys`)}else a=o;i.items.push(wr(a,c,n))}return i}const kr={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:xc,createNode:$c};class un extends Vt{constructor(){super(),this.add=Ve.prototype.add.bind(this),this.delete=Ve.prototype.delete.bind(this),this.get=Ve.prototype.get.bind(this),this.has=Ve.prototype.has.bind(this),this.set=Ve.prototype.set.bind(this),this.tag=un.tag}toJSON(t,n){if(!n)return super.toJSON(t);const s=new Map;n!=null&&n.onCreate&&n.onCreate(s);for(const i of this.items){let r,o;if(pe(i)?(r=qe(i.key,"",n),o=qe(i.value,r,n)):r=qe(i,"",n),s.has(r))throw new Error("Ordered maps must not include duplicate keys");s.set(r,o)}return s}static from(t,n,s){const i=$c(t,n,s),r=new this;return r.items=i.items,r}}un.tag="tag:yaml.org,2002:omap";const Ar={collection:"seq",identify:e=>e instanceof Map,nodeClass:un,default:!1,tag:"tag:yaml.org,2002:omap",resolve(e,t){const n=xc(e,t),s=[];for(const{key:i}of n.items)oe(i)&&(s.includes(i.value)?t(`Ordered maps must not include duplicate keys: ${i.value}`):s.push(i.value));return Object.assign(new un,n)},createNode:(e,t,n)=>un.from(e,t,n)};function Fc({value:e,source:t},n){return t&&(e?Bc:jc).test.test(t)?t:e?n.options.trueStr:n.options.falseStr}const Bc={identify:e=>e===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new q(!0),stringify:Fc},jc={identify:e=>e===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new q(!1),stringify:Fc},dd={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:e=>e.slice(-3).toLowerCase()==="nan"?NaN:e[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Ze},hd={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:e=>parseFloat(e.replace(/_/g,"")),stringify(e){const t=Number(e.value);return isFinite(t)?t.toExponential():Ze(e)}},md={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(e){const t=new q(parseFloat(e.replace(/_/g,""))),n=e.indexOf(".");if(n!==-1){const s=e.substring(n+1).replace(/_/g,"");s[s.length-1]==="0"&&(t.minFractionDigits=s.length)}return t},stringify:Ze},is=e=>typeof e=="bigint"||Number.isInteger(e);function si(e,t,n,{intAsBigInt:s}){const i=e[0];if((i==="-"||i==="+")&&(t+=1),e=e.substring(t).replace(/_/g,""),s){switch(n){case 2:e=`0b${e}`;break;case 8:e=`0o${e}`;break;case 16:e=`0x${e}`;break}const o=BigInt(e);return i==="-"?BigInt(-1)*o:o}const r=parseInt(e,n);return i==="-"?-1*r:r}function Nr(e,t,n){const{value:s}=e;if(is(s)){const i=s.toString(t);return s<0?"-"+n+i.substr(1):n+i}return Ze(e)}const gd={identify:is,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(e,t,n)=>si(e,2,2,n),stringify:e=>Nr(e,2,"0b")},yd={identify:is,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(e,t,n)=>si(e,1,8,n),stringify:e=>Nr(e,8,"0")},_d={identify:is,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(e,t,n)=>si(e,0,10,n),stringify:Ze},bd={identify:is,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(e,t,n)=>si(e,2,16,n),stringify:e=>Nr(e,16,"0x")};class fn extends Ve{constructor(t){super(t),this.tag=fn.tag}add(t){let n;pe(t)?n=t:t&&typeof t=="object"&&"key"in t&&"value"in t&&t.value===null?n=new xe(t.key,null):n=new xe(t,null),Ut(this.items,n.key)||this.items.push(n)}get(t,n){const s=Ut(this.items,t);return!n&&pe(s)?oe(s.key)?s.key.value:s.key:s}set(t,n){if(typeof n!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof n}`);const s=Ut(this.items,t);s&&!n?this.items.splice(this.items.indexOf(s),1):!s&&n&&this.items.push(new xe(t))}toJSON(t,n){return super.toJSON(t,n,Set)}toString(t,n,s){if(!t)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},t,{allNullValues:!0}),n,s);throw new Error("Set items must all have null values")}static from(t,n,s){const{replacer:i}=s,r=new this(t);if(n&&Symbol.iterator in Object(n))for(let o of n)typeof i=="function"&&(o=i.call(n,o,o)),r.items.push(wr(o,null,s));return r}}fn.tag="tag:yaml.org,2002:set";const Tr={collection:"map",identify:e=>e instanceof Set,nodeClass:fn,default:!1,tag:"tag:yaml.org,2002:set",createNode:(e,t,n)=>fn.from(e,t,n),resolve(e,t){if(ns(e)){if(e.hasAllNullValues(!0))return Object.assign(new fn,e);t("Set items must all have null values")}else t("Expected a mapping for this tag");return e}};function Or(e,t){const n=e[0],s=n==="-"||n==="+"?e.substring(1):e,i=o=>t?BigInt(o):Number(o),r=s.replace(/_/g,"").split(":").reduce((o,a)=>o*i(60)+i(a),i(0));return n==="-"?i(-1)*r:r}function Uc(e){let{value:t}=e,n=o=>o;if(typeof t=="bigint")n=o=>BigInt(o);else if(isNaN(t)||!isFinite(t))return Ze(e);let s="";t<0&&(s="-",t*=n(-1));const i=n(60),r=[t%i];return t<60?r.unshift(0):(t=(t-r[0])/i,r.unshift(t%i),t>=60&&(t=(t-r[0])/i,r.unshift(t))),s+r.map(o=>String(o).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}const Kc={identify:e=>typeof e=="bigint"||Number.isInteger(e),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(e,t,{intAsBigInt:n})=>Or(e,n),stringify:Uc},Hc={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:e=>Or(e,!1),stringify:Uc},ii={identify:e=>e instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(e){const t=e.match(ii.test);if(!t)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");const[,n,s,i,r,o,a]=t.map(Number),c=t[7]?Number((t[7]+"00").substr(1,3)):0;let l=Date.UTC(n,s-1,i,r||0,o||0,a||0,c);const u=t[8];if(u&&u!=="Z"){let f=Or(u,!1);Math.abs(f)<30&&(f*=60),l-=6e4*f}return new Date(l)},stringify:({value:e})=>(e==null?void 0:e.toISOString().replace(/(T00:00:00)?\.000Z$/,""))??""},Po=[vn,Sn,ei,ti,Bc,jc,gd,yd,_d,bd,dd,hd,md,Er,bt,Ar,kr,Tr,Kc,Hc,ii],Lo=new Map([["core",ld],["failsafe",[vn,Sn,ei]],["json",pd],["yaml11",Po],["yaml-1.1",Po]]),Do={binary:Er,bool:vr,float:Cc,floatExp:Ic,floatNaN:Rc,floatTime:Hc,int:Dc,intHex:Mc,intOct:Lc,intTime:Kc,map:vn,merge:bt,null:ti,omap:Ar,pairs:kr,seq:Sn,set:Tr,timestamp:ii},wd={"tag:yaml.org,2002:binary":Er,"tag:yaml.org,2002:merge":bt,"tag:yaml.org,2002:omap":Ar,"tag:yaml.org,2002:pairs":kr,"tag:yaml.org,2002:set":Tr,"tag:yaml.org,2002:timestamp":ii};function Si(e,t,n){const s=Lo.get(t);if(s&&!e)return n&&!s.includes(bt)?s.concat(bt):s.slice();let i=s;if(!i)if(Array.isArray(e))i=[];else{const r=Array.from(Lo.keys()).filter(o=>o!=="yaml11").map(o=>JSON.stringify(o)).join(", ");throw new Error(`Unknown schema "${t}"; use one of ${r} or define customTags array`)}if(Array.isArray(e))for(const r of e)i=i.concat(r);else typeof e=="function"&&(i=e(i.slice()));return n&&(i=i.concat(bt)),i.reduce((r,o)=>{const a=typeof o=="string"?Do[o]:o;if(!a){const c=JSON.stringify(o),l=Object.keys(Do).map(u=>JSON.stringify(u)).join(", ");throw new Error(`Unknown custom tag ${c}; use one of ${l}`)}return r.includes(a)||r.push(a),r},[])}const vd=(e,t)=>e.key<t.key?-1:e.key>t.key?1:0;class Rr{constructor({compat:t,customTags:n,merge:s,resolveKnownTags:i,schema:r,sortMapEntries:o,toStringDefaults:a}){this.compat=Array.isArray(t)?Si(t,"compat"):t?Si(null,t):null,this.name=typeof r=="string"&&r||"core",this.knownTags=i?wd:{},this.tags=Si(n,this.name,s),this.toStringOptions=a??null,Object.defineProperty(this,Lt,{value:vn}),Object.defineProperty(this,ft,{value:ei}),Object.defineProperty(this,bn,{value:Sn}),this.sortMapEntries=typeof o=="function"?o:o===!0?vd:null}clone(){const t=Object.create(Rr.prototype,Object.getOwnPropertyDescriptors(this));return t.tags=this.tags.slice(),t}}function Sd(e,t){var c;const n=[];let s=t.directives===!0;if(t.directives!==!1&&e.directives){const l=e.directives.toString(e);l?(n.push(l),s=!0):e.directives.docStart&&(s=!0)}s&&n.push("---");const i=kc(e,t),{commentString:r}=i.options;if(e.commentBefore){n.length!==1&&n.unshift("");const l=r(e.commentBefore);n.unshift(_t(l,""))}let o=!1,a=null;if(e.contents){if(ue(e.contents)){if(e.contents.spaceBefore&&s&&n.push(""),e.contents.commentBefore){const f=r(e.contents.commentBefore);n.push(_t(f,""))}i.forceBlockIndent=!!e.comment,a=e.contents.comment}const l=a?void 0:()=>o=!0;let u=yn(e.contents,i,()=>a=null,l);a&&(u+=jt(u,"",r(a))),(u[0]==="|"||u[0]===">")&&n[n.length-1]==="---"?n[n.length-1]=`--- ${u}`:n.push(u)}else n.push(yn(e.contents,i));if((c=e.directives)!=null&&c.docEnd)if(e.comment){const l=r(e.comment);l.includes(`
...
`)+`
`}class ri{constructor(t,n,s){this.commentBefore=null,this.comment=null,this.errors=[],this.warnings=[],Object.defineProperty(this,Ge,{value:Vi});let i=null;typeof n=="function"||Array.isArray(n)?i=n:s===void 0&&n&&(s=n,n=void 0);const r=Object.assign({intAsBigInt:!1,keepSourceTokens:!1,logLevel:"warn",prettyErrors:!0,strict:!0,stringKeys:!1,uniqueKeys:!0,version:"1.2"},s);this.options=r;let{version:o}=r;s!=null&&s._directives?(this.directives=s._directives.atDocument(),this.directives.yaml.explicit&&(o=this.directives.yaml.version)):this.directives=new Re({version:o}),this.setSchema(o,s),this.contents=t===void 0?null:this.createNode(t,i,s)}clone(){const t=Object.create(ri.prototype,{[Ge]:{value:Vi}});return t.commentBefore=this.commentBefore,t.comment=this.comment,t.errors=this.errors.slice(),t.warnings=this.warnings.slice(),t.options=Object.assign({},this.options),this.directives&&(t.directives=this.directives.clone()),t.schema=this.schema.clone(),t.contents=ue(this.contents)?this.contents.clone(t.schema):this.contents,this.range&&(t.range=this.range.slice()),t}add(t){Qt(this.contents)&&this.contents.add(t)}addIn(t,n){Qt(this.contents)&&this.contents.addIn(t,n)}createAlias(t,n){if(!t.anchor){const s=bc(this);t.anchor=!n||s.has(n)?wc(n||"a",s):n}return new _r(t.anchor)}createNode(t,n,s){let i;if(typeof n=="function")t=n.call({"":t},"",t),i=n;else if(Array.isArray(n)){const _=w=>typeof w=="number"||w instanceof String||w instanceof Number,v=n.filter(_).map(String);v.length>0&&(n=n.concat(v)),i=n}else s===void 0&&n&&(s=n,n=void 0);const{aliasDuplicateObjects:r,anchorPrefix:o,flow:a,keepUndefined:c,onTagObj:l,tag:u}=s??{},{onAnchor:f,setAnchors:p,sourceObjects:d}=Jp(this,o||"a"),b={aliasDuplicateObjects:r??!0,keepUndefined:c??!1,onAnchor:f,onTagObj:l,replacer:i,schema:this.schema,sourceObjects:d},g=Jn(t,u,b);return a&&le(g)&&(g.flow=!0),p(),g}createPair(t,n,s={}){const i=this.createNode(t,null,s),r=this.createNode(n,null,s);return new xe(i,r)}delete(t){return Qt(this.contents)?this.contents.delete(t):!1}deleteIn(t){return Rn(t)?this.contents==null?!1:(this.contents=null,!0):Qt(this.contents)?this.contents.deleteIn(t):!1}get(t,n){return le(this.contents)?this.contents.get(t,n):void 0}getIn(t,n){return Rn(t)?!n&&oe(this.contents)?this.contents.value:this.contents:le(this.contents)?this.contents.getIn(t,n):void 0}has(t){return le(this.contents)?this.contents.has(t):!1}hasIn(t){return Rn(t)?this.contents!==void 0:le(this.contents)?this.contents.hasIn(t):!1}set(t,n){this.contents==null?this.contents=Is(this.schema,[t],n):Qt(this.contents)&&this.contents.set(t,n)}setIn(t,n){Rn(t)?this.contents=n:this.contents==null?this.contents=Is(this.schema,Array.from(t),n):Qt(this.contents)&&this.contents.setIn(t,n)}setSchema(t,n={}){typeof t=="number"&&(t=String(t));let s;switch(t){case"1.1":this.directives?this.directives.yaml.version="1.1":this.directives=new Re({version:"1.1"}),s={resolveKnownTags:!1,schema:"yaml-1.1"};break;case"1.2":case"next":this.directives?this.directives.yaml.version=t:this.directives=new Re({version:t}),s={resolveKnownTags:!0,schema:"core"};break;case null:this.directives&&delete this.directives,s=null;break;default:{const i=JSON.stringify(t);throw new Error(`Expected '1.1', '1.2' or null as first argument, but found: ${i}`)}}if(n.schema instanceof Object)this.schema=n.schema;else if(s)this.schema=new Rr(Object.assign(s,n));else throw new Error("With a null YAML version, the { schema: Schema } option is required")}toJS({json:t,jsonArg:n,mapAsMap:s,maxAliasCount:i,onAnchor:r,reviver:o}={}){const a={anchors:new Map,doc:this,keep:!t,mapAsMap:s===!0,mapKeyWarned:!1,maxAliasCount:typeof i=="number"?i:100},c=qe(this.contents,n??"",a);if(typeof r=="function")for(const{count:l,res:u}of a.anchors.values())r(u,l);return typeof o=="function"?nn(o,{"":c},"",c):c}toJSON(t,n){return this.toJS({json:!0,jsonArg:t,mapAsMap:!1,onAnchor:n})}toString(t={}){if(this.errors.length>0)throw new Error("Document with errors cannot be stringified");if("indent"in t&&(!Number.isInteger(t.indent)||Number(t.indent)<=0)){const n=JSON.stringify(t.indent);throw new Error(`"indent" option must be a positive integer, not ${n}`)}return Sd(this,t)}}function Qt(e){if(le(e))return!0;throw new Error("Expected a YAML collection as document contents")}class Vc extends Error{constructor(t,n,s,i){super(),this.name=t,this.code=s,this.message=i,this.pos=n}}class In extends Vc{constructor(t,n,s){super("YAMLParseError",t,n,s)}}class Ed extends Vc{constructor(t,n,s){super("YAMLWarning",t,n,s)}}const Mo=(e,t)=>n=>{if(n.pos[0]===-1)return;n.linePos=n.pos.map(a=>t.linePos(a));const{line:s,col:i}=n.linePos[0];n.message+=` at line ${s}, column ${i}`;let r=i-1,o=e.substring(t.lineStarts[s-1],t.lineStarts[s]).replace(/[\n\r]+$/,"");if(r>=60&&o.length>80){const a=Math.min(r-39,o.length-79);o="…"+o.substring(a),r-=a-1}if(o.length>80&&(o=o.substring(0,79)+"…"),s>1&&/^ *$/.test(o.substring(0,r))){let a=e.substring(t.lineStarts[s-2],t.lineStarts[s-1]);a.length>80&&(a=a.substring(0,79)+`…
...
${o}
${l}
`}};function _n(e,{flow:t,indicator:n,next:s,offset:i,onError:r,parentIndent:o,startOnNewline:a}){let c=!1,l=a,u=a,f="",p="",d=!1,b=!1,g=null,_=null,v=null,w=null,T=null,N=null,P=null;for(const $ of e)switch(b&&($.type!=="space"&&$.type!=="newline"&&$.type!=="comma"&&r($.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),b=!1),g&&(l&&$.type!=="comment"&&$.type!=="newline"&&r(g,"TAB_AS_INDENT","Tabs are not allowed as indentation"),g=null),$.type){case"space":!t&&(n!=="doc-start"||(s==null?void 0:s.type)!=="flow-collection")&&$.source.includes("	")&&(g=$),u=!0;break;case"comment":{u||r($,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const G=$.source.substring(1)||" ";f?f+=p+G:f=G,p="",l=!1;break}case"newline":l?f?f+=$.source:(!N||n!=="seq-item-ind")&&(c=!0):p+=$.source,l=!0,d=!0,(_||v)&&(w=$),u=!0;break;case"anchor":_&&r($,"MULTIPLE_ANCHORS","A node can have at most one anchor"),$.source.endsWith(":")&&r($.offset+$.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),_=$,P??(P=$.offset),l=!1,u=!1,b=!0;break;case"tag":{v&&r($,"MULTIPLE_TAGS","A node can have at most one tag"),v=$,P??(P=$.offset),l=!1,u=!1,b=!0;break}case n:(_||v)&&r($,"BAD_PROP_ORDER",`Anchors and tags must be after the ${$.source} indicator`),N&&r($,"UNEXPECTED_TOKEN",`Unexpected ${$.source} in ${t??"collection"}`),N=$,l=n==="seq-item-ind"||n==="explicit-key-ind",u=!1;break;case"comma":if(t){T&&r($,"UNEXPECTED_TOKEN",`Unexpected , in ${t}`),T=$,l=!1,u=!1;break}default:r($,"UNEXPECTED_TOKEN",`Unexpected ${$.type} token`),l=!1,u=!1}const U=e[e.length-1],M=U?U.offset+U.source.length:i;return b&&s&&s.type!=="space"&&s.type!=="newline"&&s.type!=="comma"&&(s.type!=="scalar"||s.source!=="")&&r(s.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),g&&(l&&g.indent<=o||(s==null?void 0:s.type)==="block-map"||(s==null?void 0:s.type)==="block-seq")&&r(g,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:T,found:N,spaceBefore:c,comment:f,hasNewline:d,anchor:_,tag:v,newlineAfterProp:w,end:M,start:P??M}}function Qn(e){if(!e)return null;switch(e.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(e.source.includes(`
`))return!0;if(e.end){for(const t of e.end)if(t.type==="newline")return!0}return!1;case"flow-collection":for(const t of e.items){for(const n of t.start)if(n.type==="newline")return!0;if(t.sep){for(const n of t.sep)if(n.type==="newline")return!0}if(Qn(t.key)||Qn(t.value))return!0}return!1;default:return!0}}function Yi(e,t,n){if((t==null?void 0:t.type)==="flow-collection"){const s=t.end[0];s.indent===e&&(s.source==="]"||s.source==="}")&&Qn(t)&&n(s,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function qc(e,t,n){const{uniqueKeys:s}=e.options;if(s===!1)return!1;const i=typeof s=="function"?s:(r,o)=>r===o||oe(r)&&oe(o)&&r.value===o.value;return t.some(r=>i(r.key,n))}const xo="All mapping items must start at the same column";function kd({composeNode:e,composeEmptyNode:t},n,s,i,r){var u;const o=(r==null?void 0:r.nodeClass)??Ve,a=new o(n.schema);n.atRoot&&(n.atRoot=!1);let c=s.offset,l=null;for(const f of s.items){const{start:p,key:d,sep:b,value:g}=f,_=_n(p,{indicator:"explicit-key-ind",next:d??(b==null?void 0:b[0]),offset:c,onError:i,parentIndent:s.indent,startOnNewline:!0}),v=!_.found;if(v){if(d&&(d.type==="block-seq"?i(c,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in d&&d.indent!==s.indent&&i(c,"BAD_INDENT",xo)),!_.anchor&&!_.tag&&!b){l=_.end,_.comment&&(a.comment?a.comment+=`
`+_.comment:a.comment=_.comment);continue}(_.newlineAfterProp||Qn(d))&&i(d??p[p.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((u=_.found)==null?void 0:u.indent)!==s.indent&&i(c,"BAD_INDENT",xo);n.atKey=!0;const w=_.end,T=d?e(n,d,_,i):t(n,w,p,null,_,i);n.schema.compat&&Yi(s.indent,d,i),n.atKey=!1,qc(n,a.items,T)&&i(w,"DUPLICATE_KEY","Map keys must be unique");const N=_n(b??[],{indicator:"map-value-ind",next:g,offset:T.range[2],onError:i,parentIndent:s.indent,startOnNewline:!d||d.type==="block-scalar"});if(c=N.end,N.found){v&&((g==null?void 0:g.type)==="block-map"&&!N.hasNewline&&i(c,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),n.options.strict&&_.start<N.found.offset-1024&&i(T.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const P=g?e(n,g,N,i):t(n,c,b,null,N,i);n.schema.compat&&Yi(s.indent,g,i),c=P.range[2];const U=new xe(T,P);n.options.keepSourceTokens&&(U.srcToken=f),a.items.push(U)}else{v&&i(T.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),N.comment&&(T.comment?T.comment+=`
`+N.comment:T.comment=N.comment);const P=new xe(T);n.options.keepSourceTokens&&(P.srcToken=f),a.items.push(P)}}return l&&l<c&&i(l,"IMPOSSIBLE","Map comment with trailing content"),a.range=[s.offset,c,l??c],a}function Ad({composeNode:e,composeEmptyNode:t},n,s,i,r){const o=(r==null?void 0:r.nodeClass)??Vt,a=new o(n.schema);n.atRoot&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let c=s.offset,l=null;for(const{start:u,value:f}of s.items){const p=_n(u,{indicator:"seq-item-ind",next:f,offset:c,onError:i,parentIndent:s.indent,startOnNewline:!0});if(!p.found)if(p.anchor||p.tag||f)(f==null?void 0:f.type)==="block-seq"?i(p.end,"BAD_INDENT","All sequence items must start at the same column"):i(c,"MISSING_CHAR","Sequence item without - indicator");else{l=p.end,p.comment&&(a.comment=p.comment);continue}const d=f?e(n,f,p,i):t(n,p.end,u,null,p,i);n.schema.compat&&Yi(s.indent,f,i),c=d.range[2],a.items.push(d)}return a.range=[s.offset,c,l??c],a}function rs(e,t,n,s){let i="";if(e){let r=!1,o="";for(const a of e){const{source:c,type:l}=a;switch(l){case"space":r=!0;break;case"comment":{n&&!r&&s(a,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const u=c.substring(1)||" ";i?i+=o+u:i=u,o="";break}case"newline":i&&(o+=c),r=!0;break;default:s(a,"UNEXPECTED_TOKEN",`Unexpected ${l} at node end`)}t+=c.length}}return{comment:i,offset:t}}const Ei="Block collections are not allowed within flow collections",ki=e=>e&&(e.type==="block-map"||e.type==="block-seq");function Nd({composeNode:e,composeEmptyNode:t},n,s,i,r){var _;const o=s.start.source==="{",a=o?"flow map":"flow sequence",c=(r==null?void 0:r.nodeClass)??(o?Ve:Vt),l=new c(n.schema);l.flow=!0;const u=n.atRoot;u&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let f=s.offset+s.start.source.length;for(let v=0;v<s.items.length;++v){const w=s.items[v],{start:T,key:N,sep:P,value:U}=w,M=_n(T,{flow:a,indicator:"explicit-key-ind",next:N??(P==null?void 0:P[0]),offset:f,onError:i,parentIndent:s.indent,startOnNewline:!1});if(!M.found){if(!M.anchor&&!M.tag&&!P&&!U){v===0&&M.comma?i(M.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${a}`):v<s.items.length-1&&i(M.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${a}`),M.comment&&(l.comment?l.comment+=`
`+M.comment:l.comment=M.comment),f=M.end;continue}!o&&n.options.strict&&Qn(N)&&i(N,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(v===0)M.comma&&i(M.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${a}`);else if(M.comma||i(M.start,"MISSING_CHAR",`Missing , between ${a} items`),M.comment){let $="";e:for(const G of T)switch(G.type){case"comma":case"space":break;case"comment":$=G.source.substring(1);break e;default:break e}if($){let G=l.items[l.items.length-1];pe(G)&&(G=G.value??G.key),G.comment?G.comment+=`
`+$:G.comment=$,M.comment=M.comment.substring($.length+1)}}if(!o&&!P&&!M.found){const $=U?e(n,U,M,i):t(n,M.end,P,null,M,i);l.items.push($),f=$.range[2],ki(U)&&i($.range,"BLOCK_IN_FLOW",Ei)}else{n.atKey=!0;const $=M.end,G=N?e(n,N,M,i):t(n,$,T,null,M,i);ki(N)&&i(G.range,"BLOCK_IN_FLOW",Ei),n.atKey=!1;const ne=_n(P??[],{flow:a,indicator:"map-value-ind",next:U,offset:G.range[2],onError:i,parentIndent:s.indent,startOnNewline:!1});if(ne.found){if(!o&&!M.found&&n.options.strict){if(P)for(const ae of P){if(ae===ne.found)break;if(ae.type==="newline"){i(ae,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}M.start<ne.found.offset-1024&&i(ne.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else U&&("source"in U&&((_=U.source)==null?void 0:_[0])===":"?i(U,"MISSING_CHAR",`Missing space after : in ${a}`):i(ne.start,"MISSING_CHAR",`Missing , or : between ${a} items`));const _e=U?e(n,U,ne,i):ne.found?t(n,ne.end,P,null,ne,i):null;_e?ki(U)&&i(_e.range,"BLOCK_IN_FLOW",Ei):ne.comment&&(G.comment?G.comment+=`
`+ne.comment:G.comment=ne.comment);const he=new xe(G,_e);if(n.options.keepSourceTokens&&(he.srcToken=w),o){const ae=l;qc(n,ae.items,G)&&i($,"DUPLICATE_KEY","Map keys must be unique"),ae.items.push(he)}else{const ae=new Ve(n.schema);ae.flow=!0,ae.items.push(he);const At=(_e??G).range;ae.range=[G.range[0],At[1],At[2]],l.items.push(ae)}f=_e?_e.range[2]:ne.end}}const p=o?"}":"]",[d,...b]=s.end;let g=f;if((d==null?void 0:d.source)===p)g=d.offset+d.source.length;else{const v=a[0].toUpperCase()+a.substring(1),w=u?`${v} must end with a ${p}`:`${v} in block collection must be sufficiently indented and end with a ${p}`;i(f,u?"MISSING_CHAR":"BAD_INDENT",w),d&&d.source.length!==1&&b.unshift(d)}if(b.length>0){const v=rs(b,g,n.options.strict,i);v.comment&&(l.comment?l.comment+=`
`+v.comment:l.comment=v.comment),l.range=[s.offset,g,v.offset]}else l.range=[s.offset,g,g];return l}function Ai(e,t,n,s,i,r){const o=n.type==="block-map"?kd(e,t,n,s,r):n.type==="block-seq"?Ad(e,t,n,s,r):Nd(e,t,n,s,r),a=o.constructor;return i==="!"||i===a.tagName?(o.tag=a.tagName,o):(i&&(o.tag=i),o)}function Td(e,t,n,s,i){var p;const r=s.tag,o=r?t.directives.tagName(r.source,d=>i(r,"TAG_RESOLVE_FAILED",d)):null;if(n.type==="block-seq"){const{anchor:d,newlineAfterProp:b}=s,g=d&&r?d.offset>r.offset?d:r:d??r;g&&(!b||b.offset<g.offset)&&i(g,"MISSING_CHAR","Missing newline after block sequence props")}const a=n.type==="block-map"?"map":n.type==="block-seq"?"seq":n.start.source==="{"?"map":"seq";if(!r||!o||o==="!"||o===Ve.tagName&&a==="map"||o===Vt.tagName&&a==="seq")return Ai(e,t,n,i,o);let c=t.schema.tags.find(d=>d.tag===o&&d.collection===a);if(!c){const d=t.schema.knownTags[o];if((d==null?void 0:d.collection)===a)t.schema.tags.push(Object.assign({},d,{default:!1})),c=d;else return d?i(r,"BAD_COLLECTION_TYPE",`${d.tag} used for ${a} collection, but expects ${d.collection??"scalar"}`,!0):i(r,"TAG_RESOLVE_FAILED",`Unresolved tag: ${o}`,!0),Ai(e,t,n,i,o)}const l=Ai(e,t,n,i,o,c),u=((p=c.resolve)==null?void 0:p.call(c,l,d=>i(r,"TAG_RESOLVE_FAILED",d),t.options))??l,f=ue(u)?u:new q(u);return f.range=l.range,f.tag=o,c!=null&&c.format&&(f.format=c.format),f}function Od(e,t,n){const s=t.offset,i=Rd(t,e.options.strict,n);if(!i)return{value:"",type:null,comment:"",range:[s,s,s]};const r=i.mode===">"?q.BLOCK_FOLDED:q.BLOCK_LITERAL,o=t.source?Id(t.source):[];let a=o.length;for(let g=o.length-1;g>=0;--g){const _=o[g][1];if(_===""||_==="\r")a=g;else break}if(a===0){const g=i.chomp==="+"&&o.length>0?`
...
`;for(let g=u;g<a;++g){let[_,v]=o[g];l+=_.length+v.length+1;const w=v[v.length-1]==="\r";if(w&&(v=v.slice(0,-1)),v&&_.length<c){const N=`Block scalar lines must not be less indented than their ${i.indent?"explicit indentation indicator":"first line"}`;n(l-v.length-(w?2:1),"BAD_INDENT",N),_=""}r===q.BLOCK_LITERAL?(f+=p+_.slice(c)+v,p=`
`):_.length>c||v[0]==="	"?(p===" "?p=`
`:!d&&p===`
`&&(p=`
...
`&&(f+=`
`);break;default:f+=`
`}const b=s+i.length+t.source.length;return{value:f,type:r,comment:i.comment,range:[s,b,b]}}function Rd({offset:e,props:t},n,s){if(t[0].type!=="block-scalar-header")return s(t[0],"IMPOSSIBLE","Block scalar header not found"),null;const{source:i}=t[0],r=i[0];let o=0,a="",c=-1;for(let p=1;p<i.length;++p){const d=i[p];if(!a&&(d==="-"||d==="+"))a=d;else{const b=Number(d);!o&&b?o=b:c===-1&&(c=e+p)}}c!==-1&&s(c,"UNEXPECTED_TOKEN",`Block scalar header includes extra characters: ${i}`);let l=!1,u="",f=i.length;for(let p=1;p<t.length;++p){const d=t[p];switch(d.type){case"space":l=!0;case"newline":f+=d.source.length;break;case"comment":n&&!l&&s(d,"MISSING_CHAR","Comments must be separated from other tokens by white space characters"),f+=d.source.length,u=d.source.substring(1);break;case"error":s(d,"UNEXPECTED_TOKEN",d.message),f+=d.source.length;break;default:{const b=`Unexpected token in block scalar header: ${d.type}`;s(d,"UNEXPECTED_TOKEN",b);const g=d.source;g&&typeof g=="string"&&(f+=g.length)}}}return{mode:r,indent:o,chomp:a,comment:u,length:f}}function Id(e){const t=e.split(/\n( *)/),n=t[0],s=n.match(/^( *)/),r=[s!=null&&s[1]?[s[1],n.slice(s[1].length)]:["",n]];for(let o=1;o<t.length;o+=2)r.push([t[o],t[o+1]]);return r}function Cd(e,t,n){const{offset:s,type:i,source:r,end:o}=e;let a,c;const l=(p,d,b)=>n(s+p,d,b);switch(i){case"scalar":a=q.PLAIN,c=Pd(r,l);break;case"single-quoted-scalar":a=q.QUOTE_SINGLE,c=Ld(r,l);break;case"double-quoted-scalar":a=q.QUOTE_DOUBLE,c=Dd(r,l);break;default:return n(e,"UNEXPECTED_TOKEN",`Expected a flow scalar value, but found: ${i}`),{value:"",type:null,comment:"",range:[s,s+r.length,s+r.length]}}const u=s+r.length,f=rs(o,u,t,n);return{value:c,type:a,comment:f.comment,range:[s,u,f.offset]}}function Pd(e,t){let n="";switch(e[0]){case"	":n="a tab character";break;case",":n="flow indicator character ,";break;case"%":n="directive indicator character %";break;case"|":case">":{n=`block scalar indicator ${e[0]}`;break}case"@":case"`":{n=`reserved character ${e[0]}`;break}}return n&&t(0,"BAD_SCALAR_START",`Plain value cannot start with ${n}`),Gc(e)}function Ld(e,t){return(e[e.length-1]!=="'"||e.length===1)&&t(e.length,"MISSING_CHAR","Missing closing 'quote"),Gc(e.slice(1,-1)).replace(/''/g,"'")}function Gc(e){let t,n;try{t=new RegExp(`(.*?)(?<![ 	])[ 	]*\r?
`,"sy"),n=new RegExp(`[ 	]*(.*?)(?:(?<![ 	])[ 	]*)?\r?
`,"sy")}catch{t=/(.*?)[ \t]*\r?\n/sy,n=/[ \t]*(.*?)[ \t]*\r?\n/sy}let s=t.exec(e);if(!s)return e;let i=s[1],r=" ",o=t.lastIndex;for(n.lastIndex=o;s=n.exec(e);)s[1]===""?r===`
`?i+=r:r=`
`:(i+=r+s[1],r=" "),o=n.lastIndex;const a=/[ \t]*(.*)/sy;return a.lastIndex=o,s=a.exec(e),i+r+((s==null?void 0:s[1])??"")}function Dd(e,t){let n="";for(let s=1;s<e.length-1;++s){const i=e[s];if(!(i==="\r"&&e[s+1]===`
`))if(i===`
`){const{fold:r,offset:o}=Md(e,s);n+=r,s=o}else if(i==="\\"){let r=e[++s];const o=xd[r];if(o)n+=o;else if(r===`
`)for(r=e[s+1];r===" "||r==="	";)r=e[++s+1];else if(r==="\r"&&e[s+1]===`
`)for(r=e[++s+1];r===" "||r==="	";)r=e[++s+1];else if(r==="x"||r==="u"||r==="U"){const a={x:2,u:4,U:8}[r];n+=$d(e,s+1,a,t),s+=a}else{const a=e.substr(s-1,2);t(s-1,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),n+=a}}else if(i===" "||i==="	"){const r=s;let o=e[s+1];for(;o===" "||o==="	";)o=e[++s+1];o!==`
`&&!(o==="\r"&&e[s+2]===`
`)&&(n+=s>r?e.slice(r,s+1):i)}else n+=i}return(e[e.length-1]!=='"'||e.length===1)&&t(e.length,"MISSING_CHAR",'Missing closing "quote'),n}function Md(e,t){let n="",s=e[t+1];for(;(s===" "||s==="	"||s===`
`||s==="\r")&&!(s==="\r"&&e[t+2]!==`
`);)s===`
`&&(n+=`
`),t+=1,s=e[t+1];return n||(n=" "),{fold:n,offset:t}}const xd={0:"\0",a:"\x07",b:"\b",e:"\x1B",f:"\f",n:`
`,r:"\r",t:"	",v:"\v",N:"",_:" ",L:"\u2028",P:"\u2029"," ":" ",'"':'"',"/":"/","\\":"\\","	":"	"};function $d(e,t,n,s){const i=e.substr(t,n),o=i.length===n&&/^[0-9a-fA-F]+$/.test(i)?parseInt(i,16):NaN;if(isNaN(o)){const a=e.substr(t-2,n+2);return s(t-2,"BAD_DQ_ESCAPE",`Invalid escape sequence ${a}`),a}return String.fromCodePoint(o)}function zc(e,t,n,s){const{value:i,type:r,comment:o,range:a}=t.type==="block-scalar"?Od(e,t,s):Cd(t,e.options.strict,s),c=n?e.directives.tagName(n.source,f=>s(n,"TAG_RESOLVE_FAILED",f)):null;let l;e.options.stringKeys&&e.atKey?l=e.schema[ft]:c?l=Fd(e.schema,i,c,n,s):t.type==="scalar"?l=Bd(e,i,t,s):l=e.schema[ft];let u;try{const f=l.resolve(i,p=>s(n??t,"TAG_RESOLVE_FAILED",p),e.options);u=oe(f)?f:new q(f)}catch(f){const p=f instanceof Error?f.message:String(f);s(n??t,"TAG_RESOLVE_FAILED",p),u=new q(i)}return u.range=a,u.source=i,r&&(u.type=r),c&&(u.tag=c),l.format&&(u.format=l.format),o&&(u.comment=o),u}function Fd(e,t,n,s,i){var a;if(n==="!")return e[ft];const r=[];for(const c of e.tags)if(!c.collection&&c.tag===n)if(c.default&&c.test)r.push(c);else return c;for(const c of r)if((a=c.test)!=null&&a.test(t))return c;const o=e.knownTags[n];return o&&!o.collection?(e.tags.push(Object.assign({},o,{default:!1,test:void 0})),o):(i(s,"TAG_RESOLVE_FAILED",`Unresolved tag: ${n}`,n!=="tag:yaml.org,2002:str"),e[ft])}function Bd({atKey:e,directives:t,schema:n},s,i,r){const o=n.tags.find(a=>{var c;return(a.default===!0||e&&a.default==="key")&&((c=a.test)==null?void 0:c.test(s))})||n[ft];if(n.compat){const a=n.compat.find(c=>{var l;return c.default&&((l=c.test)==null?void 0:l.test(s))})??n[ft];if(o.tag!==a.tag){const c=t.tagString(o.tag),l=t.tagString(a.tag),u=`Value may be parsed as either ${c} or ${l}`;r(i,"TAG_RESOLVE_FAILED",u,!0)}}return o}function jd(e,t,n){if(t){n??(n=t.length);for(let s=n-1;s>=0;--s){let i=t[s];switch(i.type){case"space":case"comment":case"newline":e-=i.source.length;continue}for(i=t[++s];(i==null?void 0:i.type)==="space";)e+=i.source.length,i=t[++s];break}}return e}const Ud={composeNode:Yc,composeEmptyNode:Ir};function Yc(e,t,n,s){const i=e.atKey,{spaceBefore:r,comment:o,anchor:a,tag:c}=n;let l,u=!0;switch(t.type){case"alias":l=Kd(e,t,s),(a||c)&&s(t,"ALIAS_PROPS","An alias node must not specify any properties");break;case"scalar":case"single-quoted-scalar":case"double-quoted-scalar":case"block-scalar":l=zc(e,t,c,s),a&&(l.anchor=a.source.substring(1));break;case"block-map":case"block-seq":case"flow-collection":try{l=Td(Ud,e,t,n,s),a&&(l.anchor=a.source.substring(1))}catch(f){const p=f instanceof Error?f.message:String(f);s(t,"RESOURCE_EXHAUSTION",p)}break;default:{const f=t.type==="error"?t.message:`Unsupported token (type: ${t.type})`;s(t,"UNEXPECTED_TOKEN",f),u=!1}}return l??(l=Ir(e,t.offset,void 0,null,n,s)),a&&l.anchor===""&&s(a,"BAD_ALIAS","Anchor cannot be an empty string"),i&&e.options.stringKeys&&(!oe(l)||typeof l.value!="string"||l.tag&&l.tag!=="tag:yaml.org,2002:str")&&s(c??t,"NON_STRING_KEY","With stringKeys, all keys must be strings"),r&&(l.spaceBefore=!0),o&&(t.type==="scalar"&&t.source===""?l.comment=o:l.commentBefore=o),e.options.keepSourceTokens&&u&&(l.srcToken=t),l}function Ir(e,t,n,s,{spaceBefore:i,comment:r,anchor:o,tag:a,end:c},l){const u={type:"scalar",offset:jd(t,n,s),indent:-1,source:""},f=zc(e,u,a,l);return o&&(f.anchor=o.source.substring(1),f.anchor===""&&l(o,"BAD_ALIAS","Anchor cannot be an empty string")),i&&(f.spaceBefore=!0),r&&(f.comment=r,f.range[2]=c),f}function Kd({options:e},{offset:t,source:n,end:s},i){const r=new _r(n.substring(1));r.source===""&&i(t,"BAD_ALIAS","Alias cannot be an empty string"),r.source.endsWith(":")&&i(t+n.length-1,"BAD_ALIAS","Alias ending in : is ambiguous",!0);const o=t+n.length,a=rs(s,o,e.strict,i);return r.range=[t,o,a.offset],a.comment&&(r.comment=a.comment),r}function Hd(e,t,{offset:n,start:s,value:i,end:r},o){const a=Object.assign({_directives:t},e),c=new ri(void 0,a),l={atKey:!1,atRoot:!0,directives:c.directives,options:c.options,schema:c.schema},u=_n(s,{indicator:"doc-start",next:i??(r==null?void 0:r[0]),offset:n,onError:o,parentIndent:0,startOnNewline:!0});u.found&&(c.directives.docStart=!0,i&&(i.type==="block-map"||i.type==="block-seq")&&!u.hasNewline&&o(u.end,"MISSING_CHAR","Block collection cannot start on same line with directives-end marker")),c.contents=i?Yc(l,i,u,o):Ir(l,u.end,s,null,u,o);const f=c.contents.range[2],p=rs(r,f,!1,o);return p.comment&&(c.comment=p.comment),c.range=[n,f,p.offset],c}function Tn(e){if(typeof e=="number")return[e,e+1];if(Array.isArray(e))return e.length===2?e:[e[0],e[1]];const{offset:t,source:n}=e;return[t,t+(typeof n=="string"?n.length:1)]}function $o(e){var i;let t="",n=!1,s=!1;for(let r=0;r<e.length;++r){const o=e[r];switch(o[0]){case"#":t+=(t===""?"":s?`

`:`
`)+(o.substring(1)||" "),n=!0,s=!1;break;case"%":((i=e[r+1])==null?void 0:i[0])!=="#"&&(r+=1),n=!1;break;default:n||(s=!0),n=!1}}return{comment:t,afterEmptyLine:s}}class Vd{constructor(t={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(n,s,i,r)=>{const o=Tn(n);r?this.warnings.push(new Ed(o,s,i)):this.errors.push(new In(o,s,i))},this.directives=new Re({version:t.version||"1.2"}),this.options=t}decorate(t,n){const{comment:s,afterEmptyLine:i}=$o(this.prelude);if(s){const r=t.contents;if(n)t.comment=t.comment?`${t.comment}
...
${o}`:s}}n?(Array.prototype.push.apply(t.errors,this.errors),Array.prototype.push.apply(t.warnings,this.warnings)):(t.errors=this.errors,t.warnings=this.warnings),this.prelude=[],this.errors=[],this.warnings=[]}streamInfo(){return{comment:$o(this.prelude).comment,directives:this.directives,errors:this.errors,warnings:this.warnings}}*compose(t,n=!1,s=-1){for(const i of t)yield*this.next(i);yield*this.end(n,s)}*next(t){switch(t.type){case"directive":this.directives.add(t.source,(n,s,i)=>{const r=Tn(t);r[0]+=n,this.onError(r,"BAD_DIRECTIVE",s,i)}),this.prelude.push(t.source),this.atDirectives=!0;break;case"document":{const n=Hd(this.options,this.directives,t,this.onError);this.atDirectives&&!n.directives.docStart&&this.onError(t,"MISSING_CHAR","Missing directives-end/doc-start indicator line"),this.decorate(n,!1),this.doc&&(yield this.doc),this.doc=n,this.atDirectives=!1;break}case"byte-order-mark":case"space":break;case"comment":case"newline":this.prelude.push(t.source);break;case"error":{const n=t.source?`${t.message}: ${JSON.stringify(t.source)}`:t.message,s=new In(Tn(t),"UNEXPECTED_TOKEN",n);this.atDirectives||!this.doc?this.errors.push(s):this.doc.errors.push(s);break}case"doc-end":{if(!this.doc){const s="Unexpected doc-end without preceding document";this.errors.push(new In(Tn(t),"UNEXPECTED_TOKEN",s));break}this.doc.directives.docEnd=!0;const n=rs(t.end,t.offset+t.source.length,this.doc.options.strict,this.onError);if(this.decorate(this.doc,!0),n.comment){const s=this.doc.comment;this.doc.comment=s?`${s}
${n.comment}`:n.comment}this.doc.range[2]=n.offset;break}default:this.errors.push(new In(Tn(t),"UNEXPECTED_TOKEN",`Unsupported token ${t.type}`))}}*end(t=!1,n=-1){if(this.doc)this.decorate(this.doc,!0),yield this.doc,this.doc=null;else if(t){const s=Object.assign({_directives:this.directives},this.options),i=new ri(void 0,s);this.atDirectives&&this.onError(n,"MISSING_CHAR","Missing directives-end indicator line"),i.range=[0,n,n],this.decorate(i,!1),yield i}}}const Wc="\uFEFF",Jc="",Qc="",Wi="";function qd(e){switch(e){case Wc:return"byte-order-mark";case Jc:return"doc-mode";case Qc:return"flow-error-end";case Wi:return"scalar";case"---":return"doc-start";case"...":return"doc-end";case"":case`
`:case`\r
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const rh=({size:e,strokeWidth:t=2,absoluteStrokeWidth:n,color:s,iconNode:i,name:r,class:o,...a},{slots:c})=>Yn("svg",{...hs,width:e||hs.width,height:e||hs.height,stroke:s||hs.stroke,"stroke-width":n?Number(t)*24/Number(e):t,class:["lucide",`lucide-${ih(r??"icon")}`],...a},[...i.map(l=>Yn(...l)),...c.default?[c.default()]:[]]);/**
 * @license lucide-vue-next v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zc=(e,t)=>(n,{slots:s})=>Yn(rh,{...n,iconNode:t,name:e},s);/**
 * @license lucide-vue-next v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const oh=Zc("MoonIcon",[["path",{d:"M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z",key:"a7tn18"}]]);/**
 * @license lucide-vue-next v0.460.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ah=Zc("SunIcon",[["circle",{cx:"12",cy:"12",r:"4",key:"4exip2"}],["path",{d:"M12 2v2",key:"tus03m"}],["path",{d:"M12 20v2",key:"1lh1kg"}],["path",{d:"m4.93 4.93 1.41 1.41",key:"149t6j"}],["path",{d:"m17.66 17.66 1.41 1.41",key:"ptbguv"}],["path",{d:"M2 12h2",key:"1t8f8n"}],["path",{d:"M20 12h2",key:"1q8mjw"}],["path",{d:"m6.34 17.66-1.41 1.41",key:"1m8zz5"}],["path",{d:"m19.07 4.93-1.41 1.41",key:"1shlcs"}]]),el="standards.theme";function tl(){try{const e=localStorage.getItem(el);return e==="light"||e==="dark"?e:null}catch{return null}}function ch(){return typeof window>"u"||!window.matchMedia?"light":window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}function Cr(e){typeof document<"u"&&(document.documentElement.dataset.theme=e)}const Pt=Hs(tl()??ch());let Uo=!1;function lh(){if(!Uo&&(Uo=!0,Cr(Pt.value),typeof window<"u"&&window.matchMedia)){const e=window.matchMedia("(prefers-color-scheme: dark)"),t=n=>{tl()===null&&(Pt.value=n.matches?"dark":"light")};e.addEventListener("change",t)}}Mn(Pt,e=>{Cr(e);try{localStorage.setItem(el,e)}catch{}});typeof document<"u"&&Cr(Pt.value);function uh(){return cr(lh),lr(()=>{}),{theme:Pt,toggle:()=>{Pt.value=Pt.value==="dark"?"light":"dark"},setTheme:e=>{Pt.value=e}}}const fh=["title","aria-label"],ph=es({__name:"ThemeToggle",setup(e){const{theme:t,toggle:n}=uh();return(s,i)=>(Ie(),ot("button",{type:"button",class:"theme-toggle",title:we(t)==="dark"?"Светлая тема":"Тёмная тема","aria-label":we(t)==="dark"?"Светлая тема":"Тёмная тема",onClick:i[0]||(i[0]=(...r)=>we(n)&&we(n)(...r))},[we(t)==="dark"?(Ie(),qn(we(ah),{key:0,size:16})):(Ie(),qn(we(oh),{key:1,size:16})),Se("span",null,Pn(we(t)==="dark"?"Светлая":"Тёмная"),1)],8,fh))}}),nl=(e,t)=>{const n=e.__vccOpts||e;for(const[s,i]of t)n[s]=i;return n},dh=nl(ph,[["__scopeId","data-v-736ff43a"]]),hh={class:"sidebar"},mh={class:"sidebar-brand"},gh={class:"sidebar-body"},yh={key:0,class:"sidebar-empty"},_h={class:"sidebar-group__head"},bh={class:"sidebar-group__name"},wh={key:0,class:"sidebar-group__code"},vh={class:"sidebar-group__list"},Sh={class:"sidebar-foot"},Eh=es({__name:"Sidebar",setup(e){const t=Ip(),n=Pe(()=>Ji.contracts),s=Pe(()=>Ji.byContract),i=Pe(()=>n.value.length===0),r=Pe(()=>typeof t.params.processType=="string"?t.params.processType:null);function o(a){return sh[a]??""}return(a,c)=>(Ie(),ot("nav",hh,[Se("div",mh,[ge(we(Hi),{to:"/"},{default:Pi(()=>[...c[0]||(c[0]=[Se("div",{class:"sidebar-brand__title"},"Кооперативные стандарты",-1),Se("div",{class:"sidebar-brand__subtitle"},"Реестр v1",-1)])]),_:1})]),Se("div",gh,[i.value?(Ie(),ot("p",yh,[...c[1]||(c[1]=[ys(" Стандарты не найдены. Добавьте ",-1),Se("code",null,"*.standard.yaml",-1),ys(" рядом с кодом контракта. ",-1)])])):Xr("",!0),(Ie(!0),ot(Be,null,Hr(n.value,l=>(Ie(),ot("div",{key:l,class:"sidebar-group"},[Se("div",_h,[Se("span",bh,Pn(o(l)||l),1),o(l)?(Ie(),ot("code",wh,Pn(l),1)):Xr("",!0)]),Se("ul",vh,[(Ie(!0),ot(Be,null,Hr(s.value[l],u=>(Ie(),ot("li",{key:u.process_type},[ge(we(Hi),{to:{name:"process",params:{contract:u.contract,processType:u.process_type}},class:Fs(["sidebar-item",{"sidebar-item--active":r.value===u.process_type}])},{default:Pi(()=>[ys(Pn(u.title),1)]),_:2},1032,["to","class"])]))),128))])]))),128))]),Se("div",Sh,[ge(dh)])]))}}),kh=nl(Eh,[["__scopeId","data-v-fff96373"]]),Ah={key:0,class:"mobile-stub"},Nh={key:1,class:"app-shell"},Th={class:"app-sidebar"},Oh={class:"app-main"},Rh=900,Ih=es({__name:"App",setup(e){const t=Hs(!1);function n(){typeof window>"u"||(t.value=window.innerWidth<Rh)}return cr(()=>{n(),window.addEventListener("resize",n)}),lr(()=>{window.removeEventListener("resize",n)}),(s,i)=>{const r=fu("router-view");return t.value?(Ie(),ot("div",Ah,[...i[0]||(i[0]=[Se("div",{class:"mobile-stub__box"},[Se("h1",null,"Только для десктопа"),Se("p",null," Реестр кооперативных стандартов рассчитан на широкие экраны — BPMN-граф процесса не помещается на мобильных устройствах. Откройте сайт с компьютера или планшета. ")],-1)])])):(Ie(),ot("div",Nh,[Se("aside",Th,[ge(kh)]),Se("main",Oh,[ge(r)])]))}}}),Ch="modulepreload",Ph=function(e){return"/standards/"+e},Ko={},Ti=function(t,n,s){let i=Promise.resolve();if(n&&n.length>0){let o=function(l){return Promise.all(l.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),c=(a==null?void 0:a.nonce)||(a==null?void 0:a.getAttribute("nonce"));i=o(n.map(l=>{if(l=Ph(l),l in Ko)return;Ko[l]=!0;const u=l.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${f}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":Ch,u||(p.as="script"),p.crossOrigin="",p.href=l,c&&p.setAttribute("nonce",c),document.head.appendChild(p),u)return new Promise((d,b)=>{p.addEventListener("load",d),p.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function r(o){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=o,window.dispatchEvent(a),!a.defaultPrevented)throw o}return i.then(o=>{for(const a of o||[])a.status==="rejected"&&r(a.reason);return t().catch(r)})},Lh=[{path:"/",name:"home",component:()=>Ti(()=>import("./HomePage-8onw1bhO.js"),__vite__mapDeps([0,1]))},{path:"/:contract/:processType",name:"process",component:()=>Ti(()=>import("./ProcessPage-b4bx9n77.js"),__vite__mapDeps([2,3])),props:!0},{path:"/:pathMatch(.*)*",name:"not-found",component:()=>Ti(()=>import("./NotFoundPage-qGG0p55J.js"),[])}],Dh=Rp({history:cp(),routes:Lh,scrollBehavior(e,t){if(!(e.name!==t.name||e.params.processType!==t.params.processType))return!1;if(typeof document<"u"){const s=document.querySelector(".app-main");s?s.scrollTo({top:0,behavior:"smooth"}):window.scrollTo({top:0,behavior:"smooth"})}return{top:0}}});vf(Ih).use(Dh).mount("#app");export{zh as $,Za as A,Mh as B,sh as C,lr as D,$h as E,Be as F,Zi as G,Je as H,Us as I,ye as J,Bh as K,Fh as L,ml as M,_a as N,Ci as O,Ml as P,xh as Q,Hi as R,Wh as S,Gh as T,ms as U,Yn as V,fu as W,Vh as X,Uu as Y,Uh as Z,nl as _,Se as a,uh as a0,Ip as a1,Yh as a2,ys as b,ot as c,es as d,Xr as e,Pe as f,qn as g,Zc as h,Hh as i,Oa as j,ge as k,Kh as l,Mn as m,iu as n,Ie as o,cr as p,Fs as q,Hr as r,Ji as s,Pn as t,we as u,xl as v,Pi as w,jh as x,qh as y,Hs as z};
