const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomePage-DoNfYY5-.js","assets/HomePage-BsofTH-U.css","assets/ProcessPage-DmelNUEg.js","assets/ProcessPage-jVhBuwdi.css"])))=>i.map(i=>d[i]);
...
* @license MIT
**/function Qr(e){const t=Object.create(null);for(const n of e.split(","))t[n]=1;return n=>n in t}const ie={},rn=[],lt=()=>{},Vo=()=>!1,Ls=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),Ps=e=>e.startsWith("onUpdate:"),Se=Object.assign,Xr=(e,t)=>{const n=e.indexOf(t);n>-1&&e.splice(n,1)},sl=Object.prototype.hasOwnProperty,X=(e,t)=>sl.call(e,t),K=Array.isArray,on=e=>Xn(e)==="[object Map]",Ho=e=>Xn(e)==="[object Set]",Di=e=>Xn(e)==="[object Date]",H=e=>typeof e=="function",pe=e=>typeof e=="string",Ke=e=>typeof e=="symbol",Z=e=>e!==null&&typeof e=="object",qo=e=>(Z(e)||H(e))&&H(e.then)&&H(e.catch),Go=Object.prototype.toString,Xn=e=>Go.call(e),rl=e=>Xn(e).slice(8,-1),zo=e=>Xn(e)==="[object Object]",Ms=e=>pe(e)&&e!=="NaN"&&e[0]!=="-"&&""+parseInt(e,10)===e,Cn=Qr(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"),Ds=e=>{const t=Object.create(null);return(n=>t[n]||(t[n]=e(n)))},il=/-\w/g,De=Ds(e=>e.replace(il,t=>t.slice(1).toUpperCase())),ol=/\B([A-Z])/g,qt=Ds(e=>e.replace(ol,"-$1").toLowerCase()),Bs=Ds(e=>e.charAt(0).toUpperCase()+e.slice(1)),or=Ds(e=>e?`on${Bs(e)}`:""),Ye=(e,t)=>!Object.is(e,t),ar=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},Yo=(e,t,n,s=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:s,value:n})},al=e=>{const t=parseFloat(e);return isNaN(t)?e:t};let Bi;const xs=()=>Bi||(Bi=typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{});function Zr(e){if(K(e)){const t={};for(let n=0;n<e.length;n++){const s=e[n],r=pe(s)?pl(s):Zr(s);if(r)for(const i in r)t[i]=r[i]}return t}else if(pe(e)||Z(e))return e}const cl=/;(?![^(]*\))/g,ll=/:([^]+)/,ul=/\/\*[^]*?\*\//g;function pl(e){const t={};return e.replace(ul,"").split(cl).forEach(n=>{if(n){const s=n.split(ll);s.length>1&&(t[s[0].trim()]=s[1].trim())}}),t}function $s(e){let t="";if(pe(e))t=e;else if(K(e))for(let n=0;n<e.length;n++){const s=$s(e[n]);s&&(t+=s+" ")}else if(Z(e))for(const n in e)e[n]&&(t+=n+" ");return t.trim()}const fl="itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly",dl=Qr(fl);function Wo(e){return!!e||e===""}function hl(e,t){if(e.length!==t.length)return!1;let n=!0;for(let s=0;n&&s<e.length;s++)n=ei(e[s],t[s]);return n}function ei(e,t){if(e===t)return!0;let n=Di(e),s=Di(t);if(n||s)return n&&s?e.getTime()===t.getTime():!1;if(n=Ke(e),s=Ke(t),n||s)return e===t;if(n=K(e),s=K(t),n||s)return n&&s?hl(e,t):!1;if(n=Z(e),s=Z(t),n||s){if(!n||!s)return!1;const r=Object.keys(e).length,i=Object.keys(t).length;if(r!==i)return!1;for(const o in e){const a=e.hasOwnProperty(o),c=t.hasOwnProperty(o);if(a&&!c||!a&&c||!ei(e[o],t[o]))return!1}}return String(e)===String(t)}const Jo=e=>!!(e&&e.__v_isRef===!0),Ln=e=>pe(e)?e:e==null?"":K(e)||Z(e)&&(e.toString===Go||!H(e.toString))?Jo(e)?Ln(e.value):JSON.stringify(e,Qo,2):String(e),Qo=(e,t)=>Jo(t)?Qo(e,t.value):on(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((n,[s,r],i)=>(n[cr(s,i)+" =>"]=r,n),{})}:Ho(t)?{[`Set(${t.size})`]:[...t.values()].map(n=>cr(n))}:Ke(t)?cr(t):Z(t)&&!K(t)&&!zo(t)?String(t):t,cr=(e,t="")=>{var n;return Ke(e)?`Symbol(${(n=e.description)!=null?n:t})`:e};/**
* @vue/reactivity v3.5.31
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let Ee;class Xo{constructor(t=!1){this.detached=t,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.__v_skip=!0,this.parent=Ee,!t&&Ee&&(this.index=(Ee.scopes||(Ee.scopes=[])).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let t,n;if(this.scopes)for(t=0,n=this.scopes.length;t<n;t++)this.scopes[t].pause();for(t=0,n=this.effects.length;t<n;t++)this.effects[t].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let t,n;if(this.scopes)for(t=0,n=this.scopes.length;t<n;t++)this.scopes[t].resume();for(t=0,n=this.effects.length;t<n;t++)this.effects[t].resume()}}run(t){if(this._active){const n=Ee;try{return Ee=this,t()}finally{Ee=n}}}on(){++this._on===1&&(this.prevScope=Ee,Ee=this)}off(){this._on>0&&--this._on===0&&(Ee=this.prevScope,this.prevScope=void 0)}stop(t){if(this._active){this._active=!1;let n,s;for(n=0,s=this.effects.length;n<s;n++)this.effects[n].stop();for(this.effects.length=0,n=0,s=this.cleanups.length;n<s;n++)this.cleanups[n]();if(this.cleanups.length=0,this.scopes){for(n=0,s=this.scopes.length;n<s;n++)this.scopes[n].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!t){const r=this.parent.scopes.pop();r&&r!==this&&(this.parent.scopes[this.index]=r,r.index=this.index)}this.parent=void 0}}}function xh(e){return new Xo(e)}function ml(){return Ee}function $h(e,t=!1){Ee&&Ee.cleanups.push(e)}let re;const lr=new WeakSet;class Zo{constructor(t){this.fn=t,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,Ee&&Ee.active&&Ee.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,lr.has(this)&&(lr.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||ta(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,xi(this),na(this);const t=re,n=We;re=this,We=!0;try{return this.fn()}finally{sa(this),re=t,We=n,this.flags&=-3}}stop(){if(this.flags&1){for(let t=this.deps;t;t=t.nextDep)si(t);this.deps=this.depsTail=void 0,xi(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?lr.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Tr(this)&&this.run()}get dirty(){return Tr(this)}}let ea=0,Pn,Mn;function ta(e,t=!1){if(e.flags|=8,t){e.next=Mn,Mn=e;return}e.next=Pn,Pn=e}function ti(){ea++}function ni(){if(--ea>0)return;if(Mn){let t=Mn;for(Mn=void 0;t;){const n=t.next;t.next=void 0,t.flags&=-9,t=n}}let e;for(;Pn;){let t=Pn;for(Pn=void 0;t;){const n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(s){e||(e=s)}t=n}}if(e)throw e}function na(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function sa(e){let t,n=e.depsTail,s=n;for(;s;){const r=s.prevDep;s.version===-1?(s===n&&(n=r),si(s),gl(s)):t=s,s.dep.activeLink=s.prevActiveLink,s.prevActiveLink=void 0,s=r}e.deps=t,e.depsTail=n}function Tr(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(ra(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function ra(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Kn)||(e.globalVersion=Kn,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Tr(e))))return;e.flags|=2;const t=e.dep,n=re,s=We;re=e,We=!0;try{na(e);const r=e.fn(e._value);(t.version===0||Ye(r,e._value))&&(e.flags|=128,e._value=r,t.version++)}catch(r){throw t.version++,r}finally{re=n,We=s,sa(e),e.flags&=-3}}function si(e,t=!1){const{dep:n,prevSub:s,nextSub:r}=e;if(s&&(s.nextSub=r,e.prevSub=void 0),r&&(r.prevSub=s,e.nextSub=void 0),n.subs===e&&(n.subs=s,!s&&n.computed)){n.computed.flags&=-5;for(let i=n.computed.deps;i;i=i.nextDep)si(i,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function gl(e){const{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}let We=!0;const ia=[];function wt(){ia.push(We),We=!1}function vt(){const e=ia.pop();We=e===void 0?!0:e}function xi(e){const{cleanup:t}=e;if(e.cleanup=void 0,t){const n=re;re=void 0;try{t()}finally{re=n}}}let Kn=0;class yl{constructor(t,n){this.sub=t,this.dep=n,this.version=n.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}}class js{constructor(t){this.computed=t,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(t){if(!re||!We||re===this.computed)return;let n=this.activeLink;if(n===void 0||n.sub!==re)n=this.activeLink=new yl(re,this),re.deps?(n.prevDep=re.depsTail,re.depsTail.nextDep=n,re.depsTail=n):re.deps=re.depsTail=n,oa(n);else if(n.version===-1&&(n.version=this.version,n.nextDep)){const s=n.nextDep;s.prevDep=n.prevDep,n.prevDep&&(n.prevDep.nextDep=s),n.prevDep=re.depsTail,n.nextDep=void 0,re.depsTail.nextDep=n,re.depsTail=n,re.deps===n&&(re.deps=s)}return n}trigger(t){this.version++,Kn++,this.notify(t)}notify(t){ti();try{for(let n=this.subs;n;n=n.prevSub)n.sub.notify()&&n.sub.dep.notify()}finally{ni()}}}function oa(e){if(e.dep.sc++,e.sub.flags&4){const t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let s=t.deps;s;s=s.nextDep)oa(s)}const n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}const ks=new WeakMap,Kt=Symbol(""),Rr=Symbol(""),Vn=Symbol("");function Oe(e,t,n){if(We&&re){let s=ks.get(e);s||ks.set(e,s=new Map);let r=s.get(n);r||(s.set(n,r=new js),r.map=s,r.key=n),r.track()}}function yt(e,t,n,s,r,i){const o=ks.get(e);if(!o){Kn++;return}const a=c=>{c&&c.trigger()};if(ti(),t==="clear")o.forEach(a);else{const c=K(e),l=c&&Ms(n);if(c&&n==="length"){const u=Number(s);o.forEach((p,f)=>{(f==="length"||f===Vn||!Ke(f)&&f>=u)&&a(p)})}else switch((n!==void 0||o.has(void 0))&&a(o.get(n)),l&&a(o.get(Vn)),t){case"add":c?l&&a(o.get("length")):(a(o.get(Kt)),on(e)&&a(o.get(Rr)));break;case"delete":c||(a(o.get(Kt)),on(e)&&a(o.get(Rr)));break;case"set":on(e)&&a(o.get(Kt));break}}ni()}function _l(e,t){const n=ks.get(e);return n&&n.get(t)}function Jt(e){const t=W(e);return t===e?t:(Oe(t,"iterate",Vn),Fe(e)?t:t.map(Qe))}function Us(e){return Oe(e=W(e),"iterate",Vn),e}function at(e,t){return kt(e)?fn(Vt(e)?Qe(t):t):Qe(t)}const bl={__proto__:null,[Symbol.iterator](){return ur(this,Symbol.iterator,e=>at(this,e))},concat(...e){return Jt(this).concat(...e.map(t=>K(t)?Jt(t):t))},entries(){return ur(this,"entries",e=>(e[1]=at(this,e[1]),e))},every(e,t){return dt(this,"every",e,t,void 0,arguments)},filter(e,t){return dt(this,"filter",e,t,n=>n.map(s=>at(this,s)),arguments)},find(e,t){return dt(this,"find",e,t,n=>at(this,n),arguments)},findIndex(e,t){return dt(this,"findIndex",e,t,void 0,arguments)},findLast(e,t){return dt(this,"findLast",e,t,n=>at(this,n),arguments)},findLastIndex(e,t){return dt(this,"findLastIndex",e,t,void 0,arguments)},forEach(e,t){return dt(this,"forEach",e,t,void 0,arguments)},includes(...e){return pr(this,"includes",e)},indexOf(...e){return pr(this,"indexOf",e)},join(e){return Jt(this).join(e)},lastIndexOf(...e){return pr(this,"lastIndexOf",e)},map(e,t){return dt(this,"map",e,t,void 0,arguments)},pop(){return En(this,"pop")},push(...e){return En(this,"push",e)},reduce(e,...t){return $i(this,"reduce",e,t)},reduceRight(e,...t){return $i(this,"reduceRight",e,t)},shift(){return En(this,"shift")},some(e,t){return dt(this,"some",e,t,void 0,arguments)},splice(...e){return En(this,"splice",e)},toReversed(){return Jt(this).toReversed()},toSorted(e){return Jt(this).toSorted(e)},toSpliced(...e){return Jt(this).toSpliced(...e)},unshift(...e){return En(this,"unshift",e)},values(){return ur(this,"values",e=>at(this,e))}};function ur(e,t,n){const s=Us(e),r=s[t]();return s!==e&&!Fe(e)&&(r._next=r.next,r.next=()=>{const i=r._next();return i.done||(i.value=n(i.value)),i}),r}const wl=Array.prototype;function dt(e,t,n,s,r,i){const o=Us(e),a=o!==e&&!Fe(e),c=o[t];if(c!==wl[t]){const p=c.apply(e,i);return a?Qe(p):p}let l=n;o!==e&&(a?l=function(p,f){return n.call(this,at(e,p),f,e)}:n.length>2&&(l=function(p,f){return n.call(this,p,f,e)}));const u=c.call(o,l,s);return a&&r?r(u):u}function $i(e,t,n,s){const r=Us(e),i=r!==e&&!Fe(e);let o=n,a=!1;r!==e&&(i?(a=s.length===0,o=function(l,u,p){return a&&(a=!1,l=at(e,l)),n.call(this,l,at(e,u),p,e)}):n.length>3&&(o=function(l,u,p){return n.call(this,l,u,p,e)}));const c=r[t](o,...s);return a?at(e,c):c}function pr(e,t,n){const s=W(e);Oe(s,"iterate",Vn);const r=s[t](...n);return(r===-1||r===!1)&&Ks(n[0])?(n[0]=W(n[0]),s[t](...n)):r}function En(e,t,n=[]){wt(),ti();const s=W(e)[t].apply(e,n);return ni(),vt(),s}const vl=Qr("__proto__,__v_isRef,__isVue"),aa=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!=="arguments"&&e!=="caller").map(e=>Symbol[e]).filter(Ke));function kl(e){Ke(e)||(e=String(e));const t=W(this);return Oe(t,"has",e),t.hasOwnProperty(e)}class ca{constructor(t=!1,n=!1){this._isReadonly=t,this._isShallow=n}get(t,n,s){if(n==="__v_skip")return t.__v_skip;const r=this._isReadonly,i=this._isShallow;if(n==="__v_isReactive")return!r;if(n==="__v_isReadonly")return r;if(n==="__v_isShallow")return i;if(n==="__v_raw")return s===(r?i?Ll:fa:i?pa:ua).get(t)||Object.getPrototypeOf(t)===Object.getPrototypeOf(s)?t:void 0;const o=K(t);if(!r){let c;if(o&&(c=bl[n]))return c;if(n==="hasOwnProperty")return kl}const a=Reflect.get(t,n,ye(t)?t:s);if((Ke(n)?aa.has(n):vl(n))||(r||Oe(t,"get",n),i))return a;if(ye(a)){const c=o&&Ms(n)?a:a.value;return r&&Z(c)?Cr(c):c}return Z(a)?r?Cr(a):Fs(a):a}}class la extends ca{constructor(t=!1){super(!1,t)}set(t,n,s,r){let i=t[n];const o=K(t)&&Ms(n);if(!this._isShallow){const l=kt(i);if(!Fe(s)&&!kt(s)&&(i=W(i),s=W(s)),!o&&ye(i)&&!ye(s))return l||(i.value=s),!0}const a=o?Number(n)<t.length:X(t,n),c=Reflect.set(t,n,s,ye(t)?t:r);return t===W(r)&&(a?Ye(s,i)&&yt(t,"set",n,s):yt(t,"add",n,s)),c}deleteProperty(t,n){const s=X(t,n);t[n];const r=Reflect.deleteProperty(t,n);return r&&s&&yt(t,"delete",n,void 0),r}has(t,n){const s=Reflect.has(t,n);return(!Ke(n)||!aa.has(n))&&Oe(t,"has",n),s}ownKeys(t){return Oe(t,"iterate",K(t)?"length":Kt),Reflect.ownKeys(t)}}class Sl extends ca{constructor(t=!1){super(!0,t)}set(t,n){return!0}deleteProperty(t,n){return!0}}const El=new la,Ol=new Sl,Al=new la(!0);const Ir=e=>e,os=e=>Reflect.getPrototypeOf(e);function Nl(e,t,n){return function(...s){const r=this.__v_raw,i=W(r),o=on(i),a=e==="entries"||e===Symbol.iterator&&o,c=e==="keys"&&o,l=r[e](...s),u=n?Ir:t?fn:Qe;return!t&&Oe(i,"iterate",c?Rr:Kt),Se(Object.create(l),{next(){const{value:p,done:f}=l.next();return f?{value:p,done:f}:{value:a?[u(p[0]),u(p[1])]:u(p),done:f}}})}}function as(e){return function(...t){return e==="delete"?!1:e==="clear"?void 0:this}}function Tl(e,t){const n={get(r){const i=this.__v_raw,o=W(i),a=W(r);e||(Ye(r,a)&&Oe(o,"get",r),Oe(o,"get",a));const{has:c}=os(o),l=t?Ir:e?fn:Qe;if(c.call(o,r))return l(i.get(r));if(c.call(o,a))return l(i.get(a));i!==o&&i.get(r)},get size(){const r=this.__v_raw;return!e&&Oe(W(r),"iterate",Kt),r.size},has(r){const i=this.__v_raw,o=W(i),a=W(r);return e||(Ye(r,a)&&Oe(o,"has",r),Oe(o,"has",a)),r===a?i.has(r):i.has(r)||i.has(a)},forEach(r,i){const o=this,a=o.__v_raw,c=W(a),l=t?Ir:e?fn:Qe;return!e&&Oe(c,"iterate",Kt),a.forEach((u,p)=>r.call(i,l(u),l(p),o))}};return Se(n,e?{add:as("add"),set:as("set"),delete:as("delete"),clear:as("clear")}:{add(r){const i=W(this),o=os(i),a=W(r),c=!t&&!Fe(r)&&!kt(r)?a:r;return o.has.call(i,c)||Ye(r,c)&&o.has.call(i,r)||Ye(a,c)&&o.has.call(i,a)||(i.add(c),yt(i,"add",c,c)),this},set(r,i){!t&&!Fe(i)&&!kt(i)&&(i=W(i));const o=W(this),{has:a,get:c}=os(o);let l=a.call(o,r);l||(r=W(r),l=a.call(o,r));const u=c.call(o,r);return o.set(r,i),l?Ye(i,u)&&yt(o,"set",r,i):yt(o,"add",r,i),this},delete(r){const i=W(this),{has:o,get:a}=os(i);let c=o.call(i,r);c||(r=W(r),c=o.call(i,r)),a&&a.call(i,r);const l=i.delete(r);return c&&yt(i,"delete",r,void 0),l},clear(){const r=W(this),i=r.size!==0,o=r.clear();return i&&yt(r,"clear",void 0,void 0),o}}),["keys","values","entries",Symbol.iterator].forEach(r=>{n[r]=Nl(r,e,t)}),n}function ri(e,t){const n=Tl(e,t);return(s,r,i)=>r==="__v_isReactive"?!e:r==="__v_isReadonly"?e:r==="__v_raw"?s:Reflect.get(X(n,r)&&r in s?n:s,r,i)}const Rl={get:ri(!1,!1)},Il={get:ri(!1,!0)},Cl={get:ri(!0,!1)};const ua=new WeakMap,pa=new WeakMap,fa=new WeakMap,Ll=new WeakMap;function Pl(e){switch(e){case"Object":case"Array":return 1;case"Map":case"Set":case"WeakMap":case"WeakSet":return 2;default:return 0}}function Ml(e){return e.__v_skip||!Object.isExtensible(e)?0:Pl(rl(e))}function Fs(e){return kt(e)?e:ii(e,!1,El,Rl,ua)}function da(e){return ii(e,!1,Al,Il,pa)}function Cr(e){return ii(e,!0,Ol,Cl,fa)}function ii(e,t,n,s,r){if(!Z(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;const i=Ml(e);if(i===0)return e;const o=r.get(e);if(o)return o;const a=new Proxy(e,i===2?s:n);return r.set(e,a),a}function Vt(e){return kt(e)?Vt(e.__v_raw):!!(e&&e.__v_isReactive)}function kt(e){return!!(e&&e.__v_isReadonly)}function Fe(e){return!!(e&&e.__v_isShallow)}function Ks(e){return e?!!e.__v_raw:!1}function W(e){const t=e&&e.__v_raw;return t?W(t):e}function Dl(e){return!X(e,"__v_skip")&&Object.isExtensible(e)&&Yo(e,"__v_skip",!0),e}const Qe=e=>Z(e)?Fs(e):e,fn=e=>Z(e)?Cr(e):e;function ye(e){return e?e.__v_isRef===!0:!1}function Vs(e){return ha(e,!1)}function Bl(e){return ha(e,!0)}function ha(e,t){return ye(e)?e:new xl(e,t)}class xl{constructor(t,n){this.dep=new js,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=n?t:W(t),this._value=n?t:Qe(t),this.__v_isShallow=n}get value(){return this.dep.track(),this._value}set value(t){const n=this._rawValue,s=this.__v_isShallow||Fe(t)||kt(t);t=s?t:W(t),Ye(t,n)&&(this._rawValue=t,this._value=s?t:Qe(t),this.dep.trigger())}}function we(e){return ye(e)?e.value:e}function jh(e){return H(e)?e():we(e)}const $l={get:(e,t,n)=>t==="__v_raw"?e:we(Reflect.get(e,t,n)),set:(e,t,n,s)=>{const r=e[t];return ye(r)&&!ye(n)?(r.value=n,!0):Reflect.set(e,t,n,s)}};function ma(e){return Vt(e)?e:new Proxy(e,$l)}class jl{constructor(t){this.__v_isRef=!0,this._value=void 0;const n=this.dep=new js,{get:s,set:r}=t(n.track.bind(n),n.trigger.bind(n));this._get=s,this._set=r}get value(){return this._value=this._get()}set value(t){this._set(t)}}function Uh(e){return new jl(e)}function Fh(e){const t=K(e)?new Array(e.length):{};for(const n in e)t[n]=ga(e,n);return t}class Ul{constructor(t,n,s){this._object=t,this._defaultValue=s,this.__v_isRef=!0,this._value=void 0,this._key=Ke(n)?n:String(n),this._raw=W(t);let r=!0,i=t;if(!K(t)||Ke(this._key)||!Ms(this._key))do r=!Ks(i)||Fe(i);while(r&&(i=i.__v_raw));this._shallow=r}get value(){let t=this._object[this._key];return this._shallow&&(t=we(t)),this._value=t===void 0?this._defaultValue:t}set value(t){if(this._shallow&&ye(this._raw[this._key])){const n=this._object[this._key];if(ye(n)){n.value=t;return}}this._object[this._key]=t}get dep(){return _l(this._raw,this._key)}}class Fl{constructor(t){this._getter=t,this.__v_isRef=!0,this.__v_isReadonly=!0,this._value=void 0}get value(){return this._value=this._getter()}}function Kh(e,t,n){return ye(e)?e:H(e)?new Fl(e):Z(e)&&arguments.length>1?ga(e,t,n):Vs(e)}function ga(e,t,n){return new Ul(e,t,n)}class Kl{constructor(t,n,s){this.fn=t,this.setter=n,this._value=void 0,this.dep=new js(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Kn-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!n,this.isSSR=s}notify(){if(this.flags|=16,!(this.flags&8)&&re!==this)return ta(this,!0),!0}get value(){const t=this.dep.track();return ra(this),t&&(t.version=this.dep.version),this._value}set value(t){this.setter&&this.setter(t)}}function Vl(e,t,n=!1){let s,r;return H(e)?s=e:(s=e.get,r=e.set),new Kl(s,r,n)}const cs={},Ss=new WeakMap;let xt;function Hl(e,t=!1,n=xt){if(n){let s=Ss.get(n);s||Ss.set(n,s=[]),s.push(e)}}function ql(e,t,n=ie){const{immediate:s,deep:r,once:i,scheduler:o,augmentJob:a,call:c}=n,l=A=>r?A:Fe(A)||r===!1||r===0?Ct(A,1):Ct(A);let u,p,f,d,b=!1,g=!1;if(ye(e)?(p=()=>e.value,b=Fe(e)):Vt(e)?(p=()=>l(e),b=!0):K(e)?(g=!0,b=e.some(A=>Vt(A)||Fe(A)),p=()=>e.map(A=>{if(ye(A))return A.value;if(Vt(A))return l(A);if(H(A))return c?c(A,2):A()})):H(e)?t?p=c?()=>c(e,2):e:p=()=>{if(f){wt();try{f()}finally{vt()}}const A=xt;xt=u;try{return c?c(e,3,[d]):e(d)}finally{xt=A}}:p=lt,t&&r){const A=p,L=r===!0?1/0:r;p=()=>Ct(A(),L)}const _=ml(),v=()=>{u.stop(),_&&_.active&&Xr(_.effects,u)};if(i&&t){const A=t;t=(...L)=>{A(...L),v()}}let w=g?new Array(e.length).fill(cs):cs;const N=A=>{if(!(!(u.flags&1)||!u.dirty&&!A))if(t){const L=u.run();if(r||b||(g?L.some((F,D)=>Ye(F,w[D])):Ye(L,w))){f&&f();const F=xt;xt=u;try{const D=[L,w===cs?void 0:g&&w[0]===cs?[]:w,d];w=L,c?c(t,3,D):t(...D)}finally{xt=F}}}else u.run()};return a&&a(N),u=new Zo(p),u.scheduler=o?()=>o(N,!1):N,d=A=>Hl(A,!1,u),f=u.onStop=()=>{const A=Ss.get(u);if(A){if(c)c(A,4);else for(const L of A)L();Ss.delete(u)}},t?s?N(!0):w=u.run():o?o(N.bind(null,!0),!0):u.run(),v.pause=u.pause.bind(u),v.resume=u.resume.bind(u),v.stop=v,v}function Ct(e,t=1/0,n){if(t<=0||!Z(e)||e.__v_skip||(n=n||new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,ye(e))Ct(e.value,t,n);else if(K(e))for(let s=0;s<e.length;s++)Ct(e[s],t,n);else if(Ho(e)||on(e))e.forEach(s=>{Ct(s,t,n)});else if(zo(e)){for(const s in e)Ct(e[s],t,n);for(const s of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,s)&&Ct(e[s],t,n)}return e}/**
* @vue/runtime-core v3.5.31
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Zn(e,t,n,s){try{return s?e(...s):e()}catch(r){Hs(r,t,n)}}function ut(e,t,n,s){if(H(e)){const r=Zn(e,t,n,s);return r&&qo(r)&&r.catch(i=>{Hs(i,t,n)}),r}if(K(e)){const r=[];for(let i=0;i<e.length;i++)r.push(ut(e[i],t,n,s));return r}}function Hs(e,t,n,s=!0){const r=t?t.vnode:null,{errorHandler:i,throwUnhandledErrorInProduction:o}=t&&t.appContext.config||ie;if(t){let a=t.parent;const c=t.proxy,l=`https://vuejs.org/error-reference/#runtime-${n}`;for(;a;){const u=a.ec;if(u){for(let p=0;p<u.length;p++)if(u[p](e,c,l)===!1)return}a=a.parent}if(i){wt(),Zn(i,null,10,[e,c,l]),vt();return}}Gl(e,n,r,s,o)}function Gl(e,t,n,s=!0,r=!1){if(r)throw e;console.error(e)}const Ce=[];let it=-1;const an=[];let Tt=null,Zt=0;const ya=Promise.resolve();let Es=null;function _a(e){const t=Es||ya;return e?t.then(this?e.bind(this):e):t}function zl(e){let t=it+1,n=Ce.length;for(;t<n;){const s=t+n>>>1,r=Ce[s],i=Hn(r);i<e||i===e&&r.flags&2?t=s+1:n=s}return t}function oi(e){if(!(e.flags&1)){const t=Hn(e),n=Ce[Ce.length-1];!n||!(e.flags&2)&&t>=Hn(n)?Ce.push(e):Ce.splice(zl(t),0,e),e.flags|=1,ba()}}function ba(){Es||(Es=ya.then(va))}function Yl(e){K(e)?an.push(...e):Tt&&e.id===-1?Tt.splice(Zt+1,0,e):e.flags&1||(an.push(e),e.flags|=1),ba()}function ji(e,t,n=it+1){for(;n<Ce.length;n++){const s=Ce[n];if(s&&s.flags&2){if(e&&s.id!==e.uid)continue;Ce.splice(n,1),n--,s.flags&4&&(s.flags&=-2),s(),s.flags&4||(s.flags&=-2)}}}function wa(e){if(an.length){const t=[...new Set(an)].sort((n,s)=>Hn(n)-Hn(s));if(an.length=0,Tt){Tt.push(...t);return}for(Tt=t,Zt=0;Zt<Tt.length;Zt++){const n=Tt[Zt];n.flags&4&&(n.flags&=-2),n.flags&8||n(),n.flags&=-2}Tt=null,Zt=0}}const Hn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function va(e){try{for(it=0;it<Ce.length;it++){const t=Ce[it];t&&!(t.flags&8)&&(t.flags&4&&(t.flags&=-2),Zn(t,t.i,t.i?15:14),t.flags&4||(t.flags&=-2))}}finally{for(;it<Ce.length;it++){const t=Ce[it];t&&(t.flags&=-2)}it=-1,Ce.length=0,wa(),Es=null,(Ce.length||an.length)&&va()}}let Pe=null,ka=null;function Os(e){const t=Pe;return Pe=e,ka=e&&e.type.__scopeId||null,t}function Lr(e,t=Pe,n){if(!t||e._n)return e;const s=(...r)=>{s._d&&Ts(-1);const i=Os(t);let o;try{o=e(...r)}finally{Os(i),s._d&&Ts(1)}return o};return s._n=!0,s._c=!0,s._d=!0,s}function Dt(e,t,n,s){const r=e.dirs,i=t&&t.dirs;for(let o=0;o<r.length;o++){const a=r[o];i&&(a.oldValue=i[o].value);let c=a.dir[s];c&&(wt(),ut(c,n,8,[e.el,a,e,t]),vt())}}function ms(e,t){if(Ae){let n=Ae.provides;const s=Ae.parent&&Ae.parent.provides;s===n&&(n=Ae.provides=Object.create(s)),n[e]=t}}function Je(e,t,n=!1){const s=Za();if(s||ln){let r=ln?ln._context.provides:s?s.parent==null||s.ce?s.vnode.appContext&&s.vnode.appContext.provides:s.parent.provides:void 0;if(r&&e in r)return r[e];if(arguments.length>1)return n&&H(t)?t.call(s&&s.proxy):t}}const Wl=Symbol.for("v-scx"),Jl=()=>Je(Wl);function Dn(e,t,n){return Sa(e,t,n)}function Sa(e,t,n=ie){const{immediate:s,deep:r,flush:i,once:o}=n,a=Se({},n),c=t&&s||!t&&i!=="post";let l;if(zn){if(i==="sync"){const d=Jl();l=d.__watcherHandles||(d.__watcherHandles=[])}else if(!c){const d=()=>{};return d.stop=lt,d.resume=lt,d.pause=lt,d}}const u=Ae;a.call=(d,b,g)=>ut(d,u,b,g);let p=!1;i==="post"?a.scheduler=d=>{$e(d,u&&u.suspense)}:i!=="sync"&&(p=!0,a.scheduler=(d,b)=>{b?d():oi(d)}),a.augmentJob=d=>{t&&(d.flags|=4),p&&(d.flags|=2,u&&(d.id=u.uid,d.i=u))};const f=ql(e,t,a);return zn&&(l?l.push(f):c&&f()),f}function Ql(e,t,n){const s=this.proxy,r=pe(e)?e.includes(".")?Ea(s,e):()=>s[e]:e.bind(s,s);let i;H(t)?i=t:(i=t.handler,n=t);const o=ts(this),a=Sa(r,i.bind(s),n);return o(),a}function Ea(e,t){const n=t.split(".");return()=>{let s=e;for(let r=0;r<n.length&&s;r++)s=s[n[r]];return s}}const Xl=Symbol("_vte"),Zl=e=>e.__isTeleport,eu=Symbol("_leaveCb");function ai(e,t){e.shapeFlag&6&&e.component?(e.transition=t,ai(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function es(e,t){return H(e)?Se({name:e.name},t,{setup:e}):e}function Oa(e){e.ids=[e.ids[0]+e.ids[2]+++"-",0,0]}function Ui(e,t){let n;return!!((n=Object.getOwnPropertyDescriptor(e,t))&&!n.configurable)}const As=new WeakMap;function Bn(e,t,n,s,r=!1){if(K(e)){e.forEach((g,_)=>Bn(g,t&&(K(t)?t[_]:t),n,s,r));return}if(cn(s)&&!r){s.shapeFlag&512&&s.type.__asyncResolved&&s.component.subTree.component&&Bn(e,t,n,s.component.subTree);return}const i=s.shapeFlag&4?di(s.component):s.el,o=r?null:i,{i:a,r:c}=e,l=t&&t.r,u=a.refs===ie?a.refs={}:a.refs,p=a.setupState,f=W(p),d=p===ie?Vo:g=>Ui(u,g)?!1:X(f,g),b=(g,_)=>!(_&&Ui(u,_));if(l!=null&&l!==c){if(Fi(t),pe(l))u[l]=null,d(l)&&(p[l]=null);else if(ye(l)){const g=t;b(l,g.k)&&(l.value=null),g.k&&(u[g.k]=null)}}if(H(c))Zn(c,a,12,[o,u]);else{const g=pe(c),_=ye(c);if(g||_){const v=()=>{if(e.f){const w=g?d(c)?p[c]:u[c]:b()||!e.k?c.value:u[e.k];if(r)K(w)&&Xr(w,i);else if(K(w))w.includes(i)||w.push(i);else if(g)u[c]=[i],d(c)&&(p[c]=u[c]);else{const N=[i];b(c,e.k)&&(c.value=N),e.k&&(u[e.k]=N)}}else g?(u[c]=o,d(c)&&(p[c]=o)):_&&(b(c,e.k)&&(c.value=o),e.k&&(u[e.k]=o))};if(o){const w=()=>{v(),As.delete(e)};w.id=-1,As.set(e,w),$e(w,n)}else Fi(e),v()}}}function Fi(e){const t=As.get(e);t&&(t.flags|=8,As.delete(e))}xs().requestIdleCallback;xs().cancelIdleCallback;const cn=e=>!!e.type.__asyncLoader,Aa=e=>e.type.__isKeepAlive;function tu(e,t){Na(e,"a",t)}function nu(e,t){Na(e,"da",t)}function Na(e,t,n=Ae){const s=e.__wdc||(e.__wdc=()=>{let r=n;for(;r;){if(r.isDeactivated)return;r=r.parent}return e()});if(qs(t,s,n),n){let r=n.parent;for(;r&&r.parent;)Aa(r.parent.vnode)&&su(s,t,n,r),r=r.parent}}function su(e,t,n,s){const r=qs(t,e,s,!0);Ta(()=>{Xr(s[t],r)},n)}function qs(e,t,n=Ae,s=!1){if(n){const r=n[e]||(n[e]=[]),i=t.__weh||(t.__weh=(...o)=>{wt();const a=ts(n),c=ut(t,n,e,o);return a(),vt(),c});return s?r.unshift(i):r.push(i),i}}const Et=e=>(t,n=Ae)=>{(!zn||e==="sp")&&qs(e,(...s)=>t(...s),n)},ru=Et("bm"),ci=Et("m"),iu=Et("bu"),ou=Et("u"),li=Et("bum"),Ta=Et("um"),au=Et("sp"),cu=Et("rtg"),lu=Et("rtc");function uu(e,t=Ae){qs("ec",e,t)}const Ra="components";function pu(e,t){return Ca(Ra,e,!0,t)||e}const Ia=Symbol.for("v-ndc");function Vh(e){return pe(e)?Ca(Ra,e,!1)||e:e||Ia}function Ca(e,t,n=!0,s=!1){const r=Pe||Ae;if(r){const i=r.type;{const a=Yu(i,!1);if(a&&(a===t||a===De(t)||a===Bs(De(t))))return i}const o=Ki(r[e]||i[e],t)||Ki(r.appContext[e],t);return!o&&s?i:o}}function Ki(e,t){return e&&(e[t]||e[De(t)]||e[Bs(De(t))])}function Vi(e,t,n,s){let r;const i=n&&n[s],o=K(e);if(o||pe(e)){const a=o&&Vt(e);let c=!1,l=!1;a&&(c=!Fe(e),l=kt(e),e=Us(e)),r=new Array(e.length);for(let u=0,p=e.length;u<p;u++)r[u]=t(c?l?fn(Qe(e[u])):Qe(e[u]):e[u],u,void 0,i&&i[u])}else if(typeof e=="number"){r=new Array(e);for(let a=0;a<e;a++)r[a]=t(a+1,a,void 0,i&&i[a])}else if(Z(e))if(e[Symbol.iterator])r=Array.from(e,(a,c)=>t(a,c,void 0,i&&i[c]));else{const a=Object.keys(e);r=new Array(a.length);for(let c=0,l=a.length;c<l;c++){const u=a[c];r[c]=t(e[u],u,c,i&&i[c])}}else r=[];return n&&(n[s]=r),r}function Hh(e,t,n={},s,r){if(Pe.ce||Pe.parent&&cn(Pe.parent)&&Pe.parent.ce){const l=Object.keys(n).length>0;return t!=="default"&&(n.name=t),Ie(),qn(je,null,[ge("slot",n,s&&s())],l?-2:64)}let i=e[t];i&&i._c&&(i._d=!1),Ie();const o=i&&La(i(n)),a=n.key||o&&o.key,c=qn(je,{key:(a&&!Ke(a)?a:`_${t}`)+(!o&&s?"_fb":"")},o||(s?s():[]),o&&e._===1?64:-2);return c.scopeId&&(c.slotScopeIds=[c.scopeId+"-s"]),i&&i._c&&(i._d=!0),c}function La(e){return e.some(t=>Gn(t)?!(t.type===St||t.type===je&&!La(t.children)):!0)?e:null}const Pr=e=>e?ec(e)?di(e):Pr(e.parent):null,xn=Se(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>Pr(e.parent),$root:e=>Pr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Da(e),$forceUpdate:e=>e.f||(e.f=()=>{oi(e.update)}),$nextTick:e=>e.n||(e.n=_a.bind(e.proxy)),$watch:e=>Ql.bind(e)}),fr=(e,t)=>e!==ie&&!e.__isScriptSetup&&X(e,t),fu={get({_:e},t){if(t==="__v_skip")return!0;const{ctx:n,setupState:s,data:r,props:i,accessCache:o,type:a,appContext:c}=e;if(t[0]!=="$"){const f=o[t];if(f!==void 0)switch(f){case 1:return s[t];case 2:return r[t];case 4:return n[t];case 3:return i[t]}else{if(fr(s,t))return o[t]=1,s[t];if(r!==ie&&X(r,t))return o[t]=2,r[t];if(X(i,t))return o[t]=3,i[t];if(n!==ie&&X(n,t))return o[t]=4,n[t];Mr&&(o[t]=0)}}const l=xn[t];let u,p;if(l)return t==="$attrs"&&Oe(e.attrs,"get",""),l(e);if((u=a.__cssModules)&&(u=u[t]))return u;if(n!==ie&&X(n,t))return o[t]=4,n[t];if(p=c.config.globalProperties,X(p,t))return p[t]},set({_:e},t,n){const{data:s,setupState:r,ctx:i}=e;return fr(r,t)?(r[t]=n,!0):s!==ie&&X(s,t)?(s[t]=n,!0):X(e.props,t)||t[0]==="$"&&t.slice(1)in e?!1:(i[t]=n,!0)},has({_:{data:e,setupState:t,accessCache:n,ctx:s,appContext:r,props:i,type:o}},a){let c;return!!(n[a]||e!==ie&&a[0]!=="$"&&X(e,a)||fr(t,a)||X(i,a)||X(s,a)||X(xn,a)||X(r.config.globalProperties,a)||(c=o.__cssModules)&&c[a])},defineProperty(e,t,n){return n.get!=null?e._.accessCache[t]=0:X(n,"value")&&this.set(e,t,n.value,null),Reflect.defineProperty(e,t,n)}};function qh(){return Pa().slots}function Gh(){return Pa().attrs}function Pa(e){const t=Za();return t.setupContext||(t.setupContext=nc(t))}function Hi(e){return K(e)?e.reduce((t,n)=>(t[n]=null,t),{}):e}function zh(e,t){const n={};for(const s in e)t.includes(s)||Object.defineProperty(n,s,{enumerable:!0,get:()=>e[s]});return n}let Mr=!0;function du(e){const t=Da(e),n=e.proxy,s=e.ctx;Mr=!1,t.beforeCreate&&qi(t.beforeCreate,e,"bc");const{data:r,computed:i,methods:o,watch:a,provide:c,inject:l,created:u,beforeMount:p,mounted:f,beforeUpdate:d,updated:b,activated:g,deactivated:_,beforeDestroy:v,beforeUnmount:w,destroyed:N,unmounted:A,render:L,renderTracked:F,renderTriggered:D,errorCaptured:x,serverPrefetch:G,expose:ne,inheritAttrs:_e,components:he,directives:ae,filters:Ot}=t;if(l&&hu(l,s,null),o)for(const ee in o){const J=o[ee];H(J)&&(s[ee]=J.bind(n))}if(r){const ee=r.call(n,n);Z(ee)&&(e.data=Fs(ee))}if(Mr=!0,i)for(const ee in i){const J=i[ee],ft=H(J)?J.bind(n,n):H(J.get)?J.get.bind(n,n):lt,At=!H(J)&&H(J.set)?J.set.bind(n):lt,et=Le({get:ft,set:At});Object.defineProperty(s,ee,{enumerable:!0,configurable:!0,get:()=>et.value,set:xe=>et.value=xe})}if(a)for(const ee in a)Ma(a[ee],s,n,ee);if(c){const ee=H(c)?c.call(n):c;Reflect.ownKeys(ee).forEach(J=>{ms(J,ee[J])})}u&&qi(u,e,"c");function be(ee,J){K(J)?J.forEach(ft=>ee(ft.bind(n))):J&&ee(J.bind(n))}if(be(ru,p),be(ci,f),be(iu,d),be(ou,b),be(tu,g),be(nu,_),be(uu,x),be(lu,F),be(cu,D),be(li,w),be(Ta,A),be(au,G),K(ne))if(ne.length){const ee=e.exposed||(e.exposed={});ne.forEach(J=>{Object.defineProperty(ee,J,{get:()=>n[J],set:ft=>n[J]=ft,enumerable:!0})})}else e.exposed||(e.exposed={});L&&e.render===lt&&(e.render=L),_e!=null&&(e.inheritAttrs=_e),he&&(e.components=he),ae&&(e.directives=ae),G&&Oa(e)}function hu(e,t,n=lt){K(e)&&(e=Dr(e));for(const s in e){const r=e[s];let i;Z(r)?"default"in r?i=Je(r.from||s,r.default,!0):i=Je(r.from||s):i=Je(r),ye(i)?Object.defineProperty(t,s,{enumerable:!0,configurable:!0,get:()=>i.value,set:o=>i.value=o}):t[s]=i}}function qi(e,t,n){ut(K(e)?e.map(s=>s.bind(t.proxy)):e.bind(t.proxy),t,n)}function Ma(e,t,n,s){let r=s.includes(".")?Ea(n,s):()=>n[s];if(pe(e)){const i=t[e];H(i)&&Dn(r,i)}else if(H(e))Dn(r,e.bind(n));else if(Z(e))if(K(e))e.forEach(i=>Ma(i,t,n,s));else{const i=H(e.handler)?e.handler.bind(n):t[e.handler];H(i)&&Dn(r,i,e)}}function Da(e){const t=e.type,{mixins:n,extends:s}=t,{mixins:r,optionsCache:i,config:{optionMergeStrategies:o}}=e.appContext,a=i.get(t);let c;return a?c=a:!r.length&&!n&&!s?c=t:(c={},r.length&&r.forEach(l=>Ns(c,l,o,!0)),Ns(c,t,o)),Z(t)&&i.set(t,c),c}function Ns(e,t,n,s=!1){const{mixins:r,extends:i}=t;i&&Ns(e,i,n,!0),r&&r.forEach(o=>Ns(e,o,n,!0));for(const o in t)if(!(s&&o==="expose")){const a=mu[o]||n&&n[o];e[o]=a?a(e[o],t[o]):t[o]}return e}const mu={data:Gi,props:zi,emits:zi,methods:Tn,computed:Tn,beforeCreate:Ne,created:Ne,beforeMount:Ne,mounted:Ne,beforeUpdate:Ne,updated:Ne,beforeDestroy:Ne,beforeUnmount:Ne,destroyed:Ne,unmounted:Ne,activated:Ne,deactivated:Ne,errorCaptured:Ne,serverPrefetch:Ne,components:Tn,directives:Tn,watch:yu,provide:Gi,inject:gu};function Gi(e,t){return t?e?function(){return Se(H(e)?e.call(this,this):e,H(t)?t.call(this,this):t)}:t:e}function gu(e,t){return Tn(Dr(e),Dr(t))}function Dr(e){if(K(e)){const t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function Ne(e,t){return e?[...new Set([].concat(e,t))]:t}function Tn(e,t){return e?Se(Object.create(null),e,t):t}function zi(e,t){return e?K(e)&&K(t)?[...new Set([...e,...t])]:Se(Object.create(null),Hi(e),Hi(t??{})):t}function yu(e,t){if(!e)return t;if(!t)return e;const n=Se(Object.create(null),e);for(const s in t)n[s]=Ne(e[s],t[s]);return n}function Ba(){return{app:null,config:{isNativeTag:Vo,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}let _u=0;function bu(e,t){return function(s,r=null){H(s)||(s=Se({},s)),r!=null&&!Z(r)&&(r=null);const i=Ba(),o=new WeakSet,a=[];let c=!1;const l=i.app={_uid:_u++,_component:s,_props:r,_container:null,_context:i,_instance:null,version:Ju,get config(){return i.config},set config(u){},use(u,...p){return o.has(u)||(u&&H(u.install)?(o.add(u),u.install(l,...p)):H(u)&&(o.add(u),u(l,...p))),l},mixin(u){return i.mixins.includes(u)||i.mixins.push(u),l},component(u,p){return p?(i.components[u]=p,l):i.components[u]},directive(u,p){return p?(i.directives[u]=p,l):i.directives[u]},mount(u,p,f){if(!c){const d=l._ceVNode||ge(s,r);return d.appContext=i,f===!0?f="svg":f===!1&&(f=void 0),e(d,u,f),c=!0,l._container=u,u.__vue_app__=l,di(d.component)}},onUnmount(u){a.push(u)},unmount(){c&&(ut(a,l._instance,16),e(null,l._container),delete l._container.__vue_app__)},provide(u,p){return i.provides[u]=p,l},runWithContext(u){const p=ln;ln=l;try{return u()}finally{ln=p}}};return l}}let ln=null;const wu=(e,t)=>t==="modelValue"||t==="model-value"?e.modelModifiers:e[`${t}Modifiers`]||e[`${De(t)}Modifiers`]||e[`${qt(t)}Modifiers`];function vu(e,t,...n){if(e.isUnmounted)return;const s=e.vnode.props||ie;let r=n;const i=t.startsWith("update:"),o=i&&wu(s,t.slice(7));o&&(o.trim&&(r=n.map(u=>pe(u)?u.trim():u)),o.number&&(r=n.map(al)));let a,c=s[a=or(t)]||s[a=or(De(t))];!c&&i&&(c=s[a=or(qt(t))]),c&&ut(c,e,6,r);const l=s[a+"Once"];if(l){if(!e.emitted)e.emitted={};else if(e.emitted[a])return;e.emitted[a]=!0,ut(l,e,6,r)}}const ku=new WeakMap;function xa(e,t,n=!1){const s=n?ku:t.emitsCache,r=s.get(e);if(r!==void 0)return r;const i=e.emits;let o={},a=!1;if(!H(e)){const c=l=>{const u=xa(l,t,!0);u&&(a=!0,Se(o,u))};!n&&t.mixins.length&&t.mixins.forEach(c),e.extends&&c(e.extends),e.mixins&&e.mixins.forEach(c)}return!i&&!a?(Z(e)&&s.set(e,null),null):(K(i)?i.forEach(c=>o[c]=null):Se(o,i),Z(e)&&s.set(e,o),o)}function Gs(e,t){return!e||!Ls(t)?!1:(t=t.slice(2).replace(/Once$/,""),X(e,t[0].toLowerCase()+t.slice(1))||X(e,qt(t))||X(e,t))}function Yi(e){const{type:t,vnode:n,proxy:s,withProxy:r,propsOptions:[i],slots:o,attrs:a,emit:c,render:l,renderCache:u,props:p,data:f,setupState:d,ctx:b,inheritAttrs:g}=e,_=Os(e);let v,w;try{if(n.shapeFlag&4){const A=r||s,L=A;v=ct(l.call(L,A,u,p,d,f,b)),w=a}else{const A=t;v=ct(A.length>1?A(p,{attrs:a,slots:o,emit:c}):A(p,null)),w=t.props?a:Su(a)}}catch(A){$n.length=0,Hs(A,e,1),v=ge(St)}let N=v;if(w&&g!==!1){const A=Object.keys(w),{shapeFlag:L}=N;A.length&&L&7&&(i&&A.some(Ps)&&(w=Eu(w,i)),N=hn(N,w,!1,!0))}return n.dirs&&(N=hn(N,null,!1,!0),N.dirs=N.dirs?N.dirs.concat(n.dirs):n.dirs),n.transition&&ai(N,n.transition),v=N,Os(_),v}const Su=e=>{let t;for(const n in e)(n==="class"||n==="style"||Ls(n))&&((t||(t={}))[n]=e[n]);return t},Eu=(e,t)=>{const n={};for(const s in e)(!Ps(s)||!(s.slice(9)in t))&&(n[s]=e[s]);return n};function Ou(e,t,n){const{props:s,children:r,component:i}=e,{props:o,children:a,patchFlag:c}=t,l=i.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return s?Wi(s,o,l):!!o;if(c&8){const u=t.dynamicProps;for(let p=0;p<u.length;p++){const f=u[p];if($a(o,s,f)&&!Gs(l,f))return!0}}}else return(r||a)&&(!a||!a.$stable)?!0:s===o?!1:s?o?Wi(s,o,l):!0:!!o;return!1}function Wi(e,t,n){const s=Object.keys(t);if(s.length!==Object.keys(e).length)return!0;for(let r=0;r<s.length;r++){const i=s[r];if($a(t,e,i)&&!Gs(n,i))return!0}return!1}function $a(e,t,n){const s=e[n],r=t[n];return n==="style"&&Z(s)&&Z(r)?!ei(s,r):s!==r}function Au({vnode:e,parent:t,suspense:n},s){for(;t;){const r=t.subTree;if(r.suspense&&r.suspense.activeBranch===e&&(r.suspense.vnode.el=r.el=s,e=r),r===e)(e=t.vnode).el=s,t=t.parent;else break}n&&n.activeBranch===e&&(n.vnode.el=s)}const ja={},Ua=()=>Object.create(ja),Fa=e=>Object.getPrototypeOf(e)===ja;function Nu(e,t,n,s=!1){const r={},i=Ua();e.propsDefaults=Object.create(null),Ka(e,t,r,i);for(const o in e.propsOptions[0])o in r||(r[o]=void 0);n?e.props=s?r:da(r):e.type.props?e.props=r:e.props=i,e.attrs=i}function Tu(e,t,n,s){const{props:r,attrs:i,vnode:{patchFlag:o}}=e,a=W(r),[c]=e.propsOptions;let l=!1;if((s||o>0)&&!(o&16)){if(o&8){const u=e.vnode.dynamicProps;for(let p=0;p<u.length;p++){let f=u[p];if(Gs(e.emitsOptions,f))continue;const d=t[f];if(c)if(X(i,f))d!==i[f]&&(i[f]=d,l=!0);else{const b=De(f);r[b]=Br(c,a,b,d,e,!1)}else d!==i[f]&&(i[f]=d,l=!0)}}}else{Ka(e,t,r,i)&&(l=!0);let u;for(const p in a)(!t||!X(t,p)&&((u=qt(p))===p||!X(t,u)))&&(c?n&&(n[p]!==void 0||n[u]!==void 0)&&(r[p]=Br(c,a,p,void 0,e,!0)):delete r[p]);if(i!==a)for(const p in i)(!t||!X(t,p))&&(delete i[p],l=!0)}l&&yt(e.attrs,"set","")}function Ka(e,t,n,s){const[r,i]=e.propsOptions;let o=!1,a;if(t)for(let c in t){if(Cn(c))continue;const l=t[c];let u;r&&X(r,u=De(c))?!i||!i.includes(u)?n[u]=l:(a||(a={}))[u]=l:Gs(e.emitsOptions,c)||(!(c in s)||l!==s[c])&&(s[c]=l,o=!0)}if(i){const c=W(n),l=a||ie;for(let u=0;u<i.length;u++){const p=i[u];n[p]=Br(r,c,p,l[p],e,!X(l,p))}}return o}function Br(e,t,n,s,r,i){const o=e[n];if(o!=null){const a=X(o,"default");if(a&&s===void 0){const c=o.default;if(o.type!==Function&&!o.skipFactory&&H(c)){const{propsDefaults:l}=r;if(n in l)s=l[n];else{const u=ts(r);s=l[n]=c.call(null,t),u()}}else s=c;r.ce&&r.ce._setProp(n,s)}o[0]&&(i&&!a?s=!1:o[1]&&(s===""||s===qt(n))&&(s=!0))}return s}const Ru=new WeakMap;function Va(e,t,n=!1){const s=n?Ru:t.propsCache,r=s.get(e);if(r)return r;const i=e.props,o={},a=[];let c=!1;if(!H(e)){const u=p=>{c=!0;const[f,d]=Va(p,t,!0);Se(o,f),d&&a.push(...d)};!n&&t.mixins.length&&t.mixins.forEach(u),e.extends&&u(e.extends),e.mixins&&e.mixins.forEach(u)}if(!i&&!c)return Z(e)&&s.set(e,rn),rn;if(K(i))for(let u=0;u<i.length;u++){const p=De(i[u]);Ji(p)&&(o[p]=ie)}else if(i)for(const u in i){const p=De(u);if(Ji(p)){const f=i[u],d=o[p]=K(f)||H(f)?{type:f}:Se({},f),b=d.type;let g=!1,_=!0;if(K(b))for(let v=0;v<b.length;++v){const w=b[v],N=H(w)&&w.name;if(N==="Boolean"){g=!0;break}else N==="String"&&(_=!1)}else g=H(b)&&b.name==="Boolean";d[0]=g,d[1]=_,(g||X(d,"default"))&&a.push(p)}}const l=[o,a];return Z(e)&&s.set(e,l),l}function Ji(e){return e[0]!=="$"&&!Cn(e)}const ui=e=>e==="_"||e==="_ctx"||e==="$stable",pi=e=>K(e)?e.map(ct):[ct(e)],Iu=(e,t,n)=>{if(t._n)return t;const s=Lr((...r)=>pi(t(...r)),n);return s._c=!1,s},Ha=(e,t,n)=>{const s=e._ctx;for(const r in e){if(ui(r))continue;const i=e[r];if(H(i))t[r]=Iu(r,i,s);else if(i!=null){const o=pi(i);t[r]=()=>o}}},qa=(e,t)=>{const n=pi(t);e.slots.default=()=>n},Ga=(e,t,n)=>{for(const s in t)(n||!ui(s))&&(e[s]=t[s])},Cu=(e,t,n)=>{const s=e.slots=Ua();if(e.vnode.shapeFlag&32){const r=t._;r?(Ga(s,t,n),n&&Yo(s,"_",r,!0)):Ha(t,s)}else t&&qa(e,t)},Lu=(e,t,n)=>{const{vnode:s,slots:r}=e;let i=!0,o=ie;if(s.shapeFlag&32){const a=t._;a?n&&a===1?i=!1:Ga(r,t,n):(i=!t.$stable,Ha(t,r)),o=t}else t&&(qa(e,t),o={default:1});if(i)for(const a in r)!ui(a)&&o[a]==null&&delete r[a]},$e=xu;function Pu(e){return Mu(e)}function Mu(e,t){const n=xs();n.__VUE__=!0;const{insert:s,remove:r,patchProp:i,createElement:o,createText:a,createComment:c,setText:l,setElementText:u,parentNode:p,nextSibling:f,setScopeId:d=lt,insertStaticContent:b}=e,g=(h,m,y,k=null,O=null,S=null,C=void 0,I=null,R=!!m.dynamicChildren)=>{if(h===m)return;h&&!On(h,m)&&(k=E(h),xe(h,O,S,!0),h=null),m.patchFlag===-2&&(R=!1,m.dynamicChildren=null);const{type:T,ref:U,shapeFlag:M}=m;switch(T){case zs:_(h,m,y,k);break;case St:v(h,m,y,k);break;case hr:h==null&&w(m,y,k,C);break;case je:he(h,m,y,k,O,S,C,I,R);break;default:M&1?L(h,m,y,k,O,S,C,I,R):M&6?ae(h,m,y,k,O,S,C,I,R):(M&64||M&128)&&T.process(h,m,y,k,O,S,C,I,R,$)}U!=null&&O?Bn(U,h&&h.ref,S,m||h,!m):U==null&&h&&h.ref!=null&&Bn(h.ref,null,S,h,!0)},_=(h,m,y,k)=>{if(h==null)s(m.el=a(m.children),y,k);else{const O=m.el=h.el;m.children!==h.children&&l(O,m.children)}},v=(h,m,y,k)=>{h==null?s(m.el=c(m.children||""),y,k):m.el=h.el},w=(h,m,y,k)=>{[h.el,h.anchor]=b(h.children,m,y,k,h.el,h.anchor)},N=({el:h,anchor:m},y,k)=>{let O;for(;h&&h!==m;)O=f(h),s(h,y,k),h=O;s(m,y,k)},A=({el:h,anchor:m})=>{let y;for(;h&&h!==m;)y=f(h),r(h),h=y;r(m)},L=(h,m,y,k,O,S,C,I,R)=>{if(m.type==="svg"?C="svg":m.type==="math"&&(C="mathml"),h==null)F(m,y,k,O,S,C,I,R);else{const T=h.el&&h.el._isVueCE?h.el:null;try{T&&T._beginPatch(),G(h,m,O,S,C,I,R)}finally{T&&T._endPatch()}}},F=(h,m,y,k,O,S,C,I)=>{let R,T;const{props:U,shapeFlag:M,transition:j,dirs:V}=h;if(R=h.el=o(h.type,S,U&&U.is,U),M&8?u(R,h.children):M&16&&x(h.children,R,null,k,O,dr(h,S),C,I),V&&Dt(h,null,k,"created"),D(R,h,h.scopeId,C,k),U){for(const te in U)te!=="value"&&!Cn(te)&&i(R,te,null,U[te],S,k);"value"in U&&i(R,"value",null,U.value,S),(T=U.onVnodeBeforeMount)&&rt(T,k,h)}V&&Dt(h,null,k,"beforeMount");const Y=Du(O,j);Y&&j.beforeEnter(R),s(R,m,y),((T=U&&U.onVnodeMounted)||Y||V)&&$e(()=>{try{T&&rt(T,k,h),Y&&j.enter(R),V&&Dt(h,null,k,"mounted")}finally{}},O)},D=(h,m,y,k,O)=>{if(y&&d(h,y),k)for(let S=0;S<k.length;S++)d(h,k[S]);if(O){let S=O.subTree;if(m===S||Ja(S.type)&&(S.ssContent===m||S.ssFallback===m)){const C=O.vnode;D(h,C,C.scopeId,C.slotScopeIds,O.parent)}}},x=(h,m,y,k,O,S,C,I,R=0)=>{for(let T=R;T<h.length;T++){const U=h[T]=I?gt(h[T]):ct(h[T]);g(null,U,m,y,k,O,S,C,I)}},G=(h,m,y,k,O,S,C)=>{const I=m.el=h.el;let{patchFlag:R,dynamicChildren:T,dirs:U}=m;R|=h.patchFlag&16;const M=h.props||ie,j=m.props||ie;let V;if(y&&Bt(y,!1),(V=j.onVnodeBeforeUpdate)&&rt(V,y,m,h),U&&Dt(m,h,y,"beforeUpdate"),y&&Bt(y,!0),(M.innerHTML&&j.innerHTML==null||M.textContent&&j.textContent==null)&&u(I,""),T?ne(h.dynamicChildren,T,I,y,k,dr(m,O),S):C||J(h,m,I,null,y,k,dr(m,O),S,!1),R>0){if(R&16)_e(I,M,j,y,O);else if(R&2&&M.class!==j.class&&i(I,"class",null,j.class,O),R&4&&i(I,"style",M.style,j.style,O),R&8){const Y=m.dynamicProps;for(let te=0;te<Y.length;te++){const se=Y[te],de=M[se],ve=j[se];(ve!==de||se==="value")&&i(I,se,de,ve,O,y)}}R&1&&h.children!==m.children&&u(I,m.children)}else!C&&T==null&&_e(I,M,j,y,O);((V=j.onVnodeUpdated)||U)&&$e(()=>{V&&rt(V,y,m,h),U&&Dt(m,h,y,"updated")},k)},ne=(h,m,y,k,O,S,C)=>{for(let I=0;I<m.length;I++){const R=h[I],T=m[I],U=R.el&&(R.type===je||!On(R,T)||R.shapeFlag&198)?p(R.el):y;g(R,T,U,null,k,O,S,C,!0)}},_e=(h,m,y,k,O)=>{if(m!==y){if(m!==ie)for(const S in m)!Cn(S)&&!(S in y)&&i(h,S,m[S],null,O,k);for(const S in y){if(Cn(S))continue;const C=y[S],I=m[S];C!==I&&S!=="value"&&i(h,S,I,C,O,k)}"value"in y&&i(h,"value",m.value,y.value,O)}},he=(h,m,y,k,O,S,C,I,R)=>{const T=m.el=h?h.el:a(""),U=m.anchor=h?h.anchor:a("");let{patchFlag:M,dynamicChildren:j,slotScopeIds:V}=m;V&&(I=I?I.concat(V):V),h==null?(s(T,y,k),s(U,y,k),x(m.children||[],y,U,O,S,C,I,R)):M>0&&M&64&&j&&h.dynamicChildren&&h.dynamicChildren.length===j.length?(ne(h.dynamicChildren,j,y,O,S,C,I),(m.key!=null||O&&m===O.subTree)&&za(h,m,!0)):J(h,m,y,U,O,S,C,I,R)},ae=(h,m,y,k,O,S,C,I,R)=>{m.slotScopeIds=I,h==null?m.shapeFlag&512?O.ctx.activate(m,y,k,C,R):Ot(m,y,k,O,S,C,R):zt(h,m,R)},Ot=(h,m,y,k,O,S,C)=>{const I=h.component=Hu(h,k,O);if(Aa(h)&&(I.ctx.renderer=$),qu(I,!1,C),I.asyncDep){if(O&&O.registerDep(I,be,C),!h.el){const R=I.subTree=ge(St);v(null,R,m,y),h.placeholder=R.el}}else be(I,h,m,y,O,S,C)},zt=(h,m,y)=>{const k=m.component=h.component;if(Ou(h,m,y))if(k.asyncDep&&!k.asyncResolved){ee(k,m,y);return}else k.next=m,k.update();else m.el=h.el,k.vnode=m},be=(h,m,y,k,O,S,C)=>{const I=()=>{if(h.isMounted){let{next:M,bu:j,u:V,parent:Y,vnode:te}=h;{const nt=Ya(h);if(nt){M&&(M.el=te.el,ee(h,M,C)),nt.asyncDep.then(()=>{$e(()=>{h.isUnmounted||T()},O)});return}}let se=M,de;Bt(h,!1),M?(M.el=te.el,ee(h,M,C)):M=te,j&&ar(j),(de=M.props&&M.props.onVnodeBeforeUpdate)&&rt(de,Y,M,te),Bt(h,!0);const ve=Yi(h),tt=h.subTree;h.subTree=ve,g(tt,ve,p(tt.el),E(tt),h,O,S),M.el=ve.el,se===null&&Au(h,ve.el),V&&$e(V,O),(de=M.props&&M.props.onVnodeUpdated)&&$e(()=>rt(de,Y,M,te),O)}else{let M;const{el:j,props:V}=m,{bm:Y,m:te,parent:se,root:de,type:ve}=h,tt=cn(m);Bt(h,!1),Y&&ar(Y),!tt&&(M=V&&V.onVnodeBeforeMount)&&rt(M,se,m),Bt(h,!0);{de.ce&&de.ce._hasShadowRoot()&&de.ce._injectChildStyle(ve,h.parent?h.parent.type:void 0);const nt=h.subTree=Yi(h);g(null,nt,y,k,h,O,S),m.el=nt.el}if(te&&$e(te,O),!tt&&(M=V&&V.onVnodeMounted)){const nt=m;$e(()=>rt(M,se,nt),O)}(m.shapeFlag&256||se&&cn(se.vnode)&&se.vnode.shapeFlag&256)&&h.a&&$e(h.a,O),h.isMounted=!0,m=y=k=null}};h.scope.on();const R=h.effect=new Zo(I);h.scope.off();const T=h.update=R.run.bind(R),U=h.job=R.runIfDirty.bind(R);U.i=h,U.id=h.uid,R.scheduler=()=>oi(U),Bt(h,!0),T()},ee=(h,m,y)=>{m.component=h;const k=h.vnode.props;h.vnode=m,h.next=null,Tu(h,m.props,k,y),Lu(h,m.children,y),wt(),ji(h),vt()},J=(h,m,y,k,O,S,C,I,R=!1)=>{const T=h&&h.children,U=h?h.shapeFlag:0,M=m.children,{patchFlag:j,shapeFlag:V}=m;if(j>0){if(j&128){At(T,M,y,k,O,S,C,I,R);return}else if(j&256){ft(T,M,y,k,O,S,C,I,R);return}}V&8?(U&16&&Ve(T,O,S),M!==T&&u(y,M)):U&16?V&16?At(T,M,y,k,O,S,C,I,R):Ve(T,O,S,!0):(U&8&&u(y,""),V&16&&x(M,y,k,O,S,C,I,R))},ft=(h,m,y,k,O,S,C,I,R)=>{h=h||rn,m=m||rn;const T=h.length,U=m.length,M=Math.min(T,U);let j;for(j=0;j<M;j++){const V=m[j]=R?gt(m[j]):ct(m[j]);g(h[j],V,y,null,O,S,C,I,R)}T>U?Ve(h,O,S,!0,!1,M):x(m,y,k,O,S,C,I,R,M)},At=(h,m,y,k,O,S,C,I,R)=>{let T=0;const U=m.length;let M=h.length-1,j=U-1;for(;T<=M&&T<=j;){const V=h[T],Y=m[T]=R?gt(m[T]):ct(m[T]);if(On(V,Y))g(V,Y,y,null,O,S,C,I,R);else break;T++}for(;T<=M&&T<=j;){const V=h[M],Y=m[j]=R?gt(m[j]):ct(m[j]);if(On(V,Y))g(V,Y,y,null,O,S,C,I,R);else break;M--,j--}if(T>M){if(T<=j){const V=j+1,Y=V<U?m[V].el:k;for(;T<=j;)g(null,m[T]=R?gt(m[T]):ct(m[T]),y,Y,O,S,C,I,R),T++}}else if(T>j)for(;T<=M;)xe(h[T],O,S,!0),T++;else{const V=T,Y=T,te=new Map;for(T=Y;T<=j;T++){const Ue=m[T]=R?gt(m[T]):ct(m[T]);Ue.key!=null&&te.set(Ue.key,T)}let se,de=0;const ve=j-Y+1;let tt=!1,nt=0;const Sn=new Array(ve);for(T=0;T<ve;T++)Sn[T]=0;for(T=V;T<=M;T++){const Ue=h[T];if(de>=ve){xe(Ue,O,S,!0);continue}let st;if(Ue.key!=null)st=te.get(Ue.key);else for(se=Y;se<=j;se++)if(Sn[se-Y]===0&&On(Ue,m[se])){st=se;break}st===void 0?xe(Ue,O,S,!0):(Sn[st-Y]=T+1,st>=nt?nt=st:tt=!0,g(Ue,m[st],y,null,O,S,C,I,R),de++)}const Li=tt?Bu(Sn):rn;for(se=Li.length-1,T=ve-1;T>=0;T--){const Ue=Y+T,st=m[Ue],Pi=m[Ue+1],Mi=Ue+1<U?Pi.el||Wa(Pi):k;Sn[T]===0?g(null,st,y,Mi,O,S,C,I,R):tt&&(se<0||T!==Li[se]?et(st,y,Mi,2):se--)}}},et=(h,m,y,k,O=null)=>{const{el:S,type:C,transition:I,children:R,shapeFlag:T}=h;if(T&6){et(h.component.subTree,m,y,k);return}if(T&128){h.suspense.move(m,y,k);return}if(T&64){C.move(h,m,y,$);return}if(C===je){s(S,m,y);for(let M=0;M<R.length;M++)et(R[M],m,y,k);s(h.anchor,m,y);return}if(C===hr){N(h,m,y);return}if(k!==2&&T&1&&I)if(k===0)I.beforeEnter(S),s(S,m,y),$e(()=>I.enter(S),O);else{const{leave:M,delayLeave:j,afterLeave:V}=I,Y=()=>{h.ctx.isUnmounted?r(S):s(S,m,y)},te=()=>{S._isLeaving&&S[eu](!0),M(S,()=>{Y(),V&&V()})};j?j(S,Y,te):te()}else s(S,m,y)},xe=(h,m,y,k=!1,O=!1)=>{const{type:S,props:C,ref:I,children:R,dynamicChildren:T,shapeFlag:U,patchFlag:M,dirs:j,cacheIndex:V,memo:Y}=h;if(M===-2&&(O=!1),I!=null&&(wt(),Bn(I,null,y,h,!0),vt()),V!=null&&(m.renderCache[V]=void 0),U&256){m.ctx.deactivate(h);return}const te=U&1&&j,se=!cn(h);let de;if(se&&(de=C&&C.onVnodeBeforeUnmount)&&rt(de,m,h),U&6)Mt(h.component,y,k);else{if(U&128){h.suspense.unmount(y,k);return}te&&Dt(h,null,m,"beforeUnmount"),U&64?h.type.remove(h,m,y,$,k):T&&!T.hasOnce&&(S!==je||M>0&&M&64)?Ve(T,m,y,!1,!0):(S===je&&M&384||!O&&U&16)&&Ve(R,m,y),k&&Yt(h)}const ve=Y!=null&&V==null;(se&&(de=C&&C.onVnodeUnmounted)||te||ve)&&$e(()=>{de&&rt(de,m,h),te&&Dt(h,null,m,"unmounted"),ve&&(h.el=null)},y)},Yt=h=>{const{type:m,el:y,anchor:k,transition:O}=h;if(m===je){Wt(y,k);return}if(m===hr){A(h);return}const S=()=>{r(y),O&&!O.persisted&&O.afterLeave&&O.afterLeave()};if(h.shapeFlag&1&&O&&!O.persisted){const{leave:C,delayLeave:I}=O,R=()=>C(y,S);I?I(h.el,S,R):R()}else S()},Wt=(h,m)=>{let y;for(;h!==m;)y=f(h),r(h),h=y;r(m)},Mt=(h,m,y)=>{const{bum:k,scope:O,job:S,subTree:C,um:I,m:R,a:T}=h;Qi(R),Qi(T),k&&ar(k),O.stop(),S&&(S.flags|=8,xe(C,h,m,y)),I&&$e(I,m),$e(()=>{h.isUnmounted=!0},m)},Ve=(h,m,y,k=!1,O=!1,S=0)=>{for(let C=S;C<h.length;C++)xe(h[C],m,y,k,O)},E=h=>{if(h.shapeFlag&6)return E(h.component.subTree);if(h.shapeFlag&128)return h.suspense.next();const m=f(h.anchor||h.el),y=m&&m[Xl];return y?f(y):m};let B=!1;const P=(h,m,y)=>{let k;h==null?m._vnode&&(xe(m._vnode,null,null,!0),k=m._vnode.component):g(m._vnode||null,h,m,null,null,null,y),m._vnode=h,B||(B=!0,ji(k),wa(),B=!1)},$={p:g,um:xe,m:et,r:Yt,mt:Ot,mc:x,pc:J,pbc:ne,n:E,o:e};return{render:P,hydrate:void 0,createApp:bu(P)}}function dr({type:e,props:t},n){return n==="svg"&&e==="foreignObject"||n==="mathml"&&e==="annotation-xml"&&t&&t.encoding&&t.encoding.includes("html")?void 0:n}function Bt({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Du(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function za(e,t,n=!1){const s=e.children,r=t.children;if(K(s)&&K(r))for(let i=0;i<s.length;i++){const o=s[i];let a=r[i];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=r[i]=gt(r[i]),a.el=o.el),!n&&a.patchFlag!==-2&&za(o,a)),a.type===zs&&(a.patchFlag===-1&&(a=r[i]=gt(a)),a.el=o.el),a.type===St&&!a.el&&(a.el=o.el)}}function Bu(e){const t=e.slice(),n=[0];let s,r,i,o,a;const c=e.length;for(s=0;s<c;s++){const l=e[s];if(l!==0){if(r=n[n.length-1],e[r]<l){t[s]=r,n.push(s);continue}for(i=0,o=n.length-1;i<o;)a=i+o>>1,e[n[a]]<l?i=a+1:o=a;l<e[n[i]]&&(i>0&&(t[s]=n[i-1]),n[i]=s)}}for(i=n.length,o=n[i-1];i-- >0;)n[i]=o,o=t[o];return n}function Ya(e){const t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:Ya(t)}function Qi(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}function Wa(e){if(e.placeholder)return e.placeholder;const t=e.component;return t?Wa(t.subTree):null}const Ja=e=>e.__isSuspense;function xu(e,t){t&&t.pendingBranch?K(e)?t.effects.push(...e):t.effects.push(e):Yl(e)}const je=Symbol.for("v-fgt"),zs=Symbol.for("v-txt"),St=Symbol.for("v-cmt"),hr=Symbol.for("v-stc"),$n=[];let Me=null;function Ie(e=!1){$n.push(Me=e?null:[])}function $u(){$n.pop(),Me=$n[$n.length-1]||null}let dn=1;function Ts(e,t=!1){dn+=e,e<0&&Me&&t&&(Me.hasOnce=!0)}function Qa(e){return e.dynamicChildren=dn>0?Me||rn:null,$u(),dn>0&&Me&&Me.push(e),e}function ot(e,t,n,s,r,i){return Qa(ke(e,t,n,s,r,i,!0))}function qn(e,t,n,s,r){return Qa(ge(e,t,n,s,r,!0))}function Gn(e){return e?e.__v_isVNode===!0:!1}function On(e,t){return e.type===t.type&&e.key===t.key}const Xa=({key:e})=>e??null,gs=({ref:e,ref_key:t,ref_for:n})=>(typeof e=="number"&&(e=""+e),e!=null?pe(e)||ye(e)||H(e)?{i:Pe,r:e,k:t,f:!!n}:e:null);function ke(e,t=null,n=null,s=0,r=null,i=e===je?0:1,o=!1,a=!1){const c={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Xa(t),ref:t&&gs(t),scopeId:ka,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:i,patchFlag:s,dynamicProps:r,dynamicChildren:null,appContext:null,ctx:Pe};return a?(fi(c,n),i&128&&e.normalize(c)):n&&(c.shapeFlag|=pe(n)?8:16),dn>0&&!o&&Me&&(c.patchFlag>0||i&6)&&c.patchFlag!==32&&Me.push(c),c}const ge=ju;function ju(e,t=null,n=null,s=0,r=null,i=!1){if((!e||e===Ia)&&(e=St),Gn(e)){const a=hn(e,t,!0);return n&&fi(a,n),dn>0&&!i&&Me&&(a.shapeFlag&6?Me[Me.indexOf(e)]=a:Me.push(a)),a.patchFlag=-2,a}if(Wu(e)&&(e=e.__vccOpts),t){t=Uu(t);let{class:a,style:c}=t;a&&!pe(a)&&(t.class=$s(a)),Z(c)&&(Ks(c)&&!K(c)&&(c=Se({},c)),t.style=Zr(c))}const o=pe(e)?1:Ja(e)?128:Zl(e)?64:Z(e)?4:H(e)?2:0;return ke(e,t,n,s,r,o,i,!0)}function Uu(e){return e?Ks(e)||Fa(e)?Se({},e):e:null}function hn(e,t,n=!1,s=!1){const{props:r,ref:i,patchFlag:o,children:a,transition:c}=e,l=t?Fu(r||{},t):r,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Xa(l),ref:t&&t.ref?n&&i?K(i)?i.concat(gs(t)):[i,gs(t)]:gs(t):i,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:a,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==je?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:c,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&hn(e.ssContent),ssFallback:e.ssFallback&&hn(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return c&&s&&ai(u,c.clone(u)),u}function ys(e=" ",t=0){return ge(zs,null,e,t)}function Xi(e="",t=!1){return t?(Ie(),qn(St,null,e)):ge(St,null,e)}function ct(e){return e==null||typeof e=="boolean"?ge(St):K(e)?ge(je,null,e.slice()):Gn(e)?gt(e):ge(zs,null,String(e))}function gt(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:hn(e)}function fi(e,t){let n=0;const{shapeFlag:s}=e;if(t==null)t=null;else if(K(t))n=16;else if(typeof t=="object")if(s&65){const r=t.default;r&&(r._c&&(r._d=!1),fi(e,r()),r._c&&(r._d=!0));return}else{n=32;const r=t._;!r&&!Fa(t)?t._ctx=Pe:r===3&&Pe&&(Pe.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else H(t)?(t={default:t,_ctx:Pe},n=32):(t=String(t),s&64?(n=16,t=[ys(t)]):n=8);e.children=t,e.shapeFlag|=n}function Fu(...e){const t={};for(let n=0;n<e.length;n++){const s=e[n];for(const r in s)if(r==="class")t.class!==s.class&&(t.class=$s([t.class,s.class]));else if(r==="style")t.style=Zr([t.style,s.style]);else if(Ls(r)){const i=t[r],o=s[r];o&&i!==o&&!(K(i)&&i.includes(o))?t[r]=i?[].concat(i,o):o:o==null&&i==null&&!Ps(r)&&(t[r]=o)}else r!==""&&(t[r]=s[r])}return t}function rt(e,t,n,s=null){ut(e,t,7,[n,s])}const Ku=Ba();let Vu=0;function Hu(e,t,n){const s=e.type,r=(t?t.appContext:e.appContext)||Ku,i={uid:Vu++,vnode:e,type:s,parent:t,appContext:r,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Xo(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:t?t.provides:Object.create(r.provides),ids:t?t.ids:["",0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:Va(s,r),emitsOptions:xa(s,r),emit:null,emitted:null,propsDefaults:ie,inheritAttrs:s.inheritAttrs,ctx:ie,data:ie,props:ie,attrs:ie,slots:ie,refs:ie,setupState:ie,setupContext:null,suspense:n,suspenseId:n?n.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return i.ctx={_:i},i.root=t?t.root:i,i.emit=vu.bind(null,i),e.ce&&e.ce(i),i}let Ae=null;const Za=()=>Ae||Pe;let Rs,xr;{const e=xs(),t=(n,s)=>{let r;return(r=e[n])||(r=e[n]=[]),r.push(s),i=>{r.length>1?r.forEach(o=>o(i)):r[0](i)}};Rs=t("__VUE_INSTANCE_SETTERS__",n=>Ae=n),xr=t("__VUE_SSR_SETTERS__",n=>zn=n)}const ts=e=>{const t=Ae;return Rs(e),e.scope.on(),()=>{e.scope.off(),Rs(t)}},Zi=()=>{Ae&&Ae.scope.off(),Rs(null)};function ec(e){return e.vnode.shapeFlag&4}let zn=!1;function qu(e,t=!1,n=!1){t&&xr(t);const{props:s,children:r}=e.vnode,i=ec(e);Nu(e,s,i,t),Cu(e,r,n||t);const o=i?Gu(e,t):void 0;return t&&xr(!1),o}function Gu(e,t){const n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,fu);const{setup:s}=n;if(s){wt();const r=e.setupContext=s.length>1?nc(e):null,i=ts(e),o=Zn(s,e,0,[e.props,r]),a=qo(o);if(vt(),i(),(a||e.sp)&&!cn(e)&&Oa(e),a){if(o.then(Zi,Zi),t)return o.then(c=>{eo(e,c)}).catch(c=>{Hs(c,e,0)});e.asyncDep=o}else eo(e,o)}else tc(e)}function eo(e,t,n){H(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:Z(t)&&(e.setupState=ma(t)),tc(e)}function tc(e,t,n){const s=e.type;e.render||(e.render=s.render||lt);{const r=ts(e);wt();try{du(e)}finally{vt(),r()}}}const zu={get(e,t){return Oe(e,"get",""),e[t]}};function nc(e){const t=n=>{e.exposed=n||{}};return{attrs:new Proxy(e.attrs,zu),slots:e.slots,emit:e.emit,expose:t}}function di(e){return e.exposed?e.exposeProxy||(e.exposeProxy=new Proxy(ma(Dl(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in xn)return xn[n](e)},has(t,n){return n in t||n in xn}})):e.proxy}function Yu(e,t=!0){return H(e)?e.displayName||e.name:e.name||t&&e.__name}function Wu(e){return H(e)&&"__vccOpts"in e}const Le=(e,t)=>Vl(e,t,zn);function Yn(e,t,n){try{Ts(-1);const s=arguments.length;return s===2?Z(t)&&!K(t)?Gn(t)?ge(e,null,[t]):ge(e,t):ge(e,null,t):(s>3?n=Array.prototype.slice.call(arguments,2):s===3&&Gn(n)&&(n=[n]),ge(e,t,n))}finally{Ts(1)}}function Yh(e,t){const n=e.memo;if(n.length!=t.length)return!1;for(let s=0;s<n.length;s++)if(Ye(n[s],t[s]))return!1;return dn>0&&Me&&Me.push(e),!0}const Ju="3.5.31";/**
* @vue/runtime-dom v3.5.31
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/let $r;const to=typeof window<"u"&&window.trustedTypes;if(to)try{$r=to.createPolicy("vue",{createHTML:e=>e})}catch{}const sc=$r?e=>$r.createHTML(e):e=>e,Qu="http://www.w3.org/2000/svg",Xu="http://www.w3.org/1998/Math/MathML",mt=typeof document<"u"?document:null,no=mt&&mt.createElement("template"),Zu={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{const t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,s)=>{const r=t==="svg"?mt.createElementNS(Qu,e):t==="mathml"?mt.createElementNS(Xu,e):n?mt.createElement(e,{is:n}):mt.createElement(e);return e==="select"&&s&&s.multiple!=null&&r.setAttribute("multiple",s.multiple),r},createText:e=>mt.createTextNode(e),createComment:e=>mt.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>mt.querySelector(e),setScopeId(e,t){e.setAttribute(t,"")},insertStaticContent(e,t,n,s,r,i){const o=n?n.previousSibling:t.lastChild;if(r&&(r===i||r.nextSibling))for(;t.insertBefore(r.cloneNode(!0),n),!(r===i||!(r=r.nextSibling)););else{no.innerHTML=sc(s==="svg"?`<svg>${e}</svg>`:s==="mathml"?`<math>${e}</math>`:e);const a=no.content;if(s==="svg"||s==="mathml"){const c=a.firstChild;for(;c.firstChild;)a.appendChild(c.firstChild);a.removeChild(c)}t.insertBefore(a,n)}return[o?o.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},ep=Symbol("_vtc");function tp(e,t,n){const s=e[ep];s&&(t=(t?[t,...s]:[...s]).join(" ")),t==null?e.removeAttribute("class"):n?e.setAttribute("class",t):e.className=t}const so=Symbol("_vod"),np=Symbol("_vsh"),sp=Symbol(""),rp=/(?:^|;)\s*display\s*:/;function ip(e,t,n){const s=e.style,r=pe(n);let i=!1;if(n&&!r){if(t)if(pe(t))for(const o of t.split(";")){const a=o.slice(0,o.indexOf(":")).trim();n[a]==null&&_s(s,a,"")}else for(const o in t)n[o]==null&&_s(s,o,"");for(const o in n)o==="display"&&(i=!0),_s(s,o,n[o])}else if(r){if(t!==n){const o=s[sp];o&&(n+=";"+o),s.cssText=n,i=rp.test(n)}}else t&&e.removeAttribute("style");so in e&&(e[so]=i?s.display:"",e[np]&&(s.display="none"))}const ro=/\s*!important$/;function _s(e,t,n){if(K(n))n.forEach(s=>_s(e,t,s));else if(n==null&&(n=""),t.startsWith("--"))e.setProperty(t,n);else{const s=op(e,t);ro.test(n)?e.setProperty(qt(s),n.replace(ro,""),"important"):e[s]=n}}const io=["Webkit","Moz","ms"],mr={};function op(e,t){const n=mr[t];if(n)return n;let s=De(t);if(s!=="filter"&&s in e)return mr[t]=s;s=Bs(s);for(let r=0;r<io.length;r++){const i=io[r]+s;if(i in e)return mr[t]=i}return t}const oo="http://www.w3.org/1999/xlink";function ao(e,t,n,s,r,i=dl(t)){s&&t.startsWith("xlink:")?n==null?e.removeAttributeNS(oo,t.slice(6,t.length)):e.setAttributeNS(oo,t,n):n==null||i&&!Wo(n)?e.removeAttribute(t):e.setAttribute(t,i?"":Ke(n)?String(n):n)}function co(e,t,n,s,r){if(t==="innerHTML"||t==="textContent"){n!=null&&(e[t]=t==="innerHTML"?sc(n):n);return}const i=e.tagName;if(t==="value"&&i!=="PROGRESS"&&!i.includes("-")){const a=i==="OPTION"?e.getAttribute("value")||"":e.value,c=n==null?e.type==="checkbox"?"on":"":String(n);(a!==c||!("_value"in e))&&(e.value=c),n==null&&e.removeAttribute(t),e._value=n;return}let o=!1;if(n===""||n==null){const a=typeof e[t];a==="boolean"?n=Wo(n):n==null&&a==="string"?(n="",o=!0):a==="number"&&(n=0,o=!0)}try{e[t]=n}catch{}o&&e.removeAttribute(r||t)}function ap(e,t,n,s){e.addEventListener(t,n,s)}function cp(e,t,n,s){e.removeEventListener(t,n,s)}const lo=Symbol("_vei");function lp(e,t,n,s,r=null){const i=e[lo]||(e[lo]={}),o=i[t];if(s&&o)o.value=s;else{const[a,c]=up(t);if(s){const l=i[t]=dp(s,r);ap(e,a,l,c)}else o&&(cp(e,a,o,c),i[t]=void 0)}}const uo=/(?:Once|Passive|Capture)$/;function up(e){let t;if(uo.test(e)){t={};let s;for(;s=e.match(uo);)e=e.slice(0,e.length-s[0].length),t[s[0].toLowerCase()]=!0}return[e[2]===":"?e.slice(3):qt(e.slice(2)),t]}let gr=0;const pp=Promise.resolve(),fp=()=>gr||(pp.then(()=>gr=0),gr=Date.now());function dp(e,t){const n=s=>{if(!s._vts)s._vts=Date.now();else if(s._vts<=n.attached)return;ut(hp(s,n.value),t,5,[s])};return n.value=e,n.attached=fp(),n}function hp(e,t){if(K(t)){const n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},t.map(s=>r=>!r._stopped&&s&&s(r))}else return t}const po=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,mp=(e,t,n,s,r,i)=>{const o=r==="svg";t==="class"?tp(e,s,o):t==="style"?ip(e,n,s):Ls(t)?Ps(t)||lp(e,t,n,s,i):(t[0]==="."?(t=t.slice(1),!0):t[0]==="^"?(t=t.slice(1),!1):gp(e,t,s,o))?(co(e,t,s),!e.tagName.includes("-")&&(t==="value"||t==="checked"||t==="selected")&&ao(e,t,s,o,i,t!=="value")):e._isVueCE&&(yp(e,t)||e._def.__asyncLoader&&(/[A-Z]/.test(t)||!pe(s)))?co(e,De(t),s,i,t):(t==="true-value"?e._trueValue=s:t==="false-value"&&(e._falseValue=s),ao(e,t,s,o))};function gp(e,t,n,s){if(s)return!!(t==="innerHTML"||t==="textContent"||t in e&&po(t)&&H(n));if(t==="spellcheck"||t==="draggable"||t==="translate"||t==="autocorrect"||t==="sandbox"&&e.tagName==="IFRAME"||t==="form"||t==="list"&&e.tagName==="INPUT"||t==="type"&&e.tagName==="TEXTAREA")return!1;if(t==="width"||t==="height"){const r=e.tagName;if(r==="IMG"||r==="VIDEO"||r==="CANVAS"||r==="SOURCE")return!1}return po(t)&&pe(n)?!1:t in e}function yp(e,t){const n=e._def.props;if(!n)return!1;const s=De(t);return Array.isArray(n)?n.some(r=>De(r)===s):Object.keys(n).some(r=>De(r)===s)}const _p=Se({patchProp:mp},Zu);let fo;function bp(){return fo||(fo=Pu(_p))}const wp=((...e)=>{const t=bp().createApp(...e),{mount:n}=t;return t.mount=s=>{const r=kp(s);if(!r)return;const i=t._component;!H(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent="");const o=n(r,!1,vp(r));return r instanceof Element&&(r.removeAttribute("v-cloak"),r.setAttribute("data-v-app","")),o},t});function vp(e){if(e instanceof SVGElement)return"svg";if(typeof MathMLElement=="function"&&e instanceof MathMLElement)return"mathml"}function kp(e){return pe(e)?document.querySelector(e):e}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */const en=typeof document<"u";function rc(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function Sp(e){return e.__esModule||e[Symbol.toStringTag]==="Module"||e.default&&rc(e.default)}const Q=Object.assign;function yr(e,t){const n={};for(const s in t){const r=t[s];n[s]=Xe(r)?r.map(e):e(r)}return n}const jn=()=>{},Xe=Array.isArray;function ho(e,t){const n={};for(const s in e)n[s]=s in t?t[s]:e[s];return n}const ic=/#/g,Ep=/&/g,Op=/\//g,Ap=/=/g,Np=/\?/g,oc=/\+/g,Tp=/%5B/g,Rp=/%5D/g,ac=/%5E/g,Ip=/%60/g,cc=/%7B/g,Cp=/%7C/g,lc=/%7D/g,Lp=/%20/g;function hi(e){return e==null?"":encodeURI(""+e).replace(Cp,"|").replace(Tp,"[").replace(Rp,"]")}function Pp(e){return hi(e).replace(cc,"{").replace(lc,"}").replace(ac,"^")}function jr(e){return hi(e).replace(oc,"%2B").replace(Lp,"+").replace(ic,"%23").replace(Ep,"%26").replace(Ip,"`").replace(cc,"{").replace(lc,"}").replace(ac,"^")}function Mp(e){return jr(e).replace(Ap,"%3D")}function Dp(e){return hi(e).replace(ic,"%23").replace(Np,"%3F")}function Bp(e){return Dp(e).replace(Op,"%2F")}function Wn(e){if(e==null)return null;try{return decodeURIComponent(""+e)}catch{}return""+e}const xp=/\/$/,$p=e=>e.replace(xp,"");function _r(e,t,n="/"){let s,r={},i="",o="";const a=t.indexOf("#");let c=t.indexOf("?");return c=a>=0&&c>a?-1:c,c>=0&&(s=t.slice(0,c),i=t.slice(c,a>0?a:t.length),r=e(i.slice(1))),a>=0&&(s=s||t.slice(0,a),o=t.slice(a,t.length)),s=Kp(s??t,n),{fullPath:s+i+o,path:s,query:r,hash:Wn(o)}}function jp(e,t){const n=t.query?e(t.query):"";return t.path+(n&&"?")+n+(t.hash||"")}function mo(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function Up(e,t,n){const s=t.matched.length-1,r=n.matched.length-1;return s>-1&&s===r&&mn(t.matched[s],n.matched[r])&&uc(t.params,n.params)&&e(t.query)===e(n.query)&&t.hash===n.hash}function mn(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function uc(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(var n in e)if(!Fp(e[n],t[n]))return!1;return!0}function Fp(e,t){return Xe(e)?go(e,t):Xe(t)?go(t,e):(e==null?void 0:e.valueOf())===(t==null?void 0:t.valueOf())}function go(e,t){return Xe(t)?e.length===t.length&&e.every((n,s)=>n===t[s]):e.length===1&&e[0]===t}function Kp(e,t){if(e.startsWith("/"))return e;if(!e)return t;const n=t.split("/"),s=e.split("/"),r=s[s.length-1];(r===".."||r===".")&&s.push("");let i=n.length-1,o,a;for(o=0;o<s.length;o++)if(a=s[o],a!==".")if(a==="..")i>1&&i--;else break;return n.slice(0,i).join("/")+"/"+s.slice(o).join("/")}const Nt={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0};let Ur=(function(e){return e.pop="pop",e.push="push",e})({}),br=(function(e){return e.back="back",e.forward="forward",e.unknown="",e})({});function Vp(e){if(!e)if(en){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),$p(e)}const Hp=/^[^#]+#/;function qp(e,t){return e.replace(Hp,"#")+t}function Gp(e,t){const n=document.documentElement.getBoundingClientRect(),s=e.getBoundingClientRect();return{behavior:t.behavior,left:s.left-n.left-(t.left||0),top:s.top-n.top-(t.top||0)}}const Ys=()=>({left:window.scrollX,top:window.scrollY});function zp(e){let t;if("el"in e){const n=e.el,s=typeof n=="string"&&n.startsWith("#"),r=typeof n=="string"?s?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!r)return;t=Gp(r,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.scrollX,t.top!=null?t.top:window.scrollY)}function yo(e,t){return(history.state?history.state.position-t:-1)+e}const Fr=new Map;function Yp(e,t){Fr.set(e,t)}function Wp(e){const t=Fr.get(e);return Fr.delete(e),t}function Jp(e){return typeof e=="string"||e&&typeof e=="object"}function pc(e){return typeof e=="string"||typeof e=="symbol"}let ce=(function(e){return e[e.MATCHER_NOT_FOUND=1]="MATCHER_NOT_FOUND",e[e.NAVIGATION_GUARD_REDIRECT=2]="NAVIGATION_GUARD_REDIRECT",e[e.NAVIGATION_ABORTED=4]="NAVIGATION_ABORTED",e[e.NAVIGATION_CANCELLED=8]="NAVIGATION_CANCELLED",e[e.NAVIGATION_DUPLICATED=16]="NAVIGATION_DUPLICATED",e})({});const fc=Symbol("");ce.MATCHER_NOT_FOUND+"",ce.NAVIGATION_GUARD_REDIRECT+"",ce.NAVIGATION_ABORTED+"",ce.NAVIGATION_CANCELLED+"",ce.NAVIGATION_DUPLICATED+"";function gn(e,t){return Q(new Error,{type:e,[fc]:!0},t)}function ht(e,t){return e instanceof Error&&fc in e&&(t==null||!!(e.type&t))}const Qp=["params","query","hash"];function Xp(e){if(typeof e=="string")return e;if(e.path!=null)return e.path;const t={};for(const n of Qp)n in e&&(t[n]=e[n]);return JSON.stringify(t,null,2)}function Zp(e){const t={};if(e===""||e==="?")return t;const n=(e[0]==="?"?e.slice(1):e).split("&");for(let s=0;s<n.length;++s){const r=n[s].replace(oc," "),i=r.indexOf("="),o=Wn(i<0?r:r.slice(0,i)),a=i<0?null:Wn(r.slice(i+1));if(o in t){let c=t[o];Xe(c)||(c=t[o]=[c]),c.push(a)}else t[o]=a}return t}function _o(e){let t="";for(let n in e){const s=e[n];if(n=Mp(n),s==null){s!==void 0&&(t+=(t.length?"&":"")+n);continue}(Xe(s)?s.map(r=>r&&jr(r)):[s&&jr(s)]).forEach(r=>{r!==void 0&&(t+=(t.length?"&":"")+n,r!=null&&(t+="="+r))})}return t}function ef(e){const t={};for(const n in e){const s=e[n];s!==void 0&&(t[n]=Xe(s)?s.map(r=>r==null?null:""+r):s==null?s:""+s)}return t}const tf=Symbol(""),bo=Symbol(""),Ws=Symbol(""),mi=Symbol(""),Kr=Symbol("");function An(){let e=[];function t(s){return e.push(s),()=>{const r=e.indexOf(s);r>-1&&e.splice(r,1)}}function n(){e=[]}return{add:t,list:()=>e.slice(),reset:n}}function Rt(e,t,n,s,r,i=o=>o()){const o=s&&(s.enterCallbacks[r]=s.enterCallbacks[r]||[]);return()=>new Promise((a,c)=>{const l=f=>{f===!1?c(gn(ce.NAVIGATION_ABORTED,{from:n,to:t})):f instanceof Error?c(f):Jp(f)?c(gn(ce.NAVIGATION_GUARD_REDIRECT,{from:t,to:f})):(o&&s.enterCallbacks[r]===o&&typeof f=="function"&&o.push(f),a())},u=i(()=>e.call(s&&s.instances[r],t,n,l));let p=Promise.resolve(u);e.length<3&&(p=p.then(l)),p.catch(f=>c(f))})}function wr(e,t,n,s,r=i=>i()){const i=[];for(const o of e)for(const a in o.components){let c=o.components[a];if(!(t!=="beforeRouteEnter"&&!o.instances[a]))if(rc(c)){const l=(c.__vccOpts||c)[t];l&&i.push(Rt(l,n,s,o,a,r))}else{let l=c();i.push(()=>l.then(u=>{if(!u)throw new Error(`Couldn't resolve component "${a}" at "${o.path}"`);const p=Sp(u)?u.default:u;o.mods[a]=u,o.components[a]=p;const f=(p.__vccOpts||p)[t];return f&&Rt(f,n,s,o,a,r)()}))}}return i}function nf(e,t){const n=[],s=[],r=[],i=Math.max(t.matched.length,e.matched.length);for(let o=0;o<i;o++){const a=t.matched[o];a&&(e.matched.find(l=>mn(l,a))?s.push(a):n.push(a));const c=e.matched[o];c&&(t.matched.find(l=>mn(l,c))||r.push(c))}return[n,s,r]}/*!
 * vue-router v4.6.4
 * (c) 2025 Eduardo San Martin Morote
 * @license MIT
 */let sf=()=>location.protocol+"//"+location.host;function dc(e,t){const{pathname:n,search:s,hash:r}=t,i=e.indexOf("#");if(i>-1){let o=r.includes(e.slice(i))?e.slice(i).length:1,a=r.slice(o);return a[0]!=="/"&&(a="/"+a),mo(a,"")}return mo(n,e)+s+r}function rf(e,t,n,s){let r=[],i=[],o=null;const a=({state:f})=>{const d=dc(e,location),b=n.value,g=t.value;let _=0;if(f){if(n.value=d,t.value=f,o&&o===b){o=null;return}_=g?f.position-g.position:0}else s(d);r.forEach(v=>{v(n.value,b,{delta:_,type:Ur.pop,direction:_?_>0?br.forward:br.back:br.unknown})})};function c(){o=n.value}function l(f){r.push(f);const d=()=>{const b=r.indexOf(f);b>-1&&r.splice(b,1)};return i.push(d),d}function u(){if(document.visibilityState==="hidden"){const{history:f}=window;if(!f.state)return;f.replaceState(Q({},f.state,{scroll:Ys()}),"")}}function p(){for(const f of i)f();i=[],window.removeEventListener("popstate",a),window.removeEventListener("pagehide",u),document.removeEventListener("visibilitychange",u)}return window.addEventListener("popstate",a),window.addEventListener("pagehide",u),document.addEventListener("visibilitychange",u),{pauseListeners:c,listen:l,destroy:p}}function wo(e,t,n,s=!1,r=!1){return{back:e,current:t,forward:n,replaced:s,position:window.history.length,scroll:r?Ys():null}}function of(e){const{history:t,location:n}=window,s={value:dc(e,n)},r={value:t.state};r.value||i(s.value,{back:null,current:s.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(c,l,u){const p=e.indexOf("#"),f=p>-1?(n.host&&document.querySelector("base")?e:e.slice(p))+c:sf()+e+c;try{t[u?"replaceState":"pushState"](l,"",f),r.value=l}catch(d){console.error(d),n[u?"replace":"assign"](f)}}function o(c,l){i(c,Q({},t.state,wo(r.value.back,c,r.value.forward,!0),l,{position:r.value.position}),!0),s.value=c}function a(c,l){const u=Q({},r.value,t.state,{forward:c,scroll:Ys()});i(u.current,u,!0),i(c,Q({},wo(s.value,c,null),{position:u.position+1},l),!1),s.value=c}return{location:s,state:r,push:a,replace:o}}function af(e){e=Vp(e);const t=of(e),n=rf(e,t.state,t.location,t.replace);function s(i,o=!0){o||n.pauseListeners(),history.go(i)}const r=Q({location:"",base:e,go:s,createHref:qp.bind(null,e)},t,n);return Object.defineProperty(r,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(r,"state",{enumerable:!0,get:()=>t.state.value}),r}function cf(e){return e=location.host?e||location.pathname+location.search:"",e.includes("#")||(e+="#"),af(e)}let jt=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.Group=2]="Group",e})({});var me=(function(e){return e[e.Static=0]="Static",e[e.Param=1]="Param",e[e.ParamRegExp=2]="ParamRegExp",e[e.ParamRegExpEnd=3]="ParamRegExpEnd",e[e.EscapeNext=4]="EscapeNext",e})(me||{});const lf={type:jt.Static,value:""},uf=/[a-zA-Z0-9_]/;function pf(e){if(!e)return[[]];if(e==="/")return[[lf]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(d){throw new Error(`ERR (${n})/"${l}": ${d}`)}let n=me.Static,s=n;const r=[];let i;function o(){i&&r.push(i),i=[]}let a=0,c,l="",u="";function p(){l&&(n===me.Static?i.push({type:jt.Static,value:l}):n===me.Param||n===me.ParamRegExp||n===me.ParamRegExpEnd?(i.length>1&&(c==="*"||c==="+")&&t(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),i.push({type:jt.Param,value:l,regexp:u,repeatable:c==="*"||c==="+",optional:c==="*"||c==="?"})):t("Invalid state to consume buffer"),l="")}function f(){l+=c}for(;a<e.length;){if(c=e[a++],c==="\\"&&n!==me.ParamRegExp){s=n,n=me.EscapeNext;continue}switch(n){case me.Static:c==="/"?(l&&p(),o()):c===":"?(p(),n=me.Param):f();break;case me.EscapeNext:f(),n=s;break;case me.Param:c==="("?n=me.ParamRegExp:uf.test(c)?f():(p(),n=me.Static,c!=="*"&&c!=="?"&&c!=="+"&&a--);break;case me.ParamRegExp:c===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+c:n=me.ParamRegExpEnd:u+=c;break;case me.ParamRegExpEnd:p(),n=me.Static,c!=="*"&&c!=="?"&&c!=="+"&&a--,u="";break;default:t("Unknown state");break}}return n===me.ParamRegExp&&t(`Unfinished custom RegExp for param "${l}"`),p(),o(),r}const vo="[^/]+?",ff={sensitive:!1,strict:!1,start:!0,end:!0};var Te=(function(e){return e[e._multiplier=10]="_multiplier",e[e.Root=90]="Root",e[e.Segment=40]="Segment",e[e.SubSegment=30]="SubSegment",e[e.Static=40]="Static",e[e.Dynamic=20]="Dynamic",e[e.BonusCustomRegExp=10]="BonusCustomRegExp",e[e.BonusWildcard=-50]="BonusWildcard",e[e.BonusRepeatable=-20]="BonusRepeatable",e[e.BonusOptional=-8]="BonusOptional",e[e.BonusStrict=.7000000000000001]="BonusStrict",e[e.BonusCaseSensitive=.25]="BonusCaseSensitive",e})(Te||{});const df=/[.+*?^${}()[\]/\\]/g;function hf(e,t){const n=Q({},ff,t),s=[];let r=n.start?"^":"";const i=[];for(const l of e){const u=l.length?[]:[Te.Root];n.strict&&!l.length&&(r+="/");for(let p=0;p<l.length;p++){const f=l[p];let d=Te.Segment+(n.sensitive?Te.BonusCaseSensitive:0);if(f.type===jt.Static)p||(r+="/"),r+=f.value.replace(df,"\\$&"),d+=Te.Static;else if(f.type===jt.Param){const{value:b,repeatable:g,optional:_,regexp:v}=f;i.push({name:b,repeatable:g,optional:_});const w=v||vo;if(w!==vo){d+=Te.BonusCustomRegExp;try{`${w}`}catch(A){throw new Error(`Invalid custom RegExp for param "${b}" (${w}): `+A.message)}}let N=g?`((?:${w})(?:/(?:${w}))*)`:`(${w})`;p||(N=_&&l.length<2?`(?:/${N})`:"/"+N),_&&(N+="?"),r+=N,d+=Te.Dynamic,_&&(d+=Te.BonusOptional),g&&(d+=Te.BonusRepeatable),w===".*"&&(d+=Te.BonusWildcard)}u.push(d)}s.push(u)}if(n.strict&&n.end){const l=s.length-1;s[l][s[l].length-1]+=Te.BonusStrict}n.strict||(r+="/?"),n.end?r+="$":n.strict&&!r.endsWith("/")&&(r+="(?:/|$)");const o=new RegExp(r,n.sensitive?"":"i");function a(l){const u=l.match(o),p={};if(!u)return null;for(let f=1;f<u.length;f++){const d=u[f]||"",b=i[f-1];p[b.name]=d&&b.repeatable?d.split("/"):d}return p}function c(l){let u="",p=!1;for(const f of e){(!p||!u.endsWith("/"))&&(u+="/"),p=!1;for(const d of f)if(d.type===jt.Static)u+=d.value;else if(d.type===jt.Param){const{value:b,repeatable:g,optional:_}=d,v=b in l?l[b]:"";if(Xe(v)&&!g)throw new Error(`Provided param "${b}" is an array but it is not repeatable (* or + modifiers)`);const w=Xe(v)?v.join("/"):v;if(!w)if(_)f.length<2&&(u.endsWith("/")?u=u.slice(0,-1):p=!0);else throw new Error(`Missing required param "${b}"`);u+=w}}return u||"/"}return{re:o,score:s,keys:i,parse:a,stringify:c}}function mf(e,t){let n=0;for(;n<e.length&&n<t.length;){const s=t[n]-e[n];if(s)return s;n++}return e.length<t.length?e.length===1&&e[0]===Te.Static+Te.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===Te.Static+Te.Segment?1:-1:0}function hc(e,t){let n=0;const s=e.score,r=t.score;for(;n<s.length&&n<r.length;){const i=mf(s[n],r[n]);if(i)return i;n++}if(Math.abs(r.length-s.length)===1){if(ko(s))return 1;if(ko(r))return-1}return r.length-s.length}function ko(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const gf={strict:!1,end:!0,sensitive:!1};function yf(e,t,n){const s=hf(pf(e.path),n),r=Q(s,{record:e,parent:t,children:[],alias:[]});return t&&!r.record.aliasOf==!t.record.aliasOf&&t.children.push(r),r}function _f(e,t){const n=[],s=new Map;t=ho(gf,t);function r(p){return s.get(p)}function i(p,f,d){const b=!d,g=Eo(p);g.aliasOf=d&&d.record;const _=ho(t,p),v=[g];if("alias"in p){const A=typeof p.alias=="string"?[p.alias]:p.alias;for(const L of A)v.push(Eo(Q({},g,{components:d?d.record.components:g.components,path:L,aliasOf:d?d.record:g})))}let w,N;for(const A of v){const{path:L}=A;if(f&&L[0]!=="/"){const F=f.record.path,D=F[F.length-1]==="/"?"":"/";A.path=f.record.path+(L&&D+L)}if(w=yf(A,f,_),d?d.alias.push(w):(N=N||w,N!==w&&N.alias.push(w),b&&p.name&&!Oo(w)&&o(p.name)),mc(w)&&c(w),g.children){const F=g.children;for(let D=0;D<F.length;D++)i(F[D],w,d&&d.children[D])}d=d||w}return N?()=>{o(N)}:jn}function o(p){if(pc(p)){const f=s.get(p);f&&(s.delete(p),n.splice(n.indexOf(f),1),f.children.forEach(o),f.alias.forEach(o))}else{const f=n.indexOf(p);f>-1&&(n.splice(f,1),p.record.name&&s.delete(p.record.name),p.children.forEach(o),p.alias.forEach(o))}}function a(){return n}function c(p){const f=vf(p,n);n.splice(f,0,p),p.record.name&&!Oo(p)&&s.set(p.record.name,p)}function l(p,f){let d,b={},g,_;if("name"in p&&p.name){if(d=s.get(p.name),!d)throw gn(ce.MATCHER_NOT_FOUND,{location:p});_=d.record.name,b=Q(So(f.params,d.keys.filter(N=>!N.optional).concat(d.parent?d.parent.keys.filter(N=>N.optional):[]).map(N=>N.name)),p.params&&So(p.params,d.keys.map(N=>N.name))),g=d.stringify(b)}else if(p.path!=null)g=p.path,d=n.find(N=>N.re.test(g)),d&&(b=d.parse(g),_=d.record.name);else{if(d=f.name?s.get(f.name):n.find(N=>N.re.test(f.path)),!d)throw gn(ce.MATCHER_NOT_FOUND,{location:p,currentLocation:f});_=d.record.name,b=Q({},f.params,p.params),g=d.stringify(b)}const v=[];let w=d;for(;w;)v.unshift(w.record),w=w.parent;return{name:_,path:g,params:b,matched:v,meta:wf(v)}}e.forEach(p=>i(p));function u(){n.length=0,s.clear()}return{addRoute:i,resolve:l,removeRoute:o,clearRoutes:u,getRoutes:a,getRecordMatcher:r}}function So(e,t){const n={};for(const s of t)s in e&&(n[s]=e[s]);return n}function Eo(e){const t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:bf(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,"mods",{value:{}}),t}function bf(e){const t={},n=e.props||!1;if("component"in e)t.default=n;else for(const s in e.components)t[s]=typeof n=="object"?n[s]:n;return t}function Oo(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function wf(e){return e.reduce((t,n)=>Q(t,n.meta),{})}function vf(e,t){let n=0,s=t.length;for(;n!==s;){const i=n+s>>1;hc(e,t[i])<0?s=i:n=i+1}const r=kf(e);return r&&(s=t.lastIndexOf(r,s-1)),s}function kf(e){let t=e;for(;t=t.parent;)if(mc(t)&&hc(e,t)===0)return t}function mc({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function Ao(e){const t=Je(Ws),n=Je(mi),s=Le(()=>{const c=we(e.to);return t.resolve(c)}),r=Le(()=>{const{matched:c}=s.value,{length:l}=c,u=c[l-1],p=n.matched;if(!u||!p.length)return-1;const f=p.findIndex(mn.bind(null,u));if(f>-1)return f;const d=No(c[l-2]);return l>1&&No(u)===d&&p[p.length-1].path!==d?p.findIndex(mn.bind(null,c[l-2])):f}),i=Le(()=>r.value>-1&&Af(n.params,s.value.params)),o=Le(()=>r.value>-1&&r.value===n.matched.length-1&&uc(n.params,s.value.params));function a(c={}){if(Of(c)){const l=t[we(e.replace)?"replace":"push"](we(e.to)).catch(jn);return e.viewTransition&&typeof document<"u"&&"startViewTransition"in document&&document.startViewTransition(()=>l),l}return Promise.resolve()}return{route:s,href:Le(()=>s.value.href),isActive:i,isExactActive:o,navigate:a}}function Sf(e){return e.length===1?e[0]:e}const Ef=es({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"},viewTransition:Boolean},useLink:Ao,setup(e,{slots:t}){const n=Fs(Ao(e)),{options:s}=Je(Ws),r=Le(()=>({[To(e.activeClass,s.linkActiveClass,"router-link-active")]:n.isActive,[To(e.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:n.isExactActive}));return()=>{const i=t.default&&Sf(t.default(n));return e.custom?i:Yn("a",{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:r.value},i)}}}),Vr=Ef;function Of(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function Af(e,t){for(const n in t){const s=t[n],r=e[n];if(typeof s=="string"){if(s!==r)return!1}else if(!Xe(r)||r.length!==s.length||s.some((i,o)=>i.valueOf()!==r[o].valueOf()))return!1}return!0}function No(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const To=(e,t,n)=>e??t??n,Nf=es({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:n}){const s=Je(Kr),r=Le(()=>e.route||s.value),i=Je(bo,0),o=Le(()=>{let l=we(i);const{matched:u}=r.value;let p;for(;(p=u[l])&&!p.components;)l++;return l}),a=Le(()=>r.value.matched[o.value]);ms(bo,Le(()=>o.value+1)),ms(tf,a),ms(Kr,r);const c=Vs();return Dn(()=>[c.value,a.value,e.name],([l,u,p],[f,d,b])=>{u&&(u.instances[p]=l,d&&d!==u&&l&&l===f&&(u.leaveGuards.size||(u.leaveGuards=d.leaveGuards),u.updateGuards.size||(u.updateGuards=d.updateGuards))),l&&u&&(!d||!mn(u,d)||!f)&&(u.enterCallbacks[p]||[]).forEach(g=>g(l))},{flush:"post"}),()=>{const l=r.value,u=e.name,p=a.value,f=p&&p.components[u];if(!f)return Ro(n.default,{Component:f,route:l});const d=p.props[u],b=d?d===!0?l.params:typeof d=="function"?d(l):d:null,_=Yn(f,Q({},b,t,{onVnodeUnmounted:v=>{v.component.isUnmounted&&(p.instances[u]=null)},ref:c}));return Ro(n.default,{Component:_,route:l})||_}}});function Ro(e,t){if(!e)return null;const n=e(t);return n.length===1?n[0]:n}const Tf=Nf;function Rf(e){const t=_f(e.routes,e),n=e.parseQuery||Zp,s=e.stringifyQuery||_o,r=e.history,i=An(),o=An(),a=An(),c=Bl(Nt);let l=Nt;en&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=yr.bind(null,E=>""+E),p=yr.bind(null,Bp),f=yr.bind(null,Wn);function d(E,B){let P,$;return pc(E)?(P=t.getRecordMatcher(E),$=B):$=E,t.addRoute($,P)}function b(E){const B=t.getRecordMatcher(E);B&&t.removeRoute(B)}function g(){return t.getRoutes().map(E=>E.record)}function _(E){return!!t.getRecordMatcher(E)}function v(E,B){if(B=Q({},B||c.value),typeof E=="string"){const y=_r(n,E,B.path),k=t.resolve({path:y.path},B),O=r.createHref(y.fullPath);return Q(y,k,{params:f(k.params),hash:Wn(y.hash),redirectedFrom:void 0,href:O})}let P;if(E.path!=null)P=Q({},E,{path:_r(n,E.path,B.path).path});else{const y=Q({},E.params);for(const k in y)y[k]==null&&delete y[k];P=Q({},E,{params:p(y)}),B.params=p(B.params)}const $=t.resolve(P,B),z=E.hash||"";$.params=u(f($.params));const h=jp(s,Q({},E,{hash:Pp(z),path:$.path})),m=r.createHref(h);return Q({fullPath:h,hash:z,query:s===_o?ef(E.query):E.query||{}},$,{redirectedFrom:void 0,href:m})}function w(E){return typeof E=="string"?_r(n,E,c.value.path):Q({},E)}function N(E,B){if(l!==E)return gn(ce.NAVIGATION_CANCELLED,{from:B,to:E})}function A(E){return D(E)}function L(E){return A(Q(w(E),{replace:!0}))}function F(E,B){const P=E.matched[E.matched.length-1];if(P&&P.redirect){const{redirect:$}=P;let z=typeof $=="function"?$(E,B):$;return typeof z=="string"&&(z=z.includes("?")||z.includes("#")?z=w(z):{path:z},z.params={}),Q({query:E.query,hash:E.hash,params:z.path!=null?{}:E.params},z)}}function D(E,B){const P=l=v(E),$=c.value,z=E.state,h=E.force,m=E.replace===!0,y=F(P,$);if(y)return D(Q(w(y),{state:typeof y=="object"?Q({},z,y.state):z,force:h,replace:m}),B||P);const k=P;k.redirectedFrom=B;let O;return!h&&Up(s,$,P)&&(O=gn(ce.NAVIGATION_DUPLICATED,{to:k,from:$}),et($,$,!0,!1)),(O?Promise.resolve(O):ne(k,$)).catch(S=>ht(S)?ht(S,ce.NAVIGATION_GUARD_REDIRECT)?S:At(S):J(S,k,$)).then(S=>{if(S){if(ht(S,ce.NAVIGATION_GUARD_REDIRECT))return D(Q({replace:m},w(S.to),{state:typeof S.to=="object"?Q({},z,S.to.state):z,force:h}),B||k)}else S=he(k,$,!0,m,z);return _e(k,$,S),S})}function x(E,B){const P=N(E,B);return P?Promise.reject(P):Promise.resolve()}function G(E){const B=Wt.values().next().value;return B&&typeof B.runWithContext=="function"?B.runWithContext(E):E()}function ne(E,B){let P;const[$,z,h]=nf(E,B);P=wr($.reverse(),"beforeRouteLeave",E,B);for(const y of $)y.leaveGuards.forEach(k=>{P.push(Rt(k,E,B))});const m=x.bind(null,E,B);return P.push(m),Ve(P).then(()=>{P=[];for(const y of i.list())P.push(Rt(y,E,B));return P.push(m),Ve(P)}).then(()=>{P=wr(z,"beforeRouteUpdate",E,B);for(const y of z)y.updateGuards.forEach(k=>{P.push(Rt(k,E,B))});return P.push(m),Ve(P)}).then(()=>{P=[];for(const y of h)if(y.beforeEnter)if(Xe(y.beforeEnter))for(const k of y.beforeEnter)P.push(Rt(k,E,B));else P.push(Rt(y.beforeEnter,E,B));return P.push(m),Ve(P)}).then(()=>(E.matched.forEach(y=>y.enterCallbacks={}),P=wr(h,"beforeRouteEnter",E,B,G),P.push(m),Ve(P))).then(()=>{P=[];for(const y of o.list())P.push(Rt(y,E,B));return P.push(m),Ve(P)}).catch(y=>ht(y,ce.NAVIGATION_CANCELLED)?y:Promise.reject(y))}function _e(E,B,P){a.list().forEach($=>G(()=>$(E,B,P)))}function he(E,B,P,$,z){const h=N(E,B);if(h)return h;const m=B===Nt,y=en?history.state:{};P&&($||m?r.replace(E.fullPath,Q({scroll:m&&y&&y.scroll},z)):r.push(E.fullPath,z)),c.value=E,et(E,B,P,m),At()}let ae;function Ot(){ae||(ae=r.listen((E,B,P)=>{if(!Mt.listening)return;const $=v(E),z=F($,Mt.currentRoute.value);if(z){D(Q(z,{replace:!0,force:!0}),$).catch(jn);return}l=$;const h=c.value;en&&Yp(yo(h.fullPath,P.delta),Ys()),ne($,h).catch(m=>ht(m,ce.NAVIGATION_ABORTED|ce.NAVIGATION_CANCELLED)?m:ht(m,ce.NAVIGATION_GUARD_REDIRECT)?(D(Q(w(m.to),{force:!0}),$).then(y=>{ht(y,ce.NAVIGATION_ABORTED|ce.NAVIGATION_DUPLICATED)&&!P.delta&&P.type===Ur.pop&&r.go(-1,!1)}).catch(jn),Promise.reject()):(P.delta&&r.go(-P.delta,!1),J(m,$,h))).then(m=>{m=m||he($,h,!1),m&&(P.delta&&!ht(m,ce.NAVIGATION_CANCELLED)?r.go(-P.delta,!1):P.type===Ur.pop&&ht(m,ce.NAVIGATION_ABORTED|ce.NAVIGATION_DUPLICATED)&&r.go(-1,!1)),_e($,h,m)}).catch(jn)}))}let zt=An(),be=An(),ee;function J(E,B,P){At(E);const $=be.list();return $.length?$.forEach(z=>z(E,B,P)):console.error(E),Promise.reject(E)}function ft(){return ee&&c.value!==Nt?Promise.resolve():new Promise((E,B)=>{zt.add([E,B])})}function At(E){return ee||(ee=!E,Ot(),zt.list().forEach(([B,P])=>E?P(E):B()),zt.reset()),E}function et(E,B,P,$){const{scrollBehavior:z}=e;if(!en||!z)return Promise.resolve();const h=!P&&Wp(yo(E.fullPath,0))||($||!P)&&history.state&&history.state.scroll||null;return _a().then(()=>z(E,B,h)).then(m=>m&&zp(m)).catch(m=>J(m,E,B))}const xe=E=>r.go(E);let Yt;const Wt=new Set,Mt={currentRoute:c,listening:!0,addRoute:d,removeRoute:b,clearRoutes:t.clearRoutes,hasRoute:_,getRoutes:g,resolve:v,options:e,push:A,replace:L,go:xe,back:()=>xe(-1),forward:()=>xe(1),beforeEach:i.add,beforeResolve:o.add,afterEach:a.add,onError:be.add,isReady:ft,install(E){E.component("RouterLink",Vr),E.component("RouterView",Tf),E.config.globalProperties.$router=Mt,Object.defineProperty(E.config.globalProperties,"$route",{enumerable:!0,get:()=>we(c)}),en&&!Yt&&c.value===Nt&&(Yt=!0,A(r.location).catch($=>{}));const B={};for(const $ in Nt)Object.defineProperty(B,$,{get:()=>c.value[$],enumerable:!0});E.provide(Ws,Mt),E.provide(mi,da(B)),E.provide(Kr,c);const P=E.unmount;Wt.add(E),E.unmount=function(){Wt.delete(E),Wt.size<1&&(l=Nt,ae&&ae(),ae=null,c.value=Nt,Yt=!1,ee=!1),P()}}};function Ve(E){return E.reduce((B,P)=>B.then(()=>G(P)),Promise.resolve())}return Mt}function Wh(){return Je(Ws)}function If(e){return Je(mi)}const Cf=`# ─────────────────────────────────────────────────────────────────────────────
...
# или вывести в общий членский кошелёк (w.wal.member) через o.mkt.fefund.
#
...
actions:
  - name: marketplace::submretrn
    ...
    purpose: >
      ...
      на гарантийный возврат: указывает причину (некондиция / истёк срок /
      иное), прикладывает фотографии товара, ссылается на конкретный АПП
      выдачи. Контракт создаёт запись return_request в статусе
      pending_review. Заявление возможно только до истечения гарантийного
      срока, указанного поставщиком в Offer'е (после истечения UI скрывает
      кнопку «Гарантийный возврат», а контракт отклоняет действие).
  ...
  - name: marketplace::decretremot
    ...
    role: progress
    purpose: >
      Председатель КУ удалённо рассматривает заявление (фото + описание)
      и принимает одно из двух решений: «Одобрить визит» (возврат переходит
      в approved_for_visit, заказчику отправляется multi-channel push
      «принесите продукцию на КУ») либо «Отказать удалённо» (возврат
      переходит в rejected_remote, спор уходит в отдельную процедуру
      вне MVP). Без операций по кошелькам — это процедурное действие.
  ...
  - name: marketplace::decretvisit
    ...
    role: closer
    purpose: >
      Председатель КУ очно осматривает имущество, принесённое заказчиком,
      и принимает финальное решение: «Принять возврат» (return_accepted)
      либо «Отказать на месте» (rejected_at_ku, спор уходит в отдельную
      процедуру). При принятии возврата контракт атомарно применяет
...
states:
  - name: pending_review
    ...
    description: >
      Заявление подано пайщиком, председатель КУ получил push-уведомление
      и должен принять решение об одобрении визита либо отказе удалённо.
    kind: normal

  - name: approved_for_visit
    human: Одобрен визит
    description: >
      Председатель одобрил очное рассмотрение по фото. Пайщик получил
      multi-channel push «принесите продукцию на КУ». Ждёт визита
      пайщика и очного осмотра.
    kind: normal
  ...
  - name: return_accepted
    ...
    description: >
      ...
      o.mkt.fefund — там средства универсальны между программами.
      Дальнейшая судьба возвращённого имущества (возврат поставщику,
      перепоставка, списание) — определяется регламентом кооператива
      и нормами закона о защите прав потребителей через отдельную
      процедуру вне Стола заказов; в MVP вернувшееся имущество
      остаётся на складе КУ как материальный остаток.
    kind: final

  - name: rejected_remote
    human: Отказано удалённо
    description: >
      Председатель отказал удалённо после рассмотрения фото. Пайщику
      отправлено уведомление с причиной отказа. Спор уходит в отдельную
      процедуру вне MVP. Запись заявления остаётся для аудита; имущество
      и средства не двигаются.
    kind: final

  - name: rejected_at_ku
    human: Отказано на месте
    description: >
      Председатель отказал после очного осмотра имущества. Пайщик
      получил отказ; имущество забирает обратно. Спор уходит в отдельную
      процедуру вне MVP. Запись заявления остаётся для аудита; имущество
      и средства не двигаются.
    kind: final
  ...
  steps:
    - step: 1
      ...
      description: >
        ...
        «Гарантийный возврат» (кнопка доступна, пока не истёк гарантийный
        срок Offer'а). Указывает причину (некондиция / истёк срок / иное),
        прикладывает фотографии товара, выбирает АПП выдачи, к которому
        привязано заявление. Контракт submretrn создаёт запись
        return_request со статусом pending_review. Председатель КУ-получателя
        получает push-уведомление о новом заявлении.
      pre:
        - Order заявителя в статусе received.
        - Гарантийный срок Offer'а ещё не истёк.
        - Приложены фото и указана причина.
      post:
        - Создана запись return_request в pending_review.
        - Председатель КУ уведомлён push'ом.

    - step: 2
      title: Удалённое рассмотрение председателем
      actor: chairman
      action: marketplace::decretremot
      description: >
        Председатель КУ открывает заявление в столе админа КУ, видит фото
        и описание. Принимает одно из двух решений: (а) «Одобрить визит» —
        return_request переходит в approved_for_visit, пайщику отправляется
        multi-channel push «принесите продукцию на КУ»; (б) «Отказать
        удалённо» — return_request переходит в rejected_remote, пайщику
        отправляется уведомление с причиной отказа. Без операций по
        кошелькам.
      pre:
        - return_request в pending_review.
        - Председатель КУ авторизован.
      post:
        - return_request в approved_for_visit либо rejected_remote.
        - Пайщик уведомлён push'ом.
    ...
    - step: 3
      ...
      action: marketplace::decretvisit
      description: >
        Пайщик приходит на КУ с продукцией, передаёт председателю.
        Председатель осматривает имущество на месте и выносит финальное
        решение: (а) «Принять возврат» — return_request переходит в
        return_accepted; контракт атомарно применяет ledger2-операцию
        o.mkt.return — compensating forward выдаче: (1) имущество
        ...
        либо вывести в общий членский кошелёк (w.wal.member) через
        отдельную операцию o.mkt.fefund. (б) «Отказать на месте» — return_request переходит
        в rejected_at_ku, пайщик забирает имущество обратно, спор уходит
  ...
  alternatives:
    - branch: Истечение гарантийного срока
      ...
      description: >
        ...
        выполнении при попытке прямого вызова. Пайщик не может инициировать
        возврат через стандартный процесс; альтернативные пути — отдельная
        претензионная процедура по регламенту кооператива (вне MVP).
    ...
    - branch: Отказ удалённо
      ...
      actor: chairman
      description: >
        Председатель отказал по фото без визита (редкий случай — например,
        когда товар очевидно не подпадает под гарантию). return_request
        в rejected_remote, пайщику push с причиной. Спор уходит в отдельную
        процедуру вне MVP. Имущество и средства не двигаются.
    ...
    - branch: Отказ на месте
      ...
      description: >
        ...
        не носит гарантийный характер). return_request в rejected_at_ku,
        пайщик забирает имущество обратно. Спор — отдельная процедура.
        Имущество и средства не двигаются.
...
#   • o.wal.fconv   — конвертация цифрового рубля → общий членский пайщика
#                     (TRANSFER, w.wal.share → w.wal.member,
#                      Дт 80 / Кт 86) — conditional, только если на
#                     w.wal.member.available заказчика не хватает
#   • o.mkt.ftarg   — целевое назначение членского взноса в программу
#                     (TRANSFER, w.wal.member → w.mkt.member) — conditional,
...
#   • o.mkt.fefund  — вывод из программы в общий членский кошелёк пайщика
#                     (TRANSFER, w.mkt.member → w.wal.member) —
...
purpose: >
  ...
  принимает товар на склад и затем выдаёт заказчику. Используется, когда
  пайщики хотят провести сделку через кооператив, а не через обычный
  маркетплейс — кооператив выступает доверенным звеном и оформляет
  понятный документооборот по каждой сделке. Это позволяет пайщикам
...
actions:
  - name: marketplace::createorder
    ...
    purpose: >
      ...
      количества и КУ получения. Контракт атомарно выполняет трёхступенчатую
      серию: o.wal.fconv (paevoy → общий членский пайщика w.wal.member,
      Дт 80 / Кт 86) → o.mkt.ftarg (общий членский → программный членский
      w.mkt.member по программе Marketplace) → o.mkt.fblock (блокировка
      суммы под Order на программном кошельке, available → blocked). Первые
      две операции — conditional: вызываются только если на соответствующем
      кошельке заказчика не хватает available; третья (BLOCK) — всегда.
      Backend валидирует лимит стоимости корзины (100 000 ₽ — упрощённый
      налоговый порог ТМЦ) до вызова контракта.
  ...
  - name: marketplace::cancelorder
    ...
    purpose: >
      ...
      выполняет o.mkt.funblk (разблокировка) — сумма становится доступной
      на программном кошельке заказчика w.mkt.member.available и может
      быть потрачена на следующий заказ в Столе заказов. Если пайщик хочет
      вывести её в общий членский кошелёк (w.wal.member) для использования
      в других программах — это отдельное явное действие через o.mkt.fefund,
      не часть авто-flow отмены. Order переходит в статус cancelled.
  ...
  - name: marketplace::expirecycle
    ...
    role: progress
    purpose: >
      Backend по расписанию (по окончании окна Offer'а) проверяет, достигнут
      ли минимальный порог поставки. Если порог не достигнут — для каждого
      Order'а в этом окне контракт выполняет o.mkt.funblk (средства остаются
      на w.mkt.member.available заказчика — могут быть потрачены на новый
      заказ или выведены отдельно), заявки переходят в статус cancelled.
      Если порог достигнут — формируется консолидированная заявка поставщику
      (off-chain) и Order'ы остаются в статусе active до акцепта.
  ...
  - name: marketplace::acceptbatch
    ...
    purpose: >
      ...
      Backend'а (один или несколько Order'ов под один Offer). Контракт
      публикует пару Order+Offer on-chain, статус каждого Order'а из партии
      переходит в accepted. Операций по кошелькам не производится (средства
      уже заблокированы при создании Order'а).
  ...
  - name: marketplace::declinebatch
    ...
    purpose: >
      ...
      on-chain. Контракт для каждого Order'а из партии выполняет o.mkt.funblk
      (средства остаются на w.mkt.member.available заказчика), заявки
      переходят в cancelled. Без штрафных санкций на стороне контракта
      (договорная ответственность вне MVP).
  ...
  - name: marketplace::prepship
    ...
    purpose: >
      ...
      и выбирает модель приёмки: A (самовывоз) или B (через экспедитора).
      В модели B контракт фиксирует факт формирования ТТН и сохраняет ссылку
      на документ; экспедитор работает по бумаге. Контракт выполняет жёсткий
      акцепт: проверяет, что состав Shipment'а равен составу акцептованной
      партии (замены номенклатуры запрещены). Без операций по кошелькам.
  ...
  - name: marketplace::signsupp
    ...
    purpose: >
      ...
      takeover поставщика после либо непосредственного скана штрих-кода
      председателем КУ (модель A), либо после фотофиксации скорректированной
      ТТН председателем (модель B, дистанционно). Order переходит в статус
      supply_prepared. На этом этапе смарт-контракт **блокирует выдачу** —
      пока нет финальной подписи председателя, имущество физически на складе,
      но юридически не оприходовано. Без операций по кошелькам.
  ...
  - name: marketplace::signchair
    ...
    role: progress
    purpose: >
      Председатель КУ ставит вторую (финальную) подпись на АПП приёмки.
      Это закрывающее действие фазы приёмки: контракт атомарно применяет
      две ledger2-операции — o.mkt.purch (Дт 10 / Кт 86 — имущество принято
      на склад КУ-приёмщика, ACCOUNT_ONLY: только проводка, без кошельковых
      движений — имущество учитывается аналитикой по счёту 10) и o.mkt.payspl
      (Дт 86 / Кт 51 — оплата поставщику с расчётного счёта в w.mkt.payout).
      Order переходит в статус accepted_to_coop, выдача пайщику разблокирована.
  ...
  - name: marketplace::signiss1
    ...
    role: progress
    purpose: >
      Председатель КУ ставит первую подпись на АПП выдачи (готов передать
      имущество заказчику). Order переходит в статус ready_to_receive,
      Backend отправляет multi-channel push заказчику «заказ готов на ПВЗ».
      Без операций по кошелькам.
  ...
  - name: marketplace::signiss2
    ...
    purpose: >
      ...
      → o.mkt.funblk на разницу (остаётся available на w.mkt.member заказчика);
      факт больше → доконвертация трёхступенчатой серией (o.wal.fconv +
      o.mkt.ftarg + o.mkt.fblock на разницу — первые две conditional, как
      в createorder). Order переходит в финальный статус received.
...
states:
  - name: active
    ...
    description: >
      Order создан, средства заказчика прошли трёхступенчатую серию
      o.wal.fconv → o.mkt.ftarg → o.mkt.fblock и заблокированы на программном
      кошельке w.mkt.member. Заявка ждёт окончания цикла отсечки и акцепта
      поставщика.
    kind: normal
  ...
  - name: cancelled
    human: Отменено
    description: >
      Order аннулирован — либо заказчиком до акцепта (cancelorder), либо
      Backend'ом по истечении цикла без достижения порога (expirecycle),
      либо поставщиком при отказе от партии (declinebatch). Применена
      o.mkt.funblk — сумма разблокирована на w.mkt.member пайщика и стала
      доступной (.available). Пайщик может потратить её на следующий заказ
      в Столе заказов либо вывести в общий членский кошелёк через отдельное
      явное действие (o.mkt.fefund). Запись Order'а либо удаляется, либо
      помечается финальным статусом (зависит от реализации).
    kind: final
  ...
  - name: supply_prepared
    ...
    description: >
      Поставщик поставил первую подпись на АПП приёмки. Имущество физически
      на КУ, но юридически не оприходовано. Смарт-контракт блокирует выдачу
      пайщикам. Ждёт финальную подпись председателя.
    kind: normal

  - name: accepted_to_coop
    human: Принято кооперативом
    description: >
      Председатель закрыл АПП приёмки. Применены o.mkt.purch (имущество
      на склад через проводку Дт 10 / Кт 86) и o.mkt.payspl (оплата
      поставщику в w.mkt.payout, Дт 86 / Кт 51). Имущество легально
      на складе КУ. Ждёт отметки готовности к выдаче от оператора КУ.
    kind: normal

  - name: ready_to_receive
    human: Готово к выдаче
    description: >
      Председатель открыл АПП выдачи. Заказчику отправлен push «заказ готов
      на ПВЗ». Заявка ждёт визита заказчика и его подписи на устройстве
      оператора.
    kind: normal
  ...
  - name: received
    ...
    description: >
      ...
      открыто (старт процесса p.mkt.return при появлении заявления).
    kind: final
...
transitions:
  ...
  - from: ready_to_receive
    ...
    guards:
      ...
      - При расхождении факт vs заказ сначала выполнены корректирующие операции (o.mkt.funblk на остаток если факт меньше; o.wal.fconv + o.mkt.ftarg + o.mkt.fblock на разницу если факт больше — первые две conditional; в пределах допустимого отрицательного баланса паевого ≤5%).
...
scenario:
  steps:
    - step: 1
      ...
      description: >
        ...
        своего кооператива, указывает количество и КУ получения. Backend
        валидирует, что суммарная стоимость не превышает 100 000 ₽ (упрощённый
        налоговый порог ТМЦ). Контракт createorder атомарно выполняет
        трёхступенчатую серию: (1) o.wal.fconv — paevoy → общий членский
        пайщика (w.wal.share → w.wal.member, Дт 80 / Кт 86), conditional —
        вызывается только если на w.wal.member.available заказчика не
        хватает; (2) o.mkt.ftarg — целевое назначение членского взноса
        в программу Marketplace (w.wal.member → w.mkt.member), тоже
        conditional; (3) o.mkt.fblock — блокировка суммы order.total_cost
        под Order на программном кошельке (available -= total_cost,
        blocked += total_cost), всегда. Order переходит в статус active.
      pre:
        - Пайщик имеет статус active.
        - Подписано Соглашение ЦПП «Стол заказов» (программный кошелёк w.mkt.member открыт).
        - Совокупных средств заказчика по цепочке w.wal.share → w.wal.member → w.mkt.member достаточно.
        - Стоимость корзины ≤ 100 000 ₽.
      post:
        - Order создан со статусом active.
        - На w.mkt.member пайщика заблокирована сумма order.total_cost.
        - В журнале опубликованы операции серии (от 1 до 3 — в зависимости от того, какие conditional шаги отработали).

    - step: 2
      title: Цикл отсечки и консолидация заявок
      actor: backend
      action: marketplace::expirecycle
      description: >
        Backend Marketplace по истечении окна Offer'а собирает все Order'ы
        в этом цикле и проверяет минимальный порог поставки. Если порог
        достигнут — формируется консолидированная заявка поставщику
        (off-chain) и заявки остаются в статусе active. Если порог не
        достигнут — для каждого Order'а контракт выполняет o.mkt.funblk:
        сумма разблокируется на w.mkt.member заказчика (.available),
        остаётся в программе и может быть потрачена на следующий заказ.
        Если пайщик хочет вывести её в общий членский — отдельное явное
        действие (o.mkt.fefund). Order'ы переходят в статус cancelled,
        заказчики получают push-уведомление об отмене.
      pre:
        - Окно цикла отсечки истекло.
      post:
        - Если порог достигнут — Order'ы остаются active, поставщику отправлено уведомление о консолидированной заявке.
        - Если порог не достигнут — все Order'ы переведены в cancelled, средства разблокированы на w.mkt.member.available каждого заказчика.
    ...
    - step: 3
      ...
      description: >
        ...
        и нажимает «Акцептовать». Контракт публикует пару Order+Offer
        on-chain — это служит юридическим подтверждением, что поставщик
        обязан произвести поставку. Все Order'ы из партии переходят в
        статус accepted. Без операций по кошелькам.
      pre:
        - Минимальный порог достигнут.
        - Поставщик владеет Offer'ом, на основе которого сформирована партия.
      post:
        - Order'ы переведены в accepted.
        - Пара Order+Offer опубликована on-chain.
    ...
    - step: 4
      ...
      description: >
        ...
        Order'ы, сгруппированные по КУ-получателям. Выбирает режим: A
        (самовывоз — поставщик сам привезёт груз на КУ) или B (через
        экспедитора с бумажной ТТН). В модели B группирует Order'ы по
        машинам/экспедиторам, на каждый КУ формируется отдельная ТТН;
        контракт фиксирует факт формирования ТТН и сохраняет ссылку
        на документ. Жёсткий акцепт: контракт проверяет, что состав
        Shipment'а равен составу акцептованной партии (замены номенклатуры
        запрещены).
      pre:
        - Order'ы в статусе accepted.
        - Состав Shipment'а соответствует акцепту.
      post:
        - Shipment подготовлен в выбранной модели A или B.
        - В модели B сформирована и распечатана ТТН на принтере поставщика.

    - step: 5
      title: Доставка и приёмка — модель A (самовывоз)
      actor: chairman
      action: marketplace::signsupp
      description: >
        Поставщик прибыл на КУ. Председатель сканирует штрих-код поставщика
        — открывается карточка Shipment'а с ожидаемыми параметрами.
        Председатель корректирует quantity и/или price при необходимости и
        нажимает «Подтверждаю» (без ЭЦП). На устройство поставщика
        отправляется push-takeover в режиме full-screen с кнопкой «Передал».
        Поставщик нажимает «Передал» — это первая подпись АПП приёмки.
        Order переходит в статус supply_prepared. Без операций по кошелькам.
      pre:
        - Shipment'у соответствует Order в статусе accepted.
        - Поставщик и председатель физически на КУ.
      post:
        - АПП приёмки имеет первую подпись поставщика.
        - Order в статусе supply_prepared (выдача пайщикам ЗАБЛОКИРОВАНА).

    - step: 6
      title: Закрытие приёмки председателем — финальная подпись
      actor: chairman
      action: marketplace::signchair
      description: >
        Председатель нажимает «Закрыть» — ставит вторую (финальную) подпись
        АПП приёмки. Это закрывающее действие фазы приёмки: контракт
        атомарно применяет две ledger2-операции — o.mkt.purch (Дт 10 /
        Кт 86, ACCOUNT_ONLY — только проводка: имущество принято на склад
        КУ-приёмщика, отслеживается бухгалтерской аналитикой по счёту 10
        per-КУ) и o.mkt.payspl (Дт 86 / Кт 51, TRANSFER ∅ → w.mkt.payout
        — оплата поставщику с расчётного счёта). Order переходит в
        accepted_to_coop, выдача пайщикам разблокирована. Заказчик ещё
        не уведомлён — выдача активируется отдельным шагом.
      pre:
        - АПП приёмки имеет первую подпись поставщика.
        - Председатель имеет роль оператора КУ-получателя.
      post:
        - Order в статусе accepted_to_coop.
        - В бухгалтерии — Дт 10 / Кт 86 на сумму order.total_cost (КУ-приёмщик в аналитике).
        - Поставщик получил оплату на w.mkt.payout.
        - В журнале опубликованы o.mkt.purch и o.mkt.payspl.
    ...
    - step: 7
      ...
      action: marketplace::signiss1
      description: >
        Оператор КУ маркирует принятое имущество внутренним штрих-кодом /
        QR-кодом для учёта на складе участка (печатает на принтере КУ).
        Затем открывает АПП выдачи — ставит первую подпись (готовность
        передать имущество). Order переходит в статус ready_to_receive,
        Backend отправляет multi-channel push заказчику «заказ готов
        на ПВЗ». Без операций по кошелькам.
      pre:
        - Order в статусе accepted_to_coop.
        - Имущество физически на складе КУ.
      post:
        - Имущество промаркировано.
        - Order в статусе ready_to_receive.
    ...
    - step: 8
      ...
      description: >
        ...
        Оператор сверяет факт vs заказ и фиксирует один из трёх вариантов:
        (а) факт = заказ — без корректировок; (б) факт меньше заказа
        (например, развесной товар: 90 г вместо 100 г) — контракт
        предварительно выполняет o.mkt.funblk на разницу (остаётся
        available на w.mkt.member заказчика, расходуется в следующих
        заказах в программе); (в) факт больше заказа — контракт выполняет
        доконвертацию трёхступенчатой серией o.wal.fconv + o.mkt.ftarg +
        o.mkt.fblock на разницу (первые две conditional, как в createorder);
        при пустом цифровом паевом допускается отрицательный баланс ≤5%
        либо пайщик пополняет паевой через кассира. Заказчик подписывает
        АПП выдачи на устройстве оператора — это финальная (вторая) подпись.
        Контракт применяет o.mkt.consum (REVOKE — w.mkt.member пайщика
        .blocked → 0; проводка Дт 86 / Кт 10 — расход целевых средств на
        расход имущества). Order переходит в финальный статус received.
      pre:
        - Order в статусе ready_to_receive.
        - Заказчик присутствует на КУ.
      post:
  ...
  alternatives:
    - branch: Доставка и приёмка — модель B (экспедитор + ТТН)
      at_step: 5
      action: marketplace::signsupp
      actor: chairman
      description: >
        Бумажная ступень: председатель и экспедитор очно сверяют состав
        груза по ТТН. При расхождении вычёркивают позиции прямо в ТТН
        ручкой, экспедитор расписывается под корректировкой, председатель
        ставит подпись + дату + печать КУ. Экспедитор забирает экземпляр
        ТТН + забракованное обратно и уезжает. Цифровая ступень
        (дистанционно с поставщиком, не срочно): председатель в приложении
        открывает «Приёмка по ТТН» → фотофиксирует исправленную ТТН и/или
        вручную переносит корректировки → формируется скорректированный
        АПП приёмки → push-takeover поставщику с full-screen-окном →
        поставщик подписывает первой подписью (signsupp). Допустимый
        интервал между уходом экспедитора и подписанием поставщика —
        не более 8 часов с момента ухода экспедитора. После превышения
        Order остаётся в supply_prepared, выдача пайщикам по-прежнему
        заблокирована, претензионная процедура запускается по регламенту
        кооператива.
      pre:
        - Shipment в модели B (экспедитор + ТТН).
        - Бумажная ТТН подписана председателем + экспедитором + печатью КУ.
      post:
        - АПП приёмки на основе фотофиксации ТТН подписан поставщиком (первая подпись).
        - Order в статусе supply_prepared (выдача пайщикам ЗАБЛОКИРОВАНА).
        - Дальнейшие шаги — те же, что в модели A: signchair → signiss1 → signiss2.
    ...
    - branch: Отказ поставщика от корректировки (модель B)
      ...
      description: >
        ...
        претензионная транзакция со ссылкой на оригинальный акцепт vs
        скорректированный АПП. Дальнейшее решение — ручная договорная
        процедура по регламенту кооператива (штрафные санкции, возврат,
        перепоставка). Системные формы санкций в MVP не реализуются.
        Order остаётся в статусе supply_prepared, выдача пайщикам
        не разблокирована. По истечении регламентного срока возможна
        отдельная процедура отмены поставки.
    ...
    - branch: Отмена заказчиком до акцепта
      ...
      description: >
        ...
        o.mkt.funblk: сумма разблокируется на w.mkt.member пайщика
        (.available), остаётся в программе для следующего заказа. Если
        пайщик хочет вывести в общий членский — отдельное явное действие
        (o.mkt.fefund). Order переходит в cancelled.
    ...
    - branch: Отказ поставщика от партии
      ...
      description: >
        ...
        Order'а выполняет o.mkt.funblk, заявки переходят в cancelled,
        средства разблокированы на w.mkt.member.available каждого заказчика.
        Заказчики получают push-уведомление об отмене.
    ...
    - branch: Цикл истёк без достижения порога
      ...
      actor: backend
      description: >
        Backend по расписанию обнаруживает, что окно Offer'а истекло без
        достижения минимального порога поставки. Для каждого Order'а
        в этом окне контракт выполняет o.mkt.funblk, заявки переходят
        в cancelled, средства разблокированы на w.mkt.member.available.
        Заказчики получают push.
...
operations:
  ...
  - ledger_code: o.mkt.ftarg
    human_name: Целевое назначение членского взноса в программу Marketplace
    wallet_op: TRANSFER
    # L1 — внутри 86 счёта между аналитиками (TBD-Standardization)
    debit: 86                      # Целевое финансирование (программа Marketplace)
    credit: 86                     # Целевое финансирование (общий членский пайщика)
    # L2 — кошельки кооператива (агрегаты, по аналитике программ)
    ...
    # L3 — у того же пайщика available перетекает с w.wal.member на w.mkt.member;
    # рендерим сторону получателя; на источнике подразумевается -X
    user_wallet: w.mkt.member
    user_ref: order.customer
    available_delta: +order.total_cost
    blocked_delta: null
    ...
    description: >
      ...
      недостача. По бухгалтерии — внутрисчётное движение по 86 (членский
      фонд кооператива), меняется аналитика «программа: marketplace»; в
      ledger2 это отражено как L2-перевод между двумя именованными агрегатами.
      (TBD-Standardization: проводка Дт 86 / Кт 86 фиксируется как baseline;
      возможна альтернатива через null/null если бухгалтерия посчитает
      перенос аналитики не требующим явной двойной записи.)
  ...
  - ledger_code: o.mkt.funblk
    ...
    description: >
      ...
      (w.wal.member) — отдельное явное действие пайщика через o.mkt.fefund,
  ...
  - ledger_code: o.mkt.fefund
    ...
    wallet_op: TRANSFER
    # L1 — внутри 86 счёта между аналитиками (TBD-Standardization)
    debit: 86                      # Целевое финансирование (общий членский пайщика)
    credit: 86                     # Целевое финансирование (программа Marketplace)
    # L2 — обратный перенос аналитики
    ...
    # L3 — у того же пайщика available перетекает с w.mkt.member на w.wal.member
    user_wallet: w.wal.member
    user_ref: order.customer
    available_delta: +order.total_cost
    blocked_delta: null
    ...
    triggered_by: TBD
    description: >
      Зеркало o.mkt.ftarg. Явное действие пайщика — вывести членский взнос
      ...
      инициатива вывода — у пайщика. Внутрисчётное движение по 86
      (TBD-Standardization).
  ...
  - ledger_code: o.mkt.purch
    ...
    description: >
      ...
      кошелька. Срабатывает атомарно с o.mkt.payspl. WalletOp ACCOUNT_ONLY —
  ...
  - ledger_code: o.mkt.consum
    ...
    description: >
      ...
      операции (o.mkt.funblk на остаток если факт меньше; o.wal.fconv +
      o.mkt.ftarg + o.mkt.fblock на разницу если факт больше — первые две
...
related:
  ...
  - process_type: p.wal.depo
    ...
    note: >
      ...
      пайщика (o.wal.fconv → w.wal.member), затем в программный членский
      Marketplace (o.mkt.ftarg → w.mkt.member), и блокируются под Order
      (o.mkt.fblock).
...
actions:
  - name: marketplace::propwroff
    ...
    role: opener
    purpose: >
      Backend по крон-расписанию (раз в месяц по умолчанию) собирает позиции
      на складах КУ кооператива, удовлетворяющие критериям утилизации:
      товары с истекшим сроком и не выданные первичному заказчику, малооценка,
      позиции, помеченные оператором КУ. Контракт propwroff создаёт запись
      writeoff_proposal со статусом draft и публикует её как пункт повестки
      совета (через мост к процессу sov.decision/sov.authpkg). Без операций
      по кошелькам — это только формирование проекта.
  ...
  - name: marketplace::execwroff
    ...
    role: closer
    purpose: >
      Совет принял положительное решение по проекту утилизации (протокол
      sov.decision). Контракт execwroff применяет ledger2-операцию
      o.mkt.wroff к каждой позиции из списка: имущество списывается со
      склада КУ через транзит счёта 91 (Дт 91 / Кт 10 + Дт 86 / Кт 91).
      writeoff_proposal переходит в финальный статус executed.
  ...
  - name: marketplace::declwroff
    ...
    role: reject
    purpose: >
      Совет принял отрицательное решение либо отложил рассмотрение. Контракт
      declwroff помечает writeoff_proposal как rejected; позиции остаются
      на складе и попадут в следующий цикл утилизации либо в альтернативный
      путь (переуступка по сниженной цене — Phase 2). Без операций по
      кошелькам.
...
states:
  - name: draft
    ...
    description: >
      Backend сформировал список позиций под утилизацию и подал проект
      решения в повестку совета. Ждёт рассмотрения советом по протоколу.
    kind: normal

  - name: executed
    human: Списание исполнено
    description: >
      Совет принял положительное решение, контракт исполнил списание.
      Применена o.mkt.wroff к каждой позиции из списка: имущество
      списано со склада через транзит счёта 91 (Дт 91 / Кт 10 + Дт 86 /
      Кт 91); сумма списанного по счёту 10 КУ-источника уменьшена.
      Журнал содержит запись о каждой списанной позиции. По кошелькам
      пайщиков движений не было.
    kind: final

  - name: rejected
    human: Отклонено советом
    description: >
      Совет отклонил проект решения либо отложил рассмотрение. Позиции
      остаются на складе КУ; они либо попадут в следующий цикл утилизации,
      либо уйдут в альтернативный путь переуступки по сниженной цене
      (Phase 2). По кошелькам и проводкам движений не было.
    kind: final
...
scenario:
  steps:
    - step: 1
      ...
      action: marketplace::propwroff
      description: >
        Backend Marketplace по расписанию (по умолчанию ежемесячно, конкретная
        дата согласовывается с бухгалтером — настраивается в админ-панели
        кооператива) опрашивает все КУ кооператива и собирает позиции,
        подлежащие утилизации: (а) товары, у которых истёк гарантийный
        срок и которые не были выданы первичному заказчику; (б) товары,
        вернувшиеся через гарантийный возврат и оставшиеся как материальный
        остаток; (в) позиции, помеченные оператором КУ как малооценка.
        Контракт propwroff создаёт writeoff_proposal со статусом draft,
        прикрепляет список позиций (per-КУ) и публикует пункт повестки
        совета. Без операций по кошелькам.
      pre:
        - Сработал крон утилизации.
        - Найден непустой список позиций под списание.
      post:
        - Создана запись writeoff_proposal в draft.
    ...
    - step: 2
      ...
      action: marketplace::execwroff
      description: >
        Председатель / член совета вносит проект решения на ближайшее
        заседание (или заочное голосование). Совет рассматривает список
        позиций и принимает протокол. При положительном решении контракт
        execwroff применяет ledger2-операцию o.mkt.wroff к каждой позиции
        из списка с составной проводкой: (1) Дт 91 / Кт 10 — списание
        со склада на «Прочие расходы»; (2) Дт 86 / Кт 91 — закрытие 91
        на ЦФ программы. Транзит через 91 фиксирует, что имущество
        безвозвратно исчезло из кооператива. По кошелькам пайщиков
        движений не происходит. writeoff_proposal переходит в финальный
        статус executed.
      pre:
        - writeoff_proposal в draft.
        - Совет принял положительное решение по протоколу с подписанным authorization.
      post:
        - writeoff_proposal в финальном статусе executed.
        - На счёте 10 КУ-источника -value (по каждой списанной позиции).
        - В журнале опубликована o.mkt.wroff (одна или несколько — по позициям).
        - Бухгалтерский баланс закрыт через транзит 91.
  ...
  alternatives:
    - branch: Совет отклонил проект
      ...
      actor: council
      description: >
        Совет принял отрицательное решение по проекту (например, требует
        дополнительной экспертизы) либо отложил рассмотрение. Контракт
        declwroff помечает writeoff_proposal как rejected. Позиции
        остаются на складе и либо попадут в следующий цикл утилизации
        (через месяц), либо уйдут в альтернативный процесс переуступки
        по сниженной цене (вне MVP, Phase 2). Без операций по кошелькам
        и проводок.
    ...
    - branch: Альтернатива — переуступка по сниженной цене (вне MVP)
      ...
      actor: backend
      description: >
        Альтернативный путь: вместо списания кооператив выступает
        поставщиком в новом Offer'е по сниженной цене (товар с истекшим
        сроком, но ещё пригодный к употреблению — например, накануне
        истечения). В MVP только помечен как Out of MVP; реализуется
        отдельным процессом в Phase 2 (использует механику p.mkt.supply
        с кооперативом в роли поставщика — FR5: кооператив автоматически
        в white list для перепоставки имущества).
...
`,c+=2;o+=i,n[c+2]===" "&&(o+="\\"),c+=1,a=c+1}break;default:c+=1}return o=a?o+n.slice(a):n,s?o:Qs(o,i,ws,Xs(t,!1))}function Gr(e,t){if(t.options.singleQuote===!1||t.implicitKey&&e.includes(`
`)||/[ \t]\n|\n[ \t]/.test(e))return Fn(e,t);const n=t.indent||(Zs(e)?"  ":""),s="'"+e.replace(/'/g,"''").replace(/\n+/g,`$&
${n}`)+"'";return t.implicitKey?s:Qs(s,n,Sc,Xs(t,!1))}function sn(e,t){const{singleQuote:n}=t.options;let s;if(n===!1)s=Fn;else{const r=e.includes('"'),i=e.includes("'");r&&!i?s=Gr:i&&!r?s=Fn:s=n?Gr:Fn}return s(e,t)}let zr;try{zr=new RegExp(`(^|(?<!
))
+(?!
|$)`,"g")}catch{zr=/\n+(?!\n|$)/g}function vs({comment:e,type:t,value:n},s,r,i){const{blockQuote:o,commentString:a,lineWidth:c}=s.options;if(!o||/\n[\t ]+$/.test(n))return sn(n,s);const l=s.indent||(s.forceBlockIndent||Zs(n)?"  ":""),u=o==="literal"?!0:o==="folded"||t===q.BLOCK_FOLDED?!1:t===q.BLOCK_LITERAL?!0:!nd(n,c,l.length);if(!n)return u?`|
`:`>
...
`)v=_;else break}let w=n.substring(0,v<_?v+1:_);w&&(n=n.substring(w.length),w=w.replace(/\n+/g,`$&${l}`));let A=(g?l?"2":"1":"")+p;if(e&&(A+=" "+a(e.replace(/ ?[\r\n]+/g," ")),r&&r()),!u){const L=n.replace(/\n+/g,`
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${l}`);let F=!1;const D=Xs(s,!0);o!=="folded"&&t!==q.BLOCK_FOLDED&&(D.onOverflow=()=>{F=!0});const x=Qs(`${w}${L}${d}`,l,qr,D);if(!F)return`>${A}
${l}${x}`}return n=n.replace(/\n+/g,`$&${l}`),`|${A}
...
`)),b<e.length-1?v+=",":t.options.trailingComma&&(t.options.lineWidth>0&&(l||(l=p.reduce((w,N)=>w+N.length+2,2)+(v.length+2)>t.options.lineWidth)),l&&(v+=",")),_&&(v+=Ut(v,s,a(_))),p.push(v),u=p.length}const{start:f,end:d}=n;if(p.length===0)return f+d;if(!l){const b=p.reduce((g,_)=>g+_.length+2,2);l=t.options.lineWidth>0&&b>t.options.lineWidth}if(l){let b=f;for(const g of p)b+=g?`
${i}${r}${g}`:`
`;return`${b}
${r}${d}`}else return`${f}${o}${p.join(" ")}${o}${d}`}function Cs({indent:e,options:{commentString:t}},n,s,r){if(s&&r&&(s=s.replace(/^\n+/,"")),s){const i=_t(t(s),e);n.push(i.trimStart())}}function Ft(e,t){const n=oe(t)?t.value:t;for(const s of e)if(fe(s)&&(s.key===t||s.key===n||oe(s.key)&&s.key.value===n))return s}class He extends kc{static get tagName(){return"tag:yaml.org,2002:map"}constructor(t){super(Pt,t),this.items=[]}static from(t,n,s){const{keepUndefined:r,replacer:i}=s,o=new this(t),a=(c,l)=>{if(typeof i=="function")l=i.call(n,c,l);else if(Array.isArray(i)&&!i.includes(c))return;(l!==void 0||r)&&o.items.push(wi(c,l,s))};if(n instanceof Map)for(const[c,l]of n)a(c,l);else if(n&&typeof n=="object")for(const c of Object.keys(n))a(c,n[c]);return typeof t.sortMapEntries=="function"&&o.items.sort(t.sortMapEntries),o}add(t,n){var o;let s;fe(t)?s=t:!t||typeof t!="object"||!("key"in t)?s=new Be(t,t==null?void 0:t.value):s=new Be(t.key,t.value);const r=Ft(this.items,s.key),i=(o=this.schema)==null?void 0:o.sortMapEntries;if(r){if(!n)throw new Error(`Key ${s.key} already set`);oe(r.value)&&vc(s.value)?r.value.value=s.value:r.value=s.value}else if(i){const a=this.items.findIndex(c=>i(s,c)<0);a===-1?this.items.push(s):this.items.splice(a,0,s)}else this.items.push(s)}delete(t){const n=Ft(this.items,t);return n?this.items.splice(this.items.indexOf(n),1).length>0:!1}get(t,n){const s=Ft(this.items,t),r=s==null?void 0:s.value;return(!n&&oe(r)?r.value:r)??void 0}has(t){return!!Ft(this.items,t)}set(t,n){this.add(new Be(t,n),!0)}toJSON(t,n,s){const r=s?new s:n!=null&&n.mapAsMap?new Map:{};n!=null&&n.onCreate&&n.onCreate(r);for(const i of this.items)Nc(n,r,i);return r}toString(t,n,s){if(!t)return JSON.stringify(this);for(const r of this.items)if(!fe(r))throw new Error(`Map items must all be pairs; found ${JSON.stringify(r)} instead`);return!t.allNullValues&&this.hasAllNullValues(!1)&&(t=Object.assign({},t,{allNullValues:!0})),Tc(this,t,{blockItemPrefix:"",flowChars:{start:"{",end:"}"},itemIndent:t.indent||"",onChompKeep:s,onComment:n})}}const vn={collection:"map",default:!0,nodeClass:He,tag:"tag:yaml.org,2002:map",resolve(e,t){return ns(e)||t("Expected a mapping for this tag"),e},createNode:(e,t,n)=>He.from(e,t,n)};class Ht extends kc{static get tagName(){return"tag:yaml.org,2002:seq"}constructor(t){super(bn,t),this.items=[]}add(t){this.items.push(t)}delete(t){const n=us(t);return typeof n!="number"?!1:this.items.splice(n,1).length>0}get(t,n){const s=us(t);if(typeof s!="number")return;const r=this.items[s];return!n&&oe(r)?r.value:r}has(t){const n=us(t);return typeof n=="number"&&n<this.items.length}set(t,n){const s=us(t);if(typeof s!="number")throw new Error(`Expected a valid index, not ${t}.`);const r=this.items[s];oe(r)&&vc(n)?r.value=n:this.items[s]=n}toJSON(t,n){const s=[];n!=null&&n.onCreate&&n.onCreate(s);let r=0;for(const i of this.items)s.push(qe(i,String(r++),n));return s}toString(t,n,s){return t?Tc(this,t,{blockItemPrefix:"- ",flowChars:{start:"[",end:"]"},itemIndent:(t.indent||"")+"  ",onChompKeep:s,onComment:n}):JSON.stringify(this)}static from(t,n,s){const{replacer:r}=s,i=new this(t);if(n&&Symbol.iterator in Object(n)){let o=0;for(let a of n){if(typeof r=="function"){const c=n instanceof Set?a:String(o++);a=r.call(n,c,a)}i.items.push(Jn(a,void 0,s))}}return i}}function us(e){let t=oe(e)?e.value:e;return t&&typeof t=="string"&&(t=Number(t)),typeof t=="number"&&Number.isInteger(t)&&t>=0?t:null}const kn={collection:"seq",default:!0,nodeClass:Ht,tag:"tag:yaml.org,2002:seq",resolve(e,t){return ss(e)||t("Expected a sequence for this tag"),e},createNode:(e,t,n)=>Ht.from(e,t,n)},er={identify:e=>typeof e=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:e=>e,stringify(e,t,n,s){return t=Object.assign({actualString:!0},t),bi(e,t,n,s)}},tr={identify:e=>e==null,createNode:()=>new q(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^(?:~|[Nn]ull|NULL)?$/,resolve:()=>new q(null),stringify:({source:e},t)=>typeof e=="string"&&tr.test.test(e)?e:t.options.nullStr},vi={identify:e=>typeof e=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:[Tt]rue|TRUE|[Ff]alse|FALSE)$/,resolve:e=>new q(e[0]==="t"||e[0]==="T"),stringify({source:e,value:t},n){if(e&&vi.test.test(e)){const s=e[0]==="t"||e[0]==="T";if(t===s)return e}return t?n.options.trueStr:n.options.falseStr}};function Ze({format:e,minFractionDigits:t,tag:n,value:s}){if(typeof s=="bigint")return String(s);const r=typeof s=="number"?s:Number(s);if(!isFinite(r))return isNaN(r)?".nan":r<0?"-.inf":".inf";let i=Object.is(s,-0)?"-0":JSON.stringify(s);if(!e&&t&&(!n||n==="tag:yaml.org,2002:float")&&/^\d/.test(i)){let o=i.indexOf(".");o<0&&(o=i.length,i+=".");let a=t-(i.length-o-1);for(;a-- >0;)i+="0"}return i}const Rc={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:e=>e.slice(-3).toLowerCase()==="nan"?NaN:e[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Ze},Ic={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:\.[0-9]+|[0-9]+(?:\.[0-9]*)?)[eE][-+]?[0-9]+$/,resolve:e=>parseFloat(e),stringify(e){const t=Number(e.value);return isFinite(t)?t.toExponential():Ze(e)}},Cc={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:\.[0-9]+|[0-9]+\.[0-9]*)$/,resolve(e){const t=new q(parseFloat(e)),n=e.indexOf(".");return n!==-1&&e[e.length-1]==="0"&&(t.minFractionDigits=e.length-n-1),t},stringify:Ze},nr=e=>typeof e=="bigint"||Number.isInteger(e),ki=(e,t,n,{intAsBigInt:s})=>s?BigInt(e):parseInt(e.substring(t),n);function Lc(e,t,n){const{value:s}=e;return nr(s)&&s>=0?n+s.toString(t):Ze(e)}const Pc={identify:e=>nr(e)&&e>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^0o[0-7]+$/,resolve:(e,t,n)=>ki(e,2,8,n),stringify:e=>Lc(e,8,"0o")},Mc={identify:nr,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9]+$/,resolve:(e,t,n)=>ki(e,0,10,n),stringify:Ze},Dc={identify:e=>nr(e)&&e>=0,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^0x[0-9a-fA-F]+$/,resolve:(e,t,n)=>ki(e,2,16,n),stringify:e=>Lc(e,16,"0x")},pd=[vn,kn,er,tr,vi,Pc,Mc,Dc,Rc,Ic,Cc];function Co(e){return typeof e=="bigint"||Number.isInteger(e)}const ps=({value:e})=>JSON.stringify(e),fd=[{identify:e=>typeof e=="string",default:!0,tag:"tag:yaml.org,2002:str",resolve:e=>e,stringify:ps},{identify:e=>e==null,createNode:()=>new q(null),default:!0,tag:"tag:yaml.org,2002:null",test:/^null$/,resolve:()=>null,stringify:ps},{identify:e=>typeof e=="boolean",default:!0,tag:"tag:yaml.org,2002:bool",test:/^true$|^false$/,resolve:e=>e==="true",stringify:ps},{identify:Co,default:!0,tag:"tag:yaml.org,2002:int",test:/^-?(?:0|[1-9][0-9]*)$/,resolve:(e,t,{intAsBigInt:n})=>n?BigInt(e):parseInt(e,10),stringify:({value:e})=>Co(e)?e.toString():JSON.stringify(e)},{identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^-?(?:0|[1-9][0-9]*)(?:\.[0-9]*)?(?:[eE][-+]?[0-9]+)?$/,resolve:e=>parseFloat(e),stringify:ps}],dd={default:!0,tag:"",test:/^/,resolve(e,t){return t(`Unresolved plain scalar ${JSON.stringify(e)}`),e}},hd=[vn,kn].concat(fd,dd),Si={identify:e=>e instanceof Uint8Array,default:!1,tag:"tag:yaml.org,2002:binary",resolve(e,t){if(typeof atob=="function"){const n=atob(e.replace(/[\n\r]/g,"")),s=new Uint8Array(n.length);for(let r=0;r<n.length;++r)s[r]=n.charCodeAt(r);return s}else return t("This environment does not support reading binary tags; either Buffer or atob is required"),e},stringify({comment:e,type:t,value:n},s,r,i){if(!n)return"";const o=n;let a;if(typeof btoa=="function"){let c="";for(let l=0;l<o.length;++l)c+=String.fromCharCode(o[l]);a=btoa(c)}else throw new Error("This environment does not support writing binary tags; either Buffer or btoa is required");if(t??(t=q.BLOCK_LITERAL),t!==q.QUOTE_DOUBLE){const c=Math.max(s.options.lineWidth-s.indent.length,s.options.minContentWidth),l=Math.ceil(a.length/c),u=new Array(l);for(let p=0,f=0;p<l;++p,f+=c)u[p]=a.substr(f,c);a=u.join(t===q.BLOCK_LITERAL?`
`:" ")}return bi({comment:e,type:t,value:a},s,r,i)}};function Bc(e,t){if(ss(e))for(let n=0;n<e.items.length;++n){let s=e.items[n];if(!fe(s)){if(ns(s)){s.items.length>1&&t("Each pair must have its own sequence indicator");const r=s.items[0]||new Be(new q(null));if(s.commentBefore&&(r.key.commentBefore=r.key.commentBefore?`${s.commentBefore}
${r.key.commentBefore}`:s.commentBefore),s.comment){const i=r.value??r.key;i.comment=i.comment?`${s.comment}
${i.comment}`:s.comment}s=r}e.items[n]=fe(s)?s:new Be(s)}}else t("Expected a sequence for this tag");return e}function xc(e,t,n){const{replacer:s}=n,r=new Ht(e);r.tag="tag:yaml.org,2002:pairs";let i=0;if(t&&Symbol.iterator in Object(t))for(let o of t){typeof s=="function"&&(o=s.call(t,String(i++),o));let a,c;if(Array.isArray(o))if(o.length===2)a=o[0],c=o[1];else throw new TypeError(`Expected [key, value] tuple: ${o}`);else if(o&&o instanceof Object){const l=Object.keys(o);if(l.length===1)a=l[0],c=o[a];else throw new TypeError(`Expected tuple with one key, not ${l.length} keys`)}else a=o;r.items.push(wi(a,c,n))}return r}const Ei={collection:"seq",default:!1,tag:"tag:yaml.org,2002:pairs",resolve:Bc,createNode:xc};class un extends Ht{constructor(){super(),this.add=He.prototype.add.bind(this),this.delete=He.prototype.delete.bind(this),this.get=He.prototype.get.bind(this),this.has=He.prototype.has.bind(this),this.set=He.prototype.set.bind(this),this.tag=un.tag}toJSON(t,n){if(!n)return super.toJSON(t);const s=new Map;n!=null&&n.onCreate&&n.onCreate(s);for(const r of this.items){let i,o;if(fe(r)?(i=qe(r.key,"",n),o=qe(r.value,i,n)):i=qe(r,"",n),s.has(i))throw new Error("Ordered maps must not include duplicate keys");s.set(i,o)}return s}static from(t,n,s){const r=xc(t,n,s),i=new this;return i.items=r.items,i}}un.tag="tag:yaml.org,2002:omap";const Oi={collection:"seq",identify:e=>e instanceof Map,nodeClass:un,default:!1,tag:"tag:yaml.org,2002:omap",resolve(e,t){const n=Bc(e,t),s=[];for(const{key:r}of n.items)oe(r)&&(s.includes(r.value)?t(`Ordered maps must not include duplicate keys: ${r.value}`):s.push(r.value));return Object.assign(new un,n)},createNode:(e,t,n)=>un.from(e,t,n)};function $c({value:e,source:t},n){return t&&(e?jc:Uc).test.test(t)?t:e?n.options.trueStr:n.options.falseStr}const jc={identify:e=>e===!0,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:Y|y|[Yy]es|YES|[Tt]rue|TRUE|[Oo]n|ON)$/,resolve:()=>new q(!0),stringify:$c},Uc={identify:e=>e===!1,default:!0,tag:"tag:yaml.org,2002:bool",test:/^(?:N|n|[Nn]o|NO|[Ff]alse|FALSE|[Oo]ff|OFF)$/,resolve:()=>new q(!1),stringify:$c},md={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^(?:[-+]?\.(?:inf|Inf|INF)|\.nan|\.NaN|\.NAN)$/,resolve:e=>e.slice(-3).toLowerCase()==="nan"?NaN:e[0]==="-"?Number.NEGATIVE_INFINITY:Number.POSITIVE_INFINITY,stringify:Ze},gd={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"EXP",test:/^[-+]?(?:[0-9][0-9_]*)?(?:\.[0-9_]*)?[eE][-+]?[0-9]+$/,resolve:e=>parseFloat(e.replace(/_/g,"")),stringify(e){const t=Number(e.value);return isFinite(t)?t.toExponential():Ze(e)}},yd={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",test:/^[-+]?(?:[0-9][0-9_]*)?\.[0-9_]*$/,resolve(e){const t=new q(parseFloat(e.replace(/_/g,""))),n=e.indexOf(".");if(n!==-1){const s=e.substring(n+1).replace(/_/g,"");s[s.length-1]==="0"&&(t.minFractionDigits=s.length)}return t},stringify:Ze},rs=e=>typeof e=="bigint"||Number.isInteger(e);function sr(e,t,n,{intAsBigInt:s}){const r=e[0];if((r==="-"||r==="+")&&(t+=1),e=e.substring(t).replace(/_/g,""),s){switch(n){case 2:e=`0b${e}`;break;case 8:e=`0o${e}`;break;case 16:e=`0x${e}`;break}const o=BigInt(e);return r==="-"?BigInt(-1)*o:o}const i=parseInt(e,n);return r==="-"?-1*i:i}function Ai(e,t,n){const{value:s}=e;if(rs(s)){const r=s.toString(t);return s<0?"-"+n+r.substr(1):n+r}return Ze(e)}const _d={identify:rs,default:!0,tag:"tag:yaml.org,2002:int",format:"BIN",test:/^[-+]?0b[0-1_]+$/,resolve:(e,t,n)=>sr(e,2,2,n),stringify:e=>Ai(e,2,"0b")},bd={identify:rs,default:!0,tag:"tag:yaml.org,2002:int",format:"OCT",test:/^[-+]?0[0-7_]+$/,resolve:(e,t,n)=>sr(e,1,8,n),stringify:e=>Ai(e,8,"0")},wd={identify:rs,default:!0,tag:"tag:yaml.org,2002:int",test:/^[-+]?[0-9][0-9_]*$/,resolve:(e,t,n)=>sr(e,0,10,n),stringify:Ze},vd={identify:rs,default:!0,tag:"tag:yaml.org,2002:int",format:"HEX",test:/^[-+]?0x[0-9a-fA-F_]+$/,resolve:(e,t,n)=>sr(e,2,16,n),stringify:e=>Ai(e,16,"0x")};class pn extends He{constructor(t){super(t),this.tag=pn.tag}add(t){let n;fe(t)?n=t:t&&typeof t=="object"&&"key"in t&&"value"in t&&t.value===null?n=new Be(t.key,null):n=new Be(t,null),Ft(this.items,n.key)||this.items.push(n)}get(t,n){const s=Ft(this.items,t);return!n&&fe(s)?oe(s.key)?s.key.value:s.key:s}set(t,n){if(typeof n!="boolean")throw new Error(`Expected boolean value for set(key, value) in a YAML set, not ${typeof n}`);const s=Ft(this.items,t);s&&!n?this.items.splice(this.items.indexOf(s),1):!s&&n&&this.items.push(new Be(t))}toJSON(t,n){return super.toJSON(t,n,Set)}toString(t,n,s){if(!t)return JSON.stringify(this);if(this.hasAllNullValues(!0))return super.toString(Object.assign({},t,{allNullValues:!0}),n,s);throw new Error("Set items must all have null values")}static from(t,n,s){const{replacer:r}=s,i=new this(t);if(n&&Symbol.iterator in Object(n))for(let o of n)typeof r=="function"&&(o=r.call(n,o,o)),i.items.push(wi(o,null,s));return i}}pn.tag="tag:yaml.org,2002:set";const Ni={collection:"map",identify:e=>e instanceof Set,nodeClass:pn,default:!1,tag:"tag:yaml.org,2002:set",createNode:(e,t,n)=>pn.from(e,t,n),resolve(e,t){if(ns(e)){if(e.hasAllNullValues(!0))return Object.assign(new pn,e);t("Set items must all have null values")}else t("Expected a mapping for this tag");return e}};function Ti(e,t){const n=e[0],s=n==="-"||n==="+"?e.substring(1):e,r=o=>t?BigInt(o):Number(o),i=s.replace(/_/g,"").split(":").reduce((o,a)=>o*r(60)+r(a),r(0));return n==="-"?r(-1)*i:i}function Fc(e){let{value:t}=e,n=o=>o;if(typeof t=="bigint")n=o=>BigInt(o);else if(isNaN(t)||!isFinite(t))return Ze(e);let s="";t<0&&(s="-",t*=n(-1));const r=n(60),i=[t%r];return t<60?i.unshift(0):(t=(t-i[0])/r,i.unshift(t%r),t>=60&&(t=(t-i[0])/r,i.unshift(t))),s+i.map(o=>String(o).padStart(2,"0")).join(":").replace(/000000\d*$/,"")}const Kc={identify:e=>typeof e=="bigint"||Number.isInteger(e),default:!0,tag:"tag:yaml.org,2002:int",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+$/,resolve:(e,t,{intAsBigInt:n})=>Ti(e,n),stringify:Fc},Vc={identify:e=>typeof e=="number",default:!0,tag:"tag:yaml.org,2002:float",format:"TIME",test:/^[-+]?[0-9][0-9_]*(?::[0-5]?[0-9])+\.[0-9_]*$/,resolve:e=>Ti(e,!1),stringify:Fc},rr={identify:e=>e instanceof Date,default:!0,tag:"tag:yaml.org,2002:timestamp",test:RegExp("^([0-9]{4})-([0-9]{1,2})-([0-9]{1,2})(?:(?:t|T|[ \\t]+)([0-9]{1,2}):([0-9]{1,2}):([0-9]{1,2}(\\.[0-9]+)?)(?:[ \\t]*(Z|[-+][012]?[0-9](?::[0-9]{2})?))?)?$"),resolve(e){const t=e.match(rr.test);if(!t)throw new Error("!!timestamp expects a date, starting with yyyy-mm-dd");const[,n,s,r,i,o,a]=t.map(Number),c=t[7]?Number((t[7]+"00").substr(1,3)):0;let l=Date.UTC(n,s-1,r,i||0,o||0,a||0,c);const u=t[8];if(u&&u!=="Z"){let p=Ti(u,!1);Math.abs(p)<30&&(p*=60),l-=6e4*p}return new Date(l)},stringify:({value:e})=>(e==null?void 0:e.toISOString().replace(/(T00:00:00)?\.000Z$/,""))??""},Lo=[vn,kn,er,tr,jc,Uc,_d,bd,wd,vd,md,gd,yd,Si,bt,Oi,Ei,Ni,Kc,Vc,rr],Po=new Map([["core",pd],["failsafe",[vn,kn,er]],["json",hd],["yaml11",Lo],["yaml-1.1",Lo]]),Mo={binary:Si,bool:vi,float:Cc,floatExp:Ic,floatNaN:Rc,floatTime:Vc,int:Mc,intHex:Dc,intOct:Pc,intTime:Kc,map:vn,merge:bt,null:tr,omap:Oi,pairs:Ei,seq:kn,set:Ni,timestamp:rr},kd={"tag:yaml.org,2002:binary":Si,"tag:yaml.org,2002:merge":bt,"tag:yaml.org,2002:omap":Oi,"tag:yaml.org,2002:pairs":Ei,"tag:yaml.org,2002:set":Ni,"tag:yaml.org,2002:timestamp":rr};function kr(e,t,n){const s=Po.get(t);if(s&&!e)return n&&!s.includes(bt)?s.concat(bt):s.slice();let r=s;if(!r)if(Array.isArray(e))r=[];else{const i=Array.from(Po.keys()).filter(o=>o!=="yaml11").map(o=>JSON.stringify(o)).join(", ");throw new Error(`Unknown schema "${t}"; use one of ${i} or define customTags array`)}if(Array.isArray(e))for(const i of e)r=r.concat(i);else typeof e=="function"&&(r=e(r.slice()));return n&&(r=r.concat(bt)),r.reduce((i,o)=>{const a=typeof o=="string"?Mo[o]:o;if(!a){const c=JSON.stringify(o),l=Object.keys(Mo).map(u=>JSON.stringify(u)).join(", ");throw new Error(`Unknown custom tag ${c}; use one of ${l}`)}return i.includes(a)||i.push(a),i},[])}const Sd=(e,t)=>e.key<t.key?-1:e.key>t.key?1:0;class Ri{constructor({compat:t,customTags:n,merge:s,resolveKnownTags:r,schema:i,sortMapEntries:o,toStringDefaults:a}){this.compat=Array.isArray(t)?kr(t,"compat"):t?kr(null,t):null,this.name=typeof i=="string"&&i||"core",this.knownTags=r?kd:{},this.tags=kr(n,this.name,s),this.toStringOptions=a??null,Object.defineProperty(this,Pt,{value:vn}),Object.defineProperty(this,pt,{value:er}),Object.defineProperty(this,bn,{value:kn}),this.sortMapEntries=typeof o=="function"?o:o===!0?Sd:null}clone(){const t=Object.create(Ri.prototype,Object.getOwnPropertyDescriptors(this));return t.tags=this.tags.slice(),t}}function Ed(e,t){var c;const n=[];let s=t.directives===!0;if(t.directives!==!1&&e.directives){const l=e.directives.toString(e);l?(n.push(l),s=!0):e.directives.docStart&&(s=!0)}s&&n.push("---");const r=Ec(e,t),{commentString:i}=r.options;if(e.commentBefore){n.length!==1&&n.unshift("");const l=i(e.commentBefore);n.unshift(_t(l,""))}let o=!1,a=null;if(e.contents){if(ue(e.contents)){if(e.contents.spaceBefore&&s&&n.push(""),e.contents.commentBefore){const p=i(e.contents.commentBefore);n.push(_t(p,""))}r.forceBlockIndent=!!e.comment,a=e.contents.comment}const l=a?void 0:()=>o=!0;let u=yn(e.contents,r,()=>a=null,l);a&&(u+=Ut(u,"",i(a))),(u[0]==="|"||u[0]===">")&&n[n.length-1]==="---"?n[n.length-1]=`--- ${u}`:n.push(u)}else n.push(yn(e.contents,r));if((c=e.directives)!=null&&c.docEnd)if(e.comment){const l=i(e.comment);l.includes(`
...
${o}
${l}
`}};function _n(e,{flow:t,indicator:n,next:s,offset:r,onError:i,parentIndent:o,startOnNewline:a}){let c=!1,l=a,u=a,p="",f="",d=!1,b=!1,g=null,_=null,v=null,w=null,N=null,A=null,L=null;for(const x of e)switch(b&&(x.type!=="space"&&x.type!=="newline"&&x.type!=="comma"&&i(x.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),b=!1),g&&(l&&x.type!=="comment"&&x.type!=="newline"&&i(g,"TAB_AS_INDENT","Tabs are not allowed as indentation"),g=null),x.type){case"space":!t&&(n!=="doc-start"||(s==null?void 0:s.type)!=="flow-collection")&&x.source.includes("	")&&(g=x),u=!0;break;case"comment":{u||i(x,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const G=x.source.substring(1)||" ";p?p+=f+G:p=G,f="",l=!1;break}case"newline":l?p?p+=x.source:(!A||n!=="seq-item-ind")&&(c=!0):f+=x.source,l=!0,d=!0,(_||v)&&(w=x),u=!0;break;case"anchor":_&&i(x,"MULTIPLE_ANCHORS","A node can have at most one anchor"),x.source.endsWith(":")&&i(x.offset+x.source.length-1,"BAD_ALIAS","Anchor ending in : is ambiguous",!0),_=x,L??(L=x.offset),l=!1,u=!1,b=!0;break;case"tag":{v&&i(x,"MULTIPLE_TAGS","A node can have at most one tag"),v=x,L??(L=x.offset),l=!1,u=!1,b=!0;break}case n:(_||v)&&i(x,"BAD_PROP_ORDER",`Anchors and tags must be after the ${x.source} indicator`),A&&i(x,"UNEXPECTED_TOKEN",`Unexpected ${x.source} in ${t??"collection"}`),A=x,l=n==="seq-item-ind"||n==="explicit-key-ind",u=!1;break;case"comma":if(t){N&&i(x,"UNEXPECTED_TOKEN",`Unexpected , in ${t}`),N=x,l=!1,u=!1;break}default:i(x,"UNEXPECTED_TOKEN",`Unexpected ${x.type} token`),l=!1,u=!1}const F=e[e.length-1],D=F?F.offset+F.source.length:r;return b&&s&&s.type!=="space"&&s.type!=="newline"&&s.type!=="comma"&&(s.type!=="scalar"||s.source!=="")&&i(s.offset,"MISSING_CHAR","Tags and anchors must be separated from the next token by white space"),g&&(l&&g.indent<=o||(s==null?void 0:s.type)==="block-map"||(s==null?void 0:s.type)==="block-seq")&&i(g,"TAB_AS_INDENT","Tabs are not allowed as indentation"),{comma:N,found:A,spaceBefore:c,comment:p,hasNewline:d,anchor:_,tag:v,newlineAfterProp:w,end:D,start:L??D}}function Qn(e){if(!e)return null;switch(e.type){case"alias":case"scalar":case"double-quoted-scalar":case"single-quoted-scalar":if(e.source.includes(`
`))return!0;if(e.end){for(const t of e.end)if(t.type==="newline")return!0}return!1;case"flow-collection":for(const t of e.items){for(const n of t.start)if(n.type==="newline")return!0;if(t.sep){for(const n of t.sep)if(n.type==="newline")return!0}if(Qn(t.key)||Qn(t.value))return!0}return!1;default:return!0}}function Yr(e,t,n){if((t==null?void 0:t.type)==="flow-collection"){const s=t.end[0];s.indent===e&&(s.source==="]"||s.source==="}")&&Qn(t)&&n(s,"BAD_INDENT","Flow end indicator should be more indented than parent",!0)}}function qc(e,t,n){const{uniqueKeys:s}=e.options;if(s===!1)return!1;const r=typeof s=="function"?s:(i,o)=>i===o||oe(i)&&oe(o)&&i.value===o.value;return t.some(i=>r(i.key,n))}const Bo="All mapping items must start at the same column";function Ad({composeNode:e,composeEmptyNode:t},n,s,r,i){var u;const o=(i==null?void 0:i.nodeClass)??He,a=new o(n.schema);n.atRoot&&(n.atRoot=!1);let c=s.offset,l=null;for(const p of s.items){const{start:f,key:d,sep:b,value:g}=p,_=_n(f,{indicator:"explicit-key-ind",next:d??(b==null?void 0:b[0]),offset:c,onError:r,parentIndent:s.indent,startOnNewline:!0}),v=!_.found;if(v){if(d&&(d.type==="block-seq"?r(c,"BLOCK_AS_IMPLICIT_KEY","A block sequence may not be used as an implicit map key"):"indent"in d&&d.indent!==s.indent&&r(c,"BAD_INDENT",Bo)),!_.anchor&&!_.tag&&!b){l=_.end,_.comment&&(a.comment?a.comment+=`
`+_.comment:a.comment=_.comment);continue}(_.newlineAfterProp||Qn(d))&&r(d??f[f.length-1],"MULTILINE_IMPLICIT_KEY","Implicit keys need to be on a single line")}else((u=_.found)==null?void 0:u.indent)!==s.indent&&r(c,"BAD_INDENT",Bo);n.atKey=!0;const w=_.end,N=d?e(n,d,_,r):t(n,w,f,null,_,r);n.schema.compat&&Yr(s.indent,d,r),n.atKey=!1,qc(n,a.items,N)&&r(w,"DUPLICATE_KEY","Map keys must be unique");const A=_n(b??[],{indicator:"map-value-ind",next:g,offset:N.range[2],onError:r,parentIndent:s.indent,startOnNewline:!d||d.type==="block-scalar"});if(c=A.end,A.found){v&&((g==null?void 0:g.type)==="block-map"&&!A.hasNewline&&r(c,"BLOCK_AS_IMPLICIT_KEY","Nested mappings are not allowed in compact mappings"),n.options.strict&&_.start<A.found.offset-1024&&r(N.range,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit block mapping key"));const L=g?e(n,g,A,r):t(n,c,b,null,A,r);n.schema.compat&&Yr(s.indent,g,r),c=L.range[2];const F=new Be(N,L);n.options.keepSourceTokens&&(F.srcToken=p),a.items.push(F)}else{v&&r(N.range,"MISSING_CHAR","Implicit map keys need to be followed by map values"),A.comment&&(N.comment?N.comment+=`
`+A.comment:N.comment=A.comment);const L=new Be(N);n.options.keepSourceTokens&&(L.srcToken=p),a.items.push(L)}}return l&&l<c&&r(l,"IMPOSSIBLE","Map comment with trailing content"),a.range=[s.offset,c,l??c],a}function Nd({composeNode:e,composeEmptyNode:t},n,s,r,i){const o=(i==null?void 0:i.nodeClass)??Ht,a=new o(n.schema);n.atRoot&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let c=s.offset,l=null;for(const{start:u,value:p}of s.items){const f=_n(u,{indicator:"seq-item-ind",next:p,offset:c,onError:r,parentIndent:s.indent,startOnNewline:!0});if(!f.found)if(f.anchor||f.tag||p)(p==null?void 0:p.type)==="block-seq"?r(f.end,"BAD_INDENT","All sequence items must start at the same column"):r(c,"MISSING_CHAR","Sequence item without - indicator");else{l=f.end,f.comment&&(a.comment=f.comment);continue}const d=p?e(n,p,f,r):t(n,f.end,u,null,f,r);n.schema.compat&&Yr(s.indent,p,r),c=d.range[2],a.items.push(d)}return a.range=[s.offset,c,l??c],a}function is(e,t,n,s){let r="";if(e){let i=!1,o="";for(const a of e){const{source:c,type:l}=a;switch(l){case"space":i=!0;break;case"comment":{n&&!i&&s(a,"MISSING_CHAR","Comments must be separated from other tokens by white space characters");const u=c.substring(1)||" ";r?r+=o+u:r=u,o="";break}case"newline":r&&(o+=c),i=!0;break;default:s(a,"UNEXPECTED_TOKEN",`Unexpected ${l} at node end`)}t+=c.length}}return{comment:r,offset:t}}const Sr="Block collections are not allowed within flow collections",Er=e=>e&&(e.type==="block-map"||e.type==="block-seq");function Td({composeNode:e,composeEmptyNode:t},n,s,r,i){var _;const o=s.start.source==="{",a=o?"flow map":"flow sequence",c=(i==null?void 0:i.nodeClass)??(o?He:Ht),l=new c(n.schema);l.flow=!0;const u=n.atRoot;u&&(n.atRoot=!1),n.atKey&&(n.atKey=!1);let p=s.offset+s.start.source.length;for(let v=0;v<s.items.length;++v){const w=s.items[v],{start:N,key:A,sep:L,value:F}=w,D=_n(N,{flow:a,indicator:"explicit-key-ind",next:A??(L==null?void 0:L[0]),offset:p,onError:r,parentIndent:s.indent,startOnNewline:!1});if(!D.found){if(!D.anchor&&!D.tag&&!L&&!F){v===0&&D.comma?r(D.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${a}`):v<s.items.length-1&&r(D.start,"UNEXPECTED_TOKEN",`Unexpected empty item in ${a}`),D.comment&&(l.comment?l.comment+=`
`+D.comment:l.comment=D.comment),p=D.end;continue}!o&&n.options.strict&&Qn(A)&&r(A,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line")}if(v===0)D.comma&&r(D.comma,"UNEXPECTED_TOKEN",`Unexpected , in ${a}`);else if(D.comma||r(D.start,"MISSING_CHAR",`Missing , between ${a} items`),D.comment){let x="";e:for(const G of N)switch(G.type){case"comma":case"space":break;case"comment":x=G.source.substring(1);break e;default:break e}if(x){let G=l.items[l.items.length-1];fe(G)&&(G=G.value??G.key),G.comment?G.comment+=`
`+x:G.comment=x,D.comment=D.comment.substring(x.length+1)}}if(!o&&!L&&!D.found){const x=F?e(n,F,D,r):t(n,D.end,L,null,D,r);l.items.push(x),p=x.range[2],Er(F)&&r(x.range,"BLOCK_IN_FLOW",Sr)}else{n.atKey=!0;const x=D.end,G=A?e(n,A,D,r):t(n,x,N,null,D,r);Er(A)&&r(G.range,"BLOCK_IN_FLOW",Sr),n.atKey=!1;const ne=_n(L??[],{flow:a,indicator:"map-value-ind",next:F,offset:G.range[2],onError:r,parentIndent:s.indent,startOnNewline:!1});if(ne.found){if(!o&&!D.found&&n.options.strict){if(L)for(const ae of L){if(ae===ne.found)break;if(ae.type==="newline"){r(ae,"MULTILINE_IMPLICIT_KEY","Implicit keys of flow sequence pairs need to be on a single line");break}}D.start<ne.found.offset-1024&&r(ne.found,"KEY_OVER_1024_CHARS","The : indicator must be at most 1024 chars after the start of an implicit flow sequence key")}}else F&&("source"in F&&((_=F.source)==null?void 0:_[0])===":"?r(F,"MISSING_CHAR",`Missing space after : in ${a}`):r(ne.start,"MISSING_CHAR",`Missing , or : between ${a} items`));const _e=F?e(n,F,ne,r):ne.found?t(n,ne.end,L,null,ne,r):null;_e?Er(F)&&r(_e.range,"BLOCK_IN_FLOW",Sr):ne.comment&&(G.comment?G.comment+=`
`+ne.comment:G.comment=ne.comment);const he=new Be(G,_e);if(n.options.keepSourceTokens&&(he.srcToken=w),o){const ae=l;qc(n,ae.items,G)&&r(x,"DUPLICATE_KEY","Map keys must be unique"),ae.items.push(he)}else{const ae=new He(n.schema);ae.flow=!0,ae.items.push(he);const Ot=(_e??G).range;ae.range=[G.range[0],Ot[1],Ot[2]],l.items.push(ae)}p=_e?_e.range[2]:ne.end}}const f=o?"}":"]",[d,...b]=s.end;let g=p;if((d==null?void 0:d.source)===f)g=d.offset+d.source.length;else{const v=a[0].toUpperCase()+a.substring(1),w=u?`${v} must end with a ${f}`:`${v} in block collection must be sufficiently indented and end with a ${f}`;r(p,u?"MISSING_CHAR":"BAD_INDENT",w),d&&d.source.length!==1&&b.unshift(d)}if(b.length>0){const v=is(b,g,n.options.strict,r);v.comment&&(l.comment?l.comment+=`
`+v.comment:l.comment=v.comment),l.range=[s.offset,g,v.offset]}else l.range=[s.offset,g,g];return l}function Or(e,t,n,s,r,i){const o=n.type==="block-map"?Ad(e,t,n,s,i):n.type==="block-seq"?Nd(e,t,n,s,i):Td(e,t,n,s,i),a=o.constructor;return r==="!"||r===a.tagName?(o.tag=a.tagName,o):(r&&(o.tag=r),o)}function Rd(e,t,n,s,r){var f;const i=s.tag,o=i?t.directives.tagName(i.source,d=>r(i,"TAG_RESOLVE_FAILED",d)):null;if(n.type==="block-seq"){const{anchor:d,newlineAfterProp:b}=s,g=d&&i?d.offset>i.offset?d:i:d??i;g&&(!b||b.offset<g.offset)&&r(g,"MISSING_CHAR","Missing newline after block sequence props")}const a=n.type==="block-map"?"map":n.type==="block-seq"?"seq":n.start.source==="{"?"map":"seq";if(!i||!o||o==="!"||o===He.tagName&&a==="map"||o===Ht.tagName&&a==="seq")return Or(e,t,n,r,o);let c=t.schema.tags.find(d=>d.tag===o&&d.collection===a);if(!c){const d=t.schema.knownTags[o];if((d==null?void 0:d.collection)===a)t.schema.tags.push(Object.assign({},d,{default:!1})),c=d;else return d?r(i,"BAD_COLLECTION_TYPE",`${d.tag} used for ${a} collection, but expects ${d.collection??"scalar"}`,!0):r(i,"TAG_RESOLVE_FAILED",`Unresolved tag: ${o}`,!0),Or(e,t,n,r,o)}const l=Or(e,t,n,r,o,c),u=((f=c.resolve)==null?void 0:f.call(c,l,d=>r(i,"TAG_RESOLVE_FAILED",d),t.options))??l,p=ue(u)?u:new q(u);return p.range=l.range,p.tag=o,c!=null&&c.format&&(p.format=c.format),p}function Id(e,t,n){const s=t.offset,r=Cd(t,e.options.strict,n);if(!r)return{value:"",type:null,comment:"",range:[s,s,s]};const i=r.mode===">"?q.BLOCK_FOLDED:q.BLOCK_LITERAL,o=t.source?Ld(t.source):[];let a=o.length;for(let g=o.length-1;g>=0;--g){const _=o[g][1];if(_===""||_==="\r")a=g;else break}if(a===0){const g=r.chomp==="+"&&o.length>0?`
...
`;for(let g=u;g<a;++g){let[_,v]=o[g];l+=_.length+v.length+1;const w=v[v.length-1]==="\r";if(w&&(v=v.slice(0,-1)),v&&_.length<c){const A=`Block scalar lines must not be less indented than their ${r.indent?"explicit indentation indicator":"first line"}`;n(l-v.length-(w?2:1),"BAD_INDENT",A),_=""}i===q.BLOCK_LITERAL?(p+=f+_.slice(c)+v,f=`
`):_.length>c||v[0]==="	"?(f===" "?f=`
`:!d&&f===`
`&&(f=`
