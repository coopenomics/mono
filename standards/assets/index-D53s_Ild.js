...
$&`).replace(/(?:^|\n)([\t ].*)(?:([\n\t ]*)\n(?![\n\t ]))?/g,"$1$2").replace(/\n+/g,`$&${l}`);let F=!1;const D=Xs(s,!0);o!=="folded"&&t!==q.BLOCK_FOLDED&&(D.onOverflow=()=>{F=!0});const B=Qs(`${w}${L}${d}`,l,qr,D);if(!F)return`>${A}
...
`):F+=`
${n.indent}`}else if(!d&&le(t)){const D=L[0],B=L.indexOf(`
`),G=B!==-1,ne=n.inFlow??t.flow??t.items.length===0;if(G||!ne){let _e=!1;if(G&&(D==="&"||D==="!")){let he=L.indexOf(" ");D==="&"&&he!==-1&&he<B&&L[he+1]==="!"&&(he=L.indexOf(" ",he+1)),(he===-1||B<he)&&(_e=!0)}_e||(F=`
${n.indent}`)}}else(L===""||L[0]===`
...
`:`
`)+(o.substring(1)||" "),n=!0,s=!1;break;case"%":((r=e[i+1])==null?void 0:r[0])!=="#"&&(i+=1),n=!1;break;default:n||(s=!0),n=!1}}return{comment:t,afterEmptyLine:s}}class Gd{constructor(t={}){this.doc=null,this.atDirectives=!1,this.prelude=[],this.errors=[],this.warnings=[],this.onError=(n,s,r,i)=>{const o=Nn(n);i?this.warnings.push(new Od(o,s,r)):this.errors.push(new In(o,s,r))},this.directives=new Re({version:t.version||"1.2"}),this.options=t}decorate(t,n){const{comment:s,afterEmptyLine:r}=Bo(this.prelude);if(s){const i=t.contents;if(n)t.comment=t.comment?`${t.comment}
